...
; GFX11-NEXT:  ; %bb.1: ; %Flow
; GFX11-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s11
...
; SI:       ; %bb.0:
; SI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-NEXT:    s_mov_b32 s5, s25
; SI-NEXT:    s_mov_b32 s4, s24
; SI-NEXT:    s_mov_b32 s7, s23
; SI-NEXT:    s_mov_b32 s6, s22
; SI-NEXT:    s_mov_b32 s9, s21
; SI-NEXT:    s_mov_b32 s8, s20
; SI-NEXT:    s_mov_b32 s11, s19
; SI-NEXT:    s_mov_b32 s10, s18
; SI-NEXT:    s_mov_b32 s13, s17
; SI-NEXT:    s_mov_b32 s12, s16
; SI-NEXT:    s_cmp_lg_u32 s27, 0
...
; SI-NEXT:    s_lshr_b64 s[18:19], s[26:27], 16
...
; SI-NEXT:    s_lshl_b32 s15, s22, 16
; SI-NEXT:    s_or_b32 s10, s10, s15
; SI-NEXT:    s_and_b32 s11, s11, 0xffff
; SI-NEXT:    s_lshl_b32 s15, s42, 16
...
; SI-NEXT:    v_lshlrev_b32_e32 v30, 16, v20
; SI-NEXT:    v_lshlrev_b32_e32 v29, 16, v19
...
; SI-NEXT:  ; %bb.1: ; %cmp.false
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_or_b32_e32 v11, v0, v32
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v1
; SI-NEXT:    v_or_b32_e32 v12, v0, v31
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v2
; SI-NEXT:    v_or_b32_e32 v13, v0, v30
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v3
; SI-NEXT:    v_or_b32_e32 v14, v0, v29
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v4
; SI-NEXT:    v_or_b32_e32 v15, v0, v28
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; SI-NEXT:    v_or_b32_e32 v16, v0, v27
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v6
; SI-NEXT:    v_or_b32_e32 v17, v0, v26
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v7
; SI-NEXT:    v_or_b32_e32 v18, v0, v25
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v8
; SI-NEXT:    v_or_b32_e32 v19, v0, v24
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v9
; SI-NEXT:    v_or_b32_e32 v20, v0, v23
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v10
; SI-NEXT:    v_or_b32_e32 v21, v0, v22
...
; SI-NEXT:    v_or_b32_e32 v15, v2, v0
...
; SI-NEXT:    v_add_f32_e32 v3, 0x38000000, v3
; SI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; SI-NEXT:    v_or_b32_e32 v18, v2, v0
...
; SI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; SI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; SI-NEXT:    v_or_b32_e32 v20, v1, v0
; SI-NEXT:    v_lshlrev_b32_e32 v0, 16, v2
; SI-NEXT:    v_or_b32_e32 v21, v3, v0
; SI-NEXT:  .LBB10_4: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    v_mov_b32_e32 v0, v11
; SI-NEXT:    v_mov_b32_e32 v1, v12
...
; VI-NEXT:    v_add_f16_sdwa v1, v1, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v11, s5, v0
...
; SI-NEXT:    v_add_f32_e64 v5, s9, 1.0
; SI-NEXT:    v_add_f32_e64 v4, s8, 1.0
; SI-NEXT:    v_add_f32_e64 v9, s5, 1.0
; SI-NEXT:    v_add_f32_e64 v8, s4, 1.0
; SI-NEXT:    v_add_f32_e64 v3, s11, 1.0
; SI-NEXT:    v_add_f32_e64 v2, s10, 1.0
...
; SI-NEXT:    v_add_f32_e64 v1, s13, 1.0
; SI-NEXT:    v_add_f32_e64 v0, s12, 1.0
...
; VI-NEXT:    v_add_f16_e32 v3, s14, v0
...
; VI-NEXT:    v_mov_b32_e32 v2, s6
; VI-NEXT:    v_add_f16_e32 v11, s4, v0
