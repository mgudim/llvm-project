...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, 0x3800, v2.l ; encoding: [0x00,0x00,0x05,0xd7,0xff,0x04,0x02,0x02,0x00,0x38,0x00,0x00]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, 0xb800, v2.l ; encoding: [0x00,0x00,0x05,0xd7,0xff,0x04,0x02,0x02,0x00,0xb8,0xff,0xff]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, 0x3c00, v2.l ; encoding: [0x00,0x00,0x05,0xd7,0xff,0x04,0x02,0x02,0x00,0x3c,0x00,0x00]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, 0xbc00, v2.l ; encoding: [0x00,0x00,0x05,0xd7,0xff,0x04,0x02,0x02,0x00,0xbc,0xff,0xff]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v0.l, v2.l, 0x4000 ; encoding: [0x00,0x00,0x38,0xd7,0x02,0xff,0x01,0x02,0x00,0x40,0x00,0x00]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_lshlrev_b16 v0.l, v2.l, 0xc000 ; encoding: [0x00,0x00,0x38,0xd7,0x02,0xff,0x01,0x02,0x00,0xc0,0xff,0xff]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, 0x4400, v2.l ; encoding: [0x00,0x00,0x05,0xd7,0xff,0x04,0x02,0x02,0x00,0x44,0x00,0x00]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, 0xc400, v2.l ; encoding: [0x00,0x00,0x05,0xd7,0xff,0x04,0x02,0x02,0x00,0xc4,0xff,0xff]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0) ; encoding: [0x00,0x00,0x89,0xbf]
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0 ; encoding: [0x01,0x01,0x10,0xca,0x00,0x01,0x02,0x04]
; GFX11-TRUE16-NEXT:    v_mul_lo_u16 v0.l, 0x3118, v2.l ; encoding: [0x00,0x00,0x05,0xd7,0xff,0x04,0x02,0x02,0x18,0x31,0x00,0x00]
; GFX11-TRUE16-NEXT:    global_store_b16 v[3:4], v0, off ; encoding: [0x00,0x00,0x66,0xdc,0x03,0x00,0x7c,0x00]
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31] ; encoding: [0x1e,0x48,0x80,0xbe]
;
