...
; GFX10-NEXT:    v_max_f64 v[0:1], s[6:7], s[4:5]
...
; GFX7-NEXT:    v_max_f64 v[2:3], s[8:9], v[0:1]
...
; GFX7-NEXT:    v_max_f64 v[4:5], s[10:11], v[0:1]
...
; GFX900-NEXT:    v_max_f64 v[2:3], s[8:9], v[0:1]
...
; GFX900-NEXT:    v_max_f64 v[4:5], s[10:11], v[0:1]
...
; GFX10-NEXT:    v_max_f64 v[0:1], s[8:9], s[4:5]
; GFX10-NEXT:    v_cmp_u_f64_e64 s4, s[8:9], s[4:5]
; GFX10-NEXT:    v_max_f64 v[4:5], s[10:11], s[6:7]
...
; GFX11-NEXT:    v_max_f64 v[0:1], s[2:3], s[4:5]
...
; GFX1170-NEXT:    v_maximum_f64 v[2:3], s[2:3], s[4:5]
; GFX1170-NEXT:    v_maximum_f64 v[0:1], s[0:1], s[6:7]
; GFX1170-NEXT:    ;;#ASMSTART
...
; GFX12-NEXT:    v_maximum_f64 v[2:3], s[2:3], s[4:5]
