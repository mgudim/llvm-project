...
; CHECK-NEXT:    buffer_atomic_add_f32 v0, v[1:2], s[4:7], s20 idxen offen offset:24
...
; CHECK-NEXT:    s_mov_b32 s5, s17
; CHECK-NEXT:    s_mov_b32 s4, s16
; CHECK-NEXT:    buffer_atomic_add_f32 v0, v1, s[4:7], s20 idxen
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    s_mov_b32 s5, s17
; CHECK-NEXT:    s_mov_b32 s4, s16
; CHECK-NEXT:    buffer_atomic_add_f32 v0, v[1:2], s[4:7], s20 idxen offen slc
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    s_mov_b32 s5, s17
; CHECK-NEXT:    s_mov_b32 s4, s16
; CHECK-NEXT:    buffer_atomic_pk_add_f16 v0, v[1:2], s[4:7], s20 idxen offen offset:24
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
  %voffset.add = add i32 %voffset, 24
