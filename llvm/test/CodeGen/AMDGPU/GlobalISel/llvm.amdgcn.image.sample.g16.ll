...
; GFX10-NEXT:    v_mov_b32_e32 v12, v6
; GFX10-NEXT:    v_mov_b32_e32 v13, v7
; GFX10-NEXT:    v_lshl_or_b32 v9, v2, 16, v0
; GFX10-NEXT:    v_lshl_or_b32 v10, v4, 16, v1
; GFX10-NEXT:    image_sample_c_d_cl_g16 v[0:3], v[8:13], s[0:7], s[8:11] dmask:0xf dim:SQ_RSRC_IMG_2D
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    ; return to shader part epilog
;
...
; GFX10-NEXT:    v_mov_b32_e32 v13, v6
; GFX10-NEXT:    v_mov_b32_e32 v14, v7
; GFX10-NEXT:    v_mov_b32_e32 v15, v8
; GFX10-NEXT:    v_lshl_or_b32 v11, v3, 16, v0
; GFX10-NEXT:    v_lshl_or_b32 v12, v5, 16, v1
; GFX10-NEXT:    image_sample_c_d_o_g16 v0, v[9:15], s[0:7], s[8:11] dmask:0x4 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    ; return to shader part epilog
;
...
; GFX10-NEXT:    v_lshl_or_b32 v11, v3, 16, v0
; GFX10-NEXT:    v_lshl_or_b32 v12, v5, 16, v1
; GFX10-NEXT:    image_sample_c_d_o_g16 v[0:1], v[9:15], s[0:7], s[8:11] dmask:0x6 dim:SQ_RSRC_IMG_2D_ARRAY
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    ; return to shader part epilog
;
