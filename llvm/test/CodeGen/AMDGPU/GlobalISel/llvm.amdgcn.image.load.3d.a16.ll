...
; GFX9-NEXT:    v_lshl_or_b32 v7, s0, 16, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-NEXT:    image_load v[1:5], v[6:7], s[0:7] dmask:0xf unorm a16 tfe
...
; GFX10-NEXT:    v_mov_b32_e32 v4, v3
; GFX10-NEXT:    image_load v[4:8], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_3D unorm a16 tfe
...
; GFX11-NEXT:    v_mov_b32_e32 v4, v3
; GFX11-NEXT:    image_load v[4:8], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_3D unorm a16 tfe
...
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_and_b32 v0, 0xffff, v0
; GFX12-NEXT:    v_and_b32_e32 v2, 0xffff, v2
; GFX12-NEXT:    s_mov_b32 s0, s2
; GFX12-NEXT:    s_mov_b32 s1, s3
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX12-NEXT:    v_dual_mov_b32 v4, v3 :: v_dual_mov_b32 v7, v3
...
; GFX12-NEXT:    image_load v[4:8], [v0, v1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_3D a16 tfe
...
; GFX9-NEXT:    v_mov_b32_e32 v2, v1
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-NEXT:    image_load v[1:5], v[6:7], s[0:7] dmask:0xf unorm a16 tfe lwe
; GFX9-NEXT:    s_mov_b32 s8, s10
; GFX9-NEXT:    s_mov_b32 s9, s11
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_store_dword v0, v5, s[8:9]
...
; GFX10-NEXT:    v_mov_b32_e32 v5, v4
; GFX10-NEXT:    v_mov_b32_e32 v4, v3
; GFX10-NEXT:    image_load v[4:8], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_3D unorm a16 tfe lwe
; GFX10-NEXT:    s_mov_b32 s8, s10
; GFX10-NEXT:    s_mov_b32 s9, s11
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    global_store_dword v3, v8, s[8:9]
...
; GFX11-NEXT:    v_mov_b32_e32 v5, v4
; GFX11-NEXT:    v_mov_b32_e32 v4, v3
; GFX11-NEXT:    image_load v[4:8], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_3D unorm a16 tfe lwe
; GFX11-NEXT:    s_mov_b32 s8, s10
; GFX11-NEXT:    s_mov_b32 s9, s11
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b32 v3, v8, s[8:9]
