...
; GFX1170:       ; %bb.0: ; %bb
; GFX1170-NEXT:    global_load_b32 v32, v[20:21], off
; GFX1170-NEXT:    v_dual_mov_b32 v28, v0 :: v_dual_mov_b32 v29, v1
; GFX1170-NEXT:    v_dual_mov_b32 v30, v2 :: v_dual_mov_b32 v31, v3
; GFX1170-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX1170-NEXT:    v_dual_mov_b32 v2, v6 :: v_dual_mov_b32 v3, v7
; GFX1170-NEXT:    v_dual_mov_b32 v4, v8 :: v_dual_mov_b32 v5, v9
; GFX1170-NEXT:    v_dual_mov_b32 v6, v10 :: v_dual_mov_b32 v7, v11
; GFX1170-NEXT:    v_dual_mov_b32 v8, v22 :: v_dual_mov_b32 v9, v23
; GFX1170-NEXT:    v_dual_mov_b32 v10, v24 :: v_dual_mov_b32 v11, v25
; GFX1170-NEXT:    v_dual_mov_b32 v27, v19 :: v_dual_mov_b32 v26, v18
; GFX1170-NEXT:    v_dual_mov_b32 v25, v17 :: v_dual_mov_b32 v24, v16
; GFX1170-NEXT:    v_dual_mov_b32 v23, v15 :: v_dual_mov_b32 v22, v14
; GFX1170-NEXT:    v_dual_mov_b32 v21, v13 :: v_dual_mov_b32 v20, v12
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_f16 v[20:27], v[28:31], v[0:7], v32
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_f16 v[12:19], v[28:31], v[0:7], v32 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[8:9], v[20:23], off
; GFX1170-NEXT:    global_store_b128 v[8:9], v[24:27], off offset:16
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[10:11], v[12:15], off
; GFX1170-NEXT:    global_store_b128 v[10:11], v[16:19], off offset:16
; GFX1170-NEXT:    s_endpgm
;
; GFX12-LABEL: test_swmmac_f32_16x16x32_f16_index_key:
; GFX12:       ; %bb.0: ; %bb
; GFX12-NEXT:    global_load_b32 v32, v[20:21], off
; GFX12-NEXT:    v_dual_mov_b32 v28, v0 :: v_dual_mov_b32 v29, v1
; GFX12-NEXT:    v_dual_mov_b32 v30, v2 :: v_dual_mov_b32 v31, v3
; GFX12-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX12-NEXT:    v_dual_mov_b32 v2, v6 :: v_dual_mov_b32 v3, v7
; GFX12-NEXT:    v_dual_mov_b32 v4, v8 :: v_dual_mov_b32 v5, v9
; GFX12-NEXT:    v_dual_mov_b32 v6, v10 :: v_dual_mov_b32 v7, v11
; GFX12-NEXT:    v_dual_mov_b32 v8, v22 :: v_dual_mov_b32 v9, v23
; GFX12-NEXT:    v_dual_mov_b32 v10, v24 :: v_dual_mov_b32 v11, v25
; GFX12-NEXT:    v_dual_mov_b32 v27, v19 :: v_dual_mov_b32 v26, v18
; GFX12-NEXT:    v_dual_mov_b32 v25, v17 :: v_dual_mov_b32 v24, v16
; GFX12-NEXT:    v_dual_mov_b32 v23, v15 :: v_dual_mov_b32 v22, v14
; GFX12-NEXT:    v_dual_mov_b32 v21, v13 :: v_dual_mov_b32 v20, v12
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_f16 v[20:27], v[28:31], v[0:7], v32
; GFX12-NEXT:    v_swmmac_f32_16x16x32_f16 v[12:19], v[28:31], v[0:7], v32 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[8:9], v[20:23], off
; GFX12-NEXT:    global_store_b128 v[8:9], v[24:27], off offset:16
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[10:11], v[12:15], off
; GFX12-NEXT:    global_store_b128 v[10:11], v[16:19], off offset:16
; GFX12-NEXT:    s_endpgm
bb:
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf16 v[20:27], v[28:31], v[0:7], v32
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf16 v[12:19], v[28:31], v[0:7], v32 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[8:9], v[20:23], off
; GFX1170-NEXT:    global_store_b128 v[8:9], v[24:27], off offset:16
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf16 v[20:27], v[28:31], v[0:7], v32
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf16 v[12:19], v[28:31], v[0:7], v32 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[8:9], v[20:23], off
; GFX12-NEXT:    global_store_b128 v[8:9], v[24:27], off offset:16
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170-NEXT:    v_dual_mov_b32 v22, v0 :: v_dual_mov_b32 v23, v1
; GFX1170-NEXT:    v_dual_mov_b32 v24, v2 :: v_dual_mov_b32 v25, v3
; GFX1170-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX1170-NEXT:    v_dual_mov_b32 v2, v6 :: v_dual_mov_b32 v3, v7
; GFX1170-NEXT:    v_dual_mov_b32 v4, v8 :: v_dual_mov_b32 v5, v9
; GFX1170-NEXT:    v_dual_mov_b32 v6, v10 :: v_dual_mov_b32 v7, v11
; GFX1170-NEXT:    v_dual_mov_b32 v8, v12 :: v_dual_mov_b32 v9, v13
; GFX1170-NEXT:    v_dual_mov_b32 v10, v14 :: v_dual_mov_b32 v11, v15
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f16_16x16x32_f16 v[8:11], v[22:25], v[0:7], v16
; GFX1170-NEXT:    v_swmmac_f16_16x16x32_f16 v[12:15], v[22:25], v[0:7], v16 index_key:1
; GFX1170-NEXT:    global_store_b128 v[18:19], v[8:11], off
...
; GFX12-NEXT:    v_dual_mov_b32 v22, v0 :: v_dual_mov_b32 v23, v1
; GFX12-NEXT:    v_dual_mov_b32 v24, v2 :: v_dual_mov_b32 v25, v3
; GFX12-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5
; GFX12-NEXT:    v_dual_mov_b32 v2, v6 :: v_dual_mov_b32 v3, v7
; GFX12-NEXT:    v_dual_mov_b32 v4, v8 :: v_dual_mov_b32 v5, v9
; GFX12-NEXT:    v_dual_mov_b32 v6, v10 :: v_dual_mov_b32 v7, v11
; GFX12-NEXT:    v_dual_mov_b32 v8, v12 :: v_dual_mov_b32 v9, v13
; GFX12-NEXT:    v_dual_mov_b32 v10, v14 :: v_dual_mov_b32 v11, v15
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f16_16x16x32_f16 v[8:11], v[22:25], v[0:7], v16
; GFX12-NEXT:    v_swmmac_f16_16x16x32_f16 v[12:15], v[22:25], v[0:7], v16 index_key:1
; GFX12-NEXT:    global_store_b128 v[18:19], v[8:11], off
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[8:11], v[22:25], v[0:7], v16
; GFX1170-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[12:15], v[22:25], v[0:7], v16 index_key:1
; GFX1170-NEXT:    global_store_b128 v[18:19], v[8:11], off
; GFX1170-NEXT:    global_store_b128 v[20:21], v[12:15], off
; GFX1170-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[8:11], v[22:25], v[0:7], v16
; GFX12-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[12:15], v[22:25], v[0:7], v16 index_key:1
; GFX12-NEXT:    global_store_b128 v[18:19], v[8:11], off
; GFX12-NEXT:    global_store_b128 v[20:21], v[12:15], off
; GFX12-NEXT:    s_endpgm
bb:
...
; GFX1170:       ; %bb.0: ; %bb
; GFX1170-NEXT:    global_load_b32 v26, v[14:15], off
; GFX1170-NEXT:    v_dual_mov_b32 v22, v0 :: v_dual_mov_b32 v23, v1
; GFX1170-NEXT:    v_dual_mov_b32 v0, v2 :: v_dual_mov_b32 v1, v3
; GFX1170-NEXT:    v_dual_mov_b32 v2, v4 :: v_dual_mov_b32 v3, v5
; GFX1170-NEXT:    v_dual_mov_b32 v4, v16 :: v_dual_mov_b32 v5, v17
; GFX1170-NEXT:    v_dual_mov_b32 v24, v18 :: v_dual_mov_b32 v25, v19
; GFX1170-NEXT:    v_dual_mov_b32 v21, v13 :: v_dual_mov_b32 v20, v12
; GFX1170-NEXT:    v_dual_mov_b32 v19, v11 :: v_dual_mov_b32 v18, v10
; GFX1170-NEXT:    v_dual_mov_b32 v17, v9 :: v_dual_mov_b32 v16, v8
; GFX1170-NEXT:    v_dual_mov_b32 v15, v7 :: v_dual_mov_b32 v14, v6
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_i32_16x16x32_iu8 v[14:21], v[22:23], v[0:3], v26
; GFX1170-NEXT:    v_swmmac_i32_16x16x32_iu8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX1170-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[24:25], v[6:9], off
; GFX1170-NEXT:    global_store_b128 v[24:25], v[10:13], off offset:16
; GFX1170-NEXT:    s_endpgm
;
; GFX12-LABEL: test_swmmac_i32_16x16x32_iu8_index_key:
; GFX12:       ; %bb.0: ; %bb
; GFX12-NEXT:    global_load_b32 v26, v[14:15], off
; GFX12-NEXT:    v_dual_mov_b32 v22, v0 :: v_dual_mov_b32 v23, v1
; GFX12-NEXT:    v_dual_mov_b32 v0, v2 :: v_dual_mov_b32 v1, v3
; GFX12-NEXT:    v_dual_mov_b32 v2, v4 :: v_dual_mov_b32 v3, v5
; GFX12-NEXT:    v_dual_mov_b32 v4, v16 :: v_dual_mov_b32 v5, v17
; GFX12-NEXT:    v_dual_mov_b32 v24, v18 :: v_dual_mov_b32 v25, v19
; GFX12-NEXT:    v_dual_mov_b32 v21, v13 :: v_dual_mov_b32 v20, v12
; GFX12-NEXT:    v_dual_mov_b32 v19, v11 :: v_dual_mov_b32 v18, v10
; GFX12-NEXT:    v_dual_mov_b32 v17, v9 :: v_dual_mov_b32 v16, v8
; GFX12-NEXT:    v_dual_mov_b32 v15, v7 :: v_dual_mov_b32 v14, v6
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_i32_16x16x32_iu8 v[14:21], v[22:23], v[0:3], v26
; GFX12-NEXT:    v_swmmac_i32_16x16x32_iu8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX12-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[24:25], v[6:9], off
; GFX12-NEXT:    global_store_b128 v[24:25], v[10:13], off offset:16
; GFX12-NEXT:    s_endpgm
bb:
  %IndexVec = load <2 x i16>, ptr addrspace(1) %IndexVecPtr, align 4
  %Index0 = extractelement <2 x i16> %IndexVec, i32 0
...
; GFX1170:       ; %bb.0: ; %bb
; GFX1170-NEXT:    global_load_b32 v23, v[11:12], off
; GFX1170-NEXT:    v_dual_mov_b32 v19, v13 :: v_dual_mov_b32 v20, v14
; GFX1170-NEXT:    v_dual_mov_b32 v21, v15 :: v_dual_mov_b32 v22, v16
; GFX1170-NEXT:    v_dual_mov_b32 v18, v10 :: v_dual_mov_b32 v17, v9
; GFX1170-NEXT:    v_dual_mov_b32 v16, v8 :: v_dual_mov_b32 v15, v7
; GFX1170-NEXT:    v_dual_mov_b32 v14, v6 :: v_dual_mov_b32 v13, v5
; GFX1170-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_i32_16x16x32_iu4 v[11:18], v0, v[1:2], v23
; GFX1170-NEXT:    v_swmmac_i32_16x16x32_iu4 v[3:10], v0, v[1:2], v23 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[19:20], v[11:14], off
; GFX1170-NEXT:    global_store_b128 v[19:20], v[15:18], off offset:16
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[21:22], v[3:6], off
; GFX1170-NEXT:    global_store_b128 v[21:22], v[7:10], off offset:16
; GFX1170-NEXT:    s_endpgm
;
; GFX12-LABEL: test_swmmac_i32_16x16x32_iu4_index_key:
; GFX12:       ; %bb.0: ; %bb
; GFX12-NEXT:    global_load_b32 v23, v[11:12], off
; GFX12-NEXT:    v_dual_mov_b32 v19, v13 :: v_dual_mov_b32 v20, v14
; GFX12-NEXT:    v_dual_mov_b32 v21, v15 :: v_dual_mov_b32 v22, v16
; GFX12-NEXT:    v_dual_mov_b32 v18, v10 :: v_dual_mov_b32 v17, v9
; GFX12-NEXT:    v_dual_mov_b32 v16, v8 :: v_dual_mov_b32 v15, v7
; GFX12-NEXT:    v_dual_mov_b32 v14, v6 :: v_dual_mov_b32 v13, v5
; GFX12-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v11, v3
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_i32_16x16x32_iu4 v[11:18], v0, v[1:2], v23
; GFX12-NEXT:    v_swmmac_i32_16x16x32_iu4 v[3:10], v0, v[1:2], v23 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[19:20], v[11:14], off
; GFX12-NEXT:    global_store_b128 v[19:20], v[15:18], off offset:16
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[21:22], v[3:6], off
; GFX12-NEXT:    global_store_b128 v[21:22], v[7:10], off offset:16
; GFX12-NEXT:    s_endpgm
bb:
  %IndexVec = load <2 x i16>, ptr addrspace(1) %IndexVecPtr, align 4
  %Index0 = extractelement <2 x i16> %IndexVec, i32 0
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[14:21], v[22:23], v[0:3], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX1170-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[14:21], v[22:23], v[0:3], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX12-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[14:21], v[22:23], v[0:3], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX1170-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[14:21], v[22:23], v[0:3], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX12-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[14:21], v[22:23], v[0:3], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX1170-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[14:21], v[22:23], v[0:3], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX12-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[14:21], v[22:23], v[0:3], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX1170-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[14:21], v[22:23], v[0:3], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[6:13], v[22:23], v[0:3], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[4:5], v[14:17], off
; GFX12-NEXT:    global_store_b128 v[4:5], v[18:21], off offset:16
; GFX12-NEXT:    s_clause 0x1
