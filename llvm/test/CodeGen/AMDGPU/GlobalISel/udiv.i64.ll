...
; CHECK-NEXT:    v_mac_f32_e32 v6, 0x4f800000, v4
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v4, v6
; CHECK-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v4
; CHECK-NEXT:    v_mul_f32_e32 v6, 0x2f800000, v4
; CHECK-NEXT:    v_trunc_f32_e32 v6, v6
; CHECK-NEXT:    v_mac_f32_e32 v4, 0xcf800000, v6
...
; CHECK-NEXT:    v_mul_hi_u32 v11, v5, v4
...
; CHECK-NEXT:    v_mul_lo_u32 v8, v5, v4
; CHECK-NEXT:    v_mul_lo_u32 v7, v7, v4
; CHECK-NEXT:    v_mul_hi_u32 v9, v5, v4
; CHECK-NEXT:    v_mul_lo_u32 v5, v5, v6
; CHECK-NEXT:    v_mul_lo_u32 v10, v6, v8
; CHECK-NEXT:    v_mul_hi_u32 v11, v4, v8
; CHECK-NEXT:    v_mul_hi_u32 v8, v6, v8
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v7, v5
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v5, v9
; CHECK-NEXT:    v_mul_lo_u32 v7, v4, v5
; CHECK-NEXT:    v_mul_lo_u32 v9, v6, v5
; CHECK-NEXT:    v_mul_hi_u32 v12, v4, v5
; CHECK-NEXT:    v_mul_hi_u32 v5, v6, v5
...
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, v6, v5, vcc
...
; CHECK-NEXT:  ; %bb.3:
; CHECK-NEXT:    v_rcp_iflag_f32_e32 v1, v6
...
; CHECK-NEXT:    s_or_b64 s[0:1], s[4:5], s[2:3]
...
; CHECK-NEXT:    s_sub_u32 s0, 0, s2
; CHECK-NEXT:    v_mov_b32_e32 v3, s5
; CHECK-NEXT:    v_madmk_f32 v1, v1, 0x4f800000, v2
; CHECK-NEXT:    s_subb_u32 s1, 0, s3
...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v4, v4
; CHECK-NEXT:    v_cvt_u32_f32_e32 v1, v1
; CHECK-NEXT:    v_mul_lo_u32 v5, s0, v4
; CHECK-NEXT:    v_mul_lo_u32 v6, s0, v1
; CHECK-NEXT:    v_mul_lo_u32 v7, s1, v1
; CHECK-NEXT:    v_mul_hi_u32 v8, s0, v1
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v7, v5
...
; CHECK-NEXT:    v_mul_lo_u32 v5, s0, v1
; CHECK-NEXT:    v_mul_lo_u32 v6, s1, v1
; CHECK-NEXT:    v_mul_hi_u32 v7, s0, v1
; CHECK-NEXT:    v_mul_lo_u32 v8, s0, v4
...
; CHECK-NEXT:    v_mul_lo_u32 v5, s5, v1
; CHECK-NEXT:    v_mul_hi_u32 v6, s4, v1
; CHECK-NEXT:    v_mul_hi_u32 v1, s5, v1
; CHECK-NEXT:    v_mul_lo_u32 v7, s4, v4
; CHECK-NEXT:    v_mul_lo_u32 v8, s5, v4
; CHECK-NEXT:    v_mul_hi_u32 v9, s4, v4
; CHECK-NEXT:    v_mul_hi_u32 v4, s5, v4
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v5, v7
; CHECK-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v6, vcc, s4, v6
; CHECK-NEXT:    v_subb_u32_e64 v3, s[0:1], v3, v4, vcc
; CHECK-NEXT:    v_sub_i32_e64 v4, s[0:1], s5, v4
; CHECK-NEXT:    v_cmp_le_u32_e64 s[0:1], s2, v6
...
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, s4, v1
...
; CGP-NEXT:    v_sub_i32_e32 v9, vcc, 0, v4
; CGP-NEXT:    v_subb_u32_e32 v11, vcc, 0, v5, vcc
; CGP-NEXT:    v_mac_f32_e32 v10, 0x4f800000, v8
; CGP-NEXT:    v_rcp_iflag_f32_e32 v8, v10
; CGP-NEXT:    v_mul_f32_e32 v8, 0x5f7ffffc, v8
; CGP-NEXT:    v_mul_f32_e32 v10, 0x2f800000, v8
; CGP-NEXT:    v_trunc_f32_e32 v10, v10
; CGP-NEXT:    v_mac_f32_e32 v8, 0xcf800000, v10
...
; CGP-NEXT:    v_mul_lo_u32 v11, v11, v8
; CGP-NEXT:    v_mul_hi_u32 v13, v9, v8
; CGP-NEXT:    v_mul_lo_u32 v9, v9, v10
; CGP-NEXT:    v_mul_lo_u32 v14, v10, v12
; CGP-NEXT:    v_mul_hi_u32 v15, v8, v12
; CGP-NEXT:    v_mul_hi_u32 v12, v10, v12
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v11, v9
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v13
; CGP-NEXT:    v_mul_lo_u32 v11, v8, v9
; CGP-NEXT:    v_mul_lo_u32 v13, v10, v9
; CGP-NEXT:    v_mul_hi_u32 v16, v8, v9
; CGP-NEXT:    v_mul_hi_u32 v9, v10, v9
...
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, v10, v9, vcc
; CGP-NEXT:    v_mul_lo_u32 v10, v1, v8
; CGP-NEXT:    v_mul_hi_u32 v11, v0, v8
; CGP-NEXT:    v_mul_hi_u32 v8, v1, v8
; CGP-NEXT:    v_mul_lo_u32 v12, v0, v9
; CGP-NEXT:    v_mul_lo_u32 v13, v1, v9
; CGP-NEXT:    v_mul_hi_u32 v14, v0, v9
...
; CGP-NEXT:    v_mul_lo_u32 v10, v4, v9
; CGP-NEXT:    v_add_i32_e32 v14, vcc, 1, v8
; CGP-NEXT:    v_addc_u32_e32 v15, vcc, 0, v9, vcc
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v12, v10
...
; CGP-NEXT:    v_subb_u32_e64 v11, s[4:5], v1, v10, vcc
; CGP-NEXT:    v_sub_i32_e64 v1, s[4:5], v1, v10
...
; CGP-NEXT:    v_cndmask_b32_e32 v0, v14, v12, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v15, v16, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v10
; CGP-NEXT:    v_cndmask_b32_e32 v8, v8, v0, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v9, v9, v1, vcc
...
; CGP-NEXT:  ; %bb.3:
; CGP-NEXT:    v_rcp_iflag_f32_e32 v1, v10
...
; CGP-NEXT:  ; %bb.5:
; CGP-NEXT:    v_cvt_f32_u32_e32 v1, v7
...
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v12, v10
; CGP-NEXT:    v_mul_lo_u32 v12, v1, v11
; CGP-NEXT:    v_mul_hi_u32 v14, v0, v11
; CGP-NEXT:    v_mul_hi_u32 v11, v1, v11
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v13
; CGP-NEXT:    v_mul_lo_u32 v13, v0, v10
; CGP-NEXT:    v_mul_lo_u32 v15, v1, v10
; CGP-NEXT:    v_mul_hi_u32 v16, v0, v10
...
; CGP-NEXT:    v_mul_lo_u32 v10, v4, v0
; CGP-NEXT:    v_mul_lo_u32 v5, v5, v0
...
; CGP-NEXT:    v_mul_lo_u32 v5, v0, v4
; CGP-NEXT:    v_mul_lo_u32 v11, v1, v4
; CGP-NEXT:    v_mul_hi_u32 v14, v0, v4
...
; CGP-NEXT:    v_mul_lo_u32 v4, v3, v0
; CGP-NEXT:    v_mul_hi_u32 v5, v2, v0
; CGP-NEXT:    v_mul_hi_u32 v0, v3, v0
; CGP-NEXT:    v_mul_lo_u32 v10, v2, v1
; CGP-NEXT:    v_mul_lo_u32 v11, v3, v1
; CGP-NEXT:    v_mul_hi_u32 v12, v2, v1
; CGP-NEXT:    v_mul_hi_u32 v1, v3, v1
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
...
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; CGP-NEXT:    v_mul_lo_u32 v5, v6, v0
; CGP-NEXT:    v_mul_lo_u32 v10, v7, v0
; CGP-NEXT:    v_mul_hi_u32 v11, v6, v0
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v4
; CGP-NEXT:    v_mul_lo_u32 v4, v6, v1
...
; CGP-NEXT:    v_cndmask_b32_e32 v5, v1, v3, vcc
; CGP-NEXT:    ; implicit-def: $vgpr0
...
; CGP-NEXT:    v_lshl_b64 v[8:9], v[10:11], v4
; CGP-NEXT:    v_or_b32_e32 v13, v1, v9
; CGP-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[12:13]
; CGP-NEXT:    v_cvt_f32_u32_e32 v12, v8
; CGP-NEXT:    ; implicit-def: $vgpr4_vgpr5
; CGP-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; CGP-NEXT:    s_xor_b64 s[6:7], exec, s[4:5]
...
; CGP-NEXT:    v_sub_i32_e32 v5, vcc, 0, v8
; CGP-NEXT:    v_subb_u32_e32 v7, vcc, 0, v9, vcc
; CGP-NEXT:    v_mac_f32_e32 v12, 0x4f800000, v4
; CGP-NEXT:    v_rcp_iflag_f32_e32 v4, v12
...
; CGP-NEXT:    v_mul_lo_u32 v14, v5, v4
; CGP-NEXT:    v_mul_lo_u32 v15, v7, v4
; CGP-NEXT:    v_mul_hi_u32 v16, v5, v4
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v15, v13
; CGP-NEXT:    v_mul_lo_u32 v15, v12, v14
; CGP-NEXT:    v_mul_hi_u32 v17, v4, v14
; CGP-NEXT:    v_mul_hi_u32 v14, v12, v14
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v13, v16
; CGP-NEXT:    v_mul_lo_u32 v16, v4, v13
; CGP-NEXT:    v_mul_lo_u32 v18, v12, v13
; CGP-NEXT:    v_mul_hi_u32 v19, v4, v13
; CGP-NEXT:    v_mul_hi_u32 v13, v12, v13
...
; CGP-NEXT:    v_mul_lo_u32 v13, v5, v4
; CGP-NEXT:    v_mul_lo_u32 v7, v7, v4
; CGP-NEXT:    v_mul_hi_u32 v14, v5, v4
; CGP-NEXT:    v_mul_lo_u32 v5, v5, v12
; CGP-NEXT:    v_mul_lo_u32 v15, v12, v13
...
; CGP-NEXT:    v_mul_lo_u32 v14, v12, v5
; CGP-NEXT:    v_mul_hi_u32 v17, v4, v5
...
; CGP-NEXT:    v_mul_lo_u32 v7, v1, v4
; CGP-NEXT:    v_mul_hi_u32 v12, v0, v4
; CGP-NEXT:    v_mul_hi_u32 v4, v1, v4
; CGP-NEXT:    v_mul_lo_u32 v13, v0, v5
; CGP-NEXT:    v_mul_lo_u32 v14, v1, v5
; CGP-NEXT:    v_mul_hi_u32 v15, v0, v5
; CGP-NEXT:    v_mul_hi_u32 v5, v1, v5
...
; CGP-NEXT:    v_mul_hi_u32 v14, v8, v4
...
; CGP-NEXT:    v_subb_u32_e64 v12, s[4:5], v1, v7, vcc
; CGP-NEXT:    v_sub_i32_e64 v1, s[4:5], v1, v7
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v0, v8
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v12, v9
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[4:5]
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v1, v9, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v12, v9
; CGP-NEXT:    v_cndmask_b32_e32 v7, v14, v7, vcc
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v0, v8
; CGP-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v8
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, -1, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v9
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, -1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v1, v9
; CGP-NEXT:    v_cndmask_b32_e32 v0, v8, v0, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v0
; CGP-NEXT:    v_cndmask_b32_e32 v0, v15, v13, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v1, v16, v17, vcc
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v7
; CGP-NEXT:    v_cndmask_b32_e32 v4, v4, v0, vcc
...
; CGP-NEXT:    v_lshl_b64 v[6:7], v[10:11], v6
; CGP-NEXT:    s_xor_b64 exec, exec, s[6:7]
; CGP-NEXT:    s_cbranch_execz .LBB8_4
; CGP-NEXT:  ; %bb.3:
; CGP-NEXT:    v_rcp_iflag_f32_e32 v1, v12
...
; CGP-NEXT:    v_mul_hi_u32 v13, v8, v0
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v12, v10
; CGP-NEXT:    v_mul_lo_u32 v12, v1, v11
; CGP-NEXT:    v_mul_hi_u32 v14, v0, v11
; CGP-NEXT:    v_mul_hi_u32 v11, v1, v11
...
; CGP-NEXT:    v_mul_lo_u32 v9, v9, v0
; CGP-NEXT:    v_mul_hi_u32 v11, v8, v0
; CGP-NEXT:    v_mul_lo_u32 v8, v8, v1
; CGP-NEXT:    v_mul_lo_u32 v12, v1, v10
; CGP-NEXT:    v_mul_hi_u32 v13, v0, v10
; CGP-NEXT:    v_mul_hi_u32 v10, v1, v10
...
; CGP-NEXT:    v_mul_hi_u32 v14, v0, v8
; CGP-NEXT:    v_mul_hi_u32 v8, v1, v8
...
; CGP-NEXT:    v_mul_lo_u32 v8, v3, v0
; CGP-NEXT:    v_mul_hi_u32 v9, v2, v0
; CGP-NEXT:    v_mul_hi_u32 v0, v3, v0
; CGP-NEXT:    v_mul_lo_u32 v10, v2, v1
; CGP-NEXT:    v_mul_lo_u32 v11, v3, v1
; CGP-NEXT:    v_mul_hi_u32 v12, v2, v1
...
; CGP-NEXT:    v_mul_lo_u32 v8, v6, v1
; CGP-NEXT:    v_add_i32_e32 v12, vcc, 1, v0
; CGP-NEXT:    v_addc_u32_e32 v13, vcc, 0, v1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v10, v8
; CGP-NEXT:    v_add_i32_e32 v10, vcc, 1, v12
...
; CGP-NEXT:    v_cndmask_b32_e32 v9, v1, v3, vcc
; CGP-NEXT:    ; implicit-def: $vgpr0
