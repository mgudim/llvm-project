...
; CHECK-NEXT:    v_sub_i32_e32 v4, vcc, s4, v6
; CHECK-NEXT:    v_subb_u32_e64 v3, s[0:1], v3, v1, vcc
; CHECK-NEXT:    v_sub_i32_e64 v1, s[0:1], s5, v1
...
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, s4, v0
...
; CGP-NEXT:    v_mul_lo_u32 v9, v4, v9
...
; CGP-NEXT:    v_cndmask_b32_e32 v8, v0, v4, vcc
...
; CGP-NEXT:    v_mul_lo_u32 v1, v6, v1
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v2, v5
; CGP-NEXT:    v_subb_u32_e64 v2, s[4:5], v3, v0, vcc
; CGP-NEXT:    v_sub_i32_e64 v0, s[4:5], v3, v0
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v6
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s[4:5]
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v2, v7
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, -1, s[4:5]
; CGP-NEXT:    v_subb_u32_e32 v0, vcc, v0, v7, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v2, v7
; CGP-NEXT:    v_cndmask_b32_e32 v3, v4, v3, vcc
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v1, v6
; CGP-NEXT:    v_subbrev_u32_e64 v5, s[4:5], 0, v0, vcc
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v4, v6
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, -1, s[4:5]
; CGP-NEXT:    v_subb_u32_e32 v0, vcc, v0, v7, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v5, v7
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v6, vcc, v4, v6
...
; CGP-NEXT:    v_cndmask_b32_e32 v5, v2, v0, vcc
; CGP-NEXT:    ; implicit-def: $vgpr0
...
; CGP-NEXT:    v_subb_u32_e64 v5, s[4:5], v1, v4, vcc
; CGP-NEXT:    v_sub_i32_e64 v1, s[4:5], v1, v4
...
; CGP-NEXT:    v_sub_i32_e32 v7, vcc, v0, v8
...
; CGP-NEXT:    v_subb_u32_e32 v1, vcc, v1, v9, vcc
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v12, v9
; CGP-NEXT:    v_cndmask_b32_e64 v14, 0, -1, vcc
; CGP-NEXT:    v_sub_i32_e32 v8, vcc, v7, v8
; CGP-NEXT:    v_subbrev_u32_e32 v1, vcc, 0, v1, vcc
; CGP-NEXT:    v_cmp_eq_u32_e32 vcc, v12, v9
; CGP-NEXT:    v_cndmask_b32_e32 v9, v14, v13, vcc
...
; CGP-NEXT:    v_cndmask_b32_e32 v4, v0, v7, vcc
...
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v4
; CGP-NEXT:    v_mul_hi_u32 v1, v0, v1
; CGP-NEXT:    v_mul_lo_u32 v1, v1, v8
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v0, v1
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v0, v8
...
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v10, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v1, v0
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v2, v9
; CGP-NEXT:    v_subb_u32_e64 v2, s[4:5], v3, v0, vcc
; CGP-NEXT:    v_sub_i32_e64 v0, s[4:5], v3, v0
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v6
; CGP-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s[4:5]
...
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; CGP-NEXT:    v_cndmask_b32_e32 v8, v1, v6, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v9, v2, v0, vcc
; CGP-NEXT:    ; implicit-def: $vgpr0
