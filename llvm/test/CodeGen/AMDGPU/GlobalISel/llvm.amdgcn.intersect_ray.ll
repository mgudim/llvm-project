...
; GFX1030:       ; %bb.0:
; GFX1030-NEXT:    v_mov_b32_e32 v15, v11
; GFX1030-NEXT:    v_mov_b32_e32 v16, v12
; GFX1030-NEXT:    v_mov_b32_e32 v17, v13
; GFX1030-NEXT:    v_mov_b32_e32 v18, v14
...
; GFX1030-NEXT:    image_bvh_intersect_ray v[11:14], v[0:10], s[4:7]
; GFX1030-NEXT:    ; implicit-def: $vgpr15
; GFX1030-NEXT:    ; implicit-def: $vgpr0
; GFX1030-NEXT:    ; implicit-def: $vgpr1
; GFX1030-NEXT:    ; implicit-def: $vgpr2
; GFX1030-NEXT:    ; implicit-def: $vgpr3
; GFX1030-NEXT:    ; implicit-def: $vgpr4
; GFX1030-NEXT:    ; implicit-def: $vgpr5
; GFX1030-NEXT:    ; implicit-def: $vgpr6
; GFX1030-NEXT:    ; implicit-def: $vgpr7
; GFX1030-NEXT:    ; implicit-def: $vgpr8
; GFX1030-NEXT:    ; implicit-def: $vgpr9
; GFX1030-NEXT:    ; implicit-def: $vgpr10
; GFX1030-NEXT:    ; implicit-def: $vgpr17_vgpr18
; GFX1030-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX1030-NEXT:    s_cbranch_execnz .LBB6_1
; GFX1030-NEXT:  ; %bb.2:
; GFX1030-NEXT:    s_mov_b32 exec_lo, s1
; GFX1030-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-NEXT:    v_mov_b32_e32 v0, v11
; GFX1030-NEXT:    v_mov_b32_e32 v1, v12
; GFX1030-NEXT:    v_mov_b32_e32 v2, v13
; GFX1030-NEXT:    v_mov_b32_e32 v3, v14
...
; GFX1013-NEXT:    image_bvh_intersect_ray v[11:14], v[0:10], s[4:7]
; GFX1013-NEXT:    ; implicit-def: $vgpr15
; GFX1013-NEXT:    ; implicit-def: $vgpr0_vgpr1_vgpr2_vgpr3_vgpr4_vgpr5_vgpr6_vgpr7_vgpr8_vgpr9_vgpr10
; GFX1013-NEXT:    ; implicit-def: $vgpr17_vgpr18
...
; GFX1013-NEXT:    v_mov_b32_e32 v0, v11
; GFX1013-NEXT:    v_mov_b32_e32 v1, v12
; GFX1013-NEXT:    v_mov_b32_e32 v2, v13
; GFX1013-NEXT:    v_mov_b32_e32 v3, v14
...
; GFX11-NEXT:    v_dual_mov_b32 v19, v6 :: v_dual_mov_b32 v20, v7
; GFX11-NEXT:    v_dual_mov_b32 v6, v8 :: v_dual_mov_b32 v7, v9
; GFX11-NEXT:    v_dual_mov_b32 v8, v10 :: v_dual_mov_b32 v9, v11
; GFX11-NEXT:    v_dual_mov_b32 v10, v12 :: v_dual_mov_b32 v11, v13
...
; GFX11-NEXT:    image_bvh_intersect_ray v[2:5], [v0, v1, v[15:17], v[18:20], v[6:8]], s[4:7]
...
; GFX1030:       ; %bb.0:
; GFX1030-NEXT:    v_lshrrev_b32_e32 v13, 16, v5
; GFX1030-NEXT:    v_and_b32_e32 v14, 0xffff, v7
; GFX1030-NEXT:    v_and_b32_e32 v8, 0xffff, v8
; GFX1030-NEXT:    v_mov_b32_e32 v15, v0
; GFX1030-NEXT:    v_mov_b32_e32 v16, v1
; GFX1030-NEXT:    v_lshlrev_b32_e32 v13, 16, v13
...
; GFX1030-NEXT:    v_and_or_b32 v20, 0xffff, v5, v13
; GFX1030-NEXT:    v_and_or_b32 v21, 0xffff, v6, v14
; GFX1030-NEXT:    v_alignbit_b32 v22, v8, v7, 16
; GFX1030-NEXT:    s_mov_b32 s1, exec_lo
...
; GFX1030-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX1030-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1030-NEXT:    image_bvh_intersect_ray v[5:8], v[15:22], s[4:7] a16
; GFX1030-NEXT:    ; implicit-def: $vgpr9
; GFX1030-NEXT:    ; implicit-def: $vgpr15
...
; GFX1013-NEXT:    v_mov_b32_e32 v14, v10
...
; GFX1013-NEXT:    v_readfirstlane_b32 s4, v13
; GFX1013-NEXT:    v_readfirstlane_b32 s5, v14
; GFX1013-NEXT:    v_readfirstlane_b32 s6, v15
; GFX1013-NEXT:    v_readfirstlane_b32 s7, v16
; GFX1013-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[13:14]
; GFX1013-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[15:16]
; GFX1013-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX1013-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1013-NEXT:    image_bvh_intersect_ray v[8:11], v[0:7], s[4:7] a16
; GFX1013-NEXT:    ; implicit-def: $vgpr13
; GFX1013-NEXT:    ; implicit-def: $vgpr0_vgpr1_vgpr2_vgpr3_vgpr4_vgpr5_vgpr6_vgpr7
; GFX1013-NEXT:    ; implicit-def: $vgpr15_vgpr16
; GFX1013-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX1013-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX1013-NEXT:    s_mov_b32 exec_lo, s1
; GFX1013-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-NEXT:    v_mov_b32_e32 v0, v8
; GFX1013-NEXT:    v_mov_b32_e32 v1, v9
; GFX1013-NEXT:    v_mov_b32_e32 v2, v10
; GFX1013-NEXT:    v_mov_b32_e32 v3, v11
; GFX1013-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: image_bvh_intersect_ray_a16_vgpr_descr:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_dual_mov_b32 v13, v2 :: v_dual_mov_b32 v14, v3
; GFX11-NEXT:    v_dual_mov_b32 v17, v10 :: v_dual_and_b32 v2, 0xffff, v7
; GFX11-NEXT:    v_and_b32_e32 v3, 0xffff, v8
; GFX11-NEXT:    v_dual_mov_b32 v15, v4 :: v_dual_mov_b32 v16, v9
; GFX11-NEXT:    v_perm_b32 v9, v5, v7, 0x7060302
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_lshl_or_b32 v8, v5, 16, v2
; GFX11-NEXT:    v_lshl_or_b32 v10, v6, 16, v3
; GFX11-NEXT:    s_mov_b32 s1, exec_lo
; GFX11-NEXT:  .LBB7_1: ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    v_readfirstlane_b32 s4, v16
; GFX11-NEXT:    v_readfirstlane_b32 s5, v17
; GFX11-NEXT:    v_readfirstlane_b32 s6, v11
; GFX11-NEXT:    v_readfirstlane_b32 s7, v12
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[16:17]
; GFX11-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[11:12]
; GFX11-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    image_bvh_intersect_ray v[2:5], [v0, v1, v[13:15], v[8:10]], s[4:7] a16
...
; GFX1030-NEXT:    v_mov_b32_e32 v17, v13
; GFX1030-NEXT:    v_mov_b32_e32 v18, v14
; GFX1030-NEXT:    v_mov_b32_e32 v19, v15
; GFX1030-NEXT:    s_mov_b32 s1, exec_lo
...
; GFX1030-NEXT:    v_readfirstlane_b32 s6, v18
; GFX1030-NEXT:    v_readfirstlane_b32 s7, v19
; GFX1030-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[16:17]
; GFX1030-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[18:19]
; GFX1030-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX1030-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1030-NEXT:    image_bvh64_intersect_ray v[12:15], v[0:11], s[4:7]
; GFX1030-NEXT:    ; implicit-def: $vgpr16
; GFX1030-NEXT:    ; implicit-def: $vgpr0
; GFX1030-NEXT:    ; implicit-def: $vgpr1
; GFX1030-NEXT:    ; implicit-def: $vgpr2
...
; GFX1030-NEXT:    ; implicit-def: $vgpr18_vgpr19
; GFX1030-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX1030-NEXT:    s_cbranch_execnz .LBB8_1
; GFX1030-NEXT:  ; %bb.2:
; GFX1030-NEXT:    s_mov_b32 exec_lo, s1
; GFX1030-NEXT:    s_waitcnt vmcnt(0)
; GFX1030-NEXT:    v_mov_b32_e32 v0, v12
; GFX1030-NEXT:    v_mov_b32_e32 v1, v13
; GFX1030-NEXT:    v_mov_b32_e32 v2, v14
; GFX1030-NEXT:    v_mov_b32_e32 v3, v15
; GFX1030-NEXT:    ; return to shader part epilog
;
...
; GFX1013-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX1013-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1013-NEXT:    image_bvh64_intersect_ray v[12:15], v[0:11], s[4:7]
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_dual_mov_b32 v16, v3 :: v_dual_mov_b32 v17, v4
; GFX11-NEXT:    v_dual_mov_b32 v18, v5 :: v_dual_mov_b32 v19, v6
; GFX11-NEXT:    v_dual_mov_b32 v20, v7 :: v_dual_mov_b32 v21, v8
; GFX11-NEXT:    v_dual_mov_b32 v7, v9 :: v_dual_mov_b32 v8, v10
; GFX11-NEXT:    v_dual_mov_b32 v9, v11 :: v_dual_mov_b32 v10, v12
; GFX11-NEXT:    v_dual_mov_b32 v11, v13 :: v_dual_mov_b32 v12, v14
...
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    image_bvh64_intersect_ray v[3:6], [v[0:1], v2, v[16:18], v[19:21], v[7:9]], s[4:7]
...
; GFX1030:       ; %bb.0:
; GFX1030-NEXT:    v_lshrrev_b32_e32 v14, 16, v6
; GFX1030-NEXT:    v_and_b32_e32 v15, 0xffff, v8
...
; GFX1030-NEXT:    v_and_or_b32 v22, 0xffff, v6, v14
; GFX1030-NEXT:    v_and_or_b32 v23, 0xffff, v7, v15
; GFX1030-NEXT:    v_alignbit_b32 v24, v9, v8, 16
; GFX1030-NEXT:    s_mov_b32 s1, exec_lo
...
; GFX1030-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX1030-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1030-NEXT:    image_bvh64_intersect_ray v[6:9], v[16:24], s[4:7] a16
; GFX1030-NEXT:    ; implicit-def: $vgpr10
; GFX1030-NEXT:    ; implicit-def: $vgpr16
; GFX1030-NEXT:    ; implicit-def: $vgpr17
; GFX1030-NEXT:    ; implicit-def: $vgpr18
...
; GFX1013-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX1013-NEXT:    s_and_saveexec_b32 s0, s0
; GFX1013-NEXT:    image_bvh64_intersect_ray v[9:12], v[0:8], s[4:7] a16
; GFX1013-NEXT:    ; implicit-def: $vgpr14
...
; GFX1013-NEXT:    s_mov_b32 exec_lo, s1
; GFX1013-NEXT:    s_waitcnt vmcnt(0)
; GFX1013-NEXT:    v_mov_b32_e32 v0, v9
; GFX1013-NEXT:    v_mov_b32_e32 v1, v10
; GFX1013-NEXT:    v_mov_b32_e32 v2, v11
; GFX1013-NEXT:    v_mov_b32_e32 v3, v12
; GFX1013-NEXT:    ; return to shader part epilog
;
; GFX11-LABEL: image_bvh64_intersect_ray_a16_vgpr_descr:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_dual_mov_b32 v14, v3 :: v_dual_mov_b32 v15, v4
; GFX11-NEXT:    v_dual_mov_b32 v18, v11 :: v_dual_and_b32 v3, 0xffff, v8
; GFX11-NEXT:    v_and_b32_e32 v4, 0xffff, v9
; GFX11-NEXT:    v_dual_mov_b32 v16, v5 :: v_dual_mov_b32 v17, v10
; GFX11-NEXT:    v_perm_b32 v10, v6, v8, 0x7060302
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_lshl_or_b32 v9, v6, 16, v3
; GFX11-NEXT:    v_lshl_or_b32 v11, v7, 16, v4
; GFX11-NEXT:    s_mov_b32 s1, exec_lo
...
; GFX11-NEXT:    v_readfirstlane_b32 s7, v13
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[17:18]
; GFX11-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[12:13]
; GFX11-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    image_bvh64_intersect_ray v[3:6], [v[0:1], v2, v[14:16], v[9:11]], s[4:7] a16
