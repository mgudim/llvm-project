...
; CHECK-NEXT:    v_addc_u32_e32 v5, vcc, v3, v4, vcc
; CHECK-NEXT:    v_xor_b32_e32 v3, v2, v4
; CHECK-NEXT:    v_xor_b32_e32 v2, v5, v4
; CHECK-NEXT:    v_cvt_f32_u32_e32 v5, v3
; CHECK-NEXT:    v_cvt_f32_u32_e32 v6, v2
; CHECK-NEXT:    v_sub_i32_e32 v13, vcc, 0, v3
; CHECK-NEXT:    v_subb_u32_e32 v14, vcc, 0, v2, vcc
...
; CHECK-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v14, v12, v[7:8]
; CHECK-NEXT:    v_addc_u32_e32 v1, vcc, v1, v13, vcc
; CHECK-NEXT:    v_xor_b32_e32 v10, v0, v13
; CHECK-NEXT:    v_mul_lo_u32 v0, v11, v5
; CHECK-NEXT:    v_mul_lo_u32 v6, v12, v9
; CHECK-NEXT:    v_xor_b32_e32 v14, v1, v13
; CHECK-NEXT:    v_mul_hi_u32 v1, v12, v5
; CHECK-NEXT:    v_mul_hi_u32 v5, v11, v5
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v1, v11, v9
...
; CHECK-NEXT:    v_addc_u32_e32 v1, vcc, v11, v1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v5, v14, v0
; CHECK-NEXT:    v_mul_lo_u32 v6, v10, v1
; CHECK-NEXT:    v_mul_hi_u32 v7, v10, v0
; CHECK-NEXT:    v_mul_hi_u32 v0, v14, v0
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v5, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v5, v7
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v7, v14, v1
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CHECK-NEXT:    v_mul_hi_u32 v6, v10, v1
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v7, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
; CHECK-NEXT:    v_add_i32_e32 v9, vcc, v0, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v6, v0
; CHECK-NEXT:    v_mul_hi_u32 v6, v14, v1
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v3, v9, 0
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v6, v5
; CHECK-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v3, v11, v[1:2]
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v10, v0
; CHECK-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v2, v9, v[5:6]
; CHECK-NEXT:    v_subb_u32_e64 v1, s[4:5], v14, v7, vcc
...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v1, v2
; CHECK-NEXT:    v_subbrev_u32_e32 v5, vcc, 0, v5, vcc
; CHECK-NEXT:    v_cndmask_b32_e64 v1, v6, v7, s[4:5]
...
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v6, v2, vcc
...
; CHECK-NEXT:    v_xor_b32_e32 v2, v13, v4
...
; CHECK-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s7, v6, v[2:3]
...
; CHECK-NEXT:    s_xor_b64 s[0:1], s[4:5], s[8:9]
...
; CHECK-NEXT:    v_sub_i32_e32 v1, vcc, s6, v1
...
; CGP-NEXT:    v_or_b32_e32 v9, v1, v5
...
; CGP-NEXT:  ; %bb.1:
; CGP-NEXT:    v_ashrrev_i32_e32 v8, 31, v5
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v8
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, v5, v8, vcc
; CGP-NEXT:    v_xor_b32_e32 v5, v4, v8
; CGP-NEXT:    v_xor_b32_e32 v4, v9, v8
...
; CGP-NEXT:    v_mac_f32_e32 v9, 0x4f800000, v10
; CGP-NEXT:    v_rcp_iflag_f32_e32 v9, v9
; CGP-NEXT:    v_mul_f32_e32 v9, 0x5f7ffffc, v9
; CGP-NEXT:    v_mul_f32_e32 v10, 0x2f800000, v9
; CGP-NEXT:    v_trunc_f32_e32 v10, v10
; CGP-NEXT:    v_mac_f32_e32 v9, 0xcf800000, v10
; CGP-NEXT:    v_cvt_u32_f32_e32 v16, v9
; CGP-NEXT:    v_cvt_u32_f32_e32 v15, v10
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v17, v16, 0
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v17, v15, v[10:11]
; CGP-NEXT:    v_mul_lo_u32 v10, v15, v9
; CGP-NEXT:    v_mad_u64_u32 v[13:14], s[4:5], v18, v16, v[11:12]
; CGP-NEXT:    v_mul_hi_u32 v11, v16, v9
; CGP-NEXT:    v_mul_hi_u32 v9, v15, v9
; CGP-NEXT:    v_mul_lo_u32 v12, v16, v13
; CGP-NEXT:    v_mul_lo_u32 v14, v15, v13
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v12
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; CGP-NEXT:    v_mul_hi_u32 v11, v16, v13
...
; CGP-NEXT:    v_xor_b32_e32 v14, v0, v17
; CGP-NEXT:    v_mul_lo_u32 v0, v15, v9
; CGP-NEXT:    v_mul_lo_u32 v10, v16, v13
; CGP-NEXT:    v_xor_b32_e32 v18, v1, v17
; CGP-NEXT:    v_mul_hi_u32 v1, v16, v9
; CGP-NEXT:    v_mul_hi_u32 v9, v15, v9
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v1, v15, v13
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v10, v0
; CGP-NEXT:    v_mul_hi_u32 v10, v16, v13
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v9
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v1, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v9, v10
; CGP-NEXT:    v_mul_hi_u32 v10, v15, v13
...
; CGP-NEXT:    v_mul_lo_u32 v9, v18, v0
; CGP-NEXT:    v_mul_lo_u32 v10, v14, v1
; CGP-NEXT:    v_mul_hi_u32 v11, v14, v0
...
; CGP-NEXT:    v_mul_hi_u32 v10, v14, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v11, v0
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v11, v10
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v0, v9
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v10, v0
; CGP-NEXT:    v_mul_hi_u32 v10, v18, v1
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v5, v13, 0
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v10, v9
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v5, v15, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v14, v0
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v4, v13, v[9:10]
; CGP-NEXT:    v_subb_u32_e64 v1, s[4:5], v18, v11, vcc
; CGP-NEXT:    v_sub_i32_e64 v9, s[4:5], v18, v11
...
; CGP-NEXT:    v_cndmask_b32_e64 v1, v10, v11, s[4:5]
...
; CGP-NEXT:    v_cndmask_b32_e32 v0, v10, v4, vcc
...
; CGP-NEXT:    v_sub_i32_e64 v5, s[4:5], v0, v4
; CGP-NEXT:    v_cndmask_b32_e32 v0, v0, v5, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, 1, v1
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; CGP-NEXT:    v_cndmask_b32_e32 v8, v1, v5, vcc
; CGP-NEXT:  .LBB2_4:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    v_or_b32_e32 v1, v3, v7
...
; CGP-NEXT:  ; %bb.5:
; CGP-NEXT:    v_ashrrev_i32_e32 v0, 31, v7
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v6, v0
; CGP-NEXT:    v_addc_u32_e32 v5, vcc, v7, v0, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v10, v7, v2
; CGP-NEXT:    v_mul_hi_u32 v2, v15, v2
; CGP-NEXT:    v_xor_b32_e32 v0, v14, v0
...
; CGP-NEXT:    v_mul_hi_u32 v6, v7, v3
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v10, v2
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v6
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v10, v6
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v2, v5
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v6, v2
; CGP-NEXT:    v_mul_hi_u32 v6, v15, v3
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v12, 0
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v6, v5
; CGP-NEXT:    v_mad_u64_u32 v[5:6], s[4:5], v4, v13, v[3:4]
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v7, v2
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v1, v12, v[5:6]
; CGP-NEXT:    v_subb_u32_e64 v3, s[4:5], v15, v10, vcc
; CGP-NEXT:    v_sub_i32_e64 v5, s[4:5], v15, v10
...
; CGP-NEXT:    v_cndmask_b32_e64 v3, v6, v7, s[4:5]
; CGP-NEXT:    v_add_i32_e32 v6, vcc, 1, v12
...
; CGP-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v1
; CGP-NEXT:    v_cndmask_b32_e32 v1, v6, v2, vcc
; CGP-NEXT:    v_cndmask_b32_e32 v2, v7, v4, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v1, v0
; CGP-NEXT:    v_subb_u32_e32 v5, vcc, v2, v0, vcc
...
; CGP-NEXT:  ; %bb.7:
; CGP-NEXT:    v_cvt_f32_u32_e32 v0, v6
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, 0, v6
...
; CGP-NEXT:    v_mul_lo_u32 v1, v0, v6
...
; CGP-NEXT:    v_sub_i32_e64 v2, s[4:5], v1, v6
; CGP-NEXT:    v_cndmask_b32_e32 v1, v1, v2, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, 1, v0
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v6
; CGP-NEXT:    v_cndmask_b32_e32 v4, v0, v2, vcc
; CGP-NEXT:  .LBB2_8:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    v_mov_b32_e32 v0, v8
...
; CHECK-NEXT:    v_mov_b32_e32 v4, 0
; CHECK-NEXT:    v_lshl_b64 v[2:3], v[3:4], v2
; CHECK-NEXT:    v_mov_b32_e32 v4, 0
; CHECK-NEXT:    v_or_b32_e32 v5, v1, v3
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[4:5]
; CHECK-NEXT:    ; implicit-def: $vgpr4_vgpr5
...
; CGP:       ; %bb.0:
; CGP-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CGP-NEXT:    v_mov_b32_e32 v7, 0x1000
; CGP-NEXT:    v_mov_b32_e32 v8, 0
; CGP-NEXT:    v_lshl_b64 v[9:10], v[7:8], v4
; CGP-NEXT:    v_mov_b32_e32 v4, 0
; CGP-NEXT:    v_or_b32_e32 v5, v1, v10
...
; CGP-NEXT:    v_addc_u32_e32 v10, vcc, v10, v4, vcc
; CGP-NEXT:    v_xor_b32_e32 v9, v5, v4
; CGP-NEXT:    v_xor_b32_e32 v5, v10, v4
; CGP-NEXT:    v_cvt_f32_u32_e32 v10, v9
; CGP-NEXT:    v_cvt_f32_u32_e32 v11, v5
; CGP-NEXT:    v_sub_i32_e32 v18, vcc, 0, v9
; CGP-NEXT:    v_subb_u32_e32 v19, vcc, 0, v5, vcc
...
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v18, v17, 0
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v18, v16, v[11:12]
; CGP-NEXT:    v_ashrrev_i32_e32 v18, 31, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v18
; CGP-NEXT:    v_mad_u64_u32 v[14:15], s[4:5], v19, v17, v[12:13]
; CGP-NEXT:    v_addc_u32_e32 v1, vcc, v1, v18, vcc
; CGP-NEXT:    v_xor_b32_e32 v15, v0, v18
; CGP-NEXT:    v_mul_lo_u32 v0, v16, v10
; CGP-NEXT:    v_mul_lo_u32 v11, v17, v14
; CGP-NEXT:    v_xor_b32_e32 v19, v1, v18
; CGP-NEXT:    v_mul_hi_u32 v1, v17, v10
; CGP-NEXT:    v_mul_hi_u32 v10, v16, v10
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v1, v16, v14
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v11, v0
...
; CGP-NEXT:    v_addc_u32_e32 v1, vcc, v16, v1, vcc
; CGP-NEXT:    v_mul_lo_u32 v10, v19, v0
; CGP-NEXT:    v_mul_lo_u32 v11, v15, v1
; CGP-NEXT:    v_mul_hi_u32 v12, v15, v0
; CGP-NEXT:    v_mul_hi_u32 v0, v19, v0
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v10, v12
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v12, v19, v1
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v11, v10
; CGP-NEXT:    v_mul_hi_u32 v11, v15, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v12, v0
; CGP-NEXT:    v_cndmask_b32_e64 v12, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v11
; CGP-NEXT:    v_cndmask_b32_e64 v11, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v12, v11
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v0, v10
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v11, v0
; CGP-NEXT:    v_mul_hi_u32 v11, v19, v1
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v9, v14, 0
; CGP-NEXT:    v_add_i32_e32 v16, vcc, v11, v10
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v9, v16, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v15, v0
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v5, v14, v[10:11]
...
; CGP-NEXT:    v_mul_hi_u32 v1, v0, v1
; CGP-NEXT:    v_mul_lo_u32 v4, v1, v9
; CGP-NEXT:    v_add_i32_e32 v8, vcc, 1, v1
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v0, v4
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v9
; CGP-NEXT:    v_cndmask_b32_e32 v1, v1, v8, vcc
; CGP-NEXT:    v_sub_i32_e64 v4, s[4:5], v0, v9
; CGP-NEXT:    v_cndmask_b32_e32 v0, v0, v4, vcc
; CGP-NEXT:    v_add_i32_e32 v4, vcc, 1, v1
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v9
; CGP-NEXT:    v_cndmask_b32_e32 v4, v1, v4, vcc
; CGP-NEXT:  .LBB8_4:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    v_or_b32_e32 v1, v3, v7
; CGP-NEXT:    v_mov_b32_e32 v0, 0
...
; CGP-NEXT:    v_ashrrev_i32_e32 v0, 31, v7
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v6, v0
; CGP-NEXT:    v_addc_u32_e32 v7, vcc, v7, v0, vcc
; CGP-NEXT:    v_xor_b32_e32 v6, v1, v0
; CGP-NEXT:    v_xor_b32_e32 v1, v7, v0
; CGP-NEXT:    v_cvt_f32_u32_e32 v7, v6
; CGP-NEXT:    v_cvt_f32_u32_e32 v8, v1
; CGP-NEXT:    v_sub_i32_e32 v15, vcc, 0, v6
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v14, v7
; CGP-NEXT:    v_cvt_u32_f32_e32 v13, v8
; CGP-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v15, v14, 0
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v15, v13, v[8:9]
; CGP-NEXT:    v_mul_lo_u32 v8, v13, v7
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v16, v14, v[9:10]
; CGP-NEXT:    v_mul_hi_u32 v9, v14, v7
; CGP-NEXT:    v_mul_hi_u32 v7, v13, v7
; CGP-NEXT:    v_mul_lo_u32 v10, v14, v11
; CGP-NEXT:    v_mul_lo_u32 v12, v13, v11
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v8, v10
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; CGP-NEXT:    v_mul_hi_u32 v9, v14, v11
...
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CGP-NEXT:    v_mul_hi_u32 v10, v13, v11
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v7, v8
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v10, v8
; CGP-NEXT:    v_add_i32_e32 v14, vcc, v14, v7
; CGP-NEXT:    v_addc_u32_e32 v13, vcc, v13, v8, vcc
; CGP-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v15, v14, 0
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v15, v13, v[8:9]
...
; CGP-NEXT:    v_xor_b32_e32 v12, v2, v15
; CGP-NEXT:    v_mul_lo_u32 v2, v13, v7
; CGP-NEXT:    v_mul_lo_u32 v8, v14, v11
; CGP-NEXT:    v_xor_b32_e32 v16, v3, v15
; CGP-NEXT:    v_mul_hi_u32 v3, v14, v7
; CGP-NEXT:    v_mul_hi_u32 v7, v13, v7
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v8
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v3
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v3, v13, v11
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v8, v2
; CGP-NEXT:    v_mul_hi_u32 v8, v14, v11
...
; CGP-NEXT:    v_mul_lo_u32 v7, v16, v2
; CGP-NEXT:    v_mul_lo_u32 v8, v12, v3
; CGP-NEXT:    v_mul_hi_u32 v9, v12, v2
; CGP-NEXT:    v_mul_hi_u32 v2, v16, v2
; CGP-NEXT:    v_xor_b32_e32 v0, v15, v0
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v7, v8
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v7, v9
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v9, v16, v3
...
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v2, v7
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v8, v2
; CGP-NEXT:    v_mul_hi_u32 v8, v16, v3
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v6, v11, 0
; CGP-NEXT:    v_add_i32_e32 v13, vcc, v8, v7
; CGP-NEXT:    v_mad_u64_u32 v[7:8], s[4:5], v6, v13, v[3:4]
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v12, v2
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v1, v11, v[7:8]
; CGP-NEXT:    v_subb_u32_e64 v3, s[4:5], v16, v9, vcc
; CGP-NEXT:    v_sub_i32_e64 v7, s[4:5], v16, v9
; CGP-NEXT:    v_cmp_ge_u32_e64 s[4:5], v3, v1
; CGP-NEXT:    v_subb_u32_e32 v7, vcc, v7, v1, vcc
...
; CGP-NEXT:    v_subb_u32_e32 v9, vcc, v2, v0, vcc
...
; CGP-NEXT:    v_add_i32_e32 v2, vcc, 1, v0
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v1, v6
; CGP-NEXT:    v_cndmask_b32_e32 v8, v0, v2, vcc
; CGP-NEXT:  .LBB8_8:
; CGP-NEXT:    s_or_b64 exec, exec, s[6:7]
; CGP-NEXT:    v_mov_b32_e32 v0, v4
; CGP-NEXT:    v_mov_b32_e32 v1, v5
; CGP-NEXT:    v_mov_b32_e32 v2, v8
; CGP-NEXT:    v_mov_b32_e32 v3, v9
; CGP-NEXT:    s_setpc_b64 s[30:31]
