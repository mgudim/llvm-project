...
; GFX7-NEXT:    s_mov_b32 s0, s2
; GFX7-NEXT:    s_mov_b32 s1, s3
; GFX7-NEXT:    s_load_dwordx4 s[8:11], s[0:1], 0x0
...
; GFX11-NEXT:    s_load_b128 s[8:11], s[0:1], 0x0
; GFX11-NEXT:    v_and_b32_e32 v1, 1, v0
; GFX11-NEXT:    s_and_b32 s1, s4, 0xffff
...
; GFX10-NEXT:    s_load_dwordx8 s[8:15], s[0:1], 0x0
...
; GFX11-NEXT:    s_load_b256 s[8:15], s[0:1], 0x0
...
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v0, v1, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v2, s[0:1]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v3, s[2:3]
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v4, s[4:5]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v5, s[6:7]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v6, s[8:9]
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v7, s[10:11]
; GFX9-NEXT:    v_and_or_b32 v12, v13, s13, v12
...
; GFX7-NEXT:    s_mov_b32 s7, 0xf000
; GFX7-NEXT:    s_mov_b64 s[4:5], 0
; GFX7-NEXT:    buffer_load_dwordx4 v[0:3], v[4:5], s[4:7], 0 addr64
; GFX7-NEXT:    buffer_load_dwordx4 v[4:7], v[4:5], s[4:7], 0 addr64 offset:16
; GFX7-NEXT:    s_and_b32 s0, s3, 1
...
; GFX7-NEXT:    s_mov_b32 s6, -1
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_movrels_b32_e32 v8, v0
; GFX7-NEXT:    v_bfi_b32 v8, s0, 0, v8
; GFX7-NEXT:    v_or_b32_e32 v8, s1, v8
...
; GFX10-NEXT:    v_mov_b32_e32 v11, 0
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_movrels_b32_e32 v8, v0
; GFX10-NEXT:    v_and_or_b32 v12, v8, s1, s0
; GFX10-NEXT:    v_mov_b32_e32 v8, 0
; GFX10-NEXT:    v_mov_b32_e32 v9, 0
...
; GFX11-NEXT:    v_mov_b32_e32 v11, 0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_movrels_b32_e32 v8, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_and_or_b32 v12, v8, s1, s0
; GFX11-NEXT:    v_mov_b32_e32 v8, 0
; GFX11-NEXT:    v_mov_b32_e32 v9, 0
...
; GFX9-NEXT:    s_mov_b32 s0, s2
; GFX9-NEXT:    s_mov_b32 s1, s3
; GFX9-NEXT:    s_load_dwordx8 s[16:23], s[0:1], 0x0
...
; GFX8-NEXT:    s_mov_b32 s0, s2
; GFX8-NEXT:    s_mov_b32 s1, s3
; GFX8-NEXT:    s_load_dwordx8 s[16:23], s[0:1], 0x0
...
; GFX7-NEXT:    s_mov_b32 s0, s2
; GFX7-NEXT:    s_mov_b32 s1, s3
; GFX7-NEXT:    s_load_dwordx8 s[16:23], s[0:1], 0x0
...
; GFX7-NEXT:    s_mov_b32 s0, s2
; GFX7-NEXT:    s_mov_b32 s1, s3
; GFX7-NEXT:    s_load_dwordx8 s[12:19], s[0:1], 0x0
