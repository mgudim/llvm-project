...
; GFX11-True16:       ; %bb.0:
; GFX11-True16-NEXT:    v_dual_mov_b32 v2, v0 :: v_dual_mov_b32 v3, v1
; GFX11-True16-NEXT:    v_mov_b32_e32 v0, 0
; GFX11-True16-NEXT:    s_clause 0x1
; GFX11-True16-NEXT:    global_load_d16_b16 v1, v0, s[0:1]
; GFX11-True16-NEXT:    global_load_d16_b16 v0, v0, s[2:3] glc dlc
...
; GFX12-True16:       ; %bb.0:
; GFX12-True16-NEXT:    v_dual_mov_b32 v2, v0 :: v_dual_mov_b32 v3, v1
; GFX12-True16-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-True16-NEXT:    s_clause 0x1
; GFX12-True16-NEXT:    global_load_d16_b16 v1, v0, s[0:1]
; GFX12-True16-NEXT:    global_load_d16_b16 v0, v0, s[2:3] scope:SCOPE_SYS
...
; GFX11-True16-NEXT:    s_clause 0x1
; GFX11-True16-NEXT:    global_load_d16_b16 v1, v0, s[0:1]
; GFX11-True16-NEXT:    global_load_d16_b16 v0, v0, s[0:1] glc dlc
; GFX11-True16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-True16-NEXT:    v_readfirstlane_b32 s0, v1
; GFX11-True16-NEXT:    v_readfirstlane_b32 s1, v0
; GFX11-True16-NEXT:    s_add_i32 s0, s0, s1
...
; GFX12-True16-NEXT:    global_load_d16_b16 v0, v0, s[0:1] scope:SCOPE_SYS
; GFX12-True16-NEXT:    s_wait_loadcnt 0x0
...
; GFX7-NEXT:    buffer_load_dwordx3 v[0:2], off, s[0:3], 0
; GFX7-NEXT:    buffer_load_dwordx3 v[3:5], off, s[0:3], 0 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_mov_b32 s2, 0
...
; GFX7-NEXT:    s_mov_b64 s[0:1], 0
; GFX7-NEXT:    buffer_store_dwordx3 v[0:2], v[6:7], s[0:3], 0 addr64
; GFX7-NEXT:    s_endpgm
;
; GFX11-LABEL: load_uniform_P1_v3i32_gfx12:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v6, v0
; GFX11-NEXT:    v_mov_b32_e32 v7, v1
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    global_load_b96 v[0:2], v3, s[0:1]
; GFX11-NEXT:    global_load_b96 v[3:5], v3, s[0:1] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    global_store_b96 v[6:7], v[0:2], off
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: load_uniform_P1_v3i32_gfx12:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_dual_mov_b32 v3, 0 :: v_dual_mov_b32 v6, v0
; GFX12-NEXT:    v_mov_b32_e32 v7, v1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b96 v[0:2], v3, s[0:1]
; GFX12-NEXT:    global_load_b96 v[3:5], v3, s[0:1] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-NEXT:    global_store_b96 v[6:7], v[0:2], off
; GFX12-NEXT:    s_endpgm
...
; GFX7-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_mov_b32 s2, 0
; GFX7-NEXT:    v_readfirstlane_b32 s0, v0
; GFX7-NEXT:    v_readfirstlane_b32 s4, v4
; GFX7-NEXT:    v_readfirstlane_b32 s1, v1
; GFX7-NEXT:    v_readfirstlane_b32 s6, v2
; GFX7-NEXT:    v_readfirstlane_b32 s7, v3
; GFX7-NEXT:    v_readfirstlane_b32 s5, v5
...
; GFX7-NEXT:    s_mov_b64 s[0:1], 0
; GFX7-NEXT:    buffer_store_dwordx4 v[0:3], v[8:9], s[0:3], 0 addr64
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    global_load_b128 v[4:7], v4, s[0:1] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s4, v4
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[0:3], v4, s[0:1]
; GFX12-NEXT:    global_load_b128 v[4:7], v4, s[0:1] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-NEXT:    v_readfirstlane_b32 s4, v4
; GFX12-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX7-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0 offset:16 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_mov_b32 s2, 0
; GFX7-NEXT:    s_mov_b64 s[0:1], 0
...
; GFX7-NEXT:    v_readfirstlane_b32 s13, v9
; GFX7-NEXT:    v_readfirstlane_b32 s14, v10
; GFX7-NEXT:    v_readfirstlane_b32 s15, v11
; GFX7-NEXT:    v_readfirstlane_b32 s16, v12
...
; GFX7-NEXT:    v_readfirstlane_b32 s17, v13
; GFX7-NEXT:    v_readfirstlane_b32 s18, v14
; GFX7-NEXT:    v_readfirstlane_b32 s19, v15
...
; GFX7-NEXT:    buffer_store_dwordx4 v[0:3], v[16:17], s[0:3], 0 addr64
; GFX7-NEXT:    buffer_store_dwordx4 v[4:7], v[16:17], s[0:3], 0 addr64 offset:16
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    global_load_b128 v[8:11], v12, s[0:1] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_b128 v[12:15], v12, s[0:1] offset:16 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
...
; GFX12-NEXT:    global_load_b128 v[0:3], v12, s[0:1]
; GFX12-NEXT:    global_load_b128 v[4:7], v12, s[0:1] offset:16
; GFX12-NEXT:    global_load_b128 v[8:11], v12, s[0:1] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_load_b128 v[12:15], v12, s[0:1] offset:16 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12-NEXT:    v_readfirstlane_b32 s8, v8
; GFX12-NEXT:    v_readfirstlane_b32 s2, v2
; GFX12-NEXT:    v_readfirstlane_b32 s3, v3
; GFX12-NEXT:    v_readfirstlane_b32 s4, v4
; GFX12-NEXT:    v_readfirstlane_b32 s9, v9
; GFX12-NEXT:    v_readfirstlane_b32 s10, v10
; GFX12-NEXT:    v_readfirstlane_b32 s11, v11
...
; GFX7-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0
; GFX7-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:16
; GFX7-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:32
; GFX7-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0 offset:48
; GFX7-NEXT:    s_waitcnt vmcnt(3)
; GFX7-NEXT:    v_readfirstlane_b32 s4, v0
; GFX7-NEXT:    v_readfirstlane_b32 s5, v1
; GFX7-NEXT:    v_readfirstlane_b32 s6, v2
; GFX7-NEXT:    v_readfirstlane_b32 s7, v3
; GFX7-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_readfirstlane_b32 s8, v4
; GFX7-NEXT:    v_readfirstlane_b32 s9, v5
; GFX7-NEXT:    v_readfirstlane_b32 s10, v6
; GFX7-NEXT:    v_readfirstlane_b32 s11, v7
; GFX7-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:16 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_readfirstlane_b32 s12, v8
; GFX7-NEXT:    v_readfirstlane_b32 s13, v9
; GFX7-NEXT:    v_readfirstlane_b32 s14, v10
; GFX7-NEXT:    v_readfirstlane_b32 s15, v11
; GFX7-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:32 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_readfirstlane_b32 s16, v12
; GFX7-NEXT:    v_readfirstlane_b32 s17, v13
; GFX7-NEXT:    v_readfirstlane_b32 s18, v14
; GFX7-NEXT:    v_readfirstlane_b32 s19, v15
; GFX7-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0 offset:48 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_mov_b32 s2, 0
; GFX7-NEXT:    s_mov_b64 s[0:1], 0
; GFX7-NEXT:    v_readfirstlane_b32 s20, v0
; GFX7-NEXT:    v_readfirstlane_b32 s21, v1
; GFX7-NEXT:    v_readfirstlane_b32 s22, v2
; GFX7-NEXT:    v_readfirstlane_b32 s23, v3
; GFX7-NEXT:    s_add_i32 s4, s4, s20
; GFX7-NEXT:    v_readfirstlane_b32 s24, v4
; GFX7-NEXT:    v_readfirstlane_b32 s25, v5
; GFX7-NEXT:    v_readfirstlane_b32 s26, v6
; GFX7-NEXT:    v_readfirstlane_b32 s27, v7
; GFX7-NEXT:    s_add_i32 s5, s5, s21
; GFX7-NEXT:    v_readfirstlane_b32 s28, v8
; GFX7-NEXT:    v_readfirstlane_b32 s29, v9
; GFX7-NEXT:    v_readfirstlane_b32 s30, v10
; GFX7-NEXT:    v_readfirstlane_b32 s31, v11
; GFX7-NEXT:    s_add_i32 s6, s6, s22
; GFX7-NEXT:    v_readfirstlane_b32 s33, v12
; GFX7-NEXT:    v_readfirstlane_b32 s34, v13
; GFX7-NEXT:    v_readfirstlane_b32 s35, v14
; GFX7-NEXT:    v_readfirstlane_b32 s36, v15
...
; GFX7-NEXT:    v_mov_b32_e32 v3, s7
; GFX7-NEXT:    v_mov_b32_e32 v4, s8
; GFX7-NEXT:    v_mov_b32_e32 v8, s12
; GFX7-NEXT:    v_mov_b32_e32 v12, s16
; GFX7-NEXT:    v_mov_b32_e32 v5, s9
; GFX7-NEXT:    v_mov_b32_e32 v6, s10
; GFX7-NEXT:    v_mov_b32_e32 v7, s11
; GFX7-NEXT:    v_mov_b32_e32 v9, s13
; GFX7-NEXT:    v_mov_b32_e32 v10, s14
; GFX7-NEXT:    v_mov_b32_e32 v11, s15
; GFX7-NEXT:    v_mov_b32_e32 v13, s17
; GFX7-NEXT:    v_mov_b32_e32 v14, s18
; GFX7-NEXT:    v_mov_b32_e32 v15, s19
; GFX7-NEXT:    buffer_store_dwordx4 v[0:3], v[16:17], s[0:3], 0 addr64
; GFX7-NEXT:    buffer_store_dwordx4 v[4:7], v[16:17], s[0:3], 0 addr64 offset:16
; GFX7-NEXT:    buffer_store_dwordx4 v[8:11], v[16:17], s[0:3], 0 addr64 offset:32
; GFX7-NEXT:    buffer_store_dwordx4 v[12:15], v[16:17], s[0:3], 0 addr64 offset:48
; GFX7-NEXT:    s_endpgm
;
; GFX11-LABEL: load_uniform_P1_v16i32:
; GFX11:       ; %bb.0:
; GFX11-NEXT:    v_mov_b32_e32 v28, 0
; GFX11-NEXT:    v_dual_mov_b32 v32, v0 :: v_dual_mov_b32 v33, v1
...
; GFX11-NEXT:    global_load_b128 v[16:19], v28, s[0:1] glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_b128 v[20:23], v28, s[0:1] offset:16 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_b128 v[24:27], v28, s[0:1] offset:32 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_load_b128 v[28:31], v28, s[0:1] offset:48 glc dlc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s0, v0
; GFX11-NEXT:    v_readfirstlane_b32 s1, v1
; GFX11-NEXT:    v_readfirstlane_b32 s2, v2
; GFX11-NEXT:    v_readfirstlane_b32 s3, v3
; GFX11-NEXT:    v_readfirstlane_b32 s16, v16
; GFX11-NEXT:    v_readfirstlane_b32 s4, v4
; GFX11-NEXT:    v_readfirstlane_b32 s17, v17
; GFX11-NEXT:    v_readfirstlane_b32 s18, v18
; GFX11-NEXT:    v_readfirstlane_b32 s19, v19
; GFX11-NEXT:    v_readfirstlane_b32 s20, v20
; GFX11-NEXT:    v_readfirstlane_b32 s5, v5
; GFX11-NEXT:    v_readfirstlane_b32 s6, v6
; GFX11-NEXT:    v_readfirstlane_b32 s7, v7
; GFX11-NEXT:    v_readfirstlane_b32 s8, v8
; GFX11-NEXT:    v_readfirstlane_b32 s21, v21
; GFX11-NEXT:    v_readfirstlane_b32 s22, v22
; GFX11-NEXT:    v_readfirstlane_b32 s23, v23
; GFX11-NEXT:    v_readfirstlane_b32 s24, v24
; GFX11-NEXT:    v_readfirstlane_b32 s9, v9
; GFX11-NEXT:    v_readfirstlane_b32 s10, v10
; GFX11-NEXT:    v_readfirstlane_b32 s11, v11
; GFX11-NEXT:    v_readfirstlane_b32 s12, v12
; GFX11-NEXT:    v_readfirstlane_b32 s25, v25
; GFX11-NEXT:    v_readfirstlane_b32 s26, v26
; GFX11-NEXT:    v_readfirstlane_b32 s27, v27
; GFX11-NEXT:    v_readfirstlane_b32 s28, v28
; GFX11-NEXT:    v_readfirstlane_b32 s13, v13
; GFX11-NEXT:    v_readfirstlane_b32 s14, v14
; GFX11-NEXT:    v_readfirstlane_b32 s15, v15
; GFX11-NEXT:    v_readfirstlane_b32 s29, v29
; GFX11-NEXT:    v_readfirstlane_b32 s30, v30
; GFX11-NEXT:    v_readfirstlane_b32 s31, v31
...
; GFX11-NEXT:    v_dual_mov_b32 v13, s13 :: v_dual_mov_b32 v14, s14
...
; GFX12-NEXT:    v_dual_mov_b32 v32, v0 :: v_dual_mov_b32 v33, v1
; GFX12-NEXT:    s_clause 0x4
; GFX12-NEXT:    global_load_b128 v[0:3], v28, s[0:1]
; GFX12-NEXT:    global_load_b128 v[4:7], v28, s[0:1] offset:16
; GFX12-NEXT:    global_load_b128 v[8:11], v28, s[0:1] offset:32
; GFX12-NEXT:    global_load_b128 v[12:15], v28, s[0:1] offset:48
; GFX12-NEXT:    global_load_b128 v[16:19], v28, s[0:1] scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_load_b128 v[20:23], v28, s[0:1] offset:16 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_load_b128 v[24:27], v28, s[0:1] offset:32 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_load_b128 v[28:31], v28, s[0:1] offset:48 scope:SCOPE_SYS
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12-NEXT:    v_readfirstlane_b32 s2, v2
; GFX12-NEXT:    v_readfirstlane_b32 s3, v3
; GFX12-NEXT:    v_readfirstlane_b32 s16, v16
; GFX12-NEXT:    v_readfirstlane_b32 s4, v4
; GFX12-NEXT:    v_readfirstlane_b32 s17, v17
; GFX12-NEXT:    v_readfirstlane_b32 s18, v18
; GFX12-NEXT:    v_readfirstlane_b32 s19, v19
; GFX12-NEXT:    v_readfirstlane_b32 s20, v20
; GFX12-NEXT:    v_readfirstlane_b32 s5, v5
; GFX12-NEXT:    v_readfirstlane_b32 s6, v6
; GFX12-NEXT:    v_readfirstlane_b32 s7, v7
; GFX12-NEXT:    v_readfirstlane_b32 s8, v8
; GFX12-NEXT:    v_readfirstlane_b32 s21, v21
; GFX12-NEXT:    v_readfirstlane_b32 s22, v22
; GFX12-NEXT:    v_readfirstlane_b32 s23, v23
; GFX12-NEXT:    v_readfirstlane_b32 s24, v24
; GFX12-NEXT:    v_readfirstlane_b32 s9, v9
; GFX12-NEXT:    v_readfirstlane_b32 s10, v10
; GFX12-NEXT:    v_readfirstlane_b32 s11, v11
; GFX12-NEXT:    v_readfirstlane_b32 s12, v12
; GFX12-NEXT:    v_readfirstlane_b32 s25, v25
; GFX12-NEXT:    v_readfirstlane_b32 s26, v26
; GFX12-NEXT:    v_readfirstlane_b32 s27, v27
; GFX12-NEXT:    v_readfirstlane_b32 s28, v28
; GFX12-NEXT:    v_readfirstlane_b32 s13, v13
; GFX12-NEXT:    v_readfirstlane_b32 s14, v14
; GFX12-NEXT:    v_readfirstlane_b32 s15, v15
; GFX12-NEXT:    v_readfirstlane_b32 s29, v29
; GFX12-NEXT:    v_readfirstlane_b32 s30, v30
; GFX12-NEXT:    v_readfirstlane_b32 s31, v31
...
; GFX12-NEXT:    global_store_b128 v[32:33], v[0:3], off
; GFX12-NEXT:    global_store_b128 v[32:33], v[4:7], off offset:16
; GFX12-NEXT:    global_store_b128 v[32:33], v[8:11], off offset:32
; GFX12-NEXT:    global_store_b128 v[32:33], v[12:15], off offset:48
; GFX12-NEXT:    s_endpgm
...
; GFX7-NEXT:    v_readfirstlane_b32 s1, v1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    v_readfirstlane_b32 s7, v2
; GFX7-NEXT:    s_add_i32 s4, s0, s4
; GFX7-NEXT:    s_add_i32 s5, s1, s5
...
; GFX11-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX11-NEXT:    v_mov_b32_e32 v2, s2
; GFX11-NEXT:    global_store_b96 v[3:4], v[0:2], off
; GFX11-NEXT:    s_endpgm
;
; GFX12-LABEL: load_uniform_P4_v3i32_gfx12:
; GFX12:       ; %bb.0:
; GFX12-NEXT:    v_dual_mov_b32 v3, v0 :: v_dual_mov_b32 v4, v1
; GFX12-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-NEXT:    global_load_b96 v[0:2], v0, s[0:1]
...
; GFX7-NEXT:    s_mov_b64 s[0:1], 0
; GFX7-NEXT:    s_waitcnt vmcnt(1)
; GFX7-NEXT:    v_readfirstlane_b32 s12, v0
; GFX7-NEXT:    v_readfirstlane_b32 s13, v1
; GFX7-NEXT:    v_readfirstlane_b32 s14, v2
; GFX7-NEXT:    v_readfirstlane_b32 s15, v3
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_readfirstlane_b32 s16, v4
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_add_i32 s4, s12, s4
; GFX7-NEXT:    v_readfirstlane_b32 s17, v5
; GFX7-NEXT:    v_readfirstlane_b32 s18, v6
; GFX7-NEXT:    v_readfirstlane_b32 s19, v7
...
; GFX7-NEXT:    v_mov_b32_e32 v7, s11
; GFX7-NEXT:    buffer_store_dwordx4 v[0:3], v[8:9], s[0:3], 0 addr64
; GFX7-NEXT:    buffer_store_dwordx4 v[4:7], v[8:9], s[0:3], 0 addr64 offset:16
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s12, v4
; GFX11-NEXT:    v_readfirstlane_b32 s13, v5
; GFX11-NEXT:    v_readfirstlane_b32 s14, v6
; GFX11-NEXT:    v_readfirstlane_b32 s15, v7
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_load_b128 v[0:3], v4, s[0:1]
; GFX12-NEXT:    global_load_b128 v[4:7], v4, s[0:1] offset:16
; GFX12-NEXT:    s_load_b256 s[0:7], s[0:1], 0x0
; GFX12-NEXT:    s_wait_loadcnt 0x1
; GFX12-NEXT:    v_readfirstlane_b32 s8, v0
; GFX12-NEXT:    v_readfirstlane_b32 s9, v1
; GFX12-NEXT:    v_readfirstlane_b32 s10, v2
; GFX12-NEXT:    v_readfirstlane_b32 s11, v3
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s12, v4
; GFX12-NEXT:    v_readfirstlane_b32 s13, v5
; GFX12-NEXT:    v_readfirstlane_b32 s14, v6
; GFX12-NEXT:    v_readfirstlane_b32 s15, v7
; GFX12-NEXT:    s_wait_kmcnt 0x0
...
; GFX7-NEXT:    s_mov_b32 s17, s1
; GFX7-NEXT:    s_mov_b32 s18, -1
; GFX7-NEXT:    s_mov_b32 s19, 0xf000
; GFX7-NEXT:    v_mov_b32_e32 v16, v0
; GFX7-NEXT:    v_mov_b32_e32 v17, v1
; GFX7-NEXT:    buffer_load_dwordx4 v[0:3], off, s[16:19], 0
; GFX7-NEXT:    buffer_load_dwordx4 v[4:7], off, s[16:19], 0 offset:16
; GFX7-NEXT:    buffer_load_dwordx4 v[8:11], off, s[16:19], 0 offset:32
; GFX7-NEXT:    buffer_load_dwordx4 v[12:15], off, s[16:19], 0 offset:48
; GFX7-NEXT:    s_load_dwordx16 s[0:15], s[16:17], 0x0
...
; GFX7-NEXT:    v_readfirstlane_b32 s35, v14
; GFX7-NEXT:    v_readfirstlane_b32 s36, v15
; GFX7-NEXT:    s_add_i32 s1, s21, s1
; GFX7-NEXT:    s_add_i32 s2, s22, s2
; GFX7-NEXT:    s_add_i32 s3, s23, s3
; GFX7-NEXT:    s_add_i32 s4, s24, s4
; GFX7-NEXT:    s_add_i32 s8, s28, s8
; GFX7-NEXT:    s_add_i32 s12, s33, s12
; GFX7-NEXT:    v_mov_b32_e32 v0, s0
; GFX7-NEXT:    s_add_i32 s5, s25, s5
; GFX7-NEXT:    s_add_i32 s6, s26, s6
; GFX7-NEXT:    s_add_i32 s7, s27, s7
; GFX7-NEXT:    s_add_i32 s9, s29, s9
; GFX7-NEXT:    s_add_i32 s10, s30, s10
; GFX7-NEXT:    s_add_i32 s11, s31, s11
; GFX7-NEXT:    s_add_i32 s13, s34, s13
; GFX7-NEXT:    s_add_i32 s14, s35, s14
; GFX7-NEXT:    s_add_i32 s15, s36, s15
...
; GFX7-NEXT:    v_mov_b32_e32 v13, s13
; GFX7-NEXT:    v_mov_b32_e32 v14, s14
; GFX7-NEXT:    v_mov_b32_e32 v15, s15
; GFX7-NEXT:    buffer_store_dwordx4 v[0:3], v[16:17], s[16:19], 0 addr64
; GFX7-NEXT:    buffer_store_dwordx4 v[4:7], v[16:17], s[16:19], 0 addr64 offset:16
; GFX7-NEXT:    buffer_store_dwordx4 v[8:11], v[16:17], s[16:19], 0 addr64 offset:32
; GFX7-NEXT:    buffer_store_dwordx4 v[12:15], v[16:17], s[16:19], 0 addr64 offset:48
; GFX7-NEXT:    s_endpgm
;
...
; GFX11-NEXT:    v_readfirstlane_b32 s16, v0
; GFX11-NEXT:    v_readfirstlane_b32 s17, v1
; GFX11-NEXT:    v_readfirstlane_b32 s18, v2
; GFX11-NEXT:    v_readfirstlane_b32 s19, v3
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    v_readfirstlane_b32 s20, v4
; GFX11-NEXT:    v_readfirstlane_b32 s21, v5
; GFX11-NEXT:    v_readfirstlane_b32 s22, v6
; GFX11-NEXT:    v_readfirstlane_b32 s23, v7
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    v_readfirstlane_b32 s24, v8
; GFX11-NEXT:    v_readfirstlane_b32 s25, v9
; GFX11-NEXT:    v_readfirstlane_b32 s26, v10
; GFX11-NEXT:    v_readfirstlane_b32 s27, v11
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_readfirstlane_b32 s28, v12
; GFX11-NEXT:    v_readfirstlane_b32 s29, v13
; GFX11-NEXT:    v_readfirstlane_b32 s30, v14
; GFX11-NEXT:    v_readfirstlane_b32 s31, v15
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX12-NEXT:    global_load_b128 v[0:3], v12, s[0:1]
; GFX12-NEXT:    global_load_b128 v[4:7], v12, s[0:1] offset:16
; GFX12-NEXT:    global_load_b128 v[8:11], v12, s[0:1] offset:32
; GFX12-NEXT:    global_load_b128 v[12:15], v12, s[0:1] offset:48
; GFX12-NEXT:    s_load_b512 s[0:15], s[0:1], 0x0
; GFX12-NEXT:    s_wait_loadcnt 0x3
; GFX12-NEXT:    v_readfirstlane_b32 s16, v0
; GFX12-NEXT:    v_readfirstlane_b32 s17, v1
; GFX12-NEXT:    v_readfirstlane_b32 s18, v2
; GFX12-NEXT:    v_readfirstlane_b32 s19, v3
; GFX12-NEXT:    s_wait_loadcnt 0x2
; GFX12-NEXT:    v_readfirstlane_b32 s20, v4
; GFX12-NEXT:    v_readfirstlane_b32 s21, v5
; GFX12-NEXT:    v_readfirstlane_b32 s22, v6
; GFX12-NEXT:    v_readfirstlane_b32 s23, v7
; GFX12-NEXT:    s_wait_loadcnt 0x1
; GFX12-NEXT:    v_readfirstlane_b32 s24, v8
; GFX12-NEXT:    v_readfirstlane_b32 s25, v9
; GFX12-NEXT:    v_readfirstlane_b32 s26, v10
; GFX12-NEXT:    v_readfirstlane_b32 s27, v11
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_readfirstlane_b32 s28, v12
; GFX12-NEXT:    v_readfirstlane_b32 s29, v13
; GFX12-NEXT:    v_readfirstlane_b32 s30, v14
; GFX12-NEXT:    v_readfirstlane_b32 s31, v15
; GFX12-NEXT:    s_wait_kmcnt 0x0
