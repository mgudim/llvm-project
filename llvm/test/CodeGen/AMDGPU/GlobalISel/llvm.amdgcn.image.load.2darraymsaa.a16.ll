...
; GFX9-NEXT:    v_lshl_or_b32 v7, v3, 16, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-NEXT:    image_load v[1:5], v[6:7], s[0:7] dmask:0xf unorm a16 tfe da
...
; GFX10-NEXT:    v_mov_b32_e32 v5, v4
; GFX10-NEXT:    image_load v[5:9], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 tfe
...
; GFX11-NEXT:    v_mov_b32_e32 v5, v4
; GFX11-NEXT:    image_load v[5:9], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 tfe
...
; GFX12-NEXT:    v_mov_b32_e32 v5, v4
; GFX12-NEXT:    image_load v[5:9], [v0, v1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY a16 tfe
...
; GFX9-NEXT:    v_mov_b32_e32 v2, v1
; GFX9-NEXT:    v_mov_b32_e32 v1, v0
; GFX9-NEXT:    image_load v[1:5], v[6:7], s[0:7] dmask:0xf unorm a16 tfe lwe da
; GFX9-NEXT:    s_mov_b32 s8, s10
; GFX9-NEXT:    s_mov_b32 s9, s11
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    global_store_dword v0, v5, s[8:9]
...
; GFX10-NEXT:    v_mov_b32_e32 v6, v5
; GFX10-NEXT:    v_mov_b32_e32 v5, v4
; GFX10-NEXT:    image_load v[5:9], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 tfe lwe
; GFX10-NEXT:    s_mov_b32 s8, s10
; GFX10-NEXT:    s_mov_b32 s9, s11
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_mov_b32_e32 v0, v5
...
; GFX11-NEXT:    v_mov_b32_e32 v6, v5
; GFX11-NEXT:    v_mov_b32_e32 v5, v4
; GFX11-NEXT:    image_load v[5:9], v[0:1], s[0:7] dmask:0xf dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm a16 tfe lwe
; GFX11-NEXT:    s_mov_b32 s8, s10
; GFX11-NEXT:    s_mov_b32 s9, s11
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_mov_b32_e32 v0, v5
