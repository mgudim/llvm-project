...
; GCN-NEXT:    v_wmma_f32_16x16x16_f16 v[0:3], v[6:7], v[8:9], 1.0
...
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_f16 v[0:3], v[6:7], v[8:9], v[0:3]
; GCN-NEXT:    global_store_b128 v[4:5], v[0:3], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v9, v3
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_bf16 v[0:3], v[6:7], v[8:9], 1.0
; GCN-NEXT:    global_store_b128 v[4:5], v[0:3], off
; GCN-NEXT:    s_endpgm
bb:
...
; GCN-NEXT:    v_mov_b32_e32 v3, s3
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_bf16 v[0:3], v[6:7], v[8:9], v[0:3]
; GCN-NEXT:    global_store_b128 v[4:5], v[0:3], off
; GCN-NEXT:    s_endpgm
bb:
