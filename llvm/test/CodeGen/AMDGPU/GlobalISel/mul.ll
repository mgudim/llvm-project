...
; GFX7-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v5, v8, v[12:13]
...
; GFX7-NEXT:    v_mad_u64_u32 v[12:13], vcc, v1, v8, v[2:3]
; GFX7-NEXT:    v_addc_u32_e32 v3, vcc, v6, v19, vcc
; GFX7-NEXT:    v_addc_u32_e32 v4, vcc, v4, v20, vcc
; GFX7-NEXT:    v_addc_u32_e32 v5, vcc, v5, v10, vcc
; GFX7-NEXT:    v_addc_u32_e32 v6, vcc, v24, v11, vcc
; GFX7-NEXT:    v_addc_u32_e32 v0, vcc, v23, v0, vcc
; GFX7-NEXT:    v_addc_u32_e64 v0, vcc, v0, v14, s[14:15]
...
; GFX8-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v5, v8, v[12:13]
...
; GFX8-NEXT:    v_mad_u64_u32 v[12:13], vcc, v1, v8, v[2:3]
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, v6, v19, vcc
; GFX8-NEXT:    v_addc_u32_e32 v4, vcc, v4, v20, vcc
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, v5, v10, vcc
; GFX8-NEXT:    v_addc_u32_e32 v6, vcc, v24, v11, vcc
; GFX8-NEXT:    v_addc_u32_e32 v0, vcc, v23, v0, vcc
; GFX8-NEXT:    v_addc_u32_e64 v0, vcc, v0, v14, s[14:15]
...
; GFX9-NEXT:    v_mad_u64_u32 v[10:11], s[14:15], v5, v8, v[12:13]
...
; GFX9-NEXT:    v_mad_u64_u32 v[12:13], vcc, v1, v8, v[2:3]
; GFX9-NEXT:    v_addc_co_u32_e32 v3, vcc, v6, v19, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v4, vcc, v4, v20, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v5, vcc, v5, v10, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v6, vcc, v24, v11, vcc
; GFX9-NEXT:    v_addc_co_u32_e32 v0, vcc, v23, v0, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v0, vcc, v0, v14, s[14:15]
...
; GFX10-NEXT:    v_add_co_ci_u32_e64 v13, s6, 0, v10, s6
...
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s8, v19, v8, v[3:4]
; GFX10-NEXT:    v_add_co_ci_u32_e64 v16, s8, 0, v13, s8
; GFX10-NEXT:    v_mad_u64_u32 v[12:13], s8, v21, v8, v[5:6]
; GFX10-NEXT:    v_mad_u64_u32 v[14:15], s9, v17, v8, v[10:11]
; GFX10-NEXT:    v_add_co_ci_u32_e64 v3, s9, v9, v1, s9
; GFX10-NEXT:    v_add_co_ci_u32_e64 v4, s9, v28, v2, s9
; GFX10-NEXT:    v_add_co_ci_u32_e64 v5, s9, v16, v12, s9
; GFX10-NEXT:    v_add_co_ci_u32_e64 v6, s9, v25, v13, s9
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, s9, v7, v30, s9
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, s8, v1, v31, s8
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, s6, v1, v24, s6
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, s6, v1, v23, s7
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, s4, v1, v29, s4
; GFX10-NEXT:    v_add_co_ci_u32_e64 v1, s4, v1, v26, s5
; GFX10-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, v1, v27, vcc_lo
; GFX10-NEXT:    v_mad_u64_u32 v[7:8], s4, v22, v8, v[1:2]
; GFX10-NEXT:    v_mov_b32_e32 v1, v14
...
; GFX11-NEXT:    v_mad_u64_u32 v[1:2], s4, v19, v22, v[3:4]
; GFX11-NEXT:    v_add_co_ci_u32_e64 v18, null, 0, v8, s4
; GFX11-NEXT:    v_mad_u64_u32 v[8:9], s4, v21, v22, v[5:6]
; GFX11-NEXT:    v_mad_u64_u32 v[12:13], s5, v17, v22, v[10:11]
; GFX11-NEXT:    v_add_co_ci_u32_e64 v3, s5, v16, v1, s5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v4, s5, v29, v2, s5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v5, s5, v18, v8, s5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v6, s5, v26, v9, s5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v7, v15, s5
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v14, s4
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v25, s2
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v24, s3
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v30, s0
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v27, s1
; GFX11-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v28, vcc_lo
; GFX11-NEXT:    v_mad_u64_u32 v[7:8], null, v23, v22, v[1:2]
...
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v13, null, 0, v10, s2
...
; GFX12-NEXT:    v_mad_co_u64_u32 v[1:2], s4, v19, v8, v[3:4]
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v16, null, 0, v13, s4
; GFX12-NEXT:    v_mad_co_u64_u32 v[12:13], s4, v21, v8, v[5:6]
; GFX12-NEXT:    v_mad_co_u64_u32 v[14:15], s5, v17, v8, v[10:11]
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_4)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v3, s5, v9, v1, s5
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v4, s5, v28, v2, s5
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v5, s5, v16, v12, s5
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v6, s5, v25, v13, s5
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, v7, v30, s5
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v31, s4
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v24, s2
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v23, s3
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v29, s0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v26, s1
; GFX12-NEXT:    s_wait_alu depctr_va_vcc(0)
; GFX12-NEXT:    v_add_co_ci_u32_e64 v1, null, v1, v27, vcc_lo
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_u64_u32 v[7:8], null, v22, v8, v[1:2]
; GFX12-NEXT:    v_dual_mov_b32 v1, v14 :: v_dual_mov_b32 v2, v15
; GFX12-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v6, 0
; GFX7-NEXT:    v_ashrrev_i32_e32 v7, 31, v2
; GFX7-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v7, v6, v[1:2]
; GFX7-NEXT:    v_mov_b32_e32 v1, v2
; GFX7-NEXT:    buffer_store_dwordx2 v[0:1], v[4:5], s[0:3], 0 addr64
; GFX7-NEXT:    s_endpgm
;
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], v2, v6, 0
; GFX8-NEXT:    v_ashrrev_i32_e32 v7, 31, v2
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v7, v6, v[1:2]
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], v2, v6, 0
; GFX9-NEXT:    v_ashrrev_i32_e32 v7, 31, v2
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v7, v6, v[1:2]
...
; GFX10-NEXT:    v_mov_b32_e32 v5, v1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], s0, 0x50, v2, 0
; GFX10-NEXT:    v_ashrrev_i32_e32 v2, 31, v2
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], s0, 0x50, v2, v[1:2]
...
; GFX11-NEXT:    v_mad_u64_u32 v[2:3], null, 0x50, v6, v[1:2]
