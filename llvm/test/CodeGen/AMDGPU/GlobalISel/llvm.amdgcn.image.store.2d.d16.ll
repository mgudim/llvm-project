...
; UNPACKED-NEXT:    v_mov_b32_e32 v0, v2
; UNPACKED-NEXT:    s_mov_b32 s0, s2
; UNPACKED-NEXT:    s_mov_b32 s1, s3
; UNPACKED-NEXT:    s_mov_b32 s2, s4
; UNPACKED-NEXT:    s_mov_b32 s3, s5
...
; UNPACKED-NEXT:    v_mov_b32_e32 v2, v3
; UNPACKED-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; UNPACKED-NEXT:    image_store v[0:2], v[4:5], s[0:7] dmask:0x7 unorm d16
; UNPACKED-NEXT:    s_endpgm
;
; GFX81-LABEL: image_store_v3f16:
; GFX81:       ; %bb.0:
; GFX81-NEXT:    v_mov_b32_e32 v4, v0
; GFX81-NEXT:    v_lshrrev_b32_e32 v0, 16, v2
; GFX81-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; GFX81-NEXT:    s_mov_b32 s0, s2
; GFX81-NEXT:    s_mov_b32 s1, s3
; GFX81-NEXT:    s_mov_b32 s2, s4
; GFX81-NEXT:    s_mov_b32 s3, s5
...
; GFX81-NEXT:    v_or_b32_sdwa v0, v2, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_0 src1_sel:DWORD
; GFX81-NEXT:    v_and_b32_e32 v1, 0xffff, v3
; GFX81-NEXT:    v_mov_b32_e32 v2, 0
; GFX81-NEXT:    image_store v[0:2], v[4:5], s[0:7] dmask:0x7 unorm d16
; GFX81-NEXT:    s_endpgm
...
; UNPACKED-NEXT:    v_lshrrev_b32_e32 v1, 16, v0
; UNPACKED-NEXT:    v_lshrrev_b32_e32 v3, 16, v2
; UNPACKED-NEXT:    image_store v[0:3], v[4:5], s[0:7] dmask:0xf unorm d16
; UNPACKED-NEXT:    s_endpgm
;
...
; GFX81-NEXT:    v_mov_b32_e32 v1, v3
; GFX81-NEXT:    image_store v[0:3], v[4:5], s[0:7] dmask:0xf unorm d16
; GFX81-NEXT:    s_endpgm
