...
; GFX900-NEXT:    v_mov_b32_e32 v1, s22
; GFX900-NEXT:    v_fma_f32 v0, s16, v0, v1
; GFX900-NEXT:    v_mov_b32_e32 v1, s20
; GFX900-NEXT:    v_mov_b32_e32 v2, s23
; GFX900-NEXT:    v_fma_f32 v1, s17, v1, v2
; GFX900-NEXT:    v_mov_b32_e32 v2, s21
; GFX900-NEXT:    v_mov_b32_e32 v5, s24
; GFX900-NEXT:    v_fma_f32 v2, s18, v2, v5
; GFX900-NEXT:    global_store_dwordx3 v[3:4], v[0:2], off
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX942-NEXT:    v_pk_fma_f32 v[0:1], s[0:1], v[0:1], v[2:3]
...
; GFX942-NEXT:    v_pk_fma_f32 v[0:1], s[2:3], v[0:1], v[2:3]
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    global_store_dwordx3 v[4:5], v[0:2], off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    v_dual_mov_b32 v0, s18 :: v_dual_mov_b32 v1, s19
; GFX11-NEXT:    v_mov_b32_e32 v2, s20
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_fma_f32 v0, s0, s3, v0
; GFX11-NEXT:    v_fma_f32 v1, s1, s16, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; GFX11-NEXT:    v_fma_f32 v2, s2, s17, v2
...
; GFX8-NEXT:    v_fma_f32 v3, s19, v3, v6
...
; GFX900-NEXT:    v_mov_b32_e32 v1, s24
; GFX900-NEXT:    v_fma_f32 v0, s16, v0, v1
; GFX900-NEXT:    v_mov_b32_e32 v1, s21
; GFX900-NEXT:    v_mov_b32_e32 v2, s25
; GFX900-NEXT:    v_fma_f32 v1, s17, v1, v2
; GFX900-NEXT:    v_mov_b32_e32 v2, s22
; GFX900-NEXT:    v_mov_b32_e32 v3, s26
; GFX900-NEXT:    v_fma_f32 v2, s18, v2, v3
; GFX900-NEXT:    v_mov_b32_e32 v3, s23
; GFX900-NEXT:    v_mov_b32_e32 v6, s27
; GFX900-NEXT:    v_fma_f32 v3, s19, v3, v6
...
; GFX11-NEXT:    v_dual_mov_b32 v2, s22 :: v_dual_mov_b32 v3, s23
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-NEXT:    v_fma_f32 v0, s0, s16, v0
; GFX11-NEXT:    v_fma_f32 v1, s1, s17, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-NEXT:    v_fma_f32 v2, s2, s18, v2
; GFX11-NEXT:    v_fma_f32 v3, s3, s19, v3
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_fmac_f32 s4, s0, s16
; GFX12-NEXT:    s_fmac_f32 s5, s1, s17
; GFX12-NEXT:    s_fmac_f32 s6, s2, s18
; GFX12-NEXT:    s_fmac_f32 s7, s3, s19
...
; GFX942-NEXT:    v_pk_fma_f32 v[2:3], v[2:3], v[4:5], s[4:5]
; GFX942-NEXT:    global_store_dwordx2 v[0:1], v[2:3], off
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
