...
; CHECK-NEXT:    v_subb_u32_e32 v13, vcc, 0, v3, vcc
...
; CHECK-NEXT:    v_cvt_u32_f32_e32 v11, v4
; CHECK-NEXT:    v_cvt_u32_f32_e32 v10, v5
; CHECK-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v11, 0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v10, v[5:6]
; CHECK-NEXT:    v_mul_lo_u32 v5, v10, v4
; CHECK-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v13, v11, v[6:7]
; CHECK-NEXT:    v_mul_hi_u32 v6, v11, v4
; CHECK-NEXT:    v_mul_hi_u32 v4, v10, v4
...
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v7, v5
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, v11, v4
; CHECK-NEXT:    v_addc_u32_e32 v10, vcc, v10, v5, vcc
; CHECK-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v12, v11, 0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v12, v10, v[5:6]
; CHECK-NEXT:    v_ashrrev_i32_e32 v12, 31, v1
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v12
; CHECK-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v13, v11, v[6:7]
; CHECK-NEXT:    v_addc_u32_e32 v1, vcc, v1, v12, vcc
; CHECK-NEXT:    v_xor_b32_e32 v9, v0, v12
; CHECK-NEXT:    v_mul_lo_u32 v0, v10, v4
; CHECK-NEXT:    v_mul_lo_u32 v5, v11, v8
; CHECK-NEXT:    v_xor_b32_e32 v13, v1, v12
; CHECK-NEXT:    v_mul_hi_u32 v1, v11, v4
; CHECK-NEXT:    v_mul_hi_u32 v4, v10, v4
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v1, v10, v8
...
; CHECK-NEXT:    v_mul_lo_u32 v4, v13, v0
; CHECK-NEXT:    v_mul_lo_u32 v5, v9, v1
; CHECK-NEXT:    v_mul_hi_u32 v6, v9, v0
; CHECK-NEXT:    v_mul_hi_u32 v0, v13, v0
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; CHECK-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CHECK-NEXT:    v_mul_lo_u32 v6, v13, v1
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v5, v4
; CHECK-NEXT:    v_mul_hi_u32 v5, v9, v1
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v6, v0
; CHECK-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v0, vcc, v0, v5
; CHECK-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, v0, v4
; CHECK-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, v5, v0
; CHECK-NEXT:    v_mul_hi_u32 v5, v13, v1
; CHECK-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v2, v8, 0
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, v5, v4
; CHECK-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v6, v[1:2]
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, v9, v0
; CHECK-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v3, v8, v[4:5]
; CHECK-NEXT:    v_subb_u32_e64 v1, s[4:5], v13, v6, vcc
; CHECK-NEXT:    v_sub_i32_e64 v4, s[4:5], v13, v6
; CHECK-NEXT:    v_cmp_ge_u32_e64 s[4:5], v1, v3
...
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], v1, v3
; CHECK-NEXT:    v_subb_u32_e32 v4, vcc, v4, v3, vcc
...
; CHECK-NEXT:    v_sub_i32_e32 v4, vcc, v0, v12
; CHECK-NEXT:    v_subb_u32_e32 v5, vcc, v1, v12, vcc
...
; CHECK-NEXT:    s_add_u32 s10, s6, s4
; CHECK-NEXT:    s_addc_u32 s11, s7, s4
...
; CHECK-NEXT:    s_xor_b64 s[10:11], s[10:11], s[4:5]
...
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; CHECK-NEXT:    v_xor_b32_e32 v0, s4, v0
; CHECK-NEXT:    v_subrev_i32_e32 v0, vcc, s4, v0
; CHECK-NEXT:    s_mov_b32 s0, 0
...
; CHECK-NEXT:    v_sub_i32_e32 v0, vcc, s6, v0
...
; CGP-NEXT:    v_xor_b32_e32 v4, v4, v8
...
; CGP-NEXT:    v_subb_u32_e32 v17, vcc, 0, v5, vcc
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v15, v8
; CGP-NEXT:    v_cvt_u32_f32_e32 v14, v9
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v16, v15, 0
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v14, v[9:10]
...
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v11, v9
; CGP-NEXT:    v_add_i32_e32 v15, vcc, v15, v8
; CGP-NEXT:    v_addc_u32_e32 v14, vcc, v14, v9, vcc
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v16, v15, 0
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v16, v14, v[9:10]
; CGP-NEXT:    v_ashrrev_i32_e32 v16, 31, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v16
; CGP-NEXT:    v_mad_u64_u32 v[12:13], s[4:5], v17, v15, v[10:11]
; CGP-NEXT:    v_addc_u32_e32 v1, vcc, v1, v16, vcc
; CGP-NEXT:    v_xor_b32_e32 v13, v0, v16
; CGP-NEXT:    v_mul_lo_u32 v0, v14, v8
; CGP-NEXT:    v_mul_lo_u32 v9, v15, v12
; CGP-NEXT:    v_xor_b32_e32 v17, v1, v16
; CGP-NEXT:    v_mul_hi_u32 v1, v15, v8
; CGP-NEXT:    v_mul_hi_u32 v8, v14, v8
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v9
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v1
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v1, v14, v12
...
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v8, v1
; CGP-NEXT:    v_add_i32_e32 v1, vcc, v9, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v15, v0
; CGP-NEXT:    v_addc_u32_e32 v1, vcc, v14, v1, vcc
; CGP-NEXT:    v_mul_lo_u32 v8, v17, v0
; CGP-NEXT:    v_mul_lo_u32 v9, v13, v1
; CGP-NEXT:    v_mul_hi_u32 v10, v13, v0
; CGP-NEXT:    v_mul_hi_u32 v0, v17, v0
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v8, v10
; CGP-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v10, v17, v1
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v9, v8
; CGP-NEXT:    v_mul_hi_u32 v9, v13, v1
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v10, v0
; CGP-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v0, v9
; CGP-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v9, vcc, v10, v9
; CGP-NEXT:    v_add_i32_e32 v12, vcc, v0, v8
; CGP-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v9, v0
; CGP-NEXT:    v_mul_hi_u32 v9, v17, v1
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v12, 0
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v9, v8
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v4, v10, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v13, v0
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v5, v12, v[8:9]
; CGP-NEXT:    v_subb_u32_e64 v1, s[4:5], v17, v10, vcc
; CGP-NEXT:    v_sub_i32_e64 v8, s[4:5], v17, v10
...
; CGP-NEXT:    v_subb_u32_e32 v8, vcc, v8, v5, vcc
...
; CGP-NEXT:    v_subb_u32_e32 v5, vcc, v8, v5, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v8, vcc, v0, v16
; CGP-NEXT:    v_subb_u32_e32 v9, vcc, v1, v16, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v0, v4
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v4
; CGP-NEXT:    v_cndmask_b32_e32 v8, v0, v1, vcc
; CGP-NEXT:  .LBB2_4:
...
; CGP-NEXT:  ; %bb.5:
; CGP-NEXT:    v_ashrrev_i32_e32 v1, 31, v7
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v6, v1
; CGP-NEXT:    v_addc_u32_e32 v4, vcc, v7, v1, vcc
...
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v4, v6
; CGP-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v6, v15, v3
...
; CGP-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v5, vcc, v6, v5
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v2, v4
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
...
; CGP-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v0, v6, v[3:4]
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v11, v2
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v1, v10, v[4:5]
; CGP-NEXT:    v_subb_u32_e64 v3, s[4:5], v15, v6, vcc
; CGP-NEXT:    v_sub_i32_e64 v4, s[4:5], v15, v6
...
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v0, v14
; CGP-NEXT:    v_subb_u32_e32 v5, vcc, v1, v14, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v2, v0
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v0, v6
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v6
; CGP-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v0, v6
; CGP-NEXT:    v_cmp_ge_u32_e32 vcc, v0, v6
; CGP-NEXT:    v_cndmask_b32_e32 v4, v0, v1, vcc
; CGP-NEXT:  .LBB2_8:
; CGP-NEXT:    s_or_b64 exec, exec, s[4:5]
...
; CGP-NEXT:  ; %bb.1:
; CGP-NEXT:    v_ashrrev_i32_e32 v5, 31, v10
; CGP-NEXT:    v_add_i32_e32 v4, vcc, v9, v5
; CGP-NEXT:    v_addc_u32_e32 v9, vcc, v10, v5, vcc
; CGP-NEXT:    v_xor_b32_e32 v4, v4, v5
; CGP-NEXT:    v_xor_b32_e32 v5, v9, v5
; CGP-NEXT:    v_cvt_f32_u32_e32 v9, v4
; CGP-NEXT:    v_cvt_f32_u32_e32 v10, v5
; CGP-NEXT:    v_sub_i32_e32 v17, vcc, 0, v4
; CGP-NEXT:    v_subb_u32_e32 v18, vcc, 0, v5, vcc
...
; CGP-NEXT:    v_mad_u64_u32 v[0:1], s[4:5], v4, v13, 0
; CGP-NEXT:    v_add_i32_e32 v11, vcc, v10, v9
; CGP-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v4, v11, v[1:2]
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v14, v0
; CGP-NEXT:    v_mad_u64_u32 v[11:12], s[4:5], v5, v13, v[9:10]
...
; CGP-NEXT:    v_cndmask_b32_e64 v10, v10, v11, s[4:5]
; CGP-NEXT:    v_sub_i32_e32 v11, vcc, v0, v4
...
; CGP-NEXT:    v_cmp_eq_u32_e64 s[4:5], v12, v5
; CGP-NEXT:    v_subb_u32_e32 v5, vcc, v9, v5, vcc
...
; CGP-NEXT:    v_sub_i32_e32 v4, vcc, v0, v17
; CGP-NEXT:    v_subb_u32_e32 v5, vcc, v1, v17, vcc
...
; CGP-NEXT:    v_mul_hi_u32 v1, v0, v1
; CGP-NEXT:    v_mul_lo_u32 v1, v1, v9
; CGP-NEXT:    v_sub_i32_e32 v0, vcc, v0, v1
; CGP-NEXT:    v_sub_i32_e32 v1, vcc, v0, v9
...
; CGP-NEXT:    v_ashrrev_i32_e32 v1, 31, v7
; CGP-NEXT:    v_add_i32_e32 v0, vcc, v6, v1
; CGP-NEXT:    v_addc_u32_e32 v6, vcc, v7, v1, vcc
; CGP-NEXT:    v_xor_b32_e32 v0, v0, v1
; CGP-NEXT:    v_xor_b32_e32 v1, v6, v1
; CGP-NEXT:    v_cvt_f32_u32_e32 v6, v0
; CGP-NEXT:    v_cvt_f32_u32_e32 v7, v1
; CGP-NEXT:    v_sub_i32_e32 v14, vcc, 0, v0
; CGP-NEXT:    v_subb_u32_e32 v15, vcc, 0, v1, vcc
...
; CGP-NEXT:    v_cvt_u32_f32_e32 v12, v7
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v14, v13, 0
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v14, v12, v[7:8]
; CGP-NEXT:    v_mul_lo_u32 v7, v12, v6
; CGP-NEXT:    v_mad_u64_u32 v[10:11], s[4:5], v15, v13, v[8:9]
...
; CGP-NEXT:    v_addc_u32_e32 v12, vcc, v12, v7, vcc
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v14, v13, 0
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v14, v12, v[7:8]
; CGP-NEXT:    v_ashrrev_i32_e32 v14, 31, v3
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v2, v14
...
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v3, v14, vcc
; CGP-NEXT:    v_xor_b32_e32 v11, v2, v14
; CGP-NEXT:    v_mul_lo_u32 v2, v12, v6
; CGP-NEXT:    v_mul_lo_u32 v7, v13, v10
; CGP-NEXT:    v_xor_b32_e32 v15, v3, v14
; CGP-NEXT:    v_mul_hi_u32 v3, v13, v6
; CGP-NEXT:    v_mul_hi_u32 v6, v12, v6
...
; CGP-NEXT:    v_add_i32_e32 v2, vcc, v13, v2
; CGP-NEXT:    v_addc_u32_e32 v3, vcc, v12, v3, vcc
; CGP-NEXT:    v_mul_lo_u32 v6, v15, v2
; CGP-NEXT:    v_mul_lo_u32 v7, v11, v3
...
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v6, v8
; CGP-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; CGP-NEXT:    v_mul_lo_u32 v8, v15, v3
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v7, v6
...
; CGP-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v7, vcc, v8, v7
; CGP-NEXT:    v_add_i32_e32 v10, vcc, v2, v6
; CGP-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; CGP-NEXT:    v_add_i32_e32 v6, vcc, v7, v2
; CGP-NEXT:    v_mul_hi_u32 v7, v15, v3
; CGP-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v0, v10, 0
; CGP-NEXT:    v_add_i32_e32 v8, vcc, v7, v6
; CGP-NEXT:    v_mad_u64_u32 v[6:7], s[4:5], v0, v8, v[3:4]
; CGP-NEXT:    v_sub_i32_e32 v2, vcc, v11, v2
; CGP-NEXT:    v_mad_u64_u32 v[8:9], s[4:5], v1, v10, v[6:7]
; CGP-NEXT:    v_subb_u32_e64 v3, s[4:5], v15, v8, vcc
...
; CGP-NEXT:    v_xor_b32_e32 v0, v0, v14
; CGP-NEXT:    v_xor_b32_e32 v1, v1, v14
; CGP-NEXT:    v_sub_i32_e32 v8, vcc, v0, v14
; CGP-NEXT:    v_subb_u32_e32 v9, vcc, v1, v14, vcc
