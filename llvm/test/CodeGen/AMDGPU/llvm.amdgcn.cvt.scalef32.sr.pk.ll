...
; GFX950-SDAG:       ; %bb.0:
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_bf6_bf16 v[18:23], v[0:15], v16, v17
...
; GFX950-GISEL:       ; %bb.0:
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_bf6_bf16 v[18:23], v[0:15], v16, v17
...
; GFX950-SDAG:       ; %bb.0:
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v23, v1
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v22, v0
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v6, s6
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v7, s7
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v8, s8
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v9, s9
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v10, s10
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v11, s11
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v12, s12
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v13, s13
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v14, s14
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v15, s15
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_bf6_bf16 v[16:21], v[0:15], s16, v24
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-SDAG-NEXT:    s_endpgm
;
; GFX950-GISEL-LABEL: test_scalef32_sr_pk32_bf6_bf16_sl:
; GFX950-GISEL:       ; %bb.0:
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v23, v1
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v22, v0
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v1, s1
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v2, s2
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v3, s3
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v4, s4
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v5, s5
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v6, s6
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v7, s7
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v8, s8
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v9, s9
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v10, s10
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v11, s11
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v12, s12
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v13, s13
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v14, s14
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v15, s15
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_bf6_bf16 v[16:21], v[0:15], s16, v24
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f16 v[18:23], v[0:15], v16, v17
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[24:25], v[22:23], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[24:25], v[18:21], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f16 v[18:23], v[0:15], v16, v17
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[24:25], v[18:21], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[24:25], v[22:23], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v15, s15
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f16 v[16:21], v[0:15], s16, v24
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f16 v[16:21], v[0:15], s16, v24
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_fp6_bf16 v[18:23], v[0:15], v16, v17
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[24:25], v[22:23], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[24:25], v[18:21], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_fp6_bf16 v[18:23], v[0:15], v16, v17
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[24:25], v[22:23], off offset:16
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[24:25], v[18:21], off
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v15, s15
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_fp6_bf16 v[16:21], v[0:15], s16, v24
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v15, s15
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_fp6_bf16 v[16:21], v[0:15], s16, v24
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f16 v[18:23], v[0:15], v16, v17
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[24:25], v[22:23], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[24:25], v[18:21], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, v18
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v25, v19
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f16 v[18:23], v[0:15], v16, v17
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[24:25], v[18:21], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[24:25], v[22:23], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v15, s15
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f16 v[16:21], v[0:15], s16, v24
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v24, 0x42c80000
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f16 v[16:21], v[0:15], s16, v24
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[22:23], v[16:19], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[22:23], v[20:21], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG:       ; %bb.0:
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v41, v35
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v40, v34
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f32 v[34:39], v[0:31], v32, v33
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[40:41], v[38:39], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[40:41], v[34:37], off
; GFX950-SDAG-NEXT:    s_endpgm
;
; GFX950-GISEL-LABEL: test_scalef32_sr_pk32_bf6_f32_vv:
; GFX950-GISEL:       ; %bb.0:
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v40, v34
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v41, v35
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f32 v[34:39], v[0:31], v32, v33
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[40:41], v[34:37], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[40:41], v[38:39], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG:       ; %bb.0:
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v39, v1
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v38, v0
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v0, s0
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v2, s2
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v3, s3
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v14, s14
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v15, s15
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v16, s16
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v17, s17
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v22, s22
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v23, s23
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v24, s24
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v25, s25
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v26, s26
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v27, s27
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v28, s28
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v29, s29
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v30, s30
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v31, s31
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v40, 0x42c80000
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f32 v[32:37], v[0:31], s32, v40
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[38:39], v[36:37], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[38:39], v[32:35], off
; GFX950-SDAG-NEXT:    s_endpgm
;
; GFX950-GISEL-LABEL: test_scalef32_sr_pk32_bf6_f32_sl:
; GFX950-GISEL:       ; %bb.0:
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v38, v0
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v39, v1
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[4:5], s[4:5]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[6:7], s[6:7]
...
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[12:13], s[12:13]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[14:15], s[14:15]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[16:17], s[16:17]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[18:19], s[18:19]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[20:21], s[20:21]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[22:23], s[22:23]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[24:25], s[24:25]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[26:27], s[26:27]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[28:29], s[28:29]
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[30:31], s[30:31]
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v40, 0x42c80000
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_bf6_f32 v[32:37], v[0:31], s32, v40
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[38:39], v[32:35], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[38:39], v[36:37], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v41, v35
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v40, v34
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f32 v[34:39], v[0:31], v32, v33
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[40:41], v[38:39], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[40:41], v[34:37], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v40, v34
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v41, v35
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f32 v[34:39], v[0:31], v32, v33
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[40:41], v[34:37], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[40:41], v[38:39], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
...
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v31, s31
; GFX950-SDAG-NEXT:    v_mov_b32_e32 v40, 0x42c80000
; GFX950-SDAG-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f32 v[32:37], v[0:31], s32, v40
; GFX950-SDAG-NEXT:    global_store_dwordx2 v[38:39], v[36:37], off offset:16
; GFX950-SDAG-NEXT:    global_store_dwordx4 v[38:39], v[32:35], off
; GFX950-SDAG-NEXT:    s_endpgm
;
...
; GFX950-GISEL-NEXT:    v_mov_b64_e32 v[30:31], s[30:31]
; GFX950-GISEL-NEXT:    v_mov_b32_e32 v40, 0x42c80000
; GFX950-GISEL-NEXT:    v_cvt_scalef32_sr_pk32_fp6_f32 v[32:37], v[0:31], s32, v40
; GFX950-GISEL-NEXT:    global_store_dwordx4 v[38:39], v[32:35], off
; GFX950-GISEL-NEXT:    global_store_dwordx2 v[38:39], v[36:37], off offset:16
; GFX950-GISEL-NEXT:    s_endpgm
