...
; GFX942-NEXT:    v_max_f32_e32 v8, v0, v5
...
; GFX90A-NEXT:    v_max_f32_e32 v8, v0, v5
...
; GFX908-NEXT:    v_max_f32_e32 v8, v0, v5
...
; GFX8-NEXT:    v_max_f32_e32 v8, v0, v5
...
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_atomic_max_f64 v[2:3], v0, s[0:3], 0 offen offset:2048 sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
...
; GFX90A-NEXT:    s_mov_b32 s4, s16
; GFX90A-NEXT:    v_mov_b32_e32 v0, s20
; GFX90A-NEXT:    buffer_atomic_max_f64 v[2:3], v0, s[4:7], 0 offen offset:2048 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
...
; GFX908-NEXT:    v_max_f64 v[0:1], v[0:1], v[8:9]
...
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_atomic_max_f64 v[2:3], v0, s[0:3], 0 offen offset:2048
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_mov_b32 s4, s16
; GFX90A-NEXT:    v_mov_b32_e32 v0, s20
; GFX90A-NEXT:    buffer_atomic_max_f64 v[2:3], v0, s[4:7], 0 offen offset:2048
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_max_num_f64_e32 v[0:1], v[0:1], v[13:14]
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_max_f64 v[0:1], v[0:1], v[13:14]
...
; GFX908-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX908-NEXT:    s_mov_b64 s[12:13], exec
; GFX908-NEXT:    v_max_f64 v[0:1], v[0:1], v[13:14]
...
; GFX8-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX8-NEXT:    s_mov_b64 s[12:13], exec
; GFX8-NEXT:    v_max_f64 v[0:1], v[0:1], v[13:14]
...
; GFX6-NEXT:    v_max_f64 v[0:1], v[0:1], v[8:9]
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v4.l, v0.h, v0.l
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX11-TRUE16-NEXT:    v_max_f16_e32 v4.l, v0.h, v0.l
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX942-NEXT:    s_mov_b64 s[8:9], exec
; GFX942-NEXT:    v_pk_max_f16 v8, v0, v5
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_mov_b64_e32 v[0:1], v[8:9]
...
; GFX90A-NEXT:    v_pk_max_f16 v8, v0, v5
; GFX90A-NEXT:    s_mov_b64 s[12:13], exec
; GFX90A-NEXT:    v_pk_mov_b32 v[0:1], v[8:9], v[8:9] op_sel:[0,1]
...
; GFX908-NEXT:    v_pk_max_f16 v8, v0, v5
; GFX908-NEXT:    v_mov_b32_e32 v0, v8
; GFX908-NEXT:    s_mov_b64 s[12:13], exec
; GFX908-NEXT:    v_mov_b32_e32 v1, v9
...
; GFX8-NEXT:    v_max_f16_sdwa v0, v0, v10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX942-NEXT:    v_max_f32_e32 v0, v0, v10
...
; GFX90A-NEXT:    v_max_f32_e32 v0, v0, v10
...
; GFX90A-NEXT:    v_max_f32_e32 v1, v1, v5
; GFX90A-NEXT:    v_bfe_u32 v8, v1, 16, 1
...
; GFX908-NEXT:    v_max_f32_e32 v0, v0, v10
...
; GFX908-NEXT:    v_max_f32_e32 v1, v1, v5
; GFX908-NEXT:    v_bfe_u32 v8, v1, 16, 1
...
; GFX8-NEXT:    v_max_f32_e32 v0, v0, v10
