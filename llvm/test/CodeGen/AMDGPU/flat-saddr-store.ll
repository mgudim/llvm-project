...
; GFX1250-SDAG-NEXT:    flat_store_b8 v0, v2, s[0:1]
...
; GFX1250-GISEL-NEXT:    flat_store_b8 v0, v2, s[0:1]
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    flat_store_b8 v0, v2, s[0:1] offset:2047
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    flat_store_b8 v0, v2, s[0:1] offset:2047
; GFX1250-GISEL-NEXT:    s_endpgm
  %voffset = load i32, ptr %voffset.ptr
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-SDAG-NEXT:    flat_store_b8 v0, v2, s[0:1] offset:-2048
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-GISEL-NEXT:    flat_store_b8 v0, v2, s[0:1] offset:-2048
; GFX1250-GISEL-NEXT:    s_endpgm
  %voffset = load i32, ptr %voffset.ptr
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b16 v0, v1, s[0:1]
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b16 v0, v1, s[0:1]
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b16 v0, v1, s[0:1] offset:-128
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b16 v0, v1, s[0:1] offset:-128
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b32 v0, v1, s[0:1]
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b32 v0, v1, s[0:1]
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b32 v0, v1, s[0:1] offset:-128
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b32 v0, v1, s[0:1] offset:-128
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b64 v0, v[2:3], s[0:1]
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b64 v0, v[4:5], s[0:1]
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b64 v0, v[2:3], s[0:1] offset:-128
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b64 v0, v[4:5], s[0:1] offset:-128
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b96 v0, v[2:4], s[0:1]
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b96 v0, v[4:6], s[0:1]
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b96 v0, v[2:4], s[0:1] offset:-128
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b96 v0, v[4:6], s[0:1] offset:-128
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b128 v0, v[2:5], s[0:1]
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b128 v0, v[6:9], s[0:1]
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_b128 v0, v[2:5], s[0:1] offset:-128
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_b128 v0, v[6:9], s[0:1] offset:-128
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
...
; GFX1250-SDAG-NEXT:    flat_store_b32 v0, v1, s[0:1] scope:SCOPE_SYS
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    flat_store_b32 v0, v1, s[0:1] scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    global_wb scope:SCOPE_SYS
; GFX1250-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1250-SDAG-NEXT:    flat_store_b32 v0, v1, s[0:1] offset:-128 scope:SCOPE_SYS
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    global_wb scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX1250-GISEL-NEXT:    flat_store_b32 v0, v1, s[0:1] offset:-128 scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
...
; GFX1250-SDAG-NEXT:    global_wb scope:SCOPE_SYS
; GFX1250-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1250-SDAG-NEXT:    flat_store_b64 v0, v[2:3], s[0:1] scope:SCOPE_SYS
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    global_wb scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX1250-GISEL-NEXT:    flat_store_b64 v0, v[4:5], s[0:1] scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    global_wb scope:SCOPE_SYS
; GFX1250-SDAG-NEXT:    s_wait_storecnt 0x0
; GFX1250-SDAG-NEXT:    flat_store_b64 v0, v[2:3], s[0:1] offset:-128 scope:SCOPE_SYS
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    global_wb scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_wait_storecnt 0x0
; GFX1250-GISEL-NEXT:    flat_store_b64 v0, v[4:5], s[0:1] offset:-128 scope:SCOPE_SYS
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_d16_hi_b16 v0, v1, s[0:1]
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_d16_hi_b16 v0, v1, s[0:1]
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_d16_hi_b16 v0, v1, s[0:1] offset:-128
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_d16_hi_b16 v0, v1, s[0:1] offset:-128
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_d16_hi_b8 v0, v1, s[0:1]
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_d16_hi_b8 v0, v1, s[0:1]
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %data.hi = extractelement <2 x i16> %data, i32 1
...
; GFX1250-SDAG-NEXT:    s_mov_b32 s1, s3
; GFX1250-SDAG-NEXT:    s_mov_b32 s0, s2
; GFX1250-SDAG-NEXT:    flat_store_d16_hi_b8 v0, v1, s[0:1] offset:-128
; GFX1250-SDAG-NEXT:    s_endpgm
;
...
; GFX1250-GISEL-NEXT:    s_mov_b32 s0, s2
; GFX1250-GISEL-NEXT:    s_mov_b32 s1, s3
; GFX1250-GISEL-NEXT:    flat_store_d16_hi_b8 v0, v1, s[0:1] offset:-128
; GFX1250-GISEL-NEXT:    s_endpgm
  %zext.offset = zext i32 %voffset to i64
  %gep0 = getelementptr inbounds i8, ptr %sbase, i64 %zext.offset
  %gep1 = getelementptr inbounds i8, ptr %gep0, i64 -128
