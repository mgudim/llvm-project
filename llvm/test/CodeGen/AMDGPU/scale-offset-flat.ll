...
; GISEL-NEXT:    v_lshl_add_u64 v[4:5], v[0:1], 3, s[0:1]
; GISEL-NEXT:    v_xor_b32_e32 v1, src_flat_scratch_base_hi, v5
; GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL-NEXT:    v_cmpx_le_u32_e32 0x4000000, v1
; GISEL-NEXT:    s_xor_b32 s2, exec_lo, s2
; GISEL-NEXT:    s_cbranch_execz .LBB21_2
; GISEL-NEXT:  ; %bb.1: ; %atomicrmw.global
; GISEL-NEXT:    v_mov_b64_e32 v[2:3], 1
; GISEL-NEXT:    ; implicit-def: $vgpr4_vgpr5
; GISEL-NEXT:    flat_atomic_add_u64 v[2:3], v0, v[2:3], s[0:1] scale_offset th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GISEL-NEXT:  .LBB21_2: ; %Flow
; GISEL-NEXT:    s_wait_xcnt 0x0
; GISEL-NEXT:    s_and_not1_saveexec_b32 s0, s2
; GISEL-NEXT:    s_cbranch_execz .LBB21_4
; GISEL-NEXT:  ; %bb.3: ; %atomicrmw.private
...
; GISEL-NEXT:    scratch_load_b64 v[2:3], v4, off
; GISEL-NEXT:    s_wait_loadcnt 0x0
; GISEL-NEXT:    v_add_nc_u64_e32 v[0:1], 1, v[2:3]
; GISEL-NEXT:    scratch_store_b64 v4, v[0:1], off
; GISEL-NEXT:  .LBB21_4: ; %atomicrmw.phi
; GISEL-NEXT:    s_wait_xcnt 0x0
; GISEL-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GISEL-NEXT:    s_wait_loadcnt_dscnt 0x0
; GISEL-NEXT:    v_dual_mov_b32 v0, v2 :: v_dual_mov_b32 v1, v3
