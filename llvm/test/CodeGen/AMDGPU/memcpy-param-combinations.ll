...
; CHECK-NEXT:    flat_load_dwordx2 v[8:9], v[4:5] offset:23
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[4:5]
; CHECK-NEXT:    flat_load_dwordx2 v[4:5], v[4:5] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(2)
; CHECK-NEXT:    flat_store_dwordx2 v[6:7], v[8:9] offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(2)
; CHECK-NEXT:    flat_store_dwordx4 v[6:7], v[0:3]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(2)
; CHECK-NEXT:    flat_store_dwordx2 v[6:7], v[4:5] offset:16
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v0
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[4:5] offset:15
; CHECK-NEXT:    flat_load_dwordx4 v[4:7], v[4:5]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[8:9], v[0:3] offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[8:9], v[4:7]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    v_mov_b32_e32 v6, v0
; CHECK-NEXT:    s_clause 0x2
; CHECK-NEXT:    global_load_dwordx2 v[8:9], v[4:5], off offset:23
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off
; CHECK-NEXT:    global_load_dwordx2 v[4:5], v[4:5], off offset:16
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v0
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:15
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v[4:5], off
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    flat_store_dwordx4 v[8:9], v[0:3] offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    v_mov_b32_e32 v6, v0
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx2 v[8:9], v[4:5], off
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:8
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    flat_store_dwordx2 v[6:7], v[8:9]
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[6:7], v[0:3] offset:8
; CHECK-NEXT:    global_load_dwordx2 v[0:1], v[4:5], off offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx2 v[6:7], v[0:1] offset:23
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off
; CHECK-NEXT:    global_load_dwordx4 v[4:7], v[4:5], off offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(1)
...
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[6:7], v[0:3] offset:15
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[6:7], v[0:3] offset:16
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    flat_load_dwordx2 v[4:5], v[4:5] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(2)
; CHECK-NEXT:    global_store_dwordx2 v[6:7], v[8:9], off offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    global_store_dwordx4 v[6:7], v[0:3], off
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx2 v[6:7], v[4:5], off offset:16
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    flat_load_dwordx4 v[4:7], v[4:5]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    global_store_dwordx4 v[8:9], v[0:3], off offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[8:9], v[4:7], off
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:8
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    global_store_dwordx2 v[6:7], v[8:9], off
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[6:7], v[0:3], off offset:8
; CHECK-NEXT:    global_load_dwordx2 v[0:1], v[4:5], off offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx2 v[6:7], v[0:1], off offset:23
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[6:7], v[0:3], off offset:15
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[6:7], v[0:3], off offset:16
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    flat_load_dwordx4 v[5:8], v[5:6] offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    ds_write2_b64 v0, v[1:2], v[3:4] offset1:1
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(1)
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[5:6] offset:15
; CHECK-NEXT:    flat_load_dwordx4 v[5:8], v[5:6]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
...
; CHECK-NEXT:    global_load_dwordx2 v[7:8], v[5:6], off offset:16
; CHECK-NEXT:    global_load_dwordx2 v[5:6], v[5:6], off offset:23
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    ds_write2_b64 v0, v[1:2], v[3:4] offset1:1
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    ds_write_b64 v0, v[7:8] offset:16
...
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx4 v[1:4], v[5:6], off
; CHECK-NEXT:    global_load_dwordx4 v[5:8], v[5:6], off offset:15
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    ds_write2_b64 v0, v[1:2], v[3:4] offset1:1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    ds_write_b128 v0, v[5:8] offset:15
