...
; SI-NEXT:  ; %bb.1: ; %cmp.false
; SI-NEXT:    s_lshr_b32 s18, s5, 16
; SI-NEXT:    s_lshr_b32 s19, s7, 16
; SI-NEXT:    s_lshr_b32 s20, s9, 16
...
; SI-NEXT:    v_cvt_f32_f16_e32 v0, v13
...
; SI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; SI-NEXT:    v_lshlrev_b32_e32 v0, 16, v0
; SI-NEXT:    v_or_b32_e32 v10, v1, v0
...
; VI-NEXT:    v_add_f16_sdwa v1, v1, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v6, s5, v0
...
; SI-NEXT:  ; %bb.1: ; %cmp.false
; SI-NEXT:    s_lshr_b32 s20, s5, 16
; SI-NEXT:    s_lshr_b32 s19, s7, 16
; SI-NEXT:    s_lshr_b32 s18, s9, 16
; SI-NEXT:    s_lshr_b64 s[10:11], s[4:5], 16
; SI-NEXT:    s_lshr_b64 s[12:13], s[6:7], 16
; SI-NEXT:    s_lshr_b64 s[14:15], s[8:9], 16
; SI-NEXT:    s_cbranch_execnz .LBB29_4
; SI-NEXT:  .LBB29_2: ; %cmp.true
; SI-NEXT:    v_add_f32_e64 v5, s5, 1.0
; SI-NEXT:    v_add_f32_e64 v4, s4, 1.0
; SI-NEXT:    v_add_f32_e64 v3, s7, 1.0
; SI-NEXT:    v_add_f32_e64 v2, s6, 1.0
; SI-NEXT:    v_lshr_b64 v[6:7], v[4:5], 16
; SI-NEXT:    v_add_f32_e64 v1, s9, 1.0
; SI-NEXT:    v_add_f32_e64 v0, s8, 1.0
...
; SI-NEXT:    v_add_f64 v[2:3], s[6:7], 1.0
; SI-NEXT:    v_add_f64 v[0:1], s[8:9], 1.0
; SI-NEXT:    v_lshr_b64 v[6:7], v[4:5], 16
; SI-NEXT:    v_lshr_b64 v[7:8], v[2:3], 16
; SI-NEXT:    v_lshr_b64 v[8:9], v[0:1], 16
