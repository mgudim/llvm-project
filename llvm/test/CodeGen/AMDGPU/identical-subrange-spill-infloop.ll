...
; CHECK-NEXT:    s_load_dwordx16 s[4:19], s[28:29], 0x1f0
...
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[72:73], 1, v5
; CHECK-NEXT:    v_writelane_b32 v6, s69, 21
; CHECK-NEXT:    v_readlane_b32 s60, v7, 8
; CHECK-NEXT:    image_sample_lz v4, v[2:3], s[52:59], s[28:31] dmask:0x1
...
; CHECK-NEXT:    image_sample_lz v0, v[0:1], s[52:59], s[20:23] dmask:0x1
...
; CHECK-NEXT:    s_andn2_saveexec_b64 s[14:15], s[14:15]
...
; CHECK-NEXT:    image_sample_lz v3, v[1:2], s[4:11], s[16:19] dmask:0x1
