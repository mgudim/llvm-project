...
; GCN3:       ; %bb.0:
; GCN3-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v4, v1
; GCN3-NEXT:    v_mov_b32_e32 v3, v0
; GCN3-NEXT:    flat_load_dword v0, v[3:4]
; GCN3-NEXT:    s_mov_b64 s[4:5], 0
; GCN3-NEXT:  .LBB32_1: ; %atomicrmw.start
; GCN3-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_sub_u32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
...
; GCN3-NEXT:    v_mov_b32_e32 v4, v1
; GCN3-NEXT:    v_mov_b32_e32 v3, v0
; GCN3-NEXT:    flat_load_dword v0, v[3:4] offset:16
; GCN3-NEXT:    s_mov_b64 s[4:5], 0
...
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_sub_u32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] offset:16 glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
; GCN3-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
...
; GCN1:       ; %bb.0:
; GCN1-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN1-NEXT:    s_mov_b32 s36, s4
; GCN1-NEXT:    s_mov_b32 s37, s5
...
; GCN2:       ; %bb.0:
; GCN2-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN2-NEXT:    s_mov_b32 s36, s4
; GCN2-NEXT:    s_mov_b32 s37, s5
...
; GCN3:       ; %bb.0:
; GCN3-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN3-NEXT:    s_mov_b32 s36, s4
; GCN3-NEXT:    s_mov_b32 s37, s5
...
; GCN1-NEXT:    v_mov_b32_e32 v1, s36
; GCN1-NEXT:    s_mov_b64 s[34:35], 0
; GCN1-NEXT:    v_mov_b32_e32 v2, s37
...
; GCN2-NEXT:    v_mov_b32_e32 v1, s36
; GCN2-NEXT:    s_mov_b64 s[34:35], 0
; GCN2-NEXT:    v_mov_b32_e32 v2, s37
...
; GCN3-NEXT:    v_mov_b32_e32 v1, s36
; GCN3-NEXT:    s_mov_b64 s[34:35], 0
; GCN3-NEXT:    v_mov_b32_e32 v2, s37
...
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_and_b32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
...
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_or_b32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
...
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_xor_b32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
...
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_max_i32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
...
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_max_u32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
...
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_min_u32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
...
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    v_mov_b32_e32 v1, v0
; GCN3-NEXT:    v_min_i32_e32 v0, v1, v2
; GCN3-NEXT:    flat_atomic_cmpswap v0, v[3:4], v[0:1] glc
; GCN3-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN3-NEXT:    buffer_wbinvl1_vol
; GCN3-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v1
...
; GCN3-NEXT:    v_cmp_lt_u32_e32 vcc, v1, v2
...
; GCN3-NEXT:    v_cmp_gt_u32_e64 s[4:5], v1, v2
; GCN3-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; GCN1:       ; %bb.0:
; GCN1-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN1-NEXT:    s_mov_b32 s34, s4
; GCN1-NEXT:    s_mov_b32 s35, s5
; GCN1-NEXT:    v_mov_b32_e32 v0, s34
; GCN1-NEXT:    v_mov_b32_e32 v1, s35
...
; GCN2:       ; %bb.0:
; GCN2-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN2-NEXT:    s_mov_b32 s34, s4
; GCN2-NEXT:    s_mov_b32 s35, s5
; GCN2-NEXT:    v_mov_b32_e32 v0, s34
; GCN2-NEXT:    v_mov_b32_e32 v1, s35
...
; GCN3:       ; %bb.0:
; GCN3-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GCN3-NEXT:    s_mov_b32 s34, s4
; GCN3-NEXT:    s_mov_b32 s35, s5
...
; GCN3-NEXT:    v_mov_b32_e32 v2, s35
