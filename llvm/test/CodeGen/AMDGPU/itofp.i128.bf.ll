...
; GCN-NEXT:    v_or_b32_e32 v6, v2, v4
; GCN-NEXT:    v_or_b32_e32 v5, v1, v3
; GCN-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[5:6]
; GCN-NEXT:    v_mov_b32_e32 v0, 0
; GCN-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; GCN-NEXT:    s_cbranch_execz .LBB1_14
; GCN-NEXT:  ; %bb.1: ; %itofp-if-end
; GCN-NEXT:    v_ffbh_u32_e32 v0, v3
; GCN-NEXT:    v_add_u32_e32 v0, 32, v0
; GCN-NEXT:    v_ffbh_u32_e32 v5, v4
; GCN-NEXT:    v_min_u32_e32 v0, v0, v5
; GCN-NEXT:    v_ffbh_u32_e32 v5, v1
; GCN-NEXT:    v_add_u32_e32 v5, 32, v5
; GCN-NEXT:    v_ffbh_u32_e32 v6, v2
; GCN-NEXT:    v_min_u32_e32 v5, v5, v6
; GCN-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[3:4]
; GCN-NEXT:    v_add_u32_e32 v5, 64, v5
; GCN-NEXT:    v_cndmask_b32_e32 v6, v5, v0, vcc
; GCN-NEXT:    v_sub_u32_e32 v0, 0x80, v6
; GCN-NEXT:    v_cmp_gt_i32_e32 vcc, 25, v0
; GCN-NEXT:    ; implicit-def: $vgpr7
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GCN-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GCN-NEXT:  ; %bb.2: ; %itofp-if-else
; GCN-NEXT:    v_add_u32_e32 v3, 0xffffff98, v6
; GCN-NEXT:    v_lshlrev_b64 v[0:1], v3, v[1:2]
...
; GCN-NEXT:  ; %bb.4: ; %NodeBlock
; GCN-NEXT:    v_cmp_lt_i32_e32 vcc, 25, v0
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GCN-NEXT:    s_xor_b64 s[10:11], exec, s[4:5]
...
; GCN-NEXT:    v_lshrrev_b64 v[7:8], v11, v[1:2]
; GCN-NEXT:    v_lshlrev_b64 v[9:10], v9, v[3:4]
; GCN-NEXT:    v_sub_u32_e32 v12, 38, v6
; GCN-NEXT:    v_or_b32_e32 v10, v8, v10
; GCN-NEXT:    v_or_b32_e32 v9, v7, v9
; GCN-NEXT:    v_lshrrev_b64 v[7:8], v12, v[3:4]
...
; GCN-NEXT:    v_lshrrev_b64 v[9:10], v12, v[1:2]
; GCN-NEXT:    v_lshlrev_b64 v[11:12], v13, v[3:4]
; GCN-NEXT:    v_subrev_u32_e32 v6, 38, v6
; GCN-NEXT:    v_cndmask_b32_e64 v14, v7, v1, s[4:5]
; GCN-NEXT:    v_lshlrev_b64 v[6:7], v6, v[1:2]
; GCN-NEXT:    v_cndmask_b32_e64 v8, v8, v2, s[4:5]
; GCN-NEXT:    v_or_b32_e32 v10, v12, v10
; GCN-NEXT:    v_or_b32_e32 v9, v11, v9
; GCN-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v13
; GCN-NEXT:    v_lshlrev_b64 v[1:2], v13, v[1:2]
; GCN-NEXT:    v_cndmask_b32_e32 v7, v7, v10, vcc
...
; GCN-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[1:2]
; GCN-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GCN-NEXT:    v_or_b32_e32 v7, v14, v1
...
; GCN-NEXT:    s_andn2_saveexec_b64 s[4:5], s[10:11]
; GCN-NEXT:  ; %bb.9: ; %itofp-sw-bb
; GCN-NEXT:    v_lshlrev_b64 v[1:2], 1, v[1:2]
; GCN-NEXT:  ; %bb.10: ; %itofp-sw-epilog
; GCN-NEXT:    s_or_b64 exec, exec, s[4:5]
; GCN-NEXT:    v_lshrrev_b32_e32 v3, 2, v1
; GCN-NEXT:    v_and_or_b32 v1, v3, 1, v1
; GCN-NEXT:    v_add_co_u32_e32 v1, vcc, 1, v1
; GCN-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v2, vcc
; GCN-NEXT:    v_and_b32_e32 v3, 0x4000000, v1
; GCN-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; GCN-NEXT:    v_alignbit_b32 v7, v2, v1, 2
; GCN-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GCN-NEXT:  ; %bb.11: ; %itofp-if-then20
; GCN-NEXT:    v_alignbit_b32 v7, v2, v1, 3
