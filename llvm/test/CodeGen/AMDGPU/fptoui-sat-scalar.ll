...
; GFX7-ISEL-LABEL: test_s_unsigned_i32_f64:
; GFX7-ISEL:       ; %bb.0:
; GFX7-ISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-ISEL-NEXT:    s_mov_b32 s5, s17
; GFX7-ISEL-NEXT:    s_mov_b32 s4, s16
...
; GFX7-ISEL-NEXT:    s_setpc_b64 s[30:31]
;
; GFX7-GI-LABEL: test_s_unsigned_i32_f64:
; GFX7-GI:       ; %bb.0:
; GFX7-GI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX7-GI-NEXT:    s_mov_b32 s4, s16
; GFX7-GI-NEXT:    s_mov_b32 s5, s17
...
; GFX7-ISEL-NEXT:    s_mov_b32 s5, s17
; GFX7-ISEL-NEXT:    s_mov_b32 s4, s16
; GFX7-ISEL-NEXT:    v_trunc_f64_e32 v[0:1], s[4:5]
; GFX7-ISEL-NEXT:    s_movk_i32 s6, 0xffe0
; GFX7-ISEL-NEXT:    v_ldexp_f64 v[2:3], v[0:1], s6
; GFX7-ISEL-NEXT:    s_mov_b32 s6, 0
; GFX7-ISEL-NEXT:    s_mov_b32 s7, 0xc1f00000
; GFX7-ISEL-NEXT:    v_floor_f64_e32 v[2:3], v[2:3]
; GFX7-ISEL-NEXT:    v_fma_f64 v[0:1], v[2:3], s[6:7], v[0:1]
...
; GFX7-ISEL-NEXT:    v_cmp_gt_f64_e32 vcc, s[4:5], v[2:3]
; GFX7-ISEL-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
; GFX7-ISEL-NEXT:    v_cndmask_b32_e64 v4, v4, 0, s[6:7]
...
; GFX7-GI-NEXT:    v_cmp_nge_f64_e64 s[6:7], s[4:5], 0
...
; GFX7-GI-NEXT:    v_cndmask_b32_e64 v4, v4, 0, s[6:7]
...
; GFX9-NEXT:    s_mov_b32 s5, s17
; GFX9-NEXT:    s_mov_b32 s4, s16
; GFX9-NEXT:    v_trunc_f64_e32 v[0:1], s[4:5]
; GFX9-NEXT:    s_movk_i32 s6, 0xffe0
; GFX9-NEXT:    v_ldexp_f64 v[2:3], v[0:1], s6
; GFX9-NEXT:    s_mov_b32 s6, 0
; GFX9-NEXT:    s_mov_b32 s7, 0xc1f00000
; GFX9-NEXT:    v_floor_f64_e32 v[2:3], v[2:3]
; GFX9-NEXT:    v_fma_f64 v[0:1], v[2:3], s[6:7], v[0:1]
...
; GFX9-NEXT:    v_cmp_gt_f64_e32 vcc, s[4:5], v[2:3]
; GFX9-NEXT:    v_cvt_u32_f64_e32 v0, v[0:1]
