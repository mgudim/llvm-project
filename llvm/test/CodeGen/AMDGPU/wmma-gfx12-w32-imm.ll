...
; GCN-NEXT:    v_wmma_f32_16x16x16_f16 v[0:7], v[12:15], v[8:11], 1.0
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v12, v0
; GCN-NEXT:    v_dual_mov_b32 v0, 0x40400000 :: v_dual_mov_b32 v17, v9
; GCN-NEXT:    v_dual_mov_b32 v16, v8 :: v_dual_mov_b32 v11, v7
; GCN-NEXT:    v_dual_mov_b32 v10, v6 :: v_dual_mov_b32 v9, v5
; GCN-NEXT:    v_dual_mov_b32 v8, v4 :: v_dual_mov_b32 v15, v3
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v14, v2 :: v_dual_mov_b32 v1, v0
...
; GCN-NEXT:    v_wmma_f32_16x16x16_f16 v[0:7], v[12:15], v[8:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[16:17], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[16:17], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v12, v0
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_bf16 v[0:7], v[12:15], v[8:11], 1.0
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[16:17], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[16:17], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v0
; GCN-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v0
; GCN-NEXT:    v_wmma_f32_16x16x16_bf16 v[0:7], v[12:15], v[8:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[16:17], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[16:17], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_wmma_f16_16x16x16_f16 v[8:11], v[0:3], v[4:7], 1.0
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v13, v9 :: v_dual_mov_b32 v12, v8
; GCN-NEXT:    v_mov_b32_e32 v8, 0x42004200
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v9, v8 :: v_dual_mov_b32 v10, v8
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v13, v9 :: v_dual_mov_b32 v12, v8
; GCN-NEXT:    v_mov_b32_e32 v8, 0x3f803f80
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v9, v8 :: v_dual_mov_b32 v10, v8
; GCN-NEXT:    v_mov_b32_e32 v11, v8
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v13, v9 :: v_dual_mov_b32 v12, v8
; GCN-NEXT:    v_mov_b32_e32 v8, 0x3fc03fc0
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v9, v8 :: v_dual_mov_b32 v10, v8
; GCN-NEXT:    v_mov_b32_e32 v11, v8
; GCN-NEXT:    v_wmma_bf16_16x16x16_bf16 v[8:11], v[0:3], v[4:7], v[8:11]
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v9, v5 :: v_dual_mov_b32 v10, v2
; GCN-NEXT:    v_dual_mov_b32 v11, v3 :: v_dual_mov_b32 v12, v0
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v8, v4
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_i32_16x16x16_iu8 v[0:7], v[12:13], v[10:11], 1
; GCN-NEXT:    s_clause 0x1
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v11, v3 :: v_dual_mov_b32 v12, v0
; GCN-NEXT:    v_dual_mov_b32 v0, 0x80 :: v_dual_mov_b32 v9, v5
; GCN-NEXT:    v_dual_mov_b32 v10, v2 :: v_dual_mov_b32 v13, v1
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v8, v4 :: v_dual_mov_b32 v1, v0
; GCN-NEXT:    v_dual_mov_b32 v2, v0 :: v_dual_mov_b32 v3, v0
; GCN-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v0
; GCN-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v0
; GCN-NEXT:    v_wmma_i32_16x16x16_iu8 v[0:7], v[12:13], v[10:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_wmma_i32_16x16x16_iu4 v[2:9], v0, v1, 1
; GCN-NEXT:    s_clause 0x1
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v11, v3 :: v_dual_mov_b32 v10, v2
; GCN-NEXT:    v_mov_b32_e32 v2, 0x80
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v3, v2 :: v_dual_mov_b32 v4, v2
; GCN-NEXT:    v_dual_mov_b32 v5, v2 :: v_dual_mov_b32 v6, v2
; GCN-NEXT:    v_dual_mov_b32 v7, v2 :: v_dual_mov_b32 v8, v2
...
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v8, v4
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_fp8_fp8 v[0:7], v[12:13], v[10:11], 1.0
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN:       ; %bb.0: ; %bb
; GCN-NEXT:    v_dual_mov_b32 v11, v3 :: v_dual_mov_b32 v12, v0
; GCN-NEXT:    v_dual_mov_b32 v0, 0x40400000 :: v_dual_mov_b32 v9, v5
; GCN-NEXT:    v_dual_mov_b32 v10, v2 :: v_dual_mov_b32 v13, v1
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1)
; GCN-NEXT:    v_dual_mov_b32 v8, v4 :: v_dual_mov_b32 v1, v0
; GCN-NEXT:    v_dual_mov_b32 v2, v0 :: v_dual_mov_b32 v3, v0
; GCN-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v0
; GCN-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v0
; GCN-NEXT:    v_wmma_f32_16x16x16_fp8_fp8 v[0:7], v[12:13], v[10:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v8, v4
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_bf8_fp8 v[0:7], v[12:13], v[10:11], 1.0
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v0
; GCN-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v0
; GCN-NEXT:    v_wmma_f32_16x16x16_bf8_fp8 v[0:7], v[12:13], v[10:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v8, v4
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_fp8_bf8 v[0:7], v[12:13], v[10:11], 1.0
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v0
; GCN-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v0
; GCN-NEXT:    v_wmma_f32_16x16x16_fp8_bf8 v[0:7], v[12:13], v[10:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v8, v4
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_f32_16x16x16_bf8_bf8 v[0:7], v[12:13], v[10:11], 1.0
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v0
; GCN-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v0
; GCN-NEXT:    v_wmma_f32_16x16x16_bf8_bf8 v[0:7], v[12:13], v[10:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v8, v4
; GCN-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GCN-NEXT:    v_wmma_i32_16x16x32_iu4 v[0:7], v[12:13], v[10:11], 1
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
...
; GCN-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v0
; GCN-NEXT:    v_dual_mov_b32 v6, v0 :: v_dual_mov_b32 v7, v0
; GCN-NEXT:    v_wmma_i32_16x16x32_iu4 v[0:7], v[12:13], v[10:11], v[0:7]
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GCN-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GCN-NEXT:    s_endpgm
