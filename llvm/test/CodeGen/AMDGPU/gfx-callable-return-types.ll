...
; GFX11-NEXT:    v_dual_mov_b32 v42, v24 :: v_dual_mov_b32 v41, v23
; GFX11-NEXT:    v_dual_mov_b32 v40, v22 :: v_dual_mov_b32 v39, v21
; GFX11-NEXT:    v_dual_mov_b32 v51, v20 :: v_dual_mov_b32 v50, v19
; GFX11-NEXT:    v_dual_mov_b32 v49, v18 :: v_dual_mov_b32 v48, v17
; GFX11-NEXT:    v_dual_mov_b32 v35, v16 :: v_dual_mov_b32 v34, v15
; GFX11-NEXT:    v_dual_mov_b32 v33, v14 :: v_dual_mov_b32 v32, v13
; GFX11-NEXT:    v_dual_mov_b32 v24, v12 :: v_dual_mov_b32 v23, v11
; GFX11-NEXT:    v_dual_mov_b32 v22, v10 :: v_dual_mov_b32 v21, v9
; GFX11-NEXT:    s_clause 0x11
; GFX11-NEXT:    scratch_load_b32 v12, off, s32 offset:16
; GFX11-NEXT:    scratch_load_b32 v11, off, s32 offset:12
; GFX11-NEXT:    scratch_load_b32 v10, off, s32 offset:8
; GFX11-NEXT:    scratch_load_b32 v16, off, s32 offset:32
; GFX11-NEXT:    scratch_load_b32 v15, off, s32 offset:28
; GFX11-NEXT:    scratch_load_b32 v14, off, s32 offset:24
; GFX11-NEXT:    scratch_load_b32 v20, off, s32 offset:48
; GFX11-NEXT:    scratch_load_b32 v19, off, s32 offset:44
; GFX11-NEXT:    scratch_load_b32 v18, off, s32 offset:40
; GFX11-NEXT:    scratch_load_b32 v38, off, s32 offset:64
; GFX11-NEXT:    scratch_load_b32 v37, off, s32 offset:60
; GFX11-NEXT:    scratch_load_b32 v36, off, s32 offset:56
; GFX11-NEXT:    scratch_load_b32 v54, off, s32 offset:80
; GFX11-NEXT:    scratch_load_b32 v53, off, s32 offset:76
; GFX11-NEXT:    scratch_load_b32 v52, off, s32 offset:72
; GFX11-NEXT:    scratch_load_b32 v45, off, s32 offset:96
; GFX11-NEXT:    scratch_load_b32 v44, off, s32 offset:92
; GFX11-NEXT:    scratch_load_b32 v43, off, s32 offset:88
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    scratch_store_b128 v0, v[39:42], off offset:80
; GFX11-NEXT:    scratch_store_b128 v0, v[48:51], off offset:64
; GFX11-NEXT:    s_clause 0x5
; GFX11-NEXT:    scratch_load_b32 v58, off, s32 offset:112
; GFX11-NEXT:    scratch_load_b32 v57, off, s32 offset:108
; GFX11-NEXT:    scratch_load_b32 v56, off, s32 offset:104
; GFX11-NEXT:    scratch_load_b32 v49, off, s32 offset:128
; GFX11-NEXT:    scratch_load_b32 v48, off, s32 offset:124
; GFX11-NEXT:    scratch_load_b32 v47, off, s32 offset:120
; GFX11-NEXT:    s_clause 0x1
; GFX11-NEXT:    scratch_store_b128 v0, v[32:35], off offset:48
; GFX11-NEXT:    scratch_store_b128 v0, v[21:24], off offset:32
; GFX11-NEXT:    s_clause 0x10
; GFX11-NEXT:    scratch_load_b32 v62, off, s32 offset:144
; GFX11-NEXT:    scratch_load_b32 v61, off, s32 offset:140
; GFX11-NEXT:    scratch_load_b32 v60, off, s32 offset:136
; GFX11-NEXT:    scratch_load_b32 v24, off, s32 offset:160
; GFX11-NEXT:    scratch_load_b32 v23, off, s32 offset:156
; GFX11-NEXT:    scratch_load_b32 v22, off, s32 offset:152
; GFX11-NEXT:    scratch_load_b32 v21, off, s32 offset:148
; GFX11-NEXT:    scratch_load_b32 v59, off, s32 offset:132
; GFX11-NEXT:    scratch_load_b32 v46, off, s32 offset:116
; GFX11-NEXT:    scratch_load_b32 v55, off, s32 offset:100
; GFX11-NEXT:    scratch_load_b32 v42, off, s32 offset:84
; GFX11-NEXT:    scratch_load_b32 v51, off, s32 offset:68
; GFX11-NEXT:    scratch_load_b32 v35, off, s32 offset:52
; GFX11-NEXT:    scratch_load_b32 v17, off, s32 offset:36
; GFX11-NEXT:    scratch_load_b32 v13, off, s32 offset:20
; GFX11-NEXT:    scratch_load_b32 v9, off, s32 offset:4
; GFX11-NEXT:    scratch_load_b32 v32, off, s32
; GFX11-NEXT:    s_waitcnt vmcnt(10)
; GFX11-NEXT:    scratch_store_b128 v0, v[21:24], off offset:272
; GFX11-NEXT:    s_waitcnt vmcnt(9)
; GFX11-NEXT:    scratch_store_b128 v0, v[59:62], off offset:256
; GFX11-NEXT:    s_waitcnt vmcnt(8)
; GFX11-NEXT:    scratch_store_b128 v0, v[46:49], off offset:240
; GFX11-NEXT:    s_waitcnt vmcnt(7)
; GFX11-NEXT:    scratch_store_b128 v0, v[55:58], off offset:224
; GFX11-NEXT:    s_waitcnt vmcnt(6)
; GFX11-NEXT:    scratch_store_b128 v0, v[42:45], off offset:208
; GFX11-NEXT:    s_waitcnt vmcnt(5)
; GFX11-NEXT:    scratch_store_b128 v0, v[51:54], off offset:192
; GFX11-NEXT:    s_waitcnt vmcnt(4)
; GFX11-NEXT:    scratch_store_b128 v0, v[35:38], off offset:176
; GFX11-NEXT:    s_waitcnt vmcnt(3)
; GFX11-NEXT:    scratch_store_b128 v0, v[17:20], off offset:160
; GFX11-NEXT:    s_waitcnt vmcnt(2)
; GFX11-NEXT:    scratch_store_b128 v0, v[13:16], off offset:144
; GFX11-NEXT:    s_waitcnt vmcnt(1)
; GFX11-NEXT:    scratch_store_b128 v0, v[9:12], off offset:128
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    scratch_load_b128 v[36:39], off, s33 offset:624
; GFX11-NEXT:    scratch_load_b128 v[40:43], off, s33 offset:640
; GFX11-NEXT:    scratch_load_b128 v[32:35], off, s33 offset:784
; GFX11-NEXT:    scratch_load_b128 v[28:31], off, s33 offset:768
; GFX11-NEXT:    scratch_load_b128 v[24:27], off, s33 offset:752
; GFX11-NEXT:    scratch_load_b128 v[20:23], off, s33 offset:736
; GFX11-NEXT:    scratch_load_b128 v[16:19], off, s33 offset:720
; GFX11-NEXT:    scratch_load_b128 v[0:3], off, s33 offset:656
; GFX11-NEXT:    scratch_load_b128 v[12:15], off, s33 offset:704
; GFX11-NEXT:    scratch_load_b128 v[8:11], off, s33 offset:688
; GFX11-NEXT:    scratch_load_b128 v[4:7], off, s33 offset:672
; GFX11-NEXT:    scratch_load_b128 v[59:62], off, s33 offset:512
; GFX11-NEXT:    scratch_load_b128 v[48:51], off, s33 offset:528
; GFX11-NEXT:    scratch_load_b128 v[52:55], off, s33 offset:544
; GFX11-NEXT:    scratch_load_b128 v[56:59], off, s33 offset:560
; GFX11-NEXT:    scratch_load_b128 v[44:47], off, s33 offset:576
; GFX11-NEXT:    s_waitcnt vmcnt(10)
; GFX11-NEXT:    v_mov_b32_e32 v22, 24
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[44:47], s33 offset:1568 ; 16-byte Folded Spill
; GFX11-NEXT:    scratch_load_b128 v[44:47], off, s33 offset:592
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[44:47], s33 offset:1552 ; 16-byte Folded Spill
; GFX11-NEXT:    scratch_load_b128 v[44:47], off, s33 offset:608
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    scratch_store_b128 off, v[44:47], s33 offset:1536 ; 16-byte Folded Spill
; GFX11-NEXT:    scratch_store_b128 off, v[39:42], s32
; GFX11-NEXT:    scratch_store_b32 off, v35, s2
; GFX11-NEXT:    scratch_store_b128 off, v[31:34], s3
; GFX11-NEXT:    scratch_store_b128 off, v[27:30], s35
; GFX11-NEXT:    scratch_store_b128 off, v[23:26], s36
; GFX11-NEXT:    s_add_i32 s2, s32, 0x60
; GFX11-NEXT:    v_dual_mov_b32 v44, v0 :: v_dual_mov_b32 v31, v38
; GFX11-NEXT:    v_dual_mov_b32 v45, v1 :: v_dual_mov_b32 v46, v2
; GFX11-NEXT:    v_mov_b32_e32 v29, v36
; GFX11-NEXT:    scratch_store_b32 off, v22, s37
; GFX11-NEXT:    scratch_store_b96 off, v[19:21], s2
...
; GFX11-NEXT:    scratch_store_b128 off, v[15:18], s2
; GFX11-NEXT:    scratch_store_b128 off, v[11:14], s3
; GFX11-NEXT:    scratch_store_b128 off, v[7:10], s35
; GFX11-NEXT:    scratch_store_b128 off, v[3:6], s36
; GFX11-NEXT:    s_add_i32 s2, s32, 16
; GFX11-NEXT:    v_dual_mov_b32 v30, v37 :: v_dual_mov_b32 v5, v48
; GFX11-NEXT:    scratch_store_b128 off, v[43:46], s2
; GFX11-NEXT:    s_clause 0x2 ; 48-byte Folded Reload
...
; GFX11-NEXT:    v_dual_mov_b32 v4, v62 :: v_dual_mov_b32 v9, v52
; GFX11-NEXT:    v_dual_mov_b32 v6, v49 :: v_dual_mov_b32 v7, v50
; GFX11-NEXT:    v_dual_mov_b32 v8, v51 :: v_dual_mov_b32 v11, v54
; GFX11-NEXT:    v_dual_mov_b32 v10, v53 :: v_dual_mov_b32 v13, v56
; GFX11-NEXT:    v_dual_mov_b32 v12, v55 :: v_dual_mov_b32 v15, v58
; GFX11-NEXT:    v_dual_mov_b32 v14, v57 :: v_dual_mov_b32 v1, 42
; GFX11-NEXT:    v_mov_b32_e32 v16, v59
