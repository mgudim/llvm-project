...
; SI-NEXT:    v_alignbit_b32 v3, v5, v4, 30
; SI-NEXT:    v_ashr_i64 v[1:2], v[0:1], 2
; SI-NEXT:    v_cmp_ne_u64_e32 vcc, v[1:2], v[4:5]
; SI-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
...
; GFX9-NEXT:    v_lshlrev_b64 v[0:1], 2, v[2:3]
; GFX9-NEXT:    v_ashrrev_i64 v[4:5], 2, v[0:1]
; GFX9-NEXT:    v_alignbit_b32 v1, v3, v2, 30
; GFX9-NEXT:    v_cmp_ne_u64_e32 vcc, v[4:5], v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    v_ashrrev_i64 v[4:5], 2, v[0:1]
; GFX10-NEXT:    v_alignbit_b32 v1, v3, v2, 30
; GFX10-NEXT:    v_cmp_ne_u64_e32 vcc_lo, v[4:5], v[2:3]
; GFX10-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
; GFX10-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-NEXT:    v_ashrrev_i64 v[4:5], 2, v[0:1]
; GFX11-NEXT:    v_alignbit_b32 v1, v3, v2, 30
...
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 2, v[2:3]
; GFX12-NEXT:    v_ashrrev_i64 v[4:5], 2, v[0:1]
; GFX12-NEXT:    v_alignbit_b32 v1, v3, v2, 30
...
; SI-NEXT:    v_and_b32_e32 v5, 0x3fffffff, v3
; SI-NEXT:    v_mov_b32_e32 v4, v0
; SI-NEXT:    v_lshl_b64 v[0:1], v[2:3], 2
; SI-NEXT:    v_alignbit_b32 v1, v3, v2, 30
; SI-NEXT:    v_cmp_ne_u64_e32 vcc, v[4:5], v[2:3]
; SI-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; SI-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX9-NEXT:    v_mov_b32_e32 v3, v1
; GFX9-NEXT:    v_mov_b32_e32 v2, v0
; GFX9-NEXT:    v_and_b32_e32 v5, 0x3fffffff, v3
...
; GFX10-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-NEXT:    v_mov_b32_e32 v4, v0
; GFX10-NEXT:    v_and_b32_e32 v5, 0x3fffffff, v3
; GFX10-NEXT:    v_lshlrev_b64 v[0:1], 2, v[2:3]
; GFX10-NEXT:    v_alignbit_b32 v1, v3, v2, 30
; GFX10-NEXT:    v_cmp_ne_u64_e32 vcc_lo, v[4:5], v[2:3]
; GFX10-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc_lo
...
; GFX11-NEXT:    v_dual_mov_b32 v3, v1 :: v_dual_mov_b32 v2, v0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_and_b32 v5, 0x3fffffff, v3
; GFX11-NEXT:    v_lshlrev_b64 v[0:1], 2, v[2:3]
; GFX11-NEXT:    v_alignbit_b32 v1, v3, v2, 30
...
; GFX12-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_and_b32 v5, 0x3fffffff, v3
; GFX12-NEXT:    v_lshlrev_b64_e32 v[0:1], 2, v[2:3]
; GFX12-NEXT:    v_alignbit_b32 v1, v3, v2, 30
