...
; GFX1250-SDAG-LABEL: test_cvt_scale_pk8_f16_fp4_vv:
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v5, v3 :: v_dual_mov_b32 v4, v2
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk8_f16_fp4 v[0:3], v0, v1 scale_sel:3
; GFX1250-SDAG-NEXT:    global_store_b128 v[4:5], v[0:3], off
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: test_cvt_scale_pk8_f16_fp4_vv:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v4, v2 :: v_dual_mov_b32 v5, v3
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk8_f16_fp4 v[0:3], v0, v1 scale_sel:3
...
; GFX1250-NEXT:    v_cvt_scale_pk8_bf16_fp4 v[0:3], v0, v1 scale_sel:4
...
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v9, v3 :: v_dual_mov_b32 v8, v2
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk8_f32_fp4 v[0:7], v0, v1 scale_sel:1
; GFX1250-SDAG-NEXT:    s_clause 0x1
; GFX1250-SDAG-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GFX1250-SDAG-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: test_cvt_scale_pk8_f32_fp4_vv:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_mov_b32 v9, v3
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk8_f32_fp4 v[0:7], v0, v1 scale_sel:1
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    global_store_b128 v[8:9], v[0:3], off
; GFX1250-GISEL-NEXT:    global_store_b128 v[8:9], v[4:7], off offset:16
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v13, v5 :: v_dual_mov_b32 v12, v4
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk16_f16_fp6 v[4:11], v[0:2], v3
; GFX1250-SDAG-NEXT:    s_clause 0x1
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[8:11], off offset:16
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[4:7], off
; GFX1250-SDAG-NEXT:    s_endpgm
...
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v13, v5
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk16_f16_fp6 v[4:11], v[0:2], v3
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[4:7], off
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[8:11], off offset:16
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v8, s0 :: v_dual_mov_b32 v9, s1
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v10, s2 :: v_dual_mov_b32 v13, v1
; GFX1250-SDAG-NEXT:    v_mov_b32_e32 v12, v0
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk16_f16_fp6 v[0:7], v[8:10], 0x64 scale_sel:1
; GFX1250-SDAG-NEXT:    s_clause 0x1
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[4:7], off offset:16
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[0:3], off
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: test_cvt_scale_pk16_f16_fp6_sl:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v10, s2 :: v_dual_mov_b32 v9, s1
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v8, s0 :: v_dual_mov_b32 v12, v0
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v13, v1
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk16_f16_fp6 v[0:7], v[8:10], 0x64 scale_sel:1
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[0:3], off
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[4:7], off offset:16
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    v_dual_mov_b32 v13, v5 :: v_dual_mov_b32 v12, v4
; GFX1250-NEXT:    v_cvt_scale_pk16_bf16_fp6 v[4:11], v[0:2], v3 scale_sel:2
...
; GFX1250-NEXT:    v_dual_mov_b32 v10, s2 :: v_dual_mov_b32 v13, v1
; GFX1250-NEXT:    v_mov_b32_e32 v12, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-NEXT:    v_cvt_scale_pk16_bf16_fp6 v[0:7], v[8:10], 0x64 scale_sel:3
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_store_b128 v[12:13], v[4:7], off offset:16
; GFX1250-NEXT:    global_store_b128 v[12:13], v[0:3], off
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v13, v5 :: v_dual_mov_b32 v12, v4
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk16_f16_bf6 v[4:11], v[0:2], v3 scale_sel:4
; GFX1250-SDAG-NEXT:    s_clause 0x1
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[8:11], off offset:16
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[4:7], off
; GFX1250-SDAG-NEXT:    s_endpgm
...
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v12, v4 :: v_dual_mov_b32 v13, v5
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk16_f16_bf6 v[4:11], v[0:2], v3 scale_sel:4
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[4:7], off
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[8:11], off offset:16
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX1250-SDAG-NEXT:    v_mov_b32_e32 v12, v0
; GFX1250-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk16_f16_bf6 v[0:7], v[8:10], 0x64 scale_sel:5
; GFX1250-SDAG-NEXT:    s_clause 0x1
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[4:7], off offset:16
; GFX1250-SDAG-NEXT:    global_store_b128 v[12:13], v[0:3], off
; GFX1250-SDAG-NEXT:    s_endpgm
...
; GFX1250-GISEL-NEXT:    v_mov_b32_e32 v13, v1
; GFX1250-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk16_f16_bf6 v[0:7], v[8:10], 0x64 scale_sel:5
; GFX1250-GISEL-NEXT:    s_clause 0x1
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[0:3], off
; GFX1250-GISEL-NEXT:    global_store_b128 v[12:13], v[4:7], off offset:16
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    v_dual_mov_b32 v13, v5 :: v_dual_mov_b32 v12, v4
; GFX1250-NEXT:    v_cvt_scale_pk16_bf16_bf6 v[4:11], v[0:2], v3 scale_sel:6
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_store_b128 v[12:13], v[8:11], off offset:16
; GFX1250-NEXT:    global_store_b128 v[12:13], v[4:7], off
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-NEXT:    v_mov_b32_e32 v12, v0
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX1250-NEXT:    v_cvt_scale_pk16_bf16_bf6 v[0:7], v[8:10], 0x64 scale_sel:8
; GFX1250-NEXT:    s_clause 0x1
; GFX1250-NEXT:    global_store_b128 v[12:13], v[4:7], off offset:16
; GFX1250-NEXT:    global_store_b128 v[12:13], v[0:3], off
; GFX1250-NEXT:    s_endpgm
...
; GFX1250-SDAG:       ; %bb.0:
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v21, v5 :: v_dual_mov_b32 v20, v4
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk16_f32_fp6 v[4:19], v[0:2], v3 scale_sel:5
; GFX1250-SDAG-NEXT:    s_clause 0x3
; GFX1250-SDAG-NEXT:    global_store_b128 v[20:21], v[16:19], off offset:48
; GFX1250-SDAG-NEXT:    global_store_b128 v[20:21], v[12:15], off offset:32
; GFX1250-SDAG-NEXT:    global_store_b128 v[20:21], v[8:11], off offset:16
; GFX1250-SDAG-NEXT:    global_store_b128 v[20:21], v[4:7], off
; GFX1250-SDAG-NEXT:    s_endpgm
;
; GFX1250-GISEL-LABEL: test_cvt_scale_pk16_f32_fp6_vv:
; GFX1250-GISEL:       ; %bb.0:
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v20, v4 :: v_dual_mov_b32 v21, v5
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk16_f32_fp6 v[4:19], v[0:2], v3 scale_sel:5
; GFX1250-GISEL-NEXT:    s_clause 0x3
; GFX1250-GISEL-NEXT:    global_store_b128 v[20:21], v[4:7], off
; GFX1250-GISEL-NEXT:    global_store_b128 v[20:21], v[8:11], off offset:16
; GFX1250-GISEL-NEXT:    global_store_b128 v[20:21], v[12:15], off offset:32
; GFX1250-GISEL-NEXT:    global_store_b128 v[20:21], v[16:19], off offset:48
; GFX1250-GISEL-NEXT:    s_endpgm
...
; GFX1250-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-SDAG-NEXT:    v_dual_mov_b32 v21, v5 :: v_dual_mov_b32 v20, v4
; GFX1250-SDAG-NEXT:    v_cvt_scale_pk16_f32_bf6 v[4:19], v[0:2], v3 scale_sel:6
; GFX1250-SDAG-NEXT:    s_clause 0x3
; GFX1250-SDAG-NEXT:    global_store_b128 v[20:21], v[16:19], off offset:48
; GFX1250-SDAG-NEXT:    global_store_b128 v[20:21], v[12:15], off offset:32
; GFX1250-SDAG-NEXT:    global_store_b128 v[20:21], v[8:11], off offset:16
...
; GFX1250-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-GISEL-NEXT:    v_dual_mov_b32 v20, v4 :: v_dual_mov_b32 v21, v5
; GFX1250-GISEL-NEXT:    v_cvt_scale_pk16_f32_bf6 v[4:19], v[0:2], v3 scale_sel:6
; GFX1250-GISEL-NEXT:    s_clause 0x3
; GFX1250-GISEL-NEXT:    global_store_b128 v[20:21], v[4:7], off
; GFX1250-GISEL-NEXT:    global_store_b128 v[20:21], v[8:11], off offset:16
; GFX1250-GISEL-NEXT:    global_store_b128 v[20:21], v[12:15], off offset:32
