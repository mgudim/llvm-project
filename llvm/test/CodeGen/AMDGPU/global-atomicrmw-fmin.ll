...
; GFX7-NEXT:    v_min_f64 v[0:1], v[0:1], v[10:11]
...
; GFX6-NEXT:    v_min_f64 v[0:1], v[0:1], v[10:11]
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX90A-NEXT:    v_min_f16_e32 v0, v0, v2
...
; GFX908-NEXT:    v_min_f16_e32 v0, v0, v1
...
; GFX12-TRUE16-NEXT:    v_min_num_f32_e32 v5, v5, v0
...
; GFX12-FAKE16-NEXT:    v_min_num_f32_e32 v0, v0, v1
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_3)
...
; GFX11-TRUE16-NEXT:    v_min_f32_e32 v5, v5, v0
...
; GFX12-NEXT:    v_pk_min_num_f16 v5, v0, v1
; GFX12-NEXT:    s_wait_storecnt 0x0
...
; GFX12-TRUE16-NEXT:    v_dual_min_num_f32 v5, v5, v1 :: v_dual_lshlrev_b32 v0, 16, v6
...
; GFX942-NEXT:    v_min_f32_e32 v6, v6, v2
