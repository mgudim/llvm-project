...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4) ; encoding: [0x41,0x02,0x87,0xbf]
; GFX11-NEXT:    v_mov_b32_e32 v7, v3 ; encoding: [0x03,0x03,0x0e,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v4, v3 ; encoding: [0x03,0x03,0x08,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v5, v3 ; encoding: [0x03,0x03,0x0a,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v6, v3 ; encoding: [0x03,0x03,0x0c,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v8, v7 ; encoding: [0x07,0x03,0x10,0x7e]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_4) ; encoding: [0x12,0x02,0x87,0xbf]
...
; GFX11-NEXT:    v_mov_b32_e32 v4, v3 ; encoding: [0x03,0x03,0x08,0x7e]
; GFX11-NEXT:    image_msaa_load v[4:8], v[0:2], s[0:7] dmask:0x2 dim:SQ_RSRC_IMG_2D_MSAA unorm tfe lwe ; encoding: [0x98,0x02,0x60,0xf0,0x00,0x04,0x60,0x00]
; GFX11-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0xf7,0x03,0x89,0xbf]
; GFX11-NEXT:    v_mov_b32_e32 v0, v4 ; encoding: [0x04,0x03,0x00,0x7e]
; GFX11-NEXT:    global_store_b32 v3, v8, s[8:9] ; encoding: [0x00,0x00,0x6a,0xdc,0x03,0x08,0x08,0x00]
; GFX11-NEXT:    v_dual_mov_b32 v1, v5 :: v_dual_mov_b32 v2, v6 ; encoding: [0x05,0x01,0x10,0xca,0x06,0x01,0x02,0x01]
; GFX11-NEXT:    v_mov_b32_e32 v3, v7 ; encoding: [0x07,0x03,0x06,0x7e]
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: load_2dmsaa_both:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_mov_b32_e32 v3, 0 ; encoding: [0x80,0x02,0x06,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2) ; encoding: [0x21,0x01,0x87,0xbf]
; GFX12-NEXT:    v_dual_mov_b32 v6, v3 :: v_dual_mov_b32 v7, v3 ; encoding: [0x03,0x01,0x10,0xca,0x03,0x01,0x06,0x06]
; GFX12-NEXT:    v_dual_mov_b32 v4, v3 :: v_dual_mov_b32 v5, v3 ; encoding: [0x03,0x01,0x10,0xca,0x03,0x01,0x04,0x04]
; GFX12-NEXT:    v_mov_b32_e32 v8, v7 ; encoding: [0x07,0x03,0x10,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3) ; encoding: [0x93,0x01,0x87,0xbf]
; GFX12-NEXT:    v_mov_b32_e32 v7, v6 ; encoding: [0x06,0x03,0x0e,0x7e]
; GFX12-NEXT:    v_mov_b32_e32 v6, v5 ; encoding: [0x05,0x03,0x0c,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_1) ; encoding: [0xc4,0x00,0x87,0xbf]
; GFX12-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX12-NEXT:    v_mov_b32_e32 v4, v3 ; encoding: [0x03,0x03,0x08,0x7e]
; GFX12-NEXT:    image_msaa_load v[4:8], [v0, v1, v2], s[0:7] dmask:0x2 dim:SQ_RSRC_IMG_2D_MSAA unorm tfe lwe ; encoding: [0x0e,0x20,0x86,0xe4,0x04,0x01,0x00,0x00,0x00,0x01,0x02,0x00]
; GFX12-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX12-NEXT:    v_mov_b32_e32 v0, v4 ; encoding: [0x04,0x03,0x00,0x7e]
; GFX12-NEXT:    global_store_b32 v3, v8, s[8:9] ; encoding: [0x08,0x80,0x06,0xee,0x00,0x00,0x00,0x04,0x03,0x00,0x00,0x00]
; GFX12-NEXT:    v_dual_mov_b32 v1, v5 :: v_dual_mov_b32 v2, v6 ; encoding: [0x05,0x01,0x10,0xca,0x06,0x01,0x02,0x01]
; GFX12-NEXT:    v_mov_b32_e32 v3, v7 ; encoding: [0x07,0x03,0x06,0x7e]
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_4) ; encoding: [0x41,0x02,0x87,0xbf]
; GFX11-NEXT:    v_mov_b32_e32 v8, v4 ; encoding: [0x04,0x03,0x10,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v6, v4 ; encoding: [0x04,0x03,0x0c,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v7, v4 ; encoding: [0x04,0x03,0x0e,0x7e]
...
; GFX11-NEXT:    v_mov_b32_e32 v6, v5 ; encoding: [0x05,0x03,0x0c,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX11-NEXT:    image_msaa_load v[5:9], v[0:3], s[0:7] dmask:0x8 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe ; encoding: [0x9c,0x08,0x60,0xf0,0x00,0x05,0x20,0x00]
; GFX11-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0xf7,0x03,0x89,0xbf]
...
; GFX11-NEXT:    global_store_b32 v4, v9, s[8:9] ; encoding: [0x00,0x00,0x6a,0xdc,0x04,0x09,0x08,0x00]
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: load_2darraymsaa_tfe:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_mov_b32_e32 v4, 0 ; encoding: [0x80,0x02,0x08,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2) ; encoding: [0x21,0x01,0x87,0xbf]
; GFX12-NEXT:    v_dual_mov_b32 v7, v4 :: v_dual_mov_b32 v8, v4 ; encoding: [0x04,0x01,0x10,0xca,0x04,0x01,0x08,0x07]
; GFX12-NEXT:    v_dual_mov_b32 v5, v4 :: v_dual_mov_b32 v6, v4 ; encoding: [0x04,0x01,0x10,0xca,0x04,0x01,0x06,0x05]
; GFX12-NEXT:    v_mov_b32_e32 v9, v8 ; encoding: [0x08,0x03,0x12,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3) ; encoding: [0x93,0x01,0x87,0xbf]
; GFX12-NEXT:    v_mov_b32_e32 v8, v7 ; encoding: [0x07,0x03,0x10,0x7e]
; GFX12-NEXT:    v_mov_b32_e32 v7, v6 ; encoding: [0x06,0x03,0x0e,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_3) | instid1(VALU_DEP_1) ; encoding: [0xc4,0x00,0x87,0xbf]
; GFX12-NEXT:    v_mov_b32_e32 v6, v5 ; encoding: [0x05,0x03,0x0c,0x7e]
; GFX12-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX12-NEXT:    image_msaa_load v[5:9], [v0, v1, v2, v3], s[0:7] dmask:0x8 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe ; encoding: [0x0f,0x20,0x06,0xe6,0x05,0x00,0x00,0x00,0x00,0x01,0x02,0x03]
; GFX12-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX12-NEXT:    v_dual_mov_b32 v0, v5 :: v_dual_mov_b32 v1, v6 ; encoding: [0x05,0x01,0x10,0xca,0x06,0x01,0x00,0x00]
; GFX12-NEXT:    v_dual_mov_b32 v2, v7 :: v_dual_mov_b32 v3, v8 ; encoding: [0x07,0x01,0x10,0xca,0x08,0x01,0x02,0x02]
; GFX12-NEXT:    global_store_b32 v4, v9, s[8:9] ; encoding: [0x08,0x80,0x06,0xee,0x00,0x00,0x80,0x04,0x04,0x00,0x00,0x00]
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v4, v3 ; encoding: [0x03,0x03,0x08,0x7e]
; GFX11-NEXT:    image_msaa_load v[4:6], v[0:2], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm tfe d16 ; encoding: [0x98,0x01,0x62,0xf0,0x00,0x04,0x20,0x00]
; GFX11-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0xf7,0x03,0x89,0xbf]
; GFX11-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5 ; encoding: [0x04,0x01,0x10,0xca,0x05,0x01,0x00,0x00]
; GFX11-NEXT:    global_store_b32 v3, v6, s[8:9] ; encoding: [0x00,0x00,0x6a,0xdc,0x03,0x06,0x08,0x00]
; GFX11-NEXT:    ; return to shader part epilog
;
; GFX12-LABEL: load_2dmsaa_tfe_d16:
; GFX12:       ; %bb.0: ; %main_body
; GFX12-NEXT:    v_mov_b32_e32 v3, 0 ; encoding: [0x80,0x02,0x06,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1) ; encoding: [0x91,0x00,0x87,0xbf]
; GFX12-NEXT:    v_dual_mov_b32 v4, v3 :: v_dual_mov_b32 v5, v3 ; encoding: [0x03,0x01,0x10,0xca,0x03,0x01,0x04,0x04]
; GFX12-NEXT:    v_mov_b32_e32 v6, v5 ; encoding: [0x05,0x03,0x0c,0x7e]
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_1) ; encoding: [0xc2,0x00,0x87,0xbf]
; GFX12-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX12-NEXT:    v_mov_b32_e32 v4, v3 ; encoding: [0x03,0x03,0x08,0x7e]
; GFX12-NEXT:    image_msaa_load v[4:6], [v0, v1, v2], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA unorm tfe d16 ; encoding: [0x2e,0x20,0x46,0xe4,0x04,0x00,0x00,0x00,0x00,0x01,0x02,0x00]
; GFX12-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX12-NEXT:    v_dual_mov_b32 v0, v4 :: v_dual_mov_b32 v1, v5 ; encoding: [0x04,0x01,0x10,0xca,0x05,0x01,0x00,0x00]
; GFX12-NEXT:    global_store_b32 v3, v6, s[8:9] ; encoding: [0x08,0x80,0x06,0xee,0x00,0x00,0x00,0x03,0x03,0x00,0x00,0x00]
; GFX12-NEXT:    ; return to shader part epilog
main_body:
...
; GFX11-NEXT:    v_mov_b32_e32 v6, v5 ; encoding: [0x05,0x03,0x0c,0x7e]
; GFX11-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX11-NEXT:    image_msaa_load v[5:7], v[0:3], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe d16 ; encoding: [0x9c,0x01,0x62,0xf0,0x00,0x05,0x20,0x00]
; GFX11-NEXT:    s_waitcnt vmcnt(0) ; encoding: [0xf7,0x03,0x89,0xbf]
; GFX11-NEXT:    v_dual_mov_b32 v0, v5 :: v_dual_mov_b32 v1, v6 ; encoding: [0x05,0x01,0x10,0xca,0x06,0x01,0x00,0x00]
; GFX11-NEXT:    global_store_b32 v4, v7, s[8:9] ; encoding: [0x00,0x00,0x6a,0xdc,0x04,0x07,0x08,0x00]
; GFX11-NEXT:    ; return to shader part epilog
;
...
; GFX12-NEXT:    v_mov_b32_e32 v6, v5 ; encoding: [0x05,0x03,0x0c,0x7e]
; GFX12-NEXT:    v_mov_b32_e32 v5, v4 ; encoding: [0x04,0x03,0x0a,0x7e]
; GFX12-NEXT:    image_msaa_load v[5:7], [v0, v1, v2, v3], s[0:7] dmask:0x1 dim:SQ_RSRC_IMG_2D_MSAA_ARRAY unorm tfe d16 ; encoding: [0x2f,0x20,0x46,0xe4,0x05,0x00,0x00,0x00,0x00,0x01,0x02,0x03]
; GFX12-NEXT:    s_wait_samplecnt 0x0 ; encoding: [0x00,0x00,0xc2,0xbf]
; GFX12-NEXT:    v_dual_mov_b32 v0, v5 :: v_dual_mov_b32 v1, v6 ; encoding: [0x05,0x01,0x10,0xca,0x06,0x01,0x00,0x00]
; GFX12-NEXT:    global_store_b32 v4, v7, s[8:9] ; encoding: [0x08,0x80,0x06,0xee,0x00,0x00,0x80,0x03,0x04,0x00,0x00,0x00]
; GFX12-NEXT:    ; return to shader part epilog
main_body:
