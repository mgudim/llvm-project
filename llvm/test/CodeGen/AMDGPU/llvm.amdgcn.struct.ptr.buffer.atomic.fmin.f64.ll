...
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen glc
...
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen glc
...
; GFX6-NEXT:    s_mov_b32 s5, s17
; GFX6-NEXT:    s_mov_b32 s4, s16
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen offset:256 glc
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_mov_b32 s5, s17
; GFX7-NEXT:    s_mov_b32 s4, s16
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen offset:256 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    s_mov_b32 s5, s17
; GFX6-NEXT:    s_mov_b32 s4, s16
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v2, s[4:7], s20 idxen glc
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_mov_b32 s5, s17
; GFX7-NEXT:    s_mov_b32 s4, s16
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v2, s[4:7], s20 idxen glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    s_mov_b32 s5, s17
; GFX6-NEXT:    s_mov_b32 s4, s16
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen glc slc
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_mov_b32 s5, s17
; GFX7-NEXT:    s_mov_b32 s4, s16
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen glc slc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
...
; GFX6-NEXT:    s_mov_b32 s5, s17
; GFX6-NEXT:    s_mov_b32 s4, s16
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_mov_b32 s5, s17
; GFX7-NEXT:    s_mov_b32 s4, s16
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %ret = call double @llvm.amdgcn.struct.ptr.buffer.atomic.fmin.f64(double %val, ptr addrspace(8) %rsrc, i32 %vindex, i32 %voffset, i32 %soffset, i32 0)
  ret void
...
; GFX6-NEXT:    s_mov_b32 s5, s17
; GFX6-NEXT:    s_mov_b32 s4, s16
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen offset:256
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_mov_b32 s5, s17
; GFX7-NEXT:    s_mov_b32 s4, s16
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen offset:256
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %voffset.add = add i32 %voffset, 256
  %ret = call double @llvm.amdgcn.struct.ptr.buffer.atomic.fmin.f64(double %val, ptr addrspace(8) %rsrc, i32 %vindex, i32 %voffset.add, i32 %soffset, i32 0)
...
; GFX6-NEXT:    s_mov_b32 s5, s17
; GFX6-NEXT:    s_mov_b32 s4, s16
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v2, s[4:7], s20 idxen
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_mov_b32 s5, s17
; GFX7-NEXT:    s_mov_b32 s4, s16
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v2, s[4:7], s20 idxen
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %ret = call double @llvm.amdgcn.struct.ptr.buffer.atomic.fmin.f64(double %val, ptr addrspace(8) %rsrc, i32 %vindex, i32 0, i32 %soffset, i32 0)
  ret void
...
; GFX6-NEXT:    s_mov_b32 s5, s17
; GFX6-NEXT:    s_mov_b32 s4, s16
; GFX6-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen slc
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    s_mov_b32 s5, s17
; GFX7-NEXT:    s_mov_b32 s4, s16
; GFX7-NEXT:    buffer_atomic_fmin_x2 v[0:1], v[2:3], s[4:7], s20 idxen offen slc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    s_setpc_b64 s[30:31]
  %ret = call double @llvm.amdgcn.struct.ptr.buffer.atomic.fmin.f64(double %val, ptr addrspace(8) %rsrc, i32 %vindex, i32 %voffset, i32 %soffset, i32 2)
  ret void
