...
; GLOBALNESS1:       ; %bb.0: ; %bb
; GLOBALNESS1-NEXT:    s_mov_b64 s[50:51], s[6:7]
...
; GLOBALNESS1-NEXT:    global_load_dword v2, v42, s[36:37]
; GLOBALNESS1-NEXT:    s_mov_b64 s[54:55], s[4:5]
...
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[36:37], 1, v0
...
; GLOBALNESS1-NEXT:    s_mov_b32 s34, s16
; GLOBALNESS1-NEXT:    s_mov_b32 s35, s15
; GLOBALNESS1-NEXT:    s_mov_b32 s66, s14
; GLOBALNESS1-NEXT:    s_mov_b64 s[48:49], s[10:11]
...
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[84:85], 1, v1
...
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], s[48:49]
; GLOBALNESS1-NEXT:    s_mov_b32 s12, s66
; GLOBALNESS1-NEXT:    s_mov_b32 s13, s35
; GLOBALNESS1-NEXT:    s_mov_b32 s14, s34
...
; GLOBALNESS1-NEXT:    v_cmp_gt_i32_e64 s[82:83], 0, v0
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v1, 0x3ff00000
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[86:87], s[82:83]
...
; GLOBALNESS1-NEXT:    s_mov_b32 s67, s39
; GLOBALNESS1-NEXT:    s_and_b64 vcc, exec, s[4:5]
...
; GLOBALNESS1-NEXT:    v_cmp_ne_u32_e64 s[38:39], 1, v0
...
; GLOBALNESS1-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS1-NEXT:    s_add_u32 s98, s52, 40
; GLOBALNESS1-NEXT:    s_addc_u32 s99, s53, 0
; GLOBALNESS1-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS1-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS1-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS1-NEXT:    s_load_dwordx2 s[64:65], s[4:5], 0x0
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[54:55]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[50:51]
...
; GLOBALNESS1-NEXT:    v_mov_b32_e32 v31, v41
; GLOBALNESS1-NEXT:    s_waitcnt lgkmcnt(0)
; GLOBALNESS1-NEXT:    s_swappc_b64 s[30:31], s[64:65]
; GLOBALNESS1-NEXT:    s_mov_b64 s[4:5], s[54:55]
; GLOBALNESS1-NEXT:    s_mov_b64 s[6:7], s[50:51]
; GLOBALNESS1-NEXT:    s_mov_b64 s[8:9], s[98:99]
; GLOBALNESS1-NEXT:    s_mov_b64 s[10:11], s[48:49]
...
; GLOBALNESS1-NEXT:    s_mov_b32 s39, s67
...
; GLOBALNESS1-NEXT:    s_and_saveexec_b64 s[4:5], s[82:83]
...
; GLOBALNESS0:       ; %bb.0: ; %bb
; GLOBALNESS0-NEXT:    s_mov_b64 s[52:53], s[8:9]
; GLOBALNESS0-NEXT:    s_mov_b64 s[48:49], s[10:11]
; GLOBALNESS0-NEXT:    s_mov_b64 s[50:51], s[6:7]
; GLOBALNESS0-NEXT:    s_load_dwordx4 s[8:11], s[8:9], 0x0
; GLOBALNESS0-NEXT:    s_nop 0
; GLOBALNESS0-NEXT:    s_load_dword s6, s[52:53], 0x14
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[54:55], s[4:5]
; GLOBALNESS0-NEXT:    s_load_dwordx2 s[4:5], s[52:53], 0x18
; GLOBALNESS0-NEXT:    s_load_dword s7, s[52:53], 0x20
...
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[36:37], 1, v0
...
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[70:71], 1, v0
; GLOBALNESS0-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s8, 0
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[80:81], 1, v0
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s9, 1
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[38:39], 1, v3
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v46, 0x80
; GLOBALNESS0-NEXT:    s_mov_b32 s34, s16
; GLOBALNESS0-NEXT:    s_mov_b32 s35, s15
; GLOBALNESS0-NEXT:    s_mov_b32 s98, s14
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v47, 0
; GLOBALNESS0-NEXT:    s_mov_b32 s99, s11
...
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[84:85], 1, v1
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s38, 8
; GLOBALNESS0-NEXT:    v_writelane_b32 v57, s39, 9
...
; GLOBALNESS0-NEXT:    s_mov_b64 s[10:11], s[48:49]
; GLOBALNESS0-NEXT:    s_mov_b32 s12, s98
; GLOBALNESS0-NEXT:    s_mov_b32 s13, s35
; GLOBALNESS0-NEXT:    s_mov_b32 s14, s34
...
; GLOBALNESS0-NEXT:    v_cmp_gt_i32_e64 s[82:83], 0, v0
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v0, 0
; GLOBALNESS0-NEXT:    v_mov_b32_e32 v1, 0x3ff00000
; GLOBALNESS0-NEXT:    s_and_saveexec_b64 s[86:87], s[82:83]
...
; GLOBALNESS0-NEXT:    v_cmp_ne_u32_e64 s[38:39], 1, v0
...
; GLOBALNESS0-NEXT:    ; in Loop: Header=BB1_16 Depth=2
; GLOBALNESS0-NEXT:    s_add_u32 s64, s52, 40
; GLOBALNESS0-NEXT:    s_addc_u32 s65, s53, 0
; GLOBALNESS0-NEXT:    s_getpc_b64 s[4:5]
; GLOBALNESS0-NEXT:    s_add_u32 s4, s4, wobble@gotpcrel32@lo+4
; GLOBALNESS0-NEXT:    s_addc_u32 s5, s5, wobble@gotpcrel32@hi+12
; GLOBALNESS0-NEXT:    s_load_dwordx2 s[66:67], s[4:5], 0x0
; GLOBALNESS0-NEXT:    s_mov_b64 s[4:5], s[54:55]
; GLOBALNESS0-NEXT:    s_mov_b64 s[6:7], s[50:51]
