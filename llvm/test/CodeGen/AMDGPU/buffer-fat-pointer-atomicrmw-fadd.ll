...
; GFX7-NEXT:    buffer_atomic_cmpswap v[4:5], v3, s[4:7], 0 offen offset:1024 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_add_f32_e32 v8, v9, v5
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_f32_e32 v8, v9, v5
...
; GFX7-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[6:7]
...
; GFX7-NEXT:    buffer_load_dword v9, v4, s[8:11], 0 offen offset:1024
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_add_f32_e32 v8, v9, v5
...
; GFX6-NEXT:    v_add_i32_e32 v10, vcc, 0x400, v4
; GFX6-NEXT:    s_mov_b64 s[6:7], exec
; GFX6-NEXT:  .LBB2_1: ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    v_readfirstlane_b32 s8, v6
; GFX6-NEXT:    v_readfirstlane_b32 s9, v7
; GFX6-NEXT:    v_readfirstlane_b32 s10, v2
; GFX6-NEXT:    v_readfirstlane_b32 s11, v3
; GFX6-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[6:7]
...
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    v_add_f32_e32 v8, v9, v5
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX90A-NEXT:    buffer_atomic_cmpswap v[4:5], v1, s[4:7], 0 offen offset:1024 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
...
; GFX12-NEXT:    buffer_load_b64 v[2:3], v0, s[0:3], null offen offset:2048
; GFX12-NEXT:  .LBB8_1: ; %atomicrmw.start
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_add_f64_e32 v[0:1], v[2:3], v[8:9]
...
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_atomic_add_f64 v[2:3], v0, s[0:3], 0 offen offset:2048 sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
...
; GFX11-NEXT:    s_mov_b32 s4, 0
; GFX11-NEXT:    buffer_load_b64 v[2:3], v0, s[0:3], 0 offen offset:2048
; GFX11-NEXT:  .LBB8_1: ; %atomicrmw.start
; GFX11-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add_f64 v[0:1], v[2:3], v[8:9]
...
; GFX10-NEXT:    buffer_load_dwordx2 v[2:3], v0, s[4:7], 0 offen offset:2048
; GFX10-NEXT:    v_mov_b32_e32 v10, s20
; GFX10-NEXT:    s_mov_b32 s8, 0
; GFX10-NEXT:  .LBB8_1: ; %atomicrmw.start
; GFX10-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_add_f64 v[0:1], v[2:3], v[8:9]
...
; GFX90A-NEXT:    s_mov_b32 s4, s16
; GFX90A-NEXT:    v_mov_b32_e32 v0, s20
; GFX90A-NEXT:    buffer_atomic_add_f64 v[2:3], v0, s[4:7], 0 offen offset:2048 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
...
; GFX908-NEXT:    v_mov_b32_e32 v0, s20
; GFX908-NEXT:    buffer_load_dwordx2 v[2:3], v0, s[4:7], 0 offen offset:2048
...
; GFX908-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_add_f64 v[0:1], v[2:3], v[8:9]
...
; GFX8-NEXT:    v_mov_b32_e32 v0, s20
; GFX8-NEXT:    buffer_load_dwordx2 v[2:3], v0, s[4:7], 0 offen offset:2048
...
; GFX8-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_f64 v[0:1], v[2:3], v[8:9]
...
; GFX7-NEXT:    v_mov_b32_e32 v0, s20
; GFX7-NEXT:    buffer_load_dwordx2 v[2:3], v0, s[4:7], 0 offen offset:2048
...
; GFX6-NEXT:    v_mov_b32_e32 v0, s20
; GFX6-NEXT:    buffer_load_dwordx2 v[2:3], v0, s[4:7], 0 offen offset:2048
...
; GFX12-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_add_f64_e32 v[0:1], v[2:3], v[4:5]
...
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_atomic_add_f64 v[2:3], v0, s[0:3], 0 offen offset:2048
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX10-NEXT:    buffer_atomic_cmpswap_x2 v[7:10], v6, s[4:7], 0 offen offset:2048 glc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
...
; GFX90A-NEXT:    s_mov_b32 s4, s16
; GFX90A-NEXT:    v_mov_b32_e32 v0, s20
; GFX90A-NEXT:    buffer_atomic_add_f64 v[2:3], v0, s[4:7], 0 offen offset:2048
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX7-NEXT:    buffer_atomic_cmpswap_x2 v[7:10], v6, s[4:7], 0 offen offset:2048 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v10, v6 :: v_dual_mov_b32 v9, v5
; GFX12-NEXT:    v_dual_mov_b32 v12, v3 :: v_dual_mov_b32 v11, v2
; GFX12-NEXT:    v_dual_mov_b32 v14, v1 :: v_dual_mov_b32 v13, v0
; GFX12-NEXT:    s_mov_b32 s1, exec_lo
; GFX12-NEXT:  .LBB10_1: ; =>This Inner Loop Header: Depth=1
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_readfirstlane_b32 s4, v13
; GFX12-NEXT:    v_readfirstlane_b32 s5, v14
; GFX12-NEXT:    v_readfirstlane_b32 s6, v11
; GFX12-NEXT:    v_readfirstlane_b32 s7, v12
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[13:14]
; GFX12-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[11:12]
; GFX12-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_add_f64_e32 v[0:1], v[2:3], v[9:10]
...
; GFX11-NEXT:    v_dual_mov_b32 v12, v3 :: v_dual_mov_b32 v11, v2
...
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[13:14]
...
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_add_f64 v[0:1], v[2:3], v[9:10]
...
; GFX10-NEXT:    v_readfirstlane_b32 s8, v13
; GFX10-NEXT:    v_readfirstlane_b32 s9, v14
; GFX10-NEXT:    v_readfirstlane_b32 s10, v11
; GFX10-NEXT:    v_readfirstlane_b32 s11, v12
; GFX10-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[8:9], v[13:14]
; GFX10-NEXT:    v_cmp_eq_u64_e64 s4, s[10:11], v[11:12]
; GFX10-NEXT:    s_and_b32 s4, vcc_lo, s4
; GFX10-NEXT:    s_and_saveexec_b32 s4, s4
; GFX10-NEXT:    buffer_load_dwordx2 v[2:3], v4, s[8:11], 0 offen offset:2048
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_xor_b32 exec_lo, exec_lo, s4
...
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_add_f64 v[0:1], v[2:3], v[9:10]
...
; GFX10-NEXT:    s_and_saveexec_b32 s4, s4
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    buffer_atomic_cmpswap_x2 v[5:8], v4, s[8:11], 0 offen offset:2048 glc
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_xor_b32 exec_lo, exec_lo, s4
...
; GFX10-NEXT:    s_mov_b32 exec_lo, s6
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[5:6], v[2:3]
...
; GFX908-NEXT:    v_mov_b32_e32 v12, v3
; GFX908-NEXT:    v_mov_b32_e32 v11, v2
; GFX908-NEXT:    v_mov_b32_e32 v14, v1
; GFX908-NEXT:    v_mov_b32_e32 v13, v0
; GFX908-NEXT:    s_mov_b64 s[6:7], exec
; GFX908-NEXT:  .LBB10_1: ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_readfirstlane_b32 s8, v13
; GFX908-NEXT:    v_readfirstlane_b32 s9, v14
; GFX908-NEXT:    v_readfirstlane_b32 s10, v11
; GFX908-NEXT:    v_readfirstlane_b32 s11, v12
; GFX908-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[13:14]
; GFX908-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[10:11], v[11:12]
; GFX908-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX908-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX908-NEXT:    s_nop 0
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_add_f64 v[0:1], v[2:3], v[9:10]
...
; GFX8-NEXT:    v_readfirstlane_b32 s8, v13
; GFX8-NEXT:    v_readfirstlane_b32 s9, v14
; GFX8-NEXT:    v_readfirstlane_b32 s10, v11
; GFX8-NEXT:    v_readfirstlane_b32 s11, v12
; GFX8-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[13:14]
; GFX8-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[10:11], v[11:12]
; GFX8-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX8-NEXT:    s_nop 0
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_f64 v[0:1], v[2:3], v[9:10]
...
; GFX7-NEXT:    v_mov_b32_e32 v11, v2
; GFX7-NEXT:    v_mov_b32_e32 v14, v1
; GFX7-NEXT:    v_mov_b32_e32 v13, v0
; GFX7-NEXT:    s_mov_b64 s[6:7], exec
; GFX7-NEXT:  .LBB10_1: ; =>This Inner Loop Header: Depth=1
; GFX7-NEXT:    v_readfirstlane_b32 s8, v13
; GFX7-NEXT:    v_readfirstlane_b32 s9, v14
; GFX7-NEXT:    v_readfirstlane_b32 s10, v11
; GFX7-NEXT:    v_readfirstlane_b32 s11, v12
; GFX7-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[13:14]
; GFX7-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[10:11], v[11:12]
; GFX7-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX7-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX7-NEXT:    buffer_load_dwordx2 v[2:3], v4, s[8:11], 0 offen offset:2048
; GFX7-NEXT:    s_xor_b64 exec, exec, s[4:5]
...
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_add_f64 v[0:1], v[2:3], v[9:10]
...
; GFX7-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_atomic_cmpswap_x2 v[5:8], v4, s[8:11], 0 offen offset:2048 glc
; GFX7-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX7-NEXT:    s_cbranch_execnz .LBB10_4
; GFX7-NEXT:  ; %bb.5: ; in Loop: Header=BB10_3 Depth=1
; GFX7-NEXT:    s_mov_b64 exec, s[12:13]
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_cmp_eq_u64_e32 vcc, v[5:6], v[2:3]
...
; GFX6:       ; %bb.0:
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v9, v6
; GFX6-NEXT:    v_mov_b32_e32 v8, v5
; GFX6-NEXT:    v_mov_b32_e32 v11, v3
; GFX6-NEXT:    v_mov_b32_e32 v10, v2
; GFX6-NEXT:    v_mov_b32_e32 v13, v1
; GFX6-NEXT:    v_mov_b32_e32 v12, v0
; GFX6-NEXT:    v_add_i32_e32 v14, vcc, 0x800, v4
; GFX6-NEXT:    s_mov_b64 s[6:7], exec
; GFX6-NEXT:  .LBB10_1: ; =>This Inner Loop Header: Depth=1
; GFX6-NEXT:    v_readfirstlane_b32 s8, v12
; GFX6-NEXT:    v_readfirstlane_b32 s9, v13
; GFX6-NEXT:    v_readfirstlane_b32 s10, v10
; GFX6-NEXT:    v_readfirstlane_b32 s11, v11
; GFX6-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[12:13]
; GFX6-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[10:11], v[10:11]
; GFX6-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX6-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX6-NEXT:    buffer_load_dwordx2 v[2:3], v4, s[8:11], 0 offen offset:2048
; GFX6-NEXT:    ; implicit-def: $vgpr4
; GFX6-NEXT:    s_xor_b64 exec, exec, s[4:5]
...
; GFX6-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX6-NEXT:    s_waitcnt vmcnt(0) expcnt(0)
; GFX6-NEXT:    buffer_atomic_cmpswap_x2 v[4:7], v14, s[8:11], 0 offen glc
; GFX6-NEXT:    s_xor_b64 exec, exec, s[4:5]
...
; GFX90A-NEXT:    v_mov_b32_e32 v0, s20
; GFX90A-NEXT:    buffer_load_dwordx2 v[2:3], v0, s[4:7], 0 offen offset:2048
...
; GFX90A-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_add_f64 v[0:1], v[2:3], v[8:9]
...
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_pk_add_f16 v8, v9, v5
; GFX908-NEXT:    v_mov_b32_e32 v0, v8
; GFX908-NEXT:    s_mov_b64 s[12:13], exec
; GFX908-NEXT:    v_mov_b32_e32 v1, v9
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_add_f16_sdwa v0, v9, v5 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_add_f16_e32 v1, v9, v5
...
; GFX942-NEXT:    v_add_f32_e32 v0, v0, v10
...
; GFX942-NEXT:    v_add_f32_e32 v1, v1, v5
; GFX942-NEXT:    v_bfe_u32 v8, v1, 16, 1
...
; GFX90A-NEXT:    v_add_f32_e32 v0, v0, v10
...
; GFX90A-NEXT:    v_add_f32_e32 v1, v1, v5
; GFX90A-NEXT:    v_bfe_u32 v8, v1, 16, 1
...
; GFX908-NEXT:    v_add_f32_e32 v0, v0, v10
...
; GFX908-NEXT:    v_add_f32_e32 v1, v1, v5
; GFX908-NEXT:    v_bfe_u32 v8, v1, 16, 1
