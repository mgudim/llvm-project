...
; SDAG-NEXT:    v_or_b32_e32 v6, v2, v4
; SDAG-NEXT:    v_or_b32_e32 v5, v1, v3
; SDAG-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[5:6]
; SDAG-NEXT:    v_mov_b32_e32 v0, 0
; SDAG-NEXT:    s_and_saveexec_b64 s[6:7], vcc
; SDAG-NEXT:    s_cbranch_execz .LBB1_14
; SDAG-NEXT:  ; %bb.1: ; %itofp-if-end
; SDAG-NEXT:    v_ffbh_u32_e32 v0, v3
; SDAG-NEXT:    v_add_u32_e32 v0, 32, v0
; SDAG-NEXT:    v_ffbh_u32_e32 v5, v4
; SDAG-NEXT:    v_min_u32_e32 v0, v0, v5
; SDAG-NEXT:    v_ffbh_u32_e32 v5, v1
...
; SDAG-NEXT:    v_cndmask_b32_e32 v6, v5, v0, vcc
; SDAG-NEXT:    v_sub_u32_e32 v0, 0x80, v6
; SDAG-NEXT:    v_cmp_gt_i32_e32 vcc, 25, v0
; SDAG-NEXT:    ; implicit-def: $vgpr7
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; SDAG-NEXT:  ; %bb.2: ; %itofp-if-else
; SDAG-NEXT:    v_add_u32_e32 v3, 0xffffff98, v6
; SDAG-NEXT:    v_lshlrev_b64 v[0:1], v3, v[1:2]
...
; SDAG-NEXT:    v_lshrrev_b64 v[9:10], v12, v[1:2]
; SDAG-NEXT:    v_lshlrev_b64 v[11:12], v13, v[3:4]
; SDAG-NEXT:    v_subrev_u32_e32 v6, 38, v6
; SDAG-NEXT:    v_cndmask_b32_e64 v14, v7, v1, s[4:5]
; SDAG-NEXT:    v_lshlrev_b64 v[6:7], v6, v[1:2]
; SDAG-NEXT:    v_cndmask_b32_e64 v8, v8, v2, s[4:5]
; SDAG-NEXT:    v_or_b32_e32 v10, v12, v10
; SDAG-NEXT:    v_or_b32_e32 v9, v11, v9
; SDAG-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v13
; SDAG-NEXT:    v_lshlrev_b64 v[1:2], v13, v[1:2]
; SDAG-NEXT:    v_cndmask_b32_e32 v7, v7, v10, vcc
; SDAG-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v13
; SDAG-NEXT:    v_cndmask_b32_e32 v6, v6, v9, vcc
; SDAG-NEXT:    v_cndmask_b32_e64 v4, v7, v4, s[4:5]
; SDAG-NEXT:    v_cndmask_b32_e64 v3, v6, v3, s[4:5]
...
; SDAG-NEXT:    v_or_b32_e32 v7, v14, v1
...
; SDAG-NEXT:    s_andn2_saveexec_b64 s[4:5], s[10:11]
; SDAG-NEXT:  ; %bb.9: ; %itofp-sw-bb
; SDAG-NEXT:    v_lshlrev_b64 v[1:2], 1, v[1:2]
; SDAG-NEXT:  ; %bb.10: ; %itofp-sw-epilog
; SDAG-NEXT:    s_or_b64 exec, exec, s[4:5]
; SDAG-NEXT:    v_lshrrev_b32_e32 v3, 2, v1
; SDAG-NEXT:    v_and_or_b32 v1, v3, 1, v1
; SDAG-NEXT:    v_add_co_u32_e32 v1, vcc, 1, v1
; SDAG-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v2, vcc
; SDAG-NEXT:    v_and_b32_e32 v3, 0x4000000, v1
; SDAG-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v3
; SDAG-NEXT:    v_alignbit_b32 v7, v2, v1, 2
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:  ; %bb.11: ; %itofp-if-then20
; SDAG-NEXT:    v_alignbit_b32 v7, v2, v1, 3
...
; GISEL-NEXT:    v_ffbh_u32_e32 v0, v5
...
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v1, v0, vcc
; GISEL-NEXT:    v_sub_u32_e32 v8, 0x80, v1
; GISEL-NEXT:    v_cmp_ge_i32_e32 vcc, 24, v8
; GISEL-NEXT:    ; implicit-def: $vgpr0
; GISEL-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GISEL-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
; GISEL-NEXT:  ; %bb.2: ; %itofp-if-else
; GISEL-NEXT:    v_add_u32_e32 v0, 0xffffff98, v1
; GISEL-NEXT:    v_lshlrev_b64 v[2:3], v0, v[4:5]
...
; GISEL-NEXT:  ; %bb.3: ; %Flow3
; GISEL-NEXT:    s_or_saveexec_b64 s[8:9], s[4:5]
; GISEL-NEXT:    v_sub_u32_e32 v9, 0x7f, v1
; GISEL-NEXT:    s_xor_b64 exec, exec, s[8:9]
...
; GISEL-NEXT:  ; %bb.6: ; %itofp-sw-default
; GISEL-NEXT:    v_sub_u32_e32 v0, 0x66, v1
; GISEL-NEXT:    v_sub_u32_e32 v10, 64, v0
; GISEL-NEXT:    v_lshrrev_b64 v[2:3], v0, v[4:5]
; GISEL-NEXT:    v_lshlrev_b64 v[10:11], v10, v[6:7]
; GISEL-NEXT:    v_add_u32_e32 v12, 0xffffffc0, v0
; GISEL-NEXT:    v_or_b32_e32 v10, v2, v10
; GISEL-NEXT:    v_or_b32_e32 v11, v3, v11
; GISEL-NEXT:    v_lshrrev_b64 v[2:3], v12, v[6:7]
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v0
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v2, v10, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v3, v3, v11, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v0
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v2, v4, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v2, v3, v5, vcc
; GISEL-NEXT:    v_add_u32_e32 v3, 26, v1
; GISEL-NEXT:    v_sub_u32_e32 v0, 64, v3
; GISEL-NEXT:    v_lshrrev_b64 v[10:11], v3, -1
; GISEL-NEXT:    v_lshlrev_b64 v[12:13], v0, -1
; GISEL-NEXT:    v_add_u32_e32 v0, 0xffffffda, v1
; GISEL-NEXT:    v_lshrrev_b64 v[0:1], v0, -1
; GISEL-NEXT:    v_or_b32_e32 v12, v10, v12
; GISEL-NEXT:    v_or_b32_e32 v13, v11, v13
; GISEL-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v3
; GISEL-NEXT:    v_cndmask_b32_e32 v0, v0, v12, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v1, v13, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[4:5], 0, v3
; GISEL-NEXT:    v_cndmask_b32_e32 v3, 0, v10, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v10, 0, v11, vcc
; GISEL-NEXT:    v_cndmask_b32_e64 v0, v0, -1, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v1, v1, -1, s[4:5]
; GISEL-NEXT:    v_and_b32_e32 v3, v3, v6
; GISEL-NEXT:    v_and_b32_e32 v6, v10, v7
; GISEL-NEXT:    v_and_or_b32 v0, v0, v4, v3
; GISEL-NEXT:    v_and_or_b32 v1, v1, v5, v6
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v1, v14, v0
; GISEL-NEXT:    v_mov_b32_e32 v7, v4
; GISEL-NEXT:    v_mov_b32_e32 v6, v3
...
; GISEL-NEXT:    v_addc_co_u32_e32 v3, vcc, 0, v5, vcc
; GISEL-NEXT:    v_and_b32_e32 v4, 0x4000000, v2
...
; GISEL-NEXT:    v_mov_b32_e32 v2, 0x7fffff
; GISEL-NEXT:    v_and_or_b32 v0, v0, v2, v1
...
; SDAG-NEXT:    v_lshlrev_b64 v[12:13], v9, v[0:1]
...
; SDAG-NEXT:    v_cndmask_b32_e64 v6, v6, v0, s[4:5]
...
; SDAG-NEXT:    v_lshrrev_b64 v[6:7], 2, v[0:1]
; SDAG-NEXT:    v_lshlrev_b32_e32 v5, 30, v4
; SDAG-NEXT:    v_or_b32_e32 v10, v7, v5
; SDAG-NEXT:    v_and_b32_e32 v5, 0x800000, v1
; SDAG-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v5
; SDAG-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SDAG-NEXT:  ; %bb.11: ; %itofp-if-then20
; SDAG-NEXT:    v_lshrrev_b64 v[6:7], 3, v[0:1]
; SDAG-NEXT:    v_lshlrev_b32_e32 v0, 29, v4
; SDAG-NEXT:    v_or_b32_e32 v10, v7, v0
; SDAG-NEXT:    v_mov_b32_e32 v8, v2
; SDAG-NEXT:  ; %bb.12: ; %Flow
; SDAG-NEXT:    s_or_b64 exec, exec, s[4:5]
; SDAG-NEXT:  .LBB2_13: ; %Flow4
; SDAG-NEXT:    s_or_b64 exec, exec, s[8:9]
; SDAG-NEXT:    v_mov_b32_e32 v1, 0x3ff00000
; SDAG-NEXT:    v_and_b32_e32 v0, 0x80000000, v3
; SDAG-NEXT:    v_lshl_add_u32 v1, v8, 20, v1
; SDAG-NEXT:    v_and_b32_e32 v2, 0xfffff, v10
; SDAG-NEXT:    v_or3_b32 v7, v2, v0, v1
...
; GISEL-NEXT:    v_and_or_b32 v0, v9, v0, v2
...
; GISEL-NEXT:    v_and_b32_e32 v0, 0x80000000, v6
; GISEL-NEXT:    v_lshl_add_u32 v1, v8, 20, v1
; GISEL-NEXT:    v_and_b32_e32 v2, 0xfffff, v10
; GISEL-NEXT:    v_or3_b32 v5, v2, v0, v1
