...
; GCN-NEXT:    v_cmp_ge_u32_e64 s[4:5], v0, v2
; GCN-NEXT:    v_cmp_ge_u32_e64 s[6:7], v1, v3
; GCN-NEXT:    v_sub_i32_e32 v8, vcc, v0, v2
; GCN-NEXT:    v_cndmask_b32_e64 v6, v6, v9, s[4:5]
; GCN-NEXT:    v_sub_i32_e32 v9, vcc, v1, v3
; GCN-NEXT:    v_cndmask_b32_e64 v5, v5, v11, s[6:7]
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v8, s[4:5]
; GCN-NEXT:    v_add_i32_e32 v8, vcc, 1, v6
; GCN-NEXT:    v_cndmask_b32_e64 v1, v1, v9, s[6:7]
...
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[4:5], v0, v2
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[6:7], v1, v3
; TONGA-NEXT:    v_sub_u32_e32 v8, vcc, v0, v2
; TONGA-NEXT:    v_cndmask_b32_e64 v6, v6, v9, s[4:5]
; TONGA-NEXT:    v_sub_u32_e32 v9, vcc, v1, v3
; TONGA-NEXT:    v_cndmask_b32_e64 v5, v5, v11, s[6:7]
; TONGA-NEXT:    v_cndmask_b32_e64 v0, v0, v8, s[4:5]
; TONGA-NEXT:    v_add_u32_e32 v8, vcc, 1, v6
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v1, v9, s[6:7]
...
; GCN-NEXT:    v_cndmask_b32_e64 v1, v12, v1, s[6:7]
; GCN-NEXT:    v_sub_i32_e32 v12, vcc, v0, v5
; GCN-NEXT:    v_mul_lo_u32 v4, v4, v9
; GCN-NEXT:    v_cndmask_b32_e64 v0, v0, v12, s[6:7]
; GCN-NEXT:    v_cmp_ge_u32_e64 s[6:7], v0, v5
...
; GCN-NEXT:    v_cndmask_b32_e64 v0, v10, v13, s[4:5]
...
; GCN-NEXT:    v_cndmask_b32_e64 v1, v1, v12, s[6:7]
...
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v12, v1, s[6:7]
; TONGA-NEXT:    v_sub_u32_e32 v12, vcc, v0, v5
; TONGA-NEXT:    v_mul_lo_u32 v4, v4, v9
; TONGA-NEXT:    v_cndmask_b32_e64 v0, v0, v12, s[6:7]
; TONGA-NEXT:    v_cmp_ge_u32_e64 s[6:7], v0, v5
...
; TONGA-NEXT:    v_cndmask_b32_e64 v0, v10, v13, s[4:5]
...
; TONGA-NEXT:    v_cndmask_b32_e64 v1, v1, v12, s[6:7]
...
; TONGA-NEXT:    v_cndmask_b32_e64 v4, v4, v8, s[4:5]
; TONGA-NEXT:    v_sub_u32_e32 v8, vcc, v2, v6
; TONGA-NEXT:    v_sub_u32_e32 v1, vcc, v1, v11
; TONGA-NEXT:    v_cndmask_b32_e64 v2, v2, v8, s[4:5]
; TONGA-NEXT:    v_add_u32_e32 v8, vcc, 1, v4
