...
; GFX90A-NEXT:    buffer_atomic_cmpswap v[0:1], v3, s[4:7], 0 offen offset:1024 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
...
; GFX908-NEXT:    buffer_atomic_cmpswap v[0:1], v3, s[4:7], 0 offen offset:1024 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
...
; GFX8-NEXT:    buffer_atomic_cmpswap v[0:1], v3, s[4:7], 0 offen offset:1024 glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
...
; GFX90A-NEXT:    buffer_atomic_cmpswap v[4:5], v3, s[4:7], 0 offen offset:1024 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
...
; GFX908-NEXT:    buffer_atomic_cmpswap v[4:5], v3, s[4:7], 0 offen offset:1024 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    buffer_wbinvl1
...
; GFX8-NEXT:    buffer_atomic_cmpswap v[4:5], v3, s[4:7], 0 offen offset:1024 glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    buffer_wbinvl1
...
; GFX942-NEXT:    v_cmp_eq_u64_e32 vcc, s[4:5], v[6:7]
; GFX942-NEXT:    s_nop 0
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_max_f32_e32 v0, v9, v9
; GFX942-NEXT:    v_min_f32_e32 v8, v0, v5
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_max_f32_e32 v0, v9, v9
; GFX90A-NEXT:    v_min_f32_e32 v8, v0, v5
...
; GFX908-NEXT:    v_readfirstlane_b32 s8, v6
; GFX908-NEXT:    v_readfirstlane_b32 s9, v7
; GFX908-NEXT:    v_readfirstlane_b32 s10, v2
; GFX908-NEXT:    v_readfirstlane_b32 s11, v3
; GFX908-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[6:7]
...
; GFX908-NEXT:    s_nop 0
; GFX908-NEXT:    buffer_load_dword v9, v4, s[8:11], 0 offen offset:1024
...
; GFX908-NEXT:    v_max_f32_e32 v5, v5, v5
; GFX908-NEXT:  .LBB2_3: ; %atomicrmw.start
; GFX908-NEXT:    ; =>This Loop Header: Depth=1
; GFX908-NEXT:    ; Child Loop BB2_4 Depth 2
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_max_f32_e32 v0, v9, v9
; GFX908-NEXT:    v_min_f32_e32 v8, v0, v5
...
; GFX8-NEXT:    v_readfirstlane_b32 s9, v7
; GFX8-NEXT:    v_readfirstlane_b32 s10, v2
; GFX8-NEXT:    v_readfirstlane_b32 s11, v3
; GFX8-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[6:7]
...
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    buffer_load_dword v9, v4, s[8:11], 0 offen offset:1024
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_mul_f32_e32 v0, 1.0, v9
; GFX8-NEXT:    v_min_f32_e32 v8, v0, v5
...
; GFX10-NEXT:    buffer_atomic_cmpswap v[0:1], v3, s[4:7], 0 offen offset:1024 glc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
...
; GFX7-NEXT:    buffer_atomic_cmpswap v[0:1], v3, s[4:7], 0 offen offset:1024 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX6-NEXT:    s_add_i32 s10, s20, 0x400
...
; GFX12-NEXT:    v_max_num_f64_e32 v[8:9], v[0:1], v[0:1]
...
; GFX12-NEXT:    buffer_atomic_cmpswap_b64 v[4:7], v10, s[0:3], null offen offset:2048 th:TH_ATOMIC_RETURN
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[4:5], v[2:3]
...
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_atomic_min_f64 v[2:3], v0, s[0:3], 0 offen offset:2048 sc0
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
...
; GFX11-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
...
; GFX11-NEXT:    buffer_atomic_cmpswap_b64 v[4:7], v10, s[0:3], 0 offen offset:2048 glc
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_gl1_inv
; GFX11-NEXT:    buffer_gl0_inv
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[4:5], v[2:3]
...
; GFX90A-NEXT:    s_mov_b32 s4, s16
; GFX90A-NEXT:    v_mov_b32_e32 v0, s20
; GFX90A-NEXT:    buffer_atomic_min_f64 v[2:3], v0, s[4:7], 0 offen offset:2048 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
...
; GFX908-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX908-NEXT:    s_mov_b64 s[8:9], 0
...
; GFX908-NEXT:    v_min_f64 v[0:1], v[0:1], v[8:9]
; GFX908-NEXT:    v_mov_b32_e32 v7, v3
; GFX908-NEXT:    v_mov_b32_e32 v6, v2
; GFX908-NEXT:    v_mov_b32_e32 v5, v1
; GFX908-NEXT:    v_mov_b32_e32 v4, v0
; GFX908-NEXT:    buffer_atomic_cmpswap_x2 v[4:7], v10, s[4:7], 0 offen offset:2048 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    v_cmp_eq_u64_e32 vcc, v[4:5], v[2:3]
...
; GFX8-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX8-NEXT:    s_mov_b64 s[8:9], 0
...
; GFX8-NEXT:    v_mov_b32_e32 v5, v1
; GFX8-NEXT:    v_mov_b32_e32 v4, v0
; GFX8-NEXT:    buffer_atomic_cmpswap_x2 v[4:7], v10, s[4:7], 0 offen offset:2048 glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    buffer_wbinvl1
...
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_atomic_min_f64 v[2:3], v0, s[0:3], 0 offen offset:2048
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    buffer_inv sc1
; GFX942-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX90A-NEXT:    s_mov_b32 s4, s16
; GFX90A-NEXT:    v_mov_b32_e32 v0, s20
; GFX90A-NEXT:    buffer_atomic_min_f64 v[2:3], v0, s[4:7], 0 offen offset:2048
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
; GFX90A-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX908-NEXT:    buffer_atomic_cmpswap_x2 v[7:10], v6, s[4:7], 0 offen offset:2048 glc
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    buffer_wbinvl1
...
; GFX8-NEXT:    buffer_atomic_cmpswap_x2 v[7:10], v6, s[4:7], 0 offen offset:2048 glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    buffer_wbinvl1
...
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v10, v3 :: v_dual_mov_b32 v9, v2
; GFX12-NEXT:    v_dual_mov_b32 v12, v1 :: v_dual_mov_b32 v11, v0
; GFX12-NEXT:    s_mov_b32 s1, exec_lo
...
; GFX12-NEXT:    v_readfirstlane_b32 s6, v9
; GFX12-NEXT:    v_readfirstlane_b32 s7, v10
; GFX12-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[11:12]
; GFX12-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[9:10]
; GFX12-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_load_b64 v[2:3], v4, s[4:7], null offen offset:2048
; GFX12-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_cbranch_execnz .LBB7_1
; GFX12-NEXT:  ; %bb.2:
; GFX12-NEXT:    s_mov_b32 exec_lo, s1
; GFX12-NEXT:    v_max_num_f64_e32 v[13:14], v[5:6], v[5:6]
...
; GFX12-NEXT:    s_wait_storecnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX12-NEXT:    v_min_num_f64_e32 v[0:1], v[0:1], v[13:14]
...
; GFX12-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_atomic_cmpswap_b64 v[5:8], v4, s[4:7], null offen offset:2048 th:TH_ATOMIC_RETURN
; GFX12-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX12-NEXT:    s_cbranch_execnz .LBB7_4
; GFX12-NEXT:  ; %bb.5: ; in Loop: Header=BB7_3 Depth=1
; GFX12-NEXT:    s_mov_b32 exec_lo, s2
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[5:6], v[2:3]
; GFX12-NEXT:    v_dual_mov_b32 v2, v5 :: v_dual_mov_b32 v3, v6
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v10, v3 :: v_dual_mov_b32 v9, v2
; GFX11-NEXT:    v_dual_mov_b32 v12, v1 :: v_dual_mov_b32 v11, v0
...
; GFX11-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[9:10]
; GFX11-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    buffer_load_b64 v[2:3], v4, s[4:7], 0 offen offset:2048
; GFX11-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_cbranch_execnz .LBB7_1
; GFX11-NEXT:  ; %bb.2:
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    v_max_f64 v[13:14], v[5:6], v[5:6]
...
; GFX11-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_min_f64 v[0:1], v[0:1], v[13:14]
...
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_atomic_cmpswap_b64 v[5:8], v4, s[4:7], 0 offen offset:2048 glc
; GFX11-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX11-NEXT:    s_cbranch_execnz .LBB7_4
; GFX11-NEXT:  ; %bb.5: ; in Loop: Header=BB7_3 Depth=1
; GFX11-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, v[5:6], v[2:3]
...
; GFX908-NEXT:    v_mov_b32_e32 v10, v3
; GFX908-NEXT:    v_mov_b32_e32 v9, v2
; GFX908-NEXT:    v_mov_b32_e32 v12, v1
; GFX908-NEXT:    v_mov_b32_e32 v11, v0
; GFX908-NEXT:    s_mov_b64 s[6:7], exec
; GFX908-NEXT:  .LBB7_1: ; =>This Inner Loop Header: Depth=1
; GFX908-NEXT:    v_readfirstlane_b32 s8, v11
; GFX908-NEXT:    v_readfirstlane_b32 s9, v12
; GFX908-NEXT:    v_readfirstlane_b32 s10, v9
; GFX908-NEXT:    v_readfirstlane_b32 s11, v10
; GFX908-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[11:12]
; GFX908-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[10:11], v[9:10]
; GFX908-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX908-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX908-NEXT:    s_nop 0
; GFX908-NEXT:    buffer_load_dwordx2 v[2:3], v4, s[8:11], 0 offen offset:2048
; GFX908-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_cbranch_execnz .LBB7_1
; GFX908-NEXT:  ; %bb.2:
; GFX908-NEXT:    s_mov_b64 exec, s[6:7]
; GFX908-NEXT:    v_max_f64 v[13:14], v[5:6], v[5:6]
; GFX908-NEXT:    s_mov_b64 s[6:7], 0
...
; GFX908-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX908-NEXT:    s_mov_b64 s[12:13], exec
; GFX908-NEXT:    v_min_f64 v[0:1], v[0:1], v[13:14]
...
; GFX908-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    buffer_atomic_cmpswap_x2 v[5:8], v4, s[8:11], 0 offen offset:2048 glc
; GFX908-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX908-NEXT:    s_cbranch_execnz .LBB7_4
; GFX908-NEXT:  ; %bb.5: ; in Loop: Header=BB7_3 Depth=1
; GFX908-NEXT:    s_mov_b64 exec, s[12:13]
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_cmp_eq_u64_e32 vcc, v[5:6], v[2:3]
; GFX908-NEXT:    v_mov_b32_e32 v2, v5
; GFX908-NEXT:    s_or_b64 s[6:7], vcc, s[6:7]
; GFX908-NEXT:    v_mov_b32_e32 v3, v6
; GFX908-NEXT:    buffer_wbinvl1
; GFX908-NEXT:    s_andn2_b64 exec, exec, s[6:7]
...
; GFX8-NEXT:    v_readfirstlane_b32 s10, v9
; GFX8-NEXT:    v_readfirstlane_b32 s11, v10
; GFX8-NEXT:    v_cmp_eq_u64_e32 vcc, s[8:9], v[11:12]
; GFX8-NEXT:    v_cmp_eq_u64_e64 s[4:5], s[10:11], v[9:10]
; GFX8-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; GFX8-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX8-NEXT:    s_nop 0
; GFX8-NEXT:    buffer_load_dwordx2 v[2:3], v4, s[8:11], 0 offen offset:2048
; GFX8-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_cbranch_execnz .LBB7_1
; GFX8-NEXT:  ; %bb.2:
; GFX8-NEXT:    s_mov_b64 exec, s[6:7]
; GFX8-NEXT:    v_max_f64 v[13:14], v[5:6], v[5:6]
; GFX8-NEXT:    s_mov_b64 s[6:7], 0
...
; GFX8-NEXT:    v_max_f64 v[0:1], v[2:3], v[2:3]
; GFX8-NEXT:    s_mov_b64 s[12:13], exec
; GFX8-NEXT:    v_min_f64 v[0:1], v[0:1], v[13:14]
...
; GFX8-NEXT:    s_and_saveexec_b64 s[4:5], s[4:5]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    buffer_atomic_cmpswap_x2 v[5:8], v4, s[8:11], 0 offen offset:2048 glc
; GFX8-NEXT:    s_xor_b64 exec, exec, s[4:5]
; GFX8-NEXT:    s_cbranch_execnz .LBB7_4
; GFX8-NEXT:  ; %bb.5: ; in Loop: Header=BB7_3 Depth=1
; GFX8-NEXT:    s_mov_b64 exec, s[12:13]
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_cmp_eq_u64_e32 vcc, v[5:6], v[2:3]
; GFX8-NEXT:    v_mov_b32_e32 v2, v5
; GFX8-NEXT:    s_or_b64 s[6:7], vcc, s[6:7]
; GFX8-NEXT:    v_mov_b32_e32 v3, v6
; GFX8-NEXT:    buffer_wbinvl1
; GFX8-NEXT:    s_andn2_b64 exec, exec, s[6:7]
...
; GFX10-NEXT:    buffer_atomic_cmpswap_x2 v[4:7], v10, s[4:7], 0 offen offset:2048 glc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
...
; GFX90A-NEXT:    v_pk_mov_b32 v[4:5], v[0:1], v[0:1] op_sel:[0,1]
; GFX90A-NEXT:    buffer_atomic_cmpswap_x2 v[4:7], v10, s[4:7], 0 offen offset:2048 glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    buffer_wbinvl1
...
; GFX7-NEXT:    buffer_atomic_cmpswap_x2 v[4:7], v10, s[4:7], 0 offen offset:2048 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX6-NEXT:    s_add_i32 s10, s20, 0x800
; GFX6-NEXT:    v_max_f64 v[8:9], v[0:1], v[0:1]
; GFX6-NEXT:    s_mov_b64 s[8:9], 0
...
; GFX10-NEXT:    s_mov_b32 s7, s19
; GFX10-NEXT:    s_and_b32 s8, s20, -4
; GFX10-NEXT:    s_mov_b32 s6, s18
; GFX10-NEXT:    v_mov_b32_e32 v4, s8
; GFX10-NEXT:    s_mov_b32 s5, s17
; GFX10-NEXT:    s_mov_b32 s4, s16
; GFX10-NEXT:    s_and_b32 s8, s20, 3
...
; GFX90A-NEXT:    s_and_b32 s8, s20, -4
; GFX90A-NEXT:    s_mov_b32 s7, s19
; GFX90A-NEXT:    s_mov_b32 s6, s18
; GFX90A-NEXT:    s_mov_b32 s5, s17
; GFX90A-NEXT:    s_mov_b32 s4, s16
...
; GFX90A-NEXT:    s_and_b32 s8, s20, 3
...
; GFX908-NEXT:    s_and_b32 s8, s20, -4
; GFX908-NEXT:    s_mov_b32 s7, s19
; GFX908-NEXT:    s_mov_b32 s6, s18
; GFX908-NEXT:    s_mov_b32 s5, s17
; GFX908-NEXT:    s_mov_b32 s4, s16
...
; GFX908-NEXT:    s_and_b32 s8, s20, 3
...
; GFX12-TRUE16-NEXT:    v_add_nc_u32_e32 v0, 0x200, v4
...
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v1, 3, v0
; GFX12-TRUE16-NEXT:    v_and_b32_e32 v10, -4, v0
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, 3, v1
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e64 v4, v1, 0xffff
; GFX12-TRUE16-NEXT:    v_not_b32_e32 v11, v4
; GFX12-TRUE16-NEXT:  .LBB12_1: ; =>This Inner Loop Header: Depth=1
; GFX12-TRUE16-NEXT:    v_readfirstlane_b32 s4, v6
; GFX12-TRUE16-NEXT:    v_readfirstlane_b32 s5, v7
...
; GFX12-TRUE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[6:7]
...
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_load_b32 v9, v10, s[4:7], null offen
...
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v0.l, v5.l, v5.l
...
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v4, v1, v9
; GFX12-TRUE16-NEXT:    v_mov_b16_e32 v4.h, 0
; GFX12-TRUE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX12-TRUE16-NEXT:    s_wait_storecnt 0x0
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_max_num_f16_e32 v0.h, v4.l, v4.l
; GFX12-TRUE16-NEXT:    v_min_num_f16_e32 v4.l, v0.h, v0.l
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_lshlrev_b32_e32 v4, v1, v4
; GFX12-TRUE16-NEXT:    v_and_or_b32 v8, v9, v11, v4
; GFX12-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-TRUE16-NEXT:    v_dual_mov_b32 v4, v8 :: v_dual_mov_b32 v5, v9
...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[4:5], v10, s[4:7], null offen th:TH_ATOMIC_RETURN
; GFX12-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v4, v9
; GFX12-TRUE16-NEXT:    v_mov_b32_e32 v9, v4
; GFX12-TRUE16-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX12-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v1, v4
; GFX12-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX11-TRUE16-NEXT:    v_add_nc_u32_e32 v0, 0x200, v4
; GFX11-TRUE16-NEXT:    s_mov_b32 s1, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v1, 3, v0
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v10, -4, v0
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v1, 3, v1
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e64 v4, v1, 0xffff
...
; GFX11-TRUE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[6:7]
...
; GFX11-TRUE16-NEXT:    buffer_load_b32 v9, v10, s[4:7], 0 offen
...
; GFX11-TRUE16-NEXT:    v_max_f16_e32 v0.l, v5.l, v5.l
...
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v4, v1, v9
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v4.h, 0
; GFX11-TRUE16-NEXT:    s_mov_b32 s2, exec_lo
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_max_f16_e32 v0.h, v4.l, v4.l
; GFX11-TRUE16-NEXT:    v_min_f16_e32 v4.l, v0.h, v0.l
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_lshlrev_b32_e32 v4, v1, v4
; GFX11-TRUE16-NEXT:    v_and_or_b32 v8, v9, v11, v4
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v4, v8 :: v_dual_mov_b32 v5, v9
...
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[4:5], v10, s[4:7], 0 offen glc
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
; GFX11-TRUE16-NEXT:    s_cbranch_execnz .LBB12_4
; GFX11-TRUE16-NEXT:  ; %bb.5: ; in Loop: Header=BB12_3 Depth=1
; GFX11-TRUE16-NEXT:    s_mov_b32 exec_lo, s2
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v4, v9
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v9, v4
; GFX11-TRUE16-NEXT:    buffer_gl1_inv
; GFX11-TRUE16-NEXT:    buffer_gl0_inv
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v0, v1, v4
; GFX11-TRUE16-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX8-NEXT:    v_mov_b32_e32 v0, v5
; GFX8-NEXT:    v_mov_b32_e32 v1, v6
; GFX8-NEXT:    buffer_atomic_cmpswap v[0:1], v4, s[4:7], 0 offen offset:1024 glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    buffer_wbinvl1
...
; GFX7-NEXT:    buffer_atomic_cmpswap v[1:2], v4, s[4:7], 0 offen offset:1024 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX6-NEXT:    buffer_atomic_cmpswap v[1:2], v4, s[4:7], 0 offen glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_wbinvl1
...
; GFX10-NEXT:    v_mov_b32_e32 v5, v1
; GFX10-NEXT:    v_mov_b32_e32 v4, v0
; GFX10-NEXT:    buffer_atomic_cmpswap v[4:5], v3, s[4:7], 0 offen offset:1024 glc
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    buffer_gl1_inv
; GFX10-NEXT:    buffer_gl0_inv
; GFX10-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v4, v1
...
; GFX8-NEXT:    v_mov_b32_e32 v6, v1
; GFX8-NEXT:    v_mov_b32_e32 v5, v0
; GFX8-NEXT:    buffer_atomic_cmpswap v[5:6], v4, s[4:7], 0 offen offset:1024 glc
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    buffer_wbinvl1
...
; GFX12-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_load_b32 v9, v4, s[4:7], null offen offset:1024
; GFX12-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v4, s[4:7], null offen offset:1024 th:TH_ATOMIC_RETURN
; GFX12-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_pk_max_f16 v0, v9, v9
; GFX942-NEXT:    s_mov_b64 s[8:9], exec
; GFX942-NEXT:    v_pk_min_f16 v8, v0, v5
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_mov_b64_e32 v[0:1], v[8:9]
...
; GFX11-NEXT:    v_readfirstlane_b32 s7, v3
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[6:7]
; GFX11-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[2:3]
; GFX11-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    buffer_load_b32 v9, v4, s[4:7], 0 offen offset:1024
; GFX11-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v4, s[4:7], 0 offen offset:1024 glc
; GFX11-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX10-NEXT:    v_readfirstlane_b32 s10, v2
; GFX10-NEXT:    v_readfirstlane_b32 s11, v3
; GFX10-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[8:9], v[6:7]
; GFX10-NEXT:    v_cmp_eq_u64_e64 s4, s[10:11], v[2:3]
; GFX10-NEXT:    s_and_b32 s4, vcc_lo, s4
; GFX10-NEXT:    s_and_saveexec_b32 s4, s4
; GFX10-NEXT:    buffer_load_dword v9, v4, s[8:11], 0 offen offset:1024
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_xor_b32 exec_lo, exec_lo, s4
...
; GFX10-NEXT:    s_and_saveexec_b32 s4, s4
; GFX10-NEXT:    s_waitcnt vmcnt(0)
; GFX10-NEXT:    buffer_atomic_cmpswap v[0:1], v4, s[8:11], 0 offen offset:1024 glc
; GFX10-NEXT:    s_waitcnt_depctr depctr_vm_vsrc(0)
; GFX10-NEXT:    s_xor_b32 exec_lo, exec_lo, s4
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_pk_max_f16 v0, v9, v9
; GFX90A-NEXT:    v_pk_min_f16 v8, v0, v5
; GFX90A-NEXT:    s_mov_b64 s[12:13], exec
; GFX90A-NEXT:    v_pk_mov_b32 v[0:1], v[8:9], v[8:9] op_sel:[0,1]
...
; GFX908-NEXT:    s_mov_b64 exec, s[6:7]
; GFX908-NEXT:    s_mov_b64 s[6:7], 0
; GFX908-NEXT:    v_pk_max_f16 v5, v5, v5
; GFX908-NEXT:  .LBB18_3: ; %atomicrmw.start
; GFX908-NEXT:    ; =>This Loop Header: Depth=1
; GFX908-NEXT:    ; Child Loop BB18_4 Depth 2
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_pk_max_f16 v0, v9, v9
; GFX908-NEXT:    v_pk_min_f16 v8, v0, v5
; GFX908-NEXT:    v_mov_b32_e32 v0, v8
; GFX908-NEXT:    s_mov_b64 s[12:13], exec
; GFX908-NEXT:    v_mov_b32_e32 v1, v9
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_max_f16_sdwa v0, v9, v9 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:WORD_1
; GFX8-NEXT:    v_max_f16_e32 v1, v9, v9
; GFX8-NEXT:    v_min_f16_sdwa v0, v0, v10 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
...
; GFX12-FAKE16-NEXT:    s_mov_b32 s7, s3
; GFX12-FAKE16-NEXT:    s_mov_b32 s6, s2
; GFX12-FAKE16-NEXT:    s_mov_b32 s5, s1
; GFX12-FAKE16-NEXT:    s_mov_b32 s4, s0
; GFX12-FAKE16-NEXT:    v_lshlrev_b32_e32 v2, 16, v1
; GFX12-FAKE16-NEXT:    buffer_load_b32 v0, v0, s[4:7], null offen offset:1024
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_cndmask_b32_e64 v0, v5, v8, s0
; GFX12-FAKE16-NEXT:    v_perm_b32 v5, v1, v0, 0x7060302
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-FAKE16-NEXT:    v_dual_mov_b32 v0, v5 :: v_dual_mov_b32 v1, v6
; GFX12-FAKE16-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v4, s[4:7], null offen offset:1024 th:TH_ATOMIC_RETURN
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    global_inv scope:SCOPE_DEV
...
; GFX942-NEXT:    v_mov_b32_e32 v0, s16
; GFX942-NEXT:    buffer_load_dword v0, v0, s[4:7], 0 offen offset:1024
; GFX942-NEXT:    s_mov_b64 s[2:3], 0
...
; GFX942-NEXT:    v_cndmask_b32_e64 v0, v5, v6, s[0:1]
...
; GFX11-FAKE16-NEXT:    buffer_load_b32 v0, v0, s[4:7], 0 offen offset:1024
...
; GFX11-FAKE16-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v4, s[4:7], 0 offen offset:1024 glc
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-FAKE16-NEXT:    buffer_gl1_inv
; GFX11-FAKE16-NEXT:    buffer_gl0_inv
...
; GFX908-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_mov_b32_e32 v1, v0
; GFX908-NEXT:    s_mov_b32 s11, s19
; GFX908-NEXT:    s_mov_b32 s10, s18
; GFX908-NEXT:    s_mov_b32 s9, s17
; GFX908-NEXT:    s_mov_b32 s8, s16
; GFX908-NEXT:    v_mov_b32_e32 v0, s20
...
; GFX8-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX8-NEXT:    v_mov_b32_e32 v1, v0
; GFX8-NEXT:    s_mov_b32 s11, s19
; GFX8-NEXT:    s_mov_b32 s10, s18
; GFX8-NEXT:    s_mov_b32 s9, s17
; GFX8-NEXT:    s_mov_b32 s8, s16
; GFX8-NEXT:    v_mov_b32_e32 v0, s20
...
; GFX7-NEXT:    buffer_atomic_cmpswap v[5:6], v2, s[4:7], 0 offen offset:1024 glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    buffer_wbinvl1
...
; GFX12-FAKE16-NEXT:    buffer_load_b32 v1, v1, s[4:7], null offen offset:1024
; GFX12-FAKE16-NEXT:    s_mov_b32 s1, 0
...
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-FAKE16-NEXT:    v_cndmask_b32_e64 v0, v6, v8, s0
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
...
; GFX942-NEXT:    s_mov_b32 s4, s0
; GFX942-NEXT:    v_mov_b32_e32 v1, s16
; GFX942-NEXT:    buffer_load_dword v1, v1, s[4:7], 0 offen offset:1024
; GFX942-NEXT:    s_mov_b64 s[2:3], 0
...
; GFX11-FAKE16-NEXT:    buffer_load_b32 v1, v1, s[4:7], 0 offen offset:1024
; GFX11-FAKE16-NEXT:    s_mov_b32 s1, 0
; GFX11-FAKE16-NEXT:    s_set_inst_prefetch_distance 0x1
; GFX11-FAKE16-NEXT:    .p2align 6
...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_load_b32 v9, v4, s[4:7], null offen offset:1024
; GFX12-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-TRUE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v4, s[4:7], null offen offset:1024 th:TH_ATOMIC_RETURN
; GFX12-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX12-FAKE16-NEXT:    v_readfirstlane_b32 s4, v6
; GFX12-FAKE16-NEXT:    v_readfirstlane_b32 s5, v7
; GFX12-FAKE16-NEXT:    v_readfirstlane_b32 s6, v2
; GFX12-FAKE16-NEXT:    v_readfirstlane_b32 s7, v3
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-FAKE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[6:7]
; GFX12-FAKE16-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[2:3]
; GFX12-FAKE16-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX12-FAKE16-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX12-FAKE16-NEXT:    s_wait_loadcnt 0x0
; GFX12-FAKE16-NEXT:    buffer_load_b32 v9, v4, s[4:7], null offen offset:1024
; GFX12-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_lshlrev_b32_e32 v0, 16, v9
; GFX942-NEXT:    v_min_f32_e32 v0, v0, v10
; GFX942-NEXT:    v_bfe_u32 v1, v0, 16, 1
; GFX942-NEXT:    v_add3_u32 v1, v1, v0, s10
; GFX942-NEXT:    v_or_b32_e32 v8, 0x400000, v0
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX942-NEXT:    s_mov_b64 s[8:9], exec
; GFX942-NEXT:    buffer_wbl2 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_cndmask_b32_e32 v0, v1, v8, vcc
; GFX942-NEXT:    v_and_b32_e32 v1, 0xffff0000, v9
; GFX942-NEXT:    v_min_f32_e32 v1, v1, v5
; GFX942-NEXT:    v_bfe_u32 v8, v1, 16, 1
; GFX942-NEXT:    v_add3_u32 v8, v8, v1, s10
; GFX942-NEXT:    v_or_b32_e32 v11, 0x400000, v1
; GFX942-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX942-NEXT:    s_nop 1
; GFX942-NEXT:    v_cndmask_b32_e32 v1, v8, v11, vcc
; GFX942-NEXT:    v_perm_b32 v8, v1, v0, s11
; GFX942-NEXT:    v_mov_b64_e32 v[0:1], v[8:9]
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-TRUE16-NEXT:    buffer_load_b32 v9, v4, s[4:7], 0 offen offset:1024
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-TRUE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-TRUE16-NEXT:    buffer_atomic_cmpswap_b32 v[0:1], v4, s[4:7], 0 offen offset:1024 glc
; GFX11-TRUE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX11-FAKE16-NEXT:    v_readfirstlane_b32 s4, v6
; GFX11-FAKE16-NEXT:    v_readfirstlane_b32 s5, v7
; GFX11-FAKE16-NEXT:    v_readfirstlane_b32 s6, v2
; GFX11-FAKE16-NEXT:    v_readfirstlane_b32 s7, v3
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[4:5], v[6:7]
; GFX11-FAKE16-NEXT:    v_cmp_eq_u64_e64 s0, s[6:7], v[2:3]
; GFX11-FAKE16-NEXT:    s_and_b32 s0, vcc_lo, s0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, s0
; GFX11-FAKE16-NEXT:    buffer_load_b32 v9, v4, s[4:7], 0 offen offset:1024
; GFX11-FAKE16-NEXT:    s_xor_b32 exec_lo, exec_lo, s0
...
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_lshlrev_b32_e32 v0, 16, v9
; GFX90A-NEXT:    v_min_f32_e32 v0, v0, v10
; GFX90A-NEXT:    v_bfe_u32 v1, v0, 16, 1
; GFX90A-NEXT:    v_add3_u32 v1, v1, v0, s14
; GFX90A-NEXT:    v_or_b32_e32 v8, 0x400000, v0
; GFX90A-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX90A-NEXT:    v_cndmask_b32_e32 v0, v1, v8, vcc
; GFX90A-NEXT:    v_and_b32_e32 v1, 0xffff0000, v9
; GFX90A-NEXT:    v_min_f32_e32 v1, v1, v5
; GFX90A-NEXT:    v_bfe_u32 v8, v1, 16, 1
; GFX90A-NEXT:    v_add3_u32 v8, v8, v1, s14
; GFX90A-NEXT:    v_or_b32_e32 v11, 0x400000, v1
; GFX90A-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX90A-NEXT:    v_cndmask_b32_e32 v1, v8, v11, vcc
; GFX90A-NEXT:    v_perm_b32 v8, v1, v0, s15
; GFX90A-NEXT:    s_mov_b64 s[12:13], exec
; GFX90A-NEXT:    v_pk_mov_b32 v[0:1], v[8:9], v[8:9] op_sel:[0,1]
...
; GFX908-NEXT:    v_lshlrev_b32_e32 v10, 16, v5
; GFX908-NEXT:    s_movk_i32 s14, 0x7fff
; GFX908-NEXT:    v_and_b32_e32 v5, 0xffff0000, v5
; GFX908-NEXT:    s_mov_b32 s15, 0x7060302
; GFX908-NEXT:  .LBB21_3: ; %atomicrmw.start
; GFX908-NEXT:    ; =>This Loop Header: Depth=1
; GFX908-NEXT:    ; Child Loop BB21_4 Depth 2
; GFX908-NEXT:    s_waitcnt vmcnt(0)
; GFX908-NEXT:    v_lshlrev_b32_e32 v0, 16, v9
; GFX908-NEXT:    v_min_f32_e32 v0, v0, v10
; GFX908-NEXT:    v_bfe_u32 v1, v0, 16, 1
; GFX908-NEXT:    v_add3_u32 v1, v1, v0, s14
; GFX908-NEXT:    v_or_b32_e32 v8, 0x400000, v0
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; GFX908-NEXT:    v_cndmask_b32_e32 v0, v1, v8, vcc
; GFX908-NEXT:    v_and_b32_e32 v1, 0xffff0000, v9
; GFX908-NEXT:    v_min_f32_e32 v1, v1, v5
; GFX908-NEXT:    v_bfe_u32 v8, v1, 16, 1
; GFX908-NEXT:    v_add3_u32 v8, v8, v1, s14
; GFX908-NEXT:    v_or_b32_e32 v11, 0x400000, v1
; GFX908-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX908-NEXT:    v_cndmask_b32_e32 v1, v8, v11, vcc
; GFX908-NEXT:    v_perm_b32 v8, v1, v0, s15
; GFX908-NEXT:    v_mov_b32_e32 v0, v8
; GFX908-NEXT:    s_mov_b64 s[12:13], exec
; GFX908-NEXT:    v_mov_b32_e32 v1, v9
...
; GFX8-NEXT:    s_waitcnt vmcnt(0)
; GFX8-NEXT:    v_lshlrev_b32_e32 v0, 16, v9
; GFX8-NEXT:    v_min_f32_e32 v0, v0, v10
...
; GFX8-NEXT:    v_cndmask_b32_e32 v0, v1, v8, vcc
; GFX8-NEXT:    v_and_b32_e32 v1, 0xffff0000, v9
; GFX8-NEXT:    v_min_f32_e32 v1, v1, v5
; GFX8-NEXT:    v_bfe_u32 v8, v1, 16, 1
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, v8, v1
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, 0x7fff, v8
; GFX8-NEXT:    v_or_b32_e32 v11, 0x400000, v1
; GFX8-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v8, v11, vcc
; GFX8-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; GFX8-NEXT:    v_alignbit_b32 v8, v1, v0, 16
; GFX8-NEXT:    v_mov_b32_e32 v0, v8
; GFX8-NEXT:    s_mov_b64 s[12:13], exec
; GFX8-NEXT:    v_mov_b32_e32 v1, v9
