...
; GFX9-NEXT:  ; %bb.1: ; %cmp.false
; GFX9-NEXT:    s_lshr_b32 s19, s4, 8
; GFX9-NEXT:    s_lshr_b32 s12, s18, 16
; GFX9-NEXT:    s_lshr_b32 s13, s18, 8
; GFX9-NEXT:    s_lshr_b32 s14, s5, 24
; GFX9-NEXT:    s_lshr_b32 s15, s5, 16
; GFX9-NEXT:    s_lshr_b32 s16, s5, 8
; GFX9-NEXT:    s_lshr_b32 s17, s4, 16
...
; GFX9-NEXT:    ; implicit-def: $sgpr17
; GFX9-NEXT:    ; implicit-def: $sgpr6
; GFX9-NEXT:    ; implicit-def: $sgpr16
...
; SI-NEXT:    ; implicit-def: $vgpr11_vgpr12_vgpr13
; SI-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SI-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
...
; VI-NEXT:    ; implicit-def: $vgpr12_vgpr13_vgpr14
; VI-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; VI-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
...
; VI-NEXT:    v_or_b32_e32 v12, v0, v1
; VI-NEXT:    v_perm_b32 v1, v6, v7, s6
; VI-NEXT:    v_perm_b32 v0, v4, v5, s6
; VI-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; VI-NEXT:    v_or_b32_e32 v13, v0, v1
; VI-NEXT:    v_perm_b32 v1, v10, v11, s6
; VI-NEXT:    v_perm_b32 v0, v8, v9, s6
; VI-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; VI-NEXT:    v_or_b32_e32 v14, v0, v1
...
; VI-NEXT:    v_lshlrev_b16_e32 v1, 8, v5
; VI-NEXT:    v_or_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; VI-NEXT:    v_add_u16_e32 v1, 3, v6
...
; VI-NEXT:    v_or_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; VI-NEXT:    v_add_u16_e32 v1, 3, v10
...
; GFX9-NEXT:    ; implicit-def: $vgpr12_vgpr13_vgpr14
; GFX9-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; GFX9-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
...
; GFX9-NEXT:    v_perm_b32 v0, v4, v5, s6
; GFX9-NEXT:    v_perm_b32 v1, v6, v7, s6
; GFX9-NEXT:    v_lshl_or_b32 v13, v1, 16, v0
; GFX9-NEXT:    v_perm_b32 v0, v8, v9, s6
; GFX9-NEXT:    v_perm_b32 v1, v10, v11, s6
...
; GFX9-NEXT:    v_or_b32_e32 v12, v0, v1
; GFX9-NEXT:    v_add_u16_e32 v0, 3, v4
; GFX9-NEXT:    v_lshlrev_b16_e32 v1, 8, v5
; GFX9-NEXT:    v_or_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-NEXT:    v_add_u16_e32 v1, 3, v6
; GFX9-NEXT:    v_lshlrev_b16_e32 v2, 8, v7
; GFX9-NEXT:    v_or_b32_sdwa v1, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-NEXT:    v_add_u16_e32 v0, 0x300, v0
; GFX9-NEXT:    v_add_u16_sdwa v1, v1, s6 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_e32 v13, v0, v1
; GFX9-NEXT:    v_add_u16_e32 v0, 3, v8
; GFX9-NEXT:    v_lshlrev_b16_e32 v1, 8, v9
; GFX9-NEXT:    v_or_b32_sdwa v0, v1, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-NEXT:    v_add_u16_e32 v1, 3, v10
; GFX9-NEXT:    v_lshlrev_b16_e32 v2, 8, v11
; GFX9-NEXT:    v_or_b32_sdwa v1, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:BYTE_0
; GFX9-NEXT:    v_add_u16_e32 v0, 0x300, v0
; GFX9-NEXT:    v_add_u16_sdwa v1, v1, s6 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_e32 v14, v0, v1
...
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr12_vgpr13_vgpr14
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_xor_b32 s0, exec_lo, s0
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v12, v1, 16, v0
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v13, v3, 16, v2
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr2
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr3
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v14, v5, 16, v4
...
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v12, v0, v2
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_3)
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v13, v3, v4
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v14, v1, v5
; GFX11-FAKE16-NEXT:  .LBB6_4: ; %end
; GFX11-FAKE16-NEXT:    s_or_b32 exec_lo, exec_lo, s0
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v0, v12 :: v_dual_mov_b32 v1, v13
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v2, v14
; GFX11-FAKE16-NEXT:    s_setpc_b64 s[30:31]
  %cmp = icmp eq i32 %b, 0
  br i1 %cmp, label %cmp.true, label %cmp.false
...
; VI-NEXT:    v_add_f32_e32 v0, s7, v5
...
; VI-NEXT:    v_add_f32_e32 v1, s6, v5
...
; VI-NEXT:    v_add_f32_e32 v0, s6, v5
; VI-NEXT:    v_bfe_u32 v1, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v0
; VI-NEXT:    v_add_u32_e32 v1, vcc, 0x7fff, v1
...
; VI-NEXT:    v_add_f32_e32 v1, s5, v5
...
; VI-NEXT:    v_add_f32_e32 v0, s5, v5
; VI-NEXT:    v_bfe_u32 v1, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v0
; VI-NEXT:    v_add_u32_e32 v1, vcc, 0x7fff, v1
...
; GFX9-NEXT:    s_pack_lh_b32_b16 s7, 0, s6
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x40c00000
; GFX9-NEXT:    v_add_f32_e32 v1, s7, v0
...
; GFX9-NEXT:    v_add_f32_e32 v2, s6, v0
...
; GFX9-NEXT:    s_pack_lh_b32_b16 s6, 0, s5
; GFX9-NEXT:    v_lshl_or_b32 v2, v1, 16, v2
; GFX9-NEXT:    v_add_f32_e32 v1, s6, v0
; GFX9-NEXT:    v_bfe_u32 v4, v1, 16, 1
...
; GFX9-NEXT:    s_pack_lh_b32_b16 s5, 0, s4
...
; VI-NEXT:    v_add_f16_sdwa v1, v1, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v3, s5, v0
...
; SI-NEXT:  ; %bb.1: ; %cmp.false
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_or_b32_e32 v3, v0, v8
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v1
; SI-NEXT:    v_or_b32_e32 v4, v0, v7
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v2
; SI-NEXT:    v_or_b32_e32 v5, v0, v6
; SI-NEXT:    ; implicit-def: $vgpr0
; SI-NEXT:    ; implicit-def: $vgpr8
; SI-NEXT:    ; implicit-def: $vgpr1
; SI-NEXT:    ; implicit-def: $vgpr7
...
; SI-NEXT:    v_add_i32_e32 v5, vcc, 0x30000, v0
; SI-NEXT:  .LBB18_4: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    v_mov_b32_e32 v0, v3
; SI-NEXT:    v_mov_b32_e32 v1, v4
...
; SI-NEXT:    s_lshr_b32 s22, s5, 16
; SI-NEXT:    s_lshr_b32 s23, s5, 8
; SI-NEXT:    s_lshr_b64 s[12:13], s[18:19], 24
...
; SI-NEXT:    v_lshrrev_b32_e32 v5, 8, v15
...
; VI-NEXT:    s_lshr_b32 s14, s5, 24
; VI-NEXT:    s_lshr_b32 s15, s5, 16
; VI-NEXT:    s_lshr_b32 s17, s5, 8
; VI-NEXT:    s_lshr_b32 s16, s4, 16
; VI-NEXT:    s_lshr_b64 s[8:9], s[18:19], 24
; VI-NEXT:    s_lshr_b64 s[6:7], s[4:5], 24
; VI-NEXT:    s_cbranch_execnz .LBB21_4
; VI-NEXT:  .LBB21_2: ; %cmp.true
; VI-NEXT:    v_add_f32_e64 v8, s18, 1.0
; VI-NEXT:    v_add_f32_e64 v14, s5, 1.0
; VI-NEXT:    v_add_f32_e64 v13, s4, 1.0
; VI-NEXT:    v_lshrrev_b32_e32 v9, 8, v8
; VI-NEXT:    v_lshrrev_b64 v[3:4], 24, v[13:14]
; VI-NEXT:    v_lshrrev_b64 v[11:12], 24, v[8:9]
; VI-NEXT:    v_lshrrev_b32_e32 v10, 16, v8
...
; GFX9-NEXT:    s_lshr_b32 s14, s5, 24
; GFX9-NEXT:    s_lshr_b32 s15, s5, 16
; GFX9-NEXT:    s_lshr_b32 s17, s5, 8
; GFX9-NEXT:    s_lshr_b32 s16, s4, 16
; GFX9-NEXT:    s_lshr_b64 s[8:9], s[18:19], 24
; GFX9-NEXT:    s_lshr_b64 s[6:7], s[4:5], 24
; GFX9-NEXT:    s_cbranch_execnz .LBB21_4
; GFX9-NEXT:  .LBB21_2: ; %cmp.true
; GFX9-NEXT:    v_add_f32_e64 v8, s18, 1.0
; GFX9-NEXT:    v_add_f32_e64 v14, s5, 1.0
; GFX9-NEXT:    v_add_f32_e64 v13, s4, 1.0
; GFX9-NEXT:    v_lshrrev_b32_e32 v9, 8, v8
; GFX9-NEXT:    v_lshrrev_b64 v[3:4], 24, v[13:14]
; GFX9-NEXT:    v_lshrrev_b64 v[11:12], 24, v[8:9]
; GFX9-NEXT:    v_lshrrev_b32_e32 v10, 16, v8
...
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_cmp_ne_u32_e32 vcc_lo, 0, v12
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr12_vgpr13_vgpr14_vgpr15
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_xor_b32 s0, exec_lo, s0
...
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; VI-NEXT:    v_cndmask_b32_e32 v0, v1, v2, vcc
; VI-NEXT:    v_and_b32_e32 v1, 0xffff0000, v14
; VI-NEXT:    v_add_f32_e32 v1, 0x40c00000, v1
; VI-NEXT:    v_bfe_u32 v2, v1, 16, 1
; VI-NEXT:    v_add_u32_e32 v2, vcc, v2, v1
; VI-NEXT:    v_add_u32_e32 v2, vcc, s6, v2
...
; VI-NEXT:    v_cndmask_b32_e32 v1, v2, v3, vcc
; VI-NEXT:    v_lshrrev_b32_e32 v1, 16, v1
; VI-NEXT:    v_alignbit_b32 v14, v1, v0, 16
...
; GFX11-TRUE16:       ; %bb.0:
; GFX11-TRUE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v13, v1 :: v_dual_mov_b32 v12, v0
; GFX11-TRUE16-NEXT:    s_mov_b32 s0, exec_lo
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v10.h, v12.h
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v4.h, v13.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v11.h, v13.h
...
; GFX11-TRUE16-NEXT:    v_mov_b32_e32 v19, 0x7fc07fc0
...
; GFX11-TRUE16-NEXT:    v_and_b32_e32 v3, 0xffff0000, v12
; GFX11-TRUE16-NEXT:    v_add_f32_e32 v12, 0x40c00000, v1
...
; GFX11-TRUE16-NEXT:    v_add3_u32 v2, v6, v0, 0x7fff
...
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4)
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v11, v2, v8, vcc_lo
...
; GFX11-TRUE16-NEXT:    v_add3_u32 v10, v0, v1, 0x7fff
...
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v10, v6, v5, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v10.l, v0.h
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v5, 8, v11
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v18, v7, v9, vcc_lo
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v18.l, v8.h
...
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[16:17], 24, v[18:19]
...
; SI-NEXT:    v_mul_f32_e64 v10, 1.0, s6
; SI-NEXT:    v_mul_f32_e64 v19, 1.0, s7
; SI-NEXT:    v_mul_f32_e64 v6, 1.0, s4
; SI-NEXT:    v_mul_f32_e64 v17, 1.0, s5
...
; SI-NEXT:    v_lshr_b64 v[15:16], v[19:20], 16
; SI-NEXT:    v_lshr_b64 v[8:9], v[17:18], 16
; SI-NEXT:    v_lshr_b64 v[3:4], v[14:15], 24
; SI-NEXT:    v_lshrrev_b32_e32 v7, 24, v10
; SI-NEXT:    v_lshrrev_b32_e32 v11, 24, v6
; SI-NEXT:    v_lshrrev_b32_e32 v5, 8, v15
; SI-NEXT:    v_lshrrev_b32_e32 v9, 8, v8
; SI-NEXT:    v_lshr_b64 v[12:13], v[14:15], 16
; SI-NEXT:    v_lshr_b64 v[1:2], v[14:15], 8
...
; SI-NEXT:    v_add_f32_e32 v19, 0x40c00000, v0
...
; VI-NEXT:    s_lshr_b32 s17, s18, 8
; VI-NEXT:    s_lshr_b32 s14, s5, 24
; VI-NEXT:    s_lshr_b32 s13, s5, 16
; VI-NEXT:    s_lshr_b32 s12, s5, 8
; VI-NEXT:    s_lshr_b32 s16, s4, 16
...
; VI-NEXT:    v_add_f32_e32 v0, s6, v3
; VI-NEXT:    v_bfe_u32 v1, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v0
; VI-NEXT:    v_add_u32_e32 v1, vcc, 0x7fff, v1
; VI-NEXT:    v_or_b32_e32 v2, 0x400000, v0
...
; VI-NEXT:    s_and_b32 s5, s5, 0xffff0000
; VI-NEXT:    v_cndmask_b32_e32 v0, v1, v2, vcc
; VI-NEXT:    v_add_f32_e32 v1, s5, v3
; VI-NEXT:    v_bfe_u32 v2, v1, 16, 1
; VI-NEXT:    v_add_u32_e32 v2, vcc, v2, v1
; VI-NEXT:    v_add_u32_e32 v2, vcc, 0x7fff, v2
; VI-NEXT:    v_or_b32_e32 v4, 0x400000, v1
...
; VI-NEXT:    v_add_f32_e32 v0, s5, v3
; VI-NEXT:    v_bfe_u32 v1, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v0
; VI-NEXT:    v_add_u32_e32 v1, vcc, 0x7fff, v1
; VI-NEXT:    v_or_b32_e32 v2, 0x400000, v0
...
; GFX9-NEXT:  ; %bb.1: ; %cmp.false
; GFX9-NEXT:    s_lshr_b32 s19, s5, 16
; GFX9-NEXT:    s_lshr_b32 s17, s18, 16
; GFX9-NEXT:    s_lshr_b32 s16, s18, 8
; GFX9-NEXT:    s_lshr_b32 s12, s5, 24
; GFX9-NEXT:    s_lshr_b32 s13, s5, 8
; GFX9-NEXT:    s_lshr_b32 s15, s4, 16
; GFX9-NEXT:    s_lshr_b32 s14, s4, 8
; GFX9-NEXT:    s_lshr_b64 s[8:9], s[18:19], 24
; GFX9-NEXT:    s_lshr_b64 s[6:7], s[4:5], 24
...
; GFX9-NEXT:    v_add_f32_e32 v0, s6, v3
; GFX9-NEXT:    v_bfe_u32 v1, v0, 16, 1
...
; GFX9-NEXT:    v_add_f32_e32 v0, s5, v3
; GFX9-NEXT:    v_bfe_u32 v1, v0, 16, 1
; GFX9-NEXT:    v_add_u32_e32 v1, v1, v0
; GFX9-NEXT:    v_add_u32_e32 v1, 0x7fff, v1
; GFX9-NEXT:    v_or_b32_e32 v2, 0x400000, v0
...
; GFX11-FAKE16:       ; %bb.0:
; GFX11-FAKE16-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v8, v2 :: v_dual_mov_b32 v15, v1
...
; VI-NEXT:  ; %bb.1: ; %cmp.false
; VI-NEXT:    s_lshr_b32 s19, s4, 16
; VI-NEXT:    s_lshr_b32 s16, s18, 16
; VI-NEXT:    s_lshr_b32 s13, s18, 8
; VI-NEXT:    s_lshr_b32 s15, s5, 24
; VI-NEXT:    s_lshr_b32 s17, s5, 16
; VI-NEXT:    s_lshr_b32 s12, s5, 8
; VI-NEXT:    s_lshr_b32 s14, s4, 8
; VI-NEXT:    s_lshr_b64 s[8:9], s[18:19], 24
; VI-NEXT:    s_lshr_b64 s[6:7], s[4:5], 24
...
; VI-NEXT:    v_add_f16_e32 v6, s6, v1
; VI-NEXT:    v_lshlrev_b32_e32 v0, 16, v6
; VI-NEXT:    v_add_f16_e32 v13, s5, v1
; VI-NEXT:    s_lshr_b32 s5, s4, 16
; VI-NEXT:    v_or_b32_e32 v12, v13, v0
; VI-NEXT:    v_add_f16_e32 v2, s5, v1
; VI-NEXT:    v_add_f16_e32 v0, s4, v1
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x200
; GFX9-NEXT:    v_pk_add_f16 v15, s5, v0 op_sel_hi:[1,0]
...
; VI-NEXT:    v_lshrrev_b32_e32 v14, 16, v15
; VI-NEXT:    ; implicit-def: $vgpr0
; VI-NEXT:    ; implicit-def: $vgpr1
; VI-NEXT:    ; implicit-def: $vgpr3
; VI-NEXT:    ; implicit-def: $vgpr13
...
; VI-NEXT:    v_add_u16_sdwa v6, v16, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_u16_e32 v13, 3, v16
; VI-NEXT:    v_lshlrev_b32_e32 v0, 16, v6
; VI-NEXT:    v_add_u16_sdwa v14, v15, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v12, v13, v0
; VI-NEXT:    v_add_u16_e32 v0, 3, v15
; VI-NEXT:    v_lshlrev_b32_e32 v3, 16, v14
; VI-NEXT:    v_or_b32_e32 v11, v0, v3
; VI-NEXT:    v_add_u16_sdwa v10, v2, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
...
; GFX9-NEXT:    v_pk_add_u16 v14, s5, 3 op_sel_hi:[1,0]
...
; VI-NEXT:    v_mov_b32_e32 v3, 0x40c00000
; VI-NEXT:    v_add_f32_e32 v0, s7, v3
; VI-NEXT:    v_bfe_u32 v1, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v0
; VI-NEXT:    v_add_u32_e32 v1, vcc, 0x7fff, v1
; VI-NEXT:    v_or_b32_e32 v2, 0x400000, v0
...
; VI-NEXT:    v_or_b32_e32 v4, 0x400000, v1
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; VI-NEXT:    s_lshl_b32 s4, s5, 16
; VI-NEXT:    v_cndmask_b32_e32 v1, v2, v4, vcc
; VI-NEXT:    v_add_f32_e32 v2, s4, v3
; VI-NEXT:    v_bfe_u32 v4, v2, 16, 1
; VI-NEXT:    v_add_u32_e32 v4, vcc, v4, v2
; VI-NEXT:    v_add_u32_e32 v4, vcc, 0x7fff, v4
; VI-NEXT:    s_and_b32 s4, s5, 0xffff0000
; VI-NEXT:    v_or_b32_e32 v5, 0x400000, v2
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v2, v2
; VI-NEXT:    v_add_f32_e32 v2, s4, v3
...
; GFX9-NEXT:    s_pack_lh_b32_b16 s7, 0, s4
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x40c00000
; GFX9-NEXT:    v_add_f32_e32 v1, s7, v0
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
; GFX9-NEXT:    v_add_u32_e32 v2, v2, v1
...
; GFX9-NEXT:    v_bfe_u32 v2, v1, 16, 1
; GFX9-NEXT:    v_add_u32_e32 v2, v2, v1
; GFX9-NEXT:    s_pack_lh_b32_b16 s4, 0, s5
; GFX9-NEXT:    v_add_u32_e32 v2, 0x7fff, v2
...
; GFX9-NEXT:    s_pack_lh_b32_b16 s4, 0, s6
; GFX9-NEXT:    v_add_u32_e32 v5, 0x7fff, v5
...
; VI-NEXT:    v_mov_b32_e32 v0, 0x200
; VI-NEXT:    v_add_f16_e32 v3, s4, v0
...
; VI-NEXT:    v_add_f16_e32 v1, s5, v0
