...
; CHECK-NEXT:    s_xor_b64 s[12:13], s[0:1], -1
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[14:15], 1, v0
; CHECK-NEXT:    s_and_b64 s[16:17], exec, s[0:1]
...
; CHECK-NEXT:    s_and_b64 s[20:21], exec, s[8:9]
; CHECK-NEXT:    v_mov_b32_e32 v18, 0x55555523
; CHECK-NEXT:    v_mov_b32_e32 v19, 0xbfd55555
; CHECK-NEXT:    s_and_b64 s[22:23], exec, s[10:11]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_2 Depth=1
; CHECK-NEXT:    s_mov_b64 vcc, s[20:21]
...
; CHECK-NEXT:    s_mov_b64 vcc, s[16:17]
...
; CHECK-NEXT:    s_mov_b64 vcc, s[22:23]
; CHECK-NEXT:    s_cbranch_vccz .LBB0_5
...
; CHECK-NEXT:    s_mov_b64 s[0:1], s[12:13]
