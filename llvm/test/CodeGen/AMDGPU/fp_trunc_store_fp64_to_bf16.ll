...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v21, v13
; CHECK-NEXT:    v_mov_b32_e32 v20, v12
; CHECK-NEXT:    v_mov_b32_e32 v12, v10
; CHECK-NEXT:    v_mov_b32_e32 v10, v4
; CHECK-NEXT:    v_mov_b32_e32 v4, v2
; CHECK-NEXT:    v_cvt_f32_f64_e32 v2, v[20:21]
; CHECK-NEXT:    v_mov_b32_e32 v19, v15
; CHECK-NEXT:    v_mov_b32_e32 v18, v14
...
; CHECK-NEXT:    v_cvt_f32_f64_e32 v3, v[18:19]
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v1, v0, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v3
; CHECK-NEXT:    v_and_b32_e32 v20, 1, v3
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[18:19]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[18:19], v[0:1]
...
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; CHECK-NEXT:    s_mov_b32 s9, 0x7060302
; CHECK-NEXT:    v_perm_b32 v3, v0, v2, s9
; CHECK-NEXT:    v_cvt_f32_f64_e32 v2, v[14:15]
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v2
; CHECK-NEXT:    v_and_b32_e32 v18, 1, v2
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[14:15]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[14:15], v[0:1]
...
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v1, v0, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v14
; CHECK-NEXT:    v_and_b32_e32 v15, 1, v14
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[12:13]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[12:13], v[0:1]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v15
; CHECK-NEXT:    v_cndmask_b32_e64 v0, -1, 1, s[6:7]
; CHECK-NEXT:    v_add_u32_e32 v0, v14, v0
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v14, vcc
; CHECK-NEXT:    v_bfe_u32 v1, v0, 16, 1
; CHECK-NEXT:    v_add3_u32 v1, v1, v0, s8
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[12:13], v[12:13]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; CHECK-NEXT:    v_cvt_f32_f64_e32 v12, v[10:11]
; CHECK-NEXT:    v_perm_b32 v2, v0, v2, s9
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v12
; CHECK-NEXT:    v_and_b32_e32 v13, 1, v12
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[10:11]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[10:11], v[0:1]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v13
; CHECK-NEXT:    v_cndmask_b32_e64 v0, -1, 1, s[6:7]
; CHECK-NEXT:    v_add_u32_e32 v0, v12, v0
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v12, vcc
; CHECK-NEXT:    v_bfe_u32 v1, v0, 16, 1
; CHECK-NEXT:    v_add3_u32 v1, v1, v0, s8
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[10:11], v[10:11]
; CHECK-NEXT:    v_cvt_f32_f64_e32 v11, v[8:9]
; CHECK-NEXT:    v_cndmask_b32_e32 v10, v1, v0, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v11
; CHECK-NEXT:    v_and_b32_e32 v12, 1, v11
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[8:9]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[8:9], v[0:1]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v12
; CHECK-NEXT:    v_cndmask_b32_e64 v0, -1, 1, s[6:7]
; CHECK-NEXT:    v_add_u32_e32 v0, v11, v0
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v11, vcc
; CHECK-NEXT:    v_bfe_u32 v1, v0, 16, 1
; CHECK-NEXT:    v_add3_u32 v1, v1, v0, s8
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[8:9], v[8:9]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; CHECK-NEXT:    v_perm_b32 v1, v0, v10, s9
; CHECK-NEXT:    v_cvt_f32_f64_e32 v0, v[6:7]
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[8:9], v0
; CHECK-NEXT:    v_and_b32_e32 v10, 1, v0
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[6:7]|, |v[8:9]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[6:7], v[8:9]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v10
; CHECK-NEXT:    v_cndmask_b32_e64 v8, -1, 1, s[6:7]
; CHECK-NEXT:    v_add_u32_e32 v8, v0, v8
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v8, v0, vcc
; CHECK-NEXT:    v_bfe_u32 v8, v0, 16, 1
; CHECK-NEXT:    v_add3_u32 v8, v8, v0, s8
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[6:7], v[6:7]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v8, v0, vcc
; CHECK-NEXT:    v_cvt_f32_f64_e32 v8, v[4:5]
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[6:7], v8
; CHECK-NEXT:    v_and_b32_e32 v9, 1, v8
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[4:5]|, |v[6:7]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[4:5], v[6:7]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v9
; CHECK-NEXT:    v_cndmask_b32_e64 v6, -1, 1, s[6:7]
; CHECK-NEXT:    v_add_u32_e32 v6, v8, v6
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; CHECK-NEXT:    v_perm_b32 v0, v4, v0, s9
...
; CHECK:       ; %bb.0: ; %entry
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v33, v9
; CHECK-NEXT:    v_mov_b32_e32 v32, v8
; CHECK-NEXT:    buffer_load_dword v9, off, s[0:3], s32 offset:8
; CHECK-NEXT:    buffer_load_dword v8, off, s[0:3], s32 offset:4
; CHECK-NEXT:    buffer_load_dword v31, off, s[0:3], s32
; CHECK-NEXT:    v_mov_b32_e32 v37, v13
; CHECK-NEXT:    v_mov_b32_e32 v36, v12
; CHECK-NEXT:    v_mov_b32_e32 v12, v4
; CHECK-NEXT:    v_mov_b32_e32 v4, v2
; CHECK-NEXT:    v_cvt_f32_f64_e32 v2, v[36:37]
; CHECK-NEXT:    v_mov_b32_e32 v35, v15
; CHECK-NEXT:    v_mov_b32_e32 v34, v14
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v3
; CHECK-NEXT:    v_and_b32_e32 v3, 1, v2
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[6:7], |v[36:37]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[36:37], v[0:1]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v3
; CHECK-NEXT:    v_cndmask_b32_e64 v0, -1, 1, s[6:7]
; CHECK-NEXT:    v_add_u32_e32 v0, v2, v0
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[36:37], v[36:37]
; CHECK-NEXT:    v_cvt_f32_f64_e32 v3, v[34:35]
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v1, v0, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v3
; CHECK-NEXT:    v_and_b32_e32 v36, 1, v3
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[34:35]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[34:35], v[0:1]
...
; CHECK-NEXT:    v_add3_u32 v1, v1, v0, s6
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[34:35], v[34:35]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; CHECK-NEXT:    s_mov_b32 s7, 0x7060302
; CHECK-NEXT:    v_perm_b32 v3, v0, v2, s7
; CHECK-NEXT:    v_cvt_f32_f64_e32 v2, v[32:33]
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v2
; CHECK-NEXT:    v_and_b32_e32 v34, 1, v2
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[32:33]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[32:33], v[0:1]
...
; CHECK-NEXT:    v_add3_u32 v1, v1, v0, s6
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[32:33], v[32:33]
; CHECK-NEXT:    v_cvt_f32_f64_e32 v32, v[14:15]
; CHECK-NEXT:    v_cndmask_b32_e32 v2, v1, v0, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v32
; CHECK-NEXT:    v_and_b32_e32 v33, 1, v32
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[14:15]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[14:15], v[0:1]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v33
; CHECK-NEXT:    v_cndmask_b32_e64 v0, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v0, v32, v0
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v32, vcc
; CHECK-NEXT:    v_bfe_u32 v1, v0, 16, 1
; CHECK-NEXT:    v_add3_u32 v1, v1, v0, s6
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[14:15], v[14:15]
...
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v14
; CHECK-NEXT:    v_and_b32_e32 v15, 1, v14
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[12:13]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[12:13], v[0:1]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v15
; CHECK-NEXT:    v_cndmask_b32_e64 v0, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v0, v14, v0
...
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[12:13], v[12:13]
; CHECK-NEXT:    v_cvt_f32_f64_e32 v13, v[10:11]
; CHECK-NEXT:    v_cndmask_b32_e32 v12, v1, v0, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[0:1], v13
; CHECK-NEXT:    v_and_b32_e32 v14, 1, v13
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[10:11]|, |v[0:1]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[10:11], v[0:1]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v14
; CHECK-NEXT:    v_cndmask_b32_e64 v0, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v0, v13, v0
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v0, v13, vcc
; CHECK-NEXT:    v_bfe_u32 v1, v0, 16, 1
; CHECK-NEXT:    v_add3_u32 v1, v1, v0, s6
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[10:11], v[10:11]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v1, v0, vcc
; CHECK-NEXT:    v_perm_b32 v1, v0, v12, s7
; CHECK-NEXT:    v_cvt_f32_f64_e32 v0, v[6:7]
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[10:11], v0
; CHECK-NEXT:    v_and_b32_e32 v12, 1, v0
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[6:7]|, |v[10:11]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[6:7], v[10:11]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v12
; CHECK-NEXT:    v_cndmask_b32_e64 v10, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v10, v0, v10
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v10, v0, vcc
; CHECK-NEXT:    v_bfe_u32 v10, v0, 16, 1
; CHECK-NEXT:    v_add3_u32 v10, v10, v0, s6
; CHECK-NEXT:    v_or_b32_e32 v0, 0x400000, v0
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[6:7], v[6:7]
; CHECK-NEXT:    v_cndmask_b32_e32 v0, v10, v0, vcc
...
; CHECK-NEXT:    v_and_b32_e32 v11, 1, v10
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[4:5]|, |v[6:7]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[4:5], v[6:7]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v11
; CHECK-NEXT:    v_cndmask_b32_e64 v6, -1, 1, s[8:9]
...
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[4:5], v[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v7, v6, vcc
; CHECK-NEXT:    v_cvt_f32_f64_e32 v6, v[28:29]
; CHECK-NEXT:    v_perm_b32 v0, v4, v0, s7
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[4:5], v6
; CHECK-NEXT:    v_and_b32_e32 v7, 1, v6
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[28:29]|, |v[4:5]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[28:29], v[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v7
...
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_cvt_f32_f64_e32 v7, v[30:31]
; CHECK-NEXT:    v_cndmask_b32_e32 v6, v5, v4, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[4:5], v7
; CHECK-NEXT:    v_and_b32_e32 v10, 1, v7
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[30:31]|, |v[4:5]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[30:31], v[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v10
; CHECK-NEXT:    v_cndmask_b32_e64 v4, -1, 1, s[8:9]
...
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v5, v4, vcc
; CHECK-NEXT:    v_perm_b32 v7, v4, v6, s7
; CHECK-NEXT:    v_cvt_f32_f64_e32 v6, v[24:25]
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[4:5], v6
; CHECK-NEXT:    v_and_b32_e32 v10, 1, v6
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[24:25]|, |v[4:5]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[24:25], v[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v10
; CHECK-NEXT:    v_cndmask_b32_e64 v4, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v4, v6, v4
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; CHECK-NEXT:    v_cvt_f32_f64_e32 v10, v[26:27]
; CHECK-NEXT:    v_cndmask_b32_e32 v6, v5, v4, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[4:5], v10
; CHECK-NEXT:    v_and_b32_e32 v11, 1, v10
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[26:27]|, |v[4:5]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[26:27], v[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v11
; CHECK-NEXT:    v_cndmask_b32_e64 v4, -1, 1, s[8:9]
...
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v5, v4, vcc
; CHECK-NEXT:    v_cvt_f32_f64_e32 v10, v[20:21]
; CHECK-NEXT:    v_perm_b32 v6, v4, v6, s7
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[4:5], v10
; CHECK-NEXT:    v_and_b32_e32 v11, 1, v10
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[20:21]|, |v[4:5]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[20:21], v[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v11
; CHECK-NEXT:    v_cndmask_b32_e64 v4, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v4, v10, v4
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; CHECK-NEXT:    v_or_b32_e32 v4, 0x400000, v4
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[20:21], v[20:21]
; CHECK-NEXT:    v_cvt_f32_f64_e32 v11, v[22:23]
; CHECK-NEXT:    v_cndmask_b32_e32 v10, v5, v4, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[4:5], v11
; CHECK-NEXT:    v_and_b32_e32 v12, 1, v11
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[22:23]|, |v[4:5]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[22:23], v[4:5]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v12
; CHECK-NEXT:    v_cndmask_b32_e64 v4, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v4, v11, v4
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; CHECK-NEXT:    v_cvt_f32_f64_e32 v4, v[16:17]
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[10:11], v4
; CHECK-NEXT:    v_and_b32_e32 v12, 1, v4
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[16:17]|, |v[10:11]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[16:17], v[10:11]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v12
; CHECK-NEXT:    v_cndmask_b32_e64 v10, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v10, v4, v10
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v10, v4, vcc
; CHECK-NEXT:    v_bfe_u32 v10, v4, 16, 1
; CHECK-NEXT:    v_add3_u32 v10, v10, v4, s6
; CHECK-NEXT:    v_or_b32_e32 v4, 0x400000, v4
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[16:17], v[16:17]
; CHECK-NEXT:    v_cvt_f32_f64_e32 v12, v[18:19]
; CHECK-NEXT:    v_cndmask_b32_e32 v4, v10, v4, vcc
; CHECK-NEXT:    v_cvt_f64_f32_e32 v[10:11], v12
; CHECK-NEXT:    v_and_b32_e32 v13, 1, v12
; CHECK-NEXT:    v_cmp_gt_f64_e64 s[8:9], |v[18:19]|, |v[10:11]|
; CHECK-NEXT:    v_cmp_nlg_f64_e32 vcc, v[18:19], v[10:11]
; CHECK-NEXT:    v_cmp_eq_u32_e64 s[4:5], 1, v13
; CHECK-NEXT:    v_cndmask_b32_e64 v10, -1, 1, s[8:9]
; CHECK-NEXT:    v_add_u32_e32 v10, v12, v10
; CHECK-NEXT:    s_or_b64 vcc, vcc, s[4:5]
...
; CHECK-NEXT:    v_cmp_u_f64_e32 vcc, v[18:19], v[18:19]
; CHECK-NEXT:    v_cndmask_b32_e32 v10, v11, v10, vcc
; CHECK-NEXT:    v_perm_b32 v4, v10, v4, s7
