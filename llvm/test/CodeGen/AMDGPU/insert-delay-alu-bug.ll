...
; GFX11-LABEL: f2:
; GFX11:       ; %bb.0: ; %bb
; GFX11-NEXT:    s_load_b32 s28, s[4:5], 0x24
...
; GFX11-NEXT:    s_mov_b32 s27, exec_lo
; GFX11-NEXT:    s_mov_b32 s32, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_mul_lo_u32 v1, s28, v1
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_cmpx_eq_u32_e32 0, v1
; GFX11-NEXT:    s_cbranch_execz .LBB2_13
; GFX11-NEXT:  ; %bb.1: ; %bb14
; GFX11-NEXT:    s_load_b128 s[16:19], s[20:21], 0x2c
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_add_u32 s8, s20, 0x58
; GFX11-NEXT:    s_addc_u32 s9, s21, 0
...
; GFX11-NEXT:    s_load_b64 s[30:31], s[4:5], 0x0
; GFX11-NEXT:    s_mov_b64 s[4:5], s[0:1]
; GFX11-NEXT:    s_mov_b64 s[6:7], s[2:3]
; GFX11-NEXT:    s_mov_b32 s13, s26
; GFX11-NEXT:    s_mov_b32 s14, s15
; GFX11-NEXT:    s_mov_b64 s[22:23], s[2:3]
; GFX11-NEXT:    s_mov_b64 s[24:25], s[0:1]
; GFX11-NEXT:    v_mov_b32_e32 v5, v0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_swappc_b64 s[30:31], s[30:31]
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_mov_b32_e32 v0, v5
; GFX11-NEXT:    s_mov_b64 s[0:1], s[24:25]
; GFX11-NEXT:    s_mov_b64 s[2:3], s[22:23]
...
; GFX11-NEXT:    s_load_b32 s4, s[20:21], 0x54
; GFX11-NEXT:    s_bitcmp1_b32 s19, 0
; GFX11-NEXT:    s_cselect_b32 s8, -1, 0
; GFX11-NEXT:    s_and_b32 s5, s19, 1
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-NEXT:    s_load_b128 s[36:39], s[20:21], 0x44
; GFX11-NEXT:    v_mov_b32_e32 v1, 0
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_hi_u32 s5, s37, s36
; GFX11-NEXT:    s_mul_i32 s4, s37, s36
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_lshr_b64 s[4:5], s[4:5], 1
; GFX11-NEXT:    s_mov_b32 s5, 0
; GFX11-NEXT:    s_or_b32 s4, s4, 1
; GFX11-NEXT:    s_lshr_b32 s4, s4, s38
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_mul_i32 s4, s4, s18
; GFX11-NEXT:    s_mul_i32 s4, s4, s16
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX11-NEXT:    s_or_b32 s4, s28, s4
; GFX11-NEXT:    s_lshl_b64 s[18:19], s[4:5], 1
; GFX11-NEXT:    s_mov_b32 s4, s5
; GFX11-NEXT:    global_load_u16 v2, v1, s[18:19]
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s29
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-NEXT:    s_and_b32 s9, s7, s9
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX11-NEXT:    s_and_b32 s9, s9, exec_lo
; GFX11-NEXT:    v_readfirstlane_b32 s13, v3
; GFX11-NEXT:    s_cselect_b32 s5, s13, s5
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    s_and_b32 s5, s5, 1
; GFX11-NEXT:    s_and_b32 s9, 0xffff, s4
; GFX11-NEXT:    s_cselect_b32 s9, -1, 0
; GFX11-NEXT:    s_and_b32 s14, s8, exec_lo
; GFX11-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s9
...
; GFX11-NEXT:    s_and_b32 s16, s6, exec_lo
; GFX11-NEXT:    s_or_not1_b32 s4, s17, exec_lo
; GFX11-NEXT:  .LBB2_13: ; %Flow9
; GFX11-NEXT:    s_or_b32 exec_lo, exec_lo, s27
; GFX11-NEXT:    s_and_saveexec_b32 s17, s4
