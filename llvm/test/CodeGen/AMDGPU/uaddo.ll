...
; SI-NEXT:    v_add_i32_e64 v0, s[6:7], v1, v2
; SI-NEXT:    s_cbranch_vccnz .LBB9_2
; SI-NEXT:  ; %bb.1: ; %if
; SI-NEXT:    s_xor_b64 s[4:5], s[6:7], -1
; SI-NEXT:  .LBB9_2: ; %exit
; SI-NEXT:    s_mov_b32 s8, s0
; SI-NEXT:    s_mov_b32 s9, s1
; SI-NEXT:    s_mov_b32 s0, s2
...
; VI-NEXT:    v_add_u32_e64 v0, s[6:7], v1, v2
; VI-NEXT:    s_cbranch_vccnz .LBB9_2
; VI-NEXT:  ; %bb.1: ; %if
; VI-NEXT:    s_xor_b64 s[4:5], s[6:7], -1
; VI-NEXT:  .LBB9_2: ; %exit
...
; GFX9-NEXT:    v_add_co_u32_e64 v1, s[2:3], v2, v3
; GFX9-NEXT:    s_cbranch_vccnz .LBB9_2
; GFX9-NEXT:  ; %bb.1: ; %if
; GFX9-NEXT:    s_xor_b64 s[0:1], s[2:3], -1
...
; SI-NEXT:    v_cmp_gt_u64_e32 vcc, s[6:7], v[2:3]
; SI-NEXT:    s_mov_b32 s2, 0
; SI-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; SI-NEXT:    v_cmp_gt_u64_e32 vcc, s[4:5], v[4:5]
...
; GFX11-NEXT:    v_add_co_u32 v0, vcc_lo, s0, v2
; GFX11-NEXT:    v_add_co_ci_u32_e32 v1, vcc_lo, s1, v3, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v2, vcc_lo, s2, v4, vcc_lo
; GFX11-NEXT:    v_add_co_ci_u32_e32 v3, vcc_lo, s3, v5, vcc_lo
...
; GFX11-NEXT:    v_mov_b16_e32 v0.l, v4.l
; GFX11-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc_lo
