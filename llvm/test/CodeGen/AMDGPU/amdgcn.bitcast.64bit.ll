...
; VI-NEXT:    v_add_f16_e32 v2, s5, v0
...
; VI-NEXT:    v_add_f32_e32 v0, s6, v4
...
; VI-NEXT:    v_add_f32_e32 v1, s5, v4
...
; VI-NEXT:    v_add_f32_e32 v0, s5, v4
; VI-NEXT:    v_bfe_u32 v1, v0, 16, 1
; VI-NEXT:    v_add_u32_e32 v1, vcc, v1, v0
; VI-NEXT:    v_add_u32_e32 v1, vcc, 0x7fff, v1
...
; GFX9-NEXT:    s_pack_lh_b32_b16 s6, 0, s4
...
; VI-NEXT:    s_lshr_b32 s12, s4, 16
; VI-NEXT:    s_lshr_b32 s13, s4, 8
...
; SI-NEXT:    ; implicit-def: $vgpr7_vgpr8
; SI-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; SI-NEXT:    s_xor_b64 s[4:5], exec, s[4:5]
...
; GFX9-NEXT:    v_add_u16_e32 v0, 0x300, v0
; GFX9-NEXT:    v_add_u16_sdwa v1, v1, s6 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; GFX9-NEXT:    v_or_b32_e32 v9, v0, v1
...
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr8_vgpr9
; GFX11-FAKE16-NEXT:    s_and_saveexec_b32 s0, vcc_lo
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-FAKE16-NEXT:    s_xor_b32 s0, exec_lo, s0
; GFX11-FAKE16-NEXT:  ; %bb.1: ; %cmp.false
...
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v8, v1, 16, v0
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr0
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr1
; GFX11-FAKE16-NEXT:    v_lshl_or_b32 v9, v3, 16, v2
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr2
; GFX11-FAKE16-NEXT:    ; implicit-def: $vgpr3
; GFX11-FAKE16-NEXT:  ; %bb.2: ; %Flow
; GFX11-FAKE16-NEXT:    s_and_not1_saveexec_b32 s0, s0
...
; GFX11-FAKE16-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GFX11-FAKE16-NEXT:    v_or_b32_e32 v9, v2, v3
...
; VI-NEXT:    s_lshr_b32 s12, s4, 8
; VI-NEXT:    s_cbranch_execnz .LBB49_4
; VI-NEXT:  .LBB49_2: ; %cmp.true
; VI-NEXT:    v_add_f64 v[8:9], s[4:5], 1.0
; VI-NEXT:    v_lshrrev_b64 v[3:4], 24, v[8:9]
; VI-NEXT:    v_lshrrev_b32_e32 v7, 24, v9
; VI-NEXT:    v_lshrrev_b32_e32 v6, 16, v9
; VI-NEXT:    v_lshrrev_b32_e32 v5, 8, v9
...
; GFX9-NEXT:  ; %bb.1: ; %cmp.false
; GFX9-NEXT:    s_lshr_b64 s[6:7], s[4:5], 24
; GFX9-NEXT:    s_lshr_b32 s11, s5, 24
; GFX9-NEXT:    s_lshr_b32 s10, s5, 16
; GFX9-NEXT:    s_lshr_b32 s7, s5, 8
; GFX9-NEXT:    s_lshr_b32 s13, s4, 16
; GFX9-NEXT:    s_lshr_b32 s12, s4, 8
; GFX9-NEXT:    s_cbranch_execnz .LBB49_4
; GFX9-NEXT:  .LBB49_2: ; %cmp.true
; GFX9-NEXT:    v_add_f64 v[8:9], s[4:5], 1.0
; GFX9-NEXT:    v_lshrrev_b64 v[3:4], 24, v[8:9]
; GFX9-NEXT:    v_lshrrev_b32_e32 v7, 24, v9
; GFX9-NEXT:    v_lshrrev_b32_e32 v6, 16, v9
; GFX9-NEXT:    v_lshrrev_b32_e32 v5, 8, v9
...
; VI-NEXT:    v_add_f32_e64 v9, s5, 1.0
; VI-NEXT:    v_add_f32_e64 v8, s4, 1.0
; VI-NEXT:    v_lshrrev_b64 v[3:4], 24, v[8:9]
; VI-NEXT:    v_lshrrev_b32_e32 v7, 24, v9
; VI-NEXT:    v_lshrrev_b32_e32 v6, 16, v9
; VI-NEXT:    v_lshrrev_b32_e32 v5, 8, v9
...
; GFX9-NEXT:    s_lshr_b32 s7, s5, 24
; GFX9-NEXT:    s_lshr_b32 s10, s5, 16
; GFX9-NEXT:    s_lshr_b32 s12, s5, 8
; GFX9-NEXT:    s_lshr_b32 s11, s4, 16
; GFX9-NEXT:    s_lshr_b32 s13, s4, 8
; GFX9-NEXT:    s_cbranch_execnz .LBB85_4
; GFX9-NEXT:  .LBB85_2: ; %cmp.true
; GFX9-NEXT:    v_add_f32_e64 v9, s5, 1.0
; GFX9-NEXT:    v_add_f32_e64 v8, s4, 1.0
; GFX9-NEXT:    v_lshrrev_b64 v[3:4], 24, v[8:9]
; GFX9-NEXT:    v_lshrrev_b32_e32 v7, 24, v9
; GFX9-NEXT:    v_lshrrev_b32_e32 v6, 16, v9
; GFX9-NEXT:    v_lshrrev_b32_e32 v5, 8, v9
...
; VI-NEXT:    v_add_u16_sdwa v6, v10, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_add_u16_e32 v8, 3, v10
; VI-NEXT:    v_lshlrev_b32_e32 v0, 16, v6
; VI-NEXT:    v_add_u16_sdwa v2, v9, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1 src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v10, v8, v0
...
; VI-NEXT:    s_add_i32 s11, s5, 3
; VI-NEXT:    s_lshr_b32 s5, s5, 16
; VI-NEXT:    s_add_i32 s10, s5, 3
; VI-NEXT:    s_and_b32 s6, s11, 0xffff
; VI-NEXT:    s_lshl_b32 s5, s10, 16
; VI-NEXT:    s_or_b32 s9, s6, s5
; VI-NEXT:    s_and_b32 s5, s4, 0xffff0000
; VI-NEXT:    s_add_i32 s4, s4, 3
; VI-NEXT:    s_and_b32 s6, s4, 0xffff
; VI-NEXT:    s_or_b32 s5, s5, s6
; VI-NEXT:    s_add_i32 s8, s5, 0x30000
; VI-NEXT:    s_lshr_b64 s[6:7], s[8:9], 24
; VI-NEXT:    s_lshr_b32 s7, s9, 8
; VI-NEXT:    s_lshr_b32 s13, s8, 16
; VI-NEXT:    s_lshr_b32 s14, s8, 8
; VI-NEXT:    s_bfe_u32 s12, s10, 0x80008
; VI-NEXT:  .LBB97_3: ; %end
; VI-NEXT:    v_mov_b32_e32 v0, s4
...
; GFX9-NEXT:    v_pk_add_u16 v9, s5, 3 op_sel_hi:[1,0]
...
; VI-NEXT:    s_lshr_b32 s7, s5, 8
; VI-NEXT:    s_lshr_b32 s13, s4, 16
; VI-NEXT:    s_lshr_b32 s11, s4, 8
; VI-NEXT:    s_cbranch_execnz .LBB105_4
; VI-NEXT:  .LBB105_2: ; %cmp.true
; VI-NEXT:    s_lshr_b32 s6, s5, 16
; VI-NEXT:    v_mov_b32_e32 v0, 0x200
; VI-NEXT:    v_add_f16_e32 v6, s6, v0
; VI-NEXT:    v_add_f16_e32 v8, s5, v0
; VI-NEXT:    s_lshr_b32 s5, s4, 16
; VI-NEXT:    v_lshlrev_b32_e32 v1, 16, v6
; VI-NEXT:    v_add_f16_e32 v2, s5, v0
...
; GFX9-NEXT:    v_mov_b32_e32 v0, 0x200
; GFX9-NEXT:    v_pk_add_f16 v9, s5, v0 op_sel_hi:[1,0]
...
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v10.h, v8.h
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v4.h, v9.l
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v11.h, v9.h
; GFX11-TRUE16-NEXT:    ; implicit-def: $vgpr8_vgpr9
...
; GFX11-TRUE16-NEXT:    v_or_b32_e32 v7, 0x400000, v0
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v0, v0
; GFX11-TRUE16-NEXT:    v_add3_u32 v10, v4, v3, 0x7fff
...
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v3, v3
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v10, v10, v5, vcc_lo
; GFX11-TRUE16-NEXT:    v_cmp_u_f32_e32 vcc_lo, v2, v2
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v10.l, v0.h
; GFX11-TRUE16-NEXT:    v_cndmask_b32_e32 v11, v8, v11, vcc_lo
; GFX11-TRUE16-NEXT:    v_mov_b16_e32 v11.l, v4.h
; GFX11-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-TRUE16-NEXT:    v_lshrrev_b32_e32 v1, 8, v10
; GFX11-TRUE16-NEXT:    v_lshrrev_b64 v[6:7], 24, v[10:11]
...
; SI-NEXT:    v_mul_f32_e64 v11, 1.0, s5
...
; SI-NEXT:    v_lshrrev_b32_e32 v7, 24, v6
; SI-NEXT:    v_lshr_b64 v[3:4], v[8:9], 24
; SI-NEXT:    v_lshr_b64 v[4:5], v[8:9], 16
; SI-NEXT:    v_lshr_b64 v[1:2], v[8:9], 8
; SI-NEXT:    v_lshrrev_b32_e32 v5, 8, v9
...
; SI-NEXT:    v_lshr_b64 v[8:9], v[0:1], 16
; SI-NEXT:    v_and_b32_e32 v0, 0xffff0000, v11
; SI-NEXT:    v_add_f32_e32 v11, 0x40c00000, v0
; SI-NEXT:    v_and_b32_e32 v0, 0xffff0000, v6
; SI-NEXT:    v_add_f32_e32 v0, 0x40c00000, v0
...
; VI-NEXT:    v_add_f32_e32 v1, s6, v0
; VI-NEXT:    v_bfe_u32 v2, v1, 16, 1
; VI-NEXT:    v_add_u32_e32 v2, vcc, v2, v1
; VI-NEXT:    v_add_u32_e32 v2, vcc, 0x7fff, v2
; VI-NEXT:    s_and_b32 s5, s5, 0xffff0000
; VI-NEXT:    v_or_b32_e32 v3, 0x400000, v1
; VI-NEXT:    v_cmp_u_f32_e32 vcc, v1, v1
; VI-NEXT:    v_add_f32_e32 v1, s5, v0
...
; VI-NEXT:    v_lshrrev_b64 v[1:2], 16, v[7:8]
; VI-NEXT:    s_lshl_b32 s5, s4, 16
; VI-NEXT:    v_add_f32_e32 v2, s5, v0
; VI-NEXT:    v_bfe_u32 v3, v2, 16, 1
; VI-NEXT:    v_add_u32_e32 v3, vcc, v3, v2
; VI-NEXT:    v_add_u32_e32 v3, vcc, 0x7fff, v3
; VI-NEXT:    s_and_b32 s4, s4, 0xffff0000
...
; GFX9-NEXT:    s_lshr_b64 s[6:7], s[4:5], 24
; GFX9-NEXT:    s_lshr_b32 s11, s5, 24
; GFX9-NEXT:    s_lshr_b32 s13, s5, 16
; GFX9-NEXT:    s_lshr_b32 s12, s5, 8
