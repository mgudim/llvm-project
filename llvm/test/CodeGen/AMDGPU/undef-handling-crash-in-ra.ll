...
; CHECK-NEXT:    v_pk_mov_b32 v[42:43], 0, 0
; CHECK-NEXT:    flat_load_dword v40, v[42:43]
; CHECK-NEXT:    s_mov_b64 s[48:49], s[8:9]
; CHECK-NEXT:    s_load_dwordx4 s[36:39], s[48:49], 0x8
; CHECK-NEXT:    s_load_dword s66, s[48:49], 0x0
; CHECK-NEXT:    s_add_u32 s0, s0, s17
; CHECK-NEXT:    s_addc_u32 s1, s1, 0
; CHECK-NEXT:    s_mov_b64 s[8:9], src_private_base
; CHECK-NEXT:    s_mov_b64 s[52:53], s[6:7]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_cmp_lg_u32 s66, -1
; CHECK-NEXT:    s_mov_b64 s[54:55], s[4:5]
; CHECK-NEXT:    s_mov_b32 s4, 0
; CHECK-NEXT:    s_cselect_b32 s5, s9, 0
; CHECK-NEXT:    s_cselect_b32 s6, s66, 0
; CHECK-NEXT:    v_pk_mov_b32 v[46:47], s[36:37], s[36:37] op_sel:[0,1]
; CHECK-NEXT:    s_add_u32 s36, s48, 48
; CHECK-NEXT:    v_mov_b32_e32 v45, s5
; CHECK-NEXT:    s_mov_b32 s5, s4
; CHECK-NEXT:    s_addc_u32 s37, s49, 0
...
; CHECK-NEXT:    s_mov_b64 s[4:5], s[54:55]
; CHECK-NEXT:    s_mov_b64 s[6:7], s[52:53]
...
; CHECK-NEXT:    v_mov_b32_e32 v58, s38
; CHECK-NEXT:    v_mov_b32_e32 v59, s39
; CHECK-NEXT:    flat_store_dwordx2 v[46:47], v[60:61]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_swappc_b64 s[30:31], s[64:65]
; CHECK-NEXT:    flat_load_dwordx2 v[62:63], v[46:47]
; CHECK-NEXT:    v_mov_b32_e32 v56, 0
; CHECK-NEXT:    v_mov_b32_e32 v57, 0x3ff00000
; CHECK-NEXT:    s_mov_b64 s[4:5], s[54:55]
; CHECK-NEXT:    s_mov_b64 s[6:7], s[52:53]
; CHECK-NEXT:    s_mov_b64 s[8:9], s[36:37]
; CHECK-NEXT:    s_mov_b64 s[10:11], s[50:51]
; CHECK-NEXT:    s_mov_b32 s12, s35
; CHECK-NEXT:    s_mov_b32 s13, s34
; CHECK-NEXT:    s_mov_b32 s14, s33
; CHECK-NEXT:    v_mov_b32_e32 v31, v41
; CHECK-NEXT:    flat_store_dwordx2 v[42:43], v[56:57]
; CHECK-NEXT:    flat_store_dwordx2 v[46:47], v[60:61]
...
; CHECK-NEXT:    v_pk_mov_b32 v[0:1], v[40:41], v[40:41] op_sel:[0,1]
...
; CHECK-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v40
; CHECK-NEXT:    v_pk_mov_b32 v[0:1], v[40:41], v[40:41] op_sel:[0,1]
; CHECK-NEXT:    v_pk_mov_b32 v[2:3], v[42:43], v[42:43] op_sel:[0,1]
; CHECK-NEXT:    s_and_saveexec_b64 s[6:7], vcc
...
; CHECK-NEXT:    s_load_dwordx4 s[8:11], s[48:49], 0x20
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
...
; CHECK-NEXT:    s_and_saveexec_b64 s[4:5], vcc
; CHECK-NEXT:    s_or_b64 exec, exec, s[4:5]
; CHECK-NEXT:    buffer_store_dword v40, off, s[0:3], 0
; CHECK-NEXT:    s_endpgm
entry:
