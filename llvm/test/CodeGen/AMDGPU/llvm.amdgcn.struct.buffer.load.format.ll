...
; GFX6-NEXT:    buffer_load_format_xyzw v[0:4], v7, s[0:3], 0 idxen tfe
...
; GFX8PLUS:       ; %bb.0:
; GFX8PLUS-NEXT:    v_mov_b32_e32 v5, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v0, 0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v6, v1
; GFX8PLUS-NEXT:    v_mov_b32_e32 v7, 2
; GFX8PLUS-NEXT:    v_mov_b32_e32 v1, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v2, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v3, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v4, v0
; GFX8PLUS-NEXT:    buffer_load_format_xyzw v[0:4], v7, s[0:3], 0 idxen tfe
; GFX8PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX8PLUS-NEXT:    flat_store_dwordx4 v[5:6], v[0:3]
; GFX8PLUS-NEXT:    s_nop 0
...
; GFX11-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v7, 2
; GFX11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX11-NEXT:    v_mov_b32_e32 v1, v0
; GFX11-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-NEXT:    v_mov_b32_e32 v4, v0
; GFX11-NEXT:    buffer_load_format_xyzw v[0:4], v7, s[0:3], 0 idxen tfe
; GFX11-NEXT:    s_waitcnt vmcnt(0)
...
; NOPRT:       ; %bb.0:
; NOPRT-NEXT:    v_dual_mov_b32 v6, v1 :: v_dual_mov_b32 v5, v0
; NOPRT-NEXT:    v_mov_b32_e32 v0, 2
; NOPRT-NEXT:    v_mov_b32_e32 v4, 0
; NOPRT-NEXT:    buffer_load_format_xyzw v[0:4], v0, s[0:3], 0 idxen tfe
; NOPRT-NEXT:    s_waitcnt vmcnt(0)
; NOPRT-NEXT:    global_store_b128 v[5:6], v[0:3], off
...
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v7, 2
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v3, v0 :: v_dual_mov_b32 v4, v0
; GFX12-SDAG-NEXT:    buffer_load_format_xyzw v[0:4], v7, s[0:3], null idxen tfe
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    global_store_b128 v[5:6], v[0:3], off
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v7, 2
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v3, v0 :: v_dual_mov_b32 v4, v0
; GFX12-GISEL-NEXT:    buffer_load_format_xyzw v[0:4], v7, s[0:3], null idxen tfe
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s2, v2
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v2, s2 :: v_dual_mov_b32 v3, s3
; GFX12-GISEL-NEXT:    global_store_b128 v[5:6], v[0:3], off
...
; GFX6-NEXT:    v_mov_b32_e32 v3, v0
; GFX6-NEXT:    v_mov_b32_e32 v4, v0
; GFX6-NEXT:    buffer_load_format_xyzw v[0:4], v0, s[0:3], 0 idxen tfe
; GFX6-NEXT:    s_mov_b32 s2, 0
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_mov_b32 s0, s2
; GFX6-NEXT:    s_mov_b32 s1, s2
...
; GFX8PLUS-NEXT:    v_mov_b32_e32 v3, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v4, v0
; GFX8PLUS-NEXT:    buffer_load_format_xyzw v[0:4], v0, s[0:3], 0 idxen tfe
; GFX8PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX8PLUS-NEXT:    flat_store_dwordx4 v[5:6], v[0:3]
; GFX8PLUS-NEXT:    s_nop 0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v0, v4
...
; GFX11-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-NEXT:    v_mov_b32_e32 v4, v0
; GFX11-NEXT:    buffer_load_format_xyzw v[0:4], v0, s[0:3], 0 idxen tfe
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b128 v[5:6], v[0:3], off
; GFX11-NEXT:    v_mov_b32_e32 v0, v4
; GFX11-NEXT:    ; return to shader part epilog
...
; NOPRT-NEXT:    v_mov_b32_e32 v4, 0
; NOPRT-NEXT:    v_dual_mov_b32 v6, v1 :: v_dual_mov_b32 v5, v0
; NOPRT-NEXT:    buffer_load_format_xyzw v[0:4], v4, s[0:3], 0 idxen tfe
; NOPRT-NEXT:    s_waitcnt vmcnt(0)
; NOPRT-NEXT:    global_store_b128 v[5:6], v[0:3], off
; NOPRT-NEXT:    v_mov_b32_e32 v0, v4
; NOPRT-NEXT:    ; return to shader part epilog
...
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v3, v0 :: v_dual_mov_b32 v4, v0
; GFX12-SDAG-NEXT:    buffer_load_format_xyzw v[0:4], v0, s[0:3], null idxen tfe
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    global_store_b128 v[5:6], v[0:3], off
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, v4
; GFX12-SDAG-NEXT:    ; return to shader part epilog
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v3, v0 :: v_dual_mov_b32 v4, v0
; GFX12-GISEL-NEXT:    buffer_load_format_xyzw v[0:4], v0, s[0:3], null idxen tfe
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s2, v2
...
; GFX6-NEXT:    v_mov_b32_e32 v2, v0
; GFX6-NEXT:    v_mov_b32_e32 v3, v0
; GFX6-NEXT:    buffer_load_format_xyz v[0:3], v0, s[0:3], 0 idxen tfe
; GFX6-NEXT:    s_mov_b32 s2, 0
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_mov_b32 s0, s2
; GFX6-NEXT:    s_mov_b32 s1, s2
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_store_dword v2, v[4:5], s[0:3], 0 addr64 offset:8
; GFX6-NEXT:    buffer_store_dwordx2 v[0:1], v[4:5], s[0:3], 0 addr64
; GFX6-NEXT:    s_waitcnt expcnt(0)
...
; GFX8PLUS-NEXT:    v_mov_b32_e32 v4, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v0, 0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v5, v1
; GFX8PLUS-NEXT:    v_mov_b32_e32 v1, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v2, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v3, v0
; GFX8PLUS-NEXT:    buffer_load_format_xyz v[0:3], v0, s[0:3], 0 idxen tfe
; GFX8PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX8PLUS-NEXT:    flat_store_dwordx3 v[4:5], v[0:2]
; GFX8PLUS-NEXT:    s_nop 0
...
; GFX11-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-NEXT:    buffer_load_format_xyz v[0:3], v0, s[0:3], 0 idxen tfe
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b96 v[4:5], v[0:2], off
...
; NOPRT-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v4, v0
; NOPRT-NEXT:    buffer_load_format_xyz v[0:3], v3, s[0:3], 0 idxen tfe
; NOPRT-NEXT:    s_waitcnt vmcnt(0)
; NOPRT-NEXT:    global_store_b96 v[4:5], v[0:2], off
; NOPRT-NEXT:    v_mov_b32_e32 v0, v3
; NOPRT-NEXT:    ; return to shader part epilog
;
; GFX12-SDAG-LABEL: buffer_load_v3i32_tfe:
; GFX12-SDAG:       ; %bb.0:
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v5, v1 :: v_dual_mov_b32 v4, v0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-SDAG-NEXT:    buffer_load_format_xyz v[0:3], v0, s[0:3], null idxen tfe
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    global_store_b96 v[4:5], v[0:2], off
; GFX12-SDAG-NEXT:    v_mov_b32_e32 v0, v3
; GFX12-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-GISEL-LABEL: buffer_load_v3i32_tfe:
; GFX12-GISEL:       ; %bb.0:
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v4, v0 :: v_dual_mov_b32 v5, v1
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v0, 0
; GFX12-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-GISEL-NEXT:    buffer_load_format_xyz v[0:3], v0, s[0:3], null idxen tfe
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s2, v2
...
; GFX12-GISEL-NEXT:    global_store_b96 v[4:5], v[0:2], off
...
; GFX8PLUS-NEXT:    v_mov_b32_e32 v3, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v0, 0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v4, v1
; GFX8PLUS-NEXT:    v_mov_b32_e32 v1, v0
; GFX8PLUS-NEXT:    v_mov_b32_e32 v2, v0
; GFX8PLUS-NEXT:    buffer_load_format_xy v[0:2], v0, s[0:3], 0 idxen tfe
; GFX8PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX8PLUS-NEXT:    flat_store_dwordx2 v[3:4], v[0:1]
; GFX8PLUS-NEXT:    v_mov_b32_e32 v0, v2
; GFX8PLUS-NEXT:    s_waitcnt vmcnt(0)
; GFX8PLUS-NEXT:    ; return to shader part epilog
;
...
; GFX11-NEXT:    v_mov_b32_e32 v1, v0
; GFX11-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-NEXT:    buffer_load_format_xy v[0:2], v0, s[0:3], 0 idxen tfe
; GFX11-NEXT:    s_waitcnt vmcnt(0)
; GFX11-NEXT:    global_store_b64 v[3:4], v[0:1], off
...
; NOPRT-NEXT:    v_dual_mov_b32 v4, v1 :: v_dual_mov_b32 v3, v0
; NOPRT-NEXT:    buffer_load_format_xy v[0:2], v2, s[0:3], 0 idxen tfe
; NOPRT-NEXT:    s_waitcnt vmcnt(0)
; NOPRT-NEXT:    global_store_b64 v[3:4], v[0:1], off
...
; GFX12-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-SDAG-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-SDAG-NEXT:    buffer_load_format_xy v[0:2], v0, s[0:3], null idxen tfe
; GFX12-SDAG-NEXT:    s_wait_loadcnt 0x0
; GFX12-SDAG-NEXT:    global_store_b64 v[3:4], v[0:1], off
...
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v1, v0 :: v_dual_mov_b32 v2, v0
; GFX12-GISEL-NEXT:    buffer_load_format_xy v[0:2], v0, s[0:3], null idxen tfe
; GFX12-GISEL-NEXT:    s_wait_loadcnt 0x0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s0, v0
; GFX12-GISEL-NEXT:    v_readfirstlane_b32 s1, v1
; GFX12-GISEL-NEXT:    v_dual_mov_b32 v0, s0 :: v_dual_mov_b32 v1, s1
; GFX12-GISEL-NEXT:    global_store_b64 v[3:4], v[0:1], off
