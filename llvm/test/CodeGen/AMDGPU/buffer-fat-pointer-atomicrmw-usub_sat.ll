...
; GFX9-NEXT:    buffer_load_dword v0, v0, s[4:7], 0 offen offset:1024
...
; GFX9-NEXT:    buffer_atomic_cmpswap v[0:1], v3, s[4:7], 0 offen offset:1024 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
...
; GFX9-NEXT:    buffer_load_dword v2, v1, s[4:7], 0 offen offset:1024
; GFX9-NEXT:    s_mov_b64 s[8:9], 0
; GFX9-NEXT:    v_mov_b32_e32 v3, s20
...
; GFX9-NEXT:    buffer_atomic_cmpswap v[4:5], v3, s[4:7], 0 offen offset:1024 glc
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    buffer_wbinvl1
