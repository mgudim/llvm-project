...
; CHECK-NEXT:    v_lshlrev_b64 v[2:3], 6, v[4:5]
; CHECK-NEXT:    v_mov_b32_e32 v7, s17
; CHECK-NEXT:    v_add_co_u32_e32 v6, vcc, s16, v2
; CHECK-NEXT:    v_addc_co_u32_e32 v7, vcc, v7, v3, vcc
...
; CHECK-NEXT:    v_lshlrev_b64 v[4:5], 6, v[4:5]
...
; CHECK-NEXT:    v_mov_b32_e32 v9, s5
; CHECK-NEXT:    v_add_co_u32_e32 v8, vcc, s4, v4
; CHECK-NEXT:    v_addc_co_u32_e32 v9, vcc, v5, v9, vcc
...
; CHECK-NEXT:    v_cmp_ne_u64_e64 s[6:7], 0, v[0:1]
; CHECK-NEXT:    v_cmp_ne_u64_e64 s[8:9], 0, v[2:3]
...
; CHECK-NEXT:    ; in Loop: Header=BB0_11 Depth=1
; CHECK-NEXT:    s_and_saveexec_b64 s[10:11], s[8:9]
...
; CHECK-NEXT:    v_cmp_ge_u64_e64 s[4:5], s[12:13], v[2:3]
; CHECK-NEXT:    v_addc_co_u32_e32 v9, vcc, v5, v10, vcc
; CHECK-NEXT:    s_or_b64 s[14:15], s[4:5], s[14:15]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
