...
; GCN-NEXT:    global_load_dword v0, v[1:2], off
; GCN-NEXT:    s_mov_b64 s[4:5], 0
; GCN-NEXT:  .LBB1_1: ; %atomicrmw.start
; GCN-NEXT:    ; =>This Inner Loop Header: Depth=1
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    v_mov_b32_e32 v4, v0
; GCN-NEXT:    v_bfi_b32 v3, v4, -5, -1
; GCN-NEXT:    global_atomic_cmpswap v0, v[1:2], v[3:4], off glc
; GCN-NEXT:    s_waitcnt vmcnt(0)
; GCN-NEXT:    buffer_wbinvl1_vol
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v4
; GCN-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
; GCN-NEXT:    s_andn2_b64 exec, exec, s[4:5]
...
; GCN-NEXT:    v_mov_b32_e32 v2, v1
; GCN-NEXT:    v_mov_b32_e32 v1, v0
; GCN-NEXT:    flat_load_dword v0, v[1:2]
; GCN-NEXT:    s_mov_b64 s[4:5], 0
...
; GCN-NEXT:    v_mov_b32_e32 v4, v0
; GCN-NEXT:    v_bfi_b32 v3, v4, -5, -1
; GCN-NEXT:    flat_atomic_cmpswap v0, v[1:2], v[3:4] glc
; GCN-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GCN-NEXT:    buffer_wbinvl1_vol
; GCN-NEXT:    v_cmp_eq_u32_e32 vcc, v0, v4
; GCN-NEXT:    s_or_b64 s[4:5], vcc, s[4:5]
