...
; GFX1170-NEXT:    v_dual_mov_b32 v29, v25 :: v_dual_mov_b32 v28, v24
; GFX1170-NEXT:    v_dual_mov_b32 v31, v23 :: v_dual_mov_b32 v30, v22
...
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_f16 v[20:27], v[0:3], v[4:11], v32
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_f16 v[12:19], v[0:3], v[4:11], v32 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[30:31], v[24:27], off offset:16
; GFX1170-NEXT:    global_store_b128 v[30:31], v[20:23], off
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[28:29], v[16:19], off offset:16
; GFX1170-NEXT:    global_store_b128 v[28:29], v[12:15], off
; GFX1170-NEXT:    s_endpgm
;
; GFX12-LABEL: test_swmmac_f32_16x16x32_f16_index_key:
; GFX12:       ; %bb.0: ; %bb
; GFX12-NEXT:    global_load_b32 v32, v[20:21], off
; GFX12-NEXT:    v_dual_mov_b32 v29, v25 :: v_dual_mov_b32 v28, v24
; GFX12-NEXT:    v_dual_mov_b32 v31, v23 :: v_dual_mov_b32 v30, v22
...
; GFX12-NEXT:    v_swmmac_f32_16x16x32_f16 v[20:27], v[0:3], v[4:11], v32
; GFX12-NEXT:    v_swmmac_f32_16x16x32_f16 v[12:19], v[0:3], v[4:11], v32 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[30:31], v[24:27], off offset:16
; GFX12-NEXT:    global_store_b128 v[30:31], v[20:23], off
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[28:29], v[16:19], off offset:16
; GFX12-NEXT:    global_store_b128 v[28:29], v[12:15], off
; GFX12-NEXT:    s_endpgm
bb:
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf16 v[20:27], v[0:3], v[4:11], v32
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf16 v[12:19], v[0:3], v[4:11], v32 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[30:31], v[24:27], off offset:16
; GFX1170-NEXT:    global_store_b128 v[30:31], v[20:23], off
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf16 v[20:27], v[0:3], v[4:11], v32
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf16 v[12:19], v[0:3], v[4:11], v32 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[30:31], v[24:27], off offset:16
; GFX12-NEXT:    global_store_b128 v[30:31], v[20:23], off
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170:       ; %bb.0: ; %bb
; GFX1170-NEXT:    global_load_b32 v24, v[16:17], off
; GFX1170-NEXT:    v_dual_mov_b32 v23, v19 :: v_dual_mov_b32 v22, v18
; GFX1170-NEXT:    v_dual_mov_b32 v19, v15 :: v_dual_mov_b32 v18, v14
; GFX1170-NEXT:    v_dual_mov_b32 v17, v13 :: v_dual_mov_b32 v16, v12
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f16_16x16x32_f16 v[16:19], v[0:3], v[4:11], v24
; GFX1170-NEXT:    v_swmmac_f16_16x16x32_f16 v[12:15], v[0:3], v[4:11], v24 index_key:1
; GFX1170-NEXT:    global_store_b128 v[22:23], v[16:19], off
; GFX1170-NEXT:    global_store_b128 v[20:21], v[12:15], off
; GFX1170-NEXT:    s_endpgm
;
; GFX12-LABEL: test_swmmac_f16_16x16x32_f16_index_key:
; GFX12:       ; %bb.0: ; %bb
; GFX12-NEXT:    global_load_b32 v24, v[16:17], off
; GFX12-NEXT:    v_dual_mov_b32 v23, v19 :: v_dual_mov_b32 v22, v18
; GFX12-NEXT:    v_dual_mov_b32 v19, v15 :: v_dual_mov_b32 v18, v14
; GFX12-NEXT:    v_dual_mov_b32 v17, v13 :: v_dual_mov_b32 v16, v12
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f16_16x16x32_f16 v[16:19], v[0:3], v[4:11], v24
; GFX12-NEXT:    v_swmmac_f16_16x16x32_f16 v[12:15], v[0:3], v[4:11], v24 index_key:1
; GFX12-NEXT:    global_store_b128 v[22:23], v[16:19], off
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[16:19], v[0:3], v[4:11], v24
; GFX1170-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[12:15], v[0:3], v[4:11], v24 index_key:1
; GFX1170-NEXT:    global_store_b128 v[22:23], v[16:19], off
; GFX1170-NEXT:    global_store_b128 v[20:21], v[12:15], off
; GFX1170-NEXT:    s_endpgm
;
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[16:19], v[0:3], v[4:11], v24
; GFX12-NEXT:    v_swmmac_bf16_16x16x32_bf16 v[12:15], v[0:3], v[4:11], v24 index_key:1
; GFX12-NEXT:    global_store_b128 v[22:23], v[16:19], off
; GFX12-NEXT:    global_store_b128 v[20:21], v[12:15], off
; GFX12-NEXT:    s_endpgm
bb:
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_i32_16x16x32_iu8 v[14:21], v[0:1], v[2:5], v26
; GFX1170-NEXT:    v_swmmac_i32_16x16x32_iu8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX1170-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[22:23], v[10:13], off offset:16
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_i32_16x16x32_iu8 v[14:21], v[0:1], v[2:5], v26
; GFX12-NEXT:    v_swmmac_i32_16x16x32_iu8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX12-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[22:23], v[10:13], off offset:16
...
; GFX1170-NEXT:    v_dual_mov_b32 v20, v16 :: v_dual_mov_b32 v19, v15
; GFX1170-NEXT:    v_dual_mov_b32 v22, v14 :: v_dual_mov_b32 v21, v13
...
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[21:22], v[15:18], off offset:16
; GFX1170-NEXT:    global_store_b128 v[21:22], v[11:14], off
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[19:20], v[7:10], off offset:16
...
; GFX12-NEXT:    v_dual_mov_b32 v20, v16 :: v_dual_mov_b32 v19, v15
; GFX12-NEXT:    v_dual_mov_b32 v22, v14 :: v_dual_mov_b32 v21, v13
...
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[21:22], v[15:18], off offset:16
; GFX12-NEXT:    global_store_b128 v[21:22], v[11:14], off
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[19:20], v[7:10], off offset:16
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[14:21], v[0:1], v[2:5], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX1170-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[14:21], v[0:1], v[2:5], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_fp8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX12-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[14:21], v[0:1], v[2:5], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX1170-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[14:21], v[0:1], v[2:5], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_fp8_bf8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX12-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[14:21], v[0:1], v[2:5], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX1170-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[14:21], v[0:1], v[2:5], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_fp8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX12-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX12-NEXT:    s_clause 0x1
...
; GFX1170-NEXT:    s_waitcnt vmcnt(0)
; GFX1170-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[14:21], v[0:1], v[2:5], v26
; GFX1170-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX1170-NEXT:    s_clause 0x1
; GFX1170-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX1170-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX1170-NEXT:    s_clause 0x1
...
; GFX12-NEXT:    s_wait_loadcnt 0x0
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[14:21], v[0:1], v[2:5], v26
; GFX12-NEXT:    v_swmmac_f32_16x16x32_bf8_bf8 v[6:13], v[0:1], v[2:5], v26 index_key:1
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    global_store_b128 v[24:25], v[18:21], off offset:16
; GFX12-NEXT:    global_store_b128 v[24:25], v[14:17], off
; GFX12-NEXT:    s_clause 0x1
