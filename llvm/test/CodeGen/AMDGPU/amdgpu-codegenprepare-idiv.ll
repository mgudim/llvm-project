...
; GFX6-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX6-NEXT:    s_cmp_ge_u32 s0, s13
; GFX6-NEXT:    s_cselect_b64 s[8:9], -1, 0
...
; GFX6-NEXT:    v_cndmask_b32_e64 v1, v1, v4, s[8:9]
...
; GFX6-NEXT:    v_cndmask_b32_e64 v2, v3, v6, s[12:13]
; GFX6-NEXT:    v_add_i32_e32 v5, vcc, v5, v7
; GFX6-NEXT:    v_mul_hi_u32 v5, s11, v5
; GFX6-NEXT:    v_readfirstlane_b32 s4, v5
...
; GFX6-NEXT:    s_ashr_i32 s16, s2, 31
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GFX6-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GFX6-NEXT:    v_cvt_u32_f32_e32 v0, v0
...
; GFX6-NEXT:    s_cmp_ge_u32 s1, s0
; GFX6-NEXT:    s_cselect_b64 s[6:7], -1, 0
; GFX6-NEXT:    s_abs_i32 s0, s13
; GFX6-NEXT:    v_cvt_f32_u32_e32 v2, s0
; GFX6-NEXT:    s_sub_i32 s1, 0, s0
; GFX6-NEXT:    v_cndmask_b32_e32 v0, v0, v1, vcc
; GFX6-NEXT:    s_xor_b32 s2, s9, s13
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v2
; GFX6-NEXT:    s_ashr_i32 s17, s2, 31
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, 1, v0
; GFX6-NEXT:    v_mul_f32_e32 v2, 0x4f7ffffe, v2
; GFX6-NEXT:    v_cvt_u32_f32_e32 v2, v2
; GFX6-NEXT:    v_cndmask_b32_e64 v0, v0, v1, s[6:7]
; GFX6-NEXT:    v_xor_b32_e32 v0, s16, v0
; GFX6-NEXT:    v_mul_lo_u32 v3, s1, v2
...
; GFX6-NEXT:    s_cmp_ge_u32 s1, s0
; GFX6-NEXT:    s_cselect_b64 s[12:13], -1, 0
; GFX6-NEXT:    s_abs_i32 s14, s15
; GFX6-NEXT:    v_cvt_f32_u32_e32 v6, s14
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; GFX6-NEXT:    v_cndmask_b32_e64 v1, v2, v3, s[8:9]
; GFX6-NEXT:    v_cndmask_b32_e64 v3, v4, v5, s[12:13]
; GFX6-NEXT:    v_xor_b32_e32 v1, s17, v1
; GFX6-NEXT:    v_mul_lo_u32 v2, s4, v6
; GFX6-NEXT:    s_xor_b32 s4, s11, s15
; GFX6-NEXT:    v_xor_b32_e32 v3, s10, v3
; GFX6-NEXT:    s_ashr_i32 s4, s4, 31
; GFX6-NEXT:    v_mul_hi_u32 v2, v6, v2
; GFX6-NEXT:    v_subrev_i32_e32 v0, vcc, s16, v0
; GFX6-NEXT:    v_subrev_i32_e32 v1, vcc, s17, v1
; GFX6-NEXT:    v_add_i32_e32 v2, vcc, v6, v2
; GFX6-NEXT:    v_mul_hi_u32 v4, s5, v2
...
; GFX6-NEXT:    s_sub_i32 s6, s5, s14
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, 1, v4
; GFX6-NEXT:    s_cmp_ge_u32 s5, s14
; GFX6-NEXT:    s_cselect_b64 vcc, -1, 0
...
; GFX6-NEXT:    s_lshl_b32 s8, 0x1000, s3
