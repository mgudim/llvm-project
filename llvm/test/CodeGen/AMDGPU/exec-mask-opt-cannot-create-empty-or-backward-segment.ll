...
; CHECK-NEXT:    s_cselect_b64 s[0:1], -1, 0
; CHECK-NEXT:    s_bitcmp1_b32 s4, 24
...
; CHECK-NEXT:    s_bitcmp1_b32 s5, 8
; CHECK-NEXT:    s_cselect_b64 s[8:9], -1, 0
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[10:11], 1, v1
; CHECK-NEXT:    s_and_b64 s[12:13], exec, s[12:13]
; CHECK-NEXT:    s_and_b64 s[14:15], exec, s[2:3]
...
; CHECK-NEXT:  ; %bb.4: ; %bb8
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    s_mov_b64 vcc, s[12:13]
...
; CHECK-NEXT:    s_mov_b64 vcc, s[14:15]
; CHECK-NEXT:    s_cbranch_vccz .LBB0_11
; CHECK-NEXT:  ; %bb.10: ; %bb16
; CHECK-NEXT:    ; in Loop: Header=BB0_3 Depth=1
; CHECK-NEXT:    s_mov_b64 s[20:21], -1
; CHECK-NEXT:    s_mov_b64 s[22:23], s[6:7]
