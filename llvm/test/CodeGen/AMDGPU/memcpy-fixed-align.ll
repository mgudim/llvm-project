...
; MUBUF-NEXT:    v_mov_b32_e32 v13, v2
; MUBUF-NEXT:    v_mov_b32_e32 v12, v1
; MUBUF-NEXT:    global_load_dwordx4 v[0:3], v[12:13], off
; MUBUF-NEXT:    global_load_dwordx4 v[4:7], v[12:13], off offset:16
; MUBUF-NEXT:    global_load_dwordx4 v[8:11], v[12:13], off offset:24
...
; MUBUF-NEXT:    buffer_store_dword v11, off, s[0:3], s32 offset:36
; MUBUF-NEXT:    buffer_store_dword v10, off, s[0:3], s32 offset:32
; MUBUF-NEXT:    buffer_store_dword v9, off, s[0:3], s32 offset:28
; MUBUF-NEXT:    buffer_store_dword v8, off, s[0:3], s32 offset:24
; MUBUF-NEXT:    ;;#ASMSTART
; MUBUF-NEXT:    ; use s4
; MUBUF-NEXT:    ;;#ASMEND
...
; FLATSCR-NEXT:    v_mov_b32_e32 v13, v2
; FLATSCR-NEXT:    v_mov_b32_e32 v12, v1
; FLATSCR-NEXT:    global_load_dwordx4 v[0:3], v[12:13], off
; FLATSCR-NEXT:    global_load_dwordx4 v[4:7], v[12:13], off offset:16
; FLATSCR-NEXT:    global_load_dwordx4 v[8:11], v[12:13], off offset:24
; FLATSCR-NEXT:    s_mov_b32 s0, s32
; FLATSCR-NEXT:    s_waitcnt vmcnt(2)
; FLATSCR-NEXT:    scratch_store_dwordx4 off, v[0:3], s32
; FLATSCR-NEXT:    s_waitcnt vmcnt(2)
; FLATSCR-NEXT:    scratch_store_dwordx4 off, v[4:7], s32 offset:16
; FLATSCR-NEXT:    s_waitcnt vmcnt(2)
; FLATSCR-NEXT:    scratch_store_dwordx4 off, v[8:11], s32 offset:24
