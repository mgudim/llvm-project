...
; GCN-SDAG-NEXT:    v_add_f64 v[0:1], s[0:1], v[0:1]
...
; GCN-GISEL-NEXT:    v_add_f64 v[0:1], s[0:1], v[0:1]
...
; GFX10-SDAG-NEXT:    v_add_f64 v[0:1], s[2:3], s[0:1]
...
; GFX10-GISEL-NEXT:    v_add_f64 v[0:1], s[0:1], s[2:3]
...
; GFX11-SDAG-NEXT:    v_add_f64 v[0:1], s[2:3], s[0:1]
...
; GFX11-GISEL-NEXT:    v_add_f64 v[0:1], s[0:1], s[2:3]
