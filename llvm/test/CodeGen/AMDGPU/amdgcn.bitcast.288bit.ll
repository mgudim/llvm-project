...
; SI-NEXT:    s_mov_b32 s4, s22
; SI-NEXT:    s_mov_b32 s7, s21
...
; SI-NEXT:    s_lshr_b64 s[16:17], s[24:25], 16
...
; SI-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; SI-NEXT:    v_lshlrev_b32_e32 v26, 16, v18
...
; SI-NEXT:    v_lshlrev_b32_e32 v19, 16, v11
...
; SI-NEXT:  ; %bb.1: ; %cmp.false
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_or_b32_e32 v9, v0, v26
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v2
; SI-NEXT:    v_or_b32_e32 v11, v0, v24
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v3
; SI-NEXT:    v_or_b32_e32 v12, v0, v23
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v4
; SI-NEXT:    v_or_b32_e32 v13, v0, v22
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; SI-NEXT:    v_or_b32_e32 v14, v0, v21
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v6
; SI-NEXT:    v_or_b32_e32 v15, v0, v20
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v7
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; SI-NEXT:    v_or_b32_e32 v16, v0, v19
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v8
; SI-NEXT:    v_or_b32_e32 v10, v1, v25
; SI-NEXT:    v_or_b32_e32 v17, v0, v18
...
; SI-NEXT:    v_add_i32_e32 v10, vcc, s6, v1
...
; SI-NEXT:    v_or_b32_e32 v12, v3, v1
...
; SI-NEXT:    v_add_f32_e32 v3, 0x38000000, v3
; SI-NEXT:    v_cvt_f16_f32_e32 v3, v3
; SI-NEXT:    v_or_b32_e32 v14, v2, v0
...
; SI-NEXT:    v_lshlrev_b32_e32 v0, 16, v2
; SI-NEXT:    v_or_b32_e32 v17, v3, v0
; SI-NEXT:  .LBB10_4: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    v_mov_b32_e32 v0, v9
; SI-NEXT:    v_mov_b32_e32 v1, v10
...
; VI-NEXT:    v_add_f16_sdwa v1, v1, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v9, s5, v0
...
; SI-NEXT:    v_add_f32_e64 v7, s5, 1.0
; SI-NEXT:    v_add_f32_e64 v6, s4, 1.0
; SI-NEXT:    v_add_f32_e64 v3, s9, 1.0
; SI-NEXT:    v_add_f32_e64 v2, s8, 1.0
; SI-NEXT:    v_lshr_b64 v[9:10], v[6:7], 16
; SI-NEXT:    v_lshr_b64 v[12:13], v[4:5], 16
; SI-NEXT:    v_add_f32_e64 v8, s24, 1.0
; SI-NEXT:    v_add_f32_e64 v1, s11, 1.0
; SI-NEXT:    v_add_f32_e64 v0, s10, 1.0
...
; VI-NEXT:    v_add_f16_e32 v3, s12, v0
...
; VI-NEXT:    v_mov_b32_e32 v2, s6
; VI-NEXT:    v_add_f16_e32 v9, s4, v0
