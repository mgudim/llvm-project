...
; CHECK-NEXT:    v_and_b32_e32 v0, 15, v8
; CHECK-NEXT:    v_swap_b32 v5, v3
; CHECK-NEXT:    v_mov_b32_e32 v4, v2
; CHECK-NEXT:    v_and_b32_e32 v2, -16, v8
; CHECK-NEXT:    v_cmp_ne_u64_e64 s4, 0, v[0:1]
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[2:3]
; CHECK-NEXT:    v_cmpx_ge_u64_e64 v[4:5], v[6:7]
...
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v9, s5
...
; CHECK-NEXT:    v_add_co_u32 v6, s5, v6, v2
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, v7, v3, s5
; CHECK-NEXT:    v_add_co_u32 v2, s5, v4, v2
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, v5, v3, s5
; CHECK-NEXT:    s_mov_b32 s9, 0
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, -1, v1, s5
; CHECK-NEXT:    v_add_co_u32 v2, s5, v2, 1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, 0, v3, s5
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[0:1]
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_byte v[6:7], v4
; CHECK-NEXT:    v_add_co_u32 v6, s6, v6, 1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, 0, v7, s6
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
...
; CHECK-NEXT:    v_add_co_u32 v10, s4, v8, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v9, s4
; CHECK-NEXT:    s_mov_b32 s8, 0
; CHECK-NEXT:    v_add_co_u32 v8, s4, v6, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, v7, v11, s4
; CHECK-NEXT:    v_add_co_u32 v10, s4, v4, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, v5, v11, s4
; CHECK-NEXT:    .p2align 6
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_byte v[8:9], v12
...
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v6, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, -1, v7, vcc_lo
...
; CHECK-NEXT:    v_add_co_u32 v2, vcc_lo, v4, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, v5, v11, vcc_lo
; CHECK-NEXT:    flat_load_dwordx4 v[6:9], v[2:3]
; CHECK-NEXT:    v_add_co_u32 v2, vcc_lo, v10, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, -1, v11, vcc_lo
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    global_load_dwordx4 v[14:17], v[8:9], off
; CHECK-NEXT:    v_add_co_u32 v12, s5, v12, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v13, null, -1, v13, s5
; CHECK-NEXT:    v_add_co_u32 v8, s5, v8, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v9, s5
...
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v9, s4
; CHECK-NEXT:    s_mov_b32 s8, 0
; CHECK-NEXT:    v_add_co_u32 v8, s4, v4, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, v5, v11, s4
; CHECK-NEXT:    v_add_co_u32 v10, s4, v6, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, v7, v11, s4
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB1_12: ; %memmove_bwd_residual_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    global_load_ubyte v12, v[8:9], off
; CHECK-NEXT:    v_add_co_u32 v0, s4, v0, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, -1, v1, s4
...
; CHECK-NEXT:  ; %bb.14: ; %memmove_bwd_main_loop.preheader
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v4, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, -1, v5, vcc_lo
...
; CHECK-NEXT:    v_mov_b32_e32 v11, v3
; CHECK-NEXT:    v_mov_b32_e32 v10, v2
; CHECK-NEXT:    v_add_co_u32 v2, vcc_lo, v0, v10
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, v1, v11, vcc_lo
...
; CHECK-NEXT:    v_and_b32_e32 v3, 15, v7
; CHECK-NEXT:    v_and_b32_e32 v0, -16, v7
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc_lo, 0, v[5:6]
; CHECK-NEXT:    v_mov_b32_e32 v1, v8
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmp_ne_u64_e64 s4, 0, v[3:4]
; CHECK-NEXT:    v_cndmask_b32_e32 v9, -1, v5, vcc_lo
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[13:16], v12
...
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[8:9], v[13:16]
; CHECK-NEXT:    v_add_co_u32 v8, s6, v8, 16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, 0, v9, s6
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
...
; CHECK-NEXT:  ; %bb.7: ; %memmove_fwd_residual_loop.preheader
; CHECK-NEXT:    v_and_b32_e32 v7, -16, v7
; CHECK-NEXT:    v_add_co_u32 v0, s5, v5, v0
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, v6, v1, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v2, v2, v7
; CHECK-NEXT:    s_mov_b32 s9, 0
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB2_8: ; %memmove_fwd_residual_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_u8 v5, v2
; CHECK-NEXT:    v_add_co_u32 v3, s5, v3, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, -1, v4, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v2, 1, v2
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[3:4]
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_byte v[0:1], v5
...
; CHECK-NEXT:  ; %bb.11: ; %memmove_bwd_residual_loop.preheader
; CHECK-NEXT:    v_add_co_u32 v9, s4, v5, v7
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, v6, v8, s4
; CHECK-NEXT:    v_add3_u32 v10, v7, v2, -1
; CHECK-NEXT:    v_add_co_u32 v8, s4, v9, -1
...
; CHECK-NEXT:    v_add_co_u32 v3, s4, v3, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, -1, v4, s4
...
; CHECK-NEXT:  ; %bb.14: ; %memmove_bwd_main_loop.preheader
; CHECK-NEXT:    v_and_b32_e32 v3, -16, v7
; CHECK-NEXT:    s_mov_b32 s7, 0
...
; CHECK-NEXT:    ds_read_b128 v[5:8], v2
; CHECK-NEXT:    v_mov_b32_e32 v9, v0
; CHECK-NEXT:    v_add_nc_u32_e32 v2, -16, v2
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v9, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v1, null, -1, v10, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v9, s4, v3, v9
; CHECK-NEXT:    v_add_co_ci_u32_e64 v10, null, v4, v10, s4
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[0:1]
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[9:10], v[5:8]
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK-NEXT:    buffer_load_dword v13, v12, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v14, v12, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_load_dword v15, v12, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_load_dword v16, v12, s[0:3], 0 offen offset:12
; CHECK-NEXT:    v_add_co_u32 v10, s5, v10, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v11, null, -1, v11, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v12, 16, v12
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[10:11]
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    buffer_load_dword v5, v2, s[0:3], 0 offen
; CHECK-NEXT:    buffer_load_dword v6, v2, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_load_dword v7, v2, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_load_dword v8, v2, s[0:3], 0 offen offset:12
; CHECK-NEXT:    v_mov_b32_e32 v10, v1
; CHECK-NEXT:    v_mov_b32_e32 v9, v0
; CHECK-NEXT:    v_add_nc_u32_e32 v2, -16, v2
; CHECK-NEXT:    v_add_co_u32 v0, vcc_lo, v9, -16
...
; CHECK-NEXT:    s_or_b32 s9, s5, s9
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_byte v[6:7], v4, off
; CHECK-NEXT:    v_add_co_u32 v6, s6, v6, 1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v7, null, 0, v7, s6
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
...
; CHECK-NEXT:    s_or_b32 s8, s4, s8
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_byte v[8:9], v12, off
; CHECK-NEXT:    v_add_co_u32 v8, s5, v8, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v9, null, -1, v9, s5
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
...
; CHECK-NEXT:    s_or_b32 s7, vcc_lo, s7
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[10:11], v[6:9], off
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s7
...
; CHECK-NEXT:    v_and_b32_e32 v1, 15, v5
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_write_b128 v6, v[13:16]
...
; CHECK-NEXT:    v_add_co_u32 v3, s5, v7, v3
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, v8, v4, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v0, v0, v5
; CHECK-NEXT:    s_mov_b32 s9, 0
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB10_8: ; %memmove_fwd_residual_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    flat_load_ubyte v5, v[3:4]
; CHECK-NEXT:    v_add_co_u32 v1, s5, v1, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v2, null, -1, v2, s5
; CHECK-NEXT:    v_add_co_u32 v3, s5, v3, 1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, 0, v4, s5
; CHECK-NEXT:    v_cmp_eq_u64_e64 s6, 0, v[1:2]
; CHECK-NEXT:    s_or_b32 s9, s6, s9
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_write_b8 v0, v5
...
; CHECK-NEXT:  ; %bb.11: ; %memmove_bwd_residual_loop.preheader
; CHECK-NEXT:    v_add_co_u32 v9, s4, v7, v5
; CHECK-NEXT:    v_add_co_ci_u32_e64 v10, null, v8, v6, s4
; CHECK-NEXT:    v_add3_u32 v6, v5, v0, -1
...
; CHECK-NEXT:    v_add_co_u32 v1, s4, v1, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v2, null, -1, v2, s4
; CHECK-NEXT:    v_add_co_u32 v9, s4, v9, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v10, null, -1, v10, s4
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[1:2]
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_write_b8 v6, v11
...
; CHECK-NEXT:  ; %bb.14: ; %memmove_bwd_main_loop.preheader
; CHECK-NEXT:    v_and_b32_e32 v1, -16, v5
; CHECK-NEXT:    s_mov_b32 s5, 0
; CHECK-NEXT:    v_add3_u32 v0, v1, v0, -16
; CHECK-NEXT:    v_add_co_u32 v1, vcc_lo, v7, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v2, null, -1, v8, vcc_lo
; CHECK-NEXT:    .p2align 6
; CHECK-NEXT:  .LBB10_15: ; %memmove_bwd_main_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    v_add_co_u32 v5, vcc_lo, v1, v3
; CHECK-NEXT:    v_add_co_ci_u32_e64 v6, null, v2, v4, vcc_lo
; CHECK-NEXT:    v_add_co_u32 v3, vcc_lo, v3, -16
; CHECK-NEXT:    v_add_co_ci_u32_e64 v4, null, -1, v4, vcc_lo
; CHECK-NEXT:    flat_load_dwordx4 v[5:8], v[5:6]
; CHECK-NEXT:    v_cmp_eq_u64_e32 vcc_lo, 0, v[3:4]
; CHECK-NEXT:    s_or_b32 s5, vcc_lo, s5
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_write_b128 v0, v[5:8]
...
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_and_b32_e32 v2, 15, v4
; CHECK-NEXT:    v_and_b32_e32 v6, -16, v4
; CHECK-NEXT:    v_mov_b32_e32 v7, v5
; CHECK-NEXT:    v_cmp_ne_u64_e64 s4, 0, v[2:3]
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_b128 v[9:12], v5
...
; CHECK-NEXT:  ; %bb.7: ; %memmove_fwd_residual_loop.preheader
; CHECK-NEXT:    v_and_b32_e32 v4, -16, v4
; CHECK-NEXT:    s_mov_b32 s8, 0
; CHECK-NEXT:    v_add_nc_u32_e32 v0, v0, v4
; CHECK-NEXT:    v_add_nc_u32_e32 v1, v1, v4
; CHECK-NEXT:  .LBB12_8: ; %memmove_fwd_residual_loop
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    ds_read_u8 v4, v1
; CHECK-NEXT:    v_add_co_u32 v2, s5, v2, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, -1, v3, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v1, 1, v1
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[2:3]
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    ds_write_b8 v0, v4
; CHECK-NEXT:    v_add_nc_u32_e32 v0, 1, v0
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
...
; CHECK-NEXT:    v_add_nc_u32_e32 v3, -16, v4
; CHECK-NEXT:    v_add_nc_u32_e32 v2, v0, v3
; CHECK-NEXT:    v_sub_co_u32 v0, vcc_lo, 0, v4
; CHECK-NEXT:    v_add_nc_u32_e32 v3, v1, v3
; CHECK-NEXT:    v_sub_co_ci_u32_e64 v1, null, 0, v5, vcc_lo
...
; CHECK-NEXT:    v_and_b32_e32 v3, 15, v2
; CHECK-NEXT:    v_mov_b32_e32 v4, 0
; CHECK-NEXT:    s_mov_b64 s[4:5], 0
; CHECK-NEXT:    s_mov_b32 s6, exec_lo
; CHECK-NEXT:    v_cmpx_ne_u64_e32 0, v[5:6]
...
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_dword v16, v6, s[0:3], 0 offen offset:12
; CHECK-NEXT:    buffer_store_dword v15, v6, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_store_dword v14, v6, s[0:3], 0 offen offset:4
; CHECK-NEXT:    buffer_store_dword v13, v6, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v6, 16, v6
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
...
; CHECK-NEXT:    s_or_b32 s9, s6, s9
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_byte v5, v0, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v0, 1, v0
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s9
...
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    buffer_store_byte v11, v6, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v6, -1, v6
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
...
; CHECK-NEXT:    buffer_load_dword v10, v5, s[0:3], 0 offen offset:8
; CHECK-NEXT:    buffer_load_dword v11, v5, s[0:3], 0 offen offset:4
...
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    buffer_load_ubyte v4, v1, s[0:3], 0 offen
; CHECK-NEXT:    v_add_co_u32 v2, s5, v2, -1
; CHECK-NEXT:    v_add_co_ci_u32_e64 v3, null, -1, v3, s5
; CHECK-NEXT:    v_add_nc_u32_e32 v1, 1, v1
; CHECK-NEXT:    v_cmp_eq_u64_e64 s5, 0, v[2:3]
; CHECK-NEXT:    s_or_b32 s8, s5, s8
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    buffer_store_byte v4, v0, s[0:3], 0 offen
; CHECK-NEXT:    v_add_nc_u32_e32 v0, 1, v0
; CHECK-NEXT:    s_andn2_b32 exec_lo, exec_lo, s8
