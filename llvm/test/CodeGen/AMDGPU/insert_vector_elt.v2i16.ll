...
; GFX9-NEXT:    s_load_dwordx2 s[2:3], s[8:9], 0x10
; GFX9-NEXT:    v_lshlrev_b32_e32 v4, 4, v0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v2, v5, s[6:7]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v1, v5, s[10:11]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v9, v0, v5, s[14:15]
...
; GFX9-NEXT:    v_perm_b32 v0, v0, v9, s16
...
; GFX9-NEXT:    global_load_dwordx4 v[4:7], v8, s[6:7] offset:16
; GFX9-NEXT:    s_cmp_eq_u32 s3, 6
; GFX9-NEXT:    s_cselect_b64 vcc, -1, 0
; GFX9-NEXT:    s_cmp_eq_u32 s3, 7
; GFX9-NEXT:    s_cselect_b64 s[0:1], -1, 0
...
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v0, v9, s[14:15]
...
; GFX9-NEXT:    s_waitcnt vmcnt(0)
; GFX9-NEXT:    v_cndmask_b32_e64 v14, v7, v9, s[18:19]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v15, v6, v9, s[22:23]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v5, v9, s[26:27]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v11, v4, v9, s[30:31]
...
; GFX9-NEXT:    global_store_dwordx4 v8, v[4:7], s[4:5] offset:16
