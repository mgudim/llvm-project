...
; SI-NEXT:    v_add_f32_e64 v11, s15, 1.0
; SI-NEXT:    v_add_f32_e64 v10, s14, 1.0
; SI-NEXT:    v_add_f32_e64 v9, s13, 1.0
; SI-NEXT:    v_add_f32_e64 v8, s12, 1.0
; SI-NEXT:    v_add_f32_e64 v7, s11, 1.0
; SI-NEXT:    v_add_f32_e64 v6, s10, 1.0
; SI-NEXT:    v_add_f32_e64 v5, s9, 1.0
; SI-NEXT:    v_add_f32_e64 v4, s8, 1.0
; SI-NEXT:    v_add_f32_e64 v3, s7, 1.0
; SI-NEXT:    v_add_f32_e64 v2, s6, 1.0
; SI-NEXT:    v_add_f32_e64 v1, s5, 1.0
...
; VI:       ; %bb.0:
; VI-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; VI-NEXT:    s_mov_b32 s15, s27
; VI-NEXT:    s_mov_b32 s14, s26
; VI-NEXT:    s_mov_b32 s13, s25
; VI-NEXT:    s_mov_b32 s12, s24
; VI-NEXT:    s_mov_b32 s11, s23
; VI-NEXT:    s_mov_b32 s10, s22
; VI-NEXT:    s_mov_b32 s9, s21
; VI-NEXT:    s_mov_b32 s8, s20
...
; VI-NEXT:    v_add_f32_e64 v11, s15, 1.0
; VI-NEXT:    v_add_f32_e64 v10, s14, 1.0
; VI-NEXT:    v_add_f32_e64 v9, s13, 1.0
; VI-NEXT:    v_add_f32_e64 v8, s12, 1.0
; VI-NEXT:    v_add_f32_e64 v7, s11, 1.0
; VI-NEXT:    v_add_f32_e64 v6, s10, 1.0
; VI-NEXT:    v_add_f32_e64 v5, s9, 1.0
; VI-NEXT:    v_add_f32_e64 v4, s8, 1.0
; VI-NEXT:    v_add_f32_e64 v3, s7, 1.0
; VI-NEXT:    v_add_f32_e64 v2, s6, 1.0
; VI-NEXT:    v_add_f32_e64 v1, s5, 1.0
...
; GFX9:       ; %bb.0:
; GFX9-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-NEXT:    s_mov_b32 s15, s27
; GFX9-NEXT:    s_mov_b32 s14, s26
; GFX9-NEXT:    s_mov_b32 s13, s25
; GFX9-NEXT:    s_mov_b32 s12, s24
...
; GFX9-NEXT:    v_add_f32_e64 v11, s15, 1.0
; GFX9-NEXT:    v_add_f32_e64 v10, s14, 1.0
; GFX9-NEXT:    v_add_f32_e64 v9, s13, 1.0
; GFX9-NEXT:    v_add_f32_e64 v8, s12, 1.0
; GFX9-NEXT:    v_add_f32_e64 v7, s11, 1.0
; GFX9-NEXT:    v_add_f32_e64 v6, s10, 1.0
; GFX9-NEXT:    v_add_f32_e64 v5, s9, 1.0
; GFX9-NEXT:    v_add_f32_e64 v4, s8, 1.0
; GFX9-NEXT:    v_add_f32_e64 v3, s7, 1.0
; GFX9-NEXT:    v_add_f32_e64 v2, s6, 1.0
; GFX9-NEXT:    v_add_f32_e64 v1, s5, 1.0
; GFX9-NEXT:    v_add_f32_e64 v0, s4, 1.0
; GFX9-NEXT:    s_setpc_b64 s[30:31]
; GFX9-NEXT:  .LBB3_3:
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    s_mov_b32 s11, s23
; GFX11-NEXT:    s_mov_b32 s10, s22
; GFX11-NEXT:    s_mov_b32 s9, s21
; GFX11-NEXT:    s_mov_b32 s8, s20
...
; GFX11-NEXT:    v_add_f32_e64 v11, s11, 1.0
; GFX11-NEXT:    v_add_f32_e64 v10, s10, 1.0
; GFX11-NEXT:    v_add_f32_e64 v9, s9, 1.0
; GFX11-NEXT:    v_add_f32_e64 v8, s8, 1.0
...
; SI-NEXT:    v_add_f64 v[10:11], s[14:15], 1.0
; SI-NEXT:    v_add_f64 v[8:9], s[12:13], 1.0
; SI-NEXT:    v_add_f64 v[6:7], s[10:11], 1.0
; SI-NEXT:    v_add_f64 v[4:5], s[8:9], 1.0
; SI-NEXT:    v_add_f64 v[2:3], s[6:7], 1.0
; SI-NEXT:    v_add_f64 v[0:1], s[4:5], 1.0
; SI-NEXT:    s_setpc_b64 s[30:31]
; SI-NEXT:  .LBB7_3:
...
; VI-NEXT:    v_add_f64 v[10:11], s[14:15], 1.0
; VI-NEXT:    v_add_f64 v[8:9], s[12:13], 1.0
; VI-NEXT:    v_add_f64 v[6:7], s[10:11], 1.0
; VI-NEXT:    v_add_f64 v[4:5], s[8:9], 1.0
; VI-NEXT:    v_add_f64 v[2:3], s[6:7], 1.0
; VI-NEXT:    v_add_f64 v[0:1], s[4:5], 1.0
; VI-NEXT:    s_setpc_b64 s[30:31]
; VI-NEXT:  .LBB7_3:
...
; GFX9-NEXT:    v_add_f64 v[10:11], s[14:15], 1.0
; GFX9-NEXT:    v_add_f64 v[8:9], s[12:13], 1.0
; GFX9-NEXT:    v_add_f64 v[6:7], s[10:11], 1.0
; GFX9-NEXT:    v_add_f64 v[4:5], s[8:9], 1.0
; GFX9-NEXT:    v_add_f64 v[2:3], s[6:7], 1.0
...
; GFX11-NEXT:    v_add_f64 v[10:11], s[10:11], 1.0
; GFX11-NEXT:    v_add_f64 v[8:9], s[8:9], 1.0
...
; SI-NEXT:    s_mov_b32 s4, s26
; SI-NEXT:    s_mov_b32 s7, s25
; SI-NEXT:    s_mov_b32 s6, s24
; SI-NEXT:    s_mov_b32 s9, s23
; SI-NEXT:    s_mov_b32 s8, s22
; SI-NEXT:    s_mov_b32 s11, s21
...
; SI-NEXT:    s_lshl_b32 s17, s26, 16
; SI-NEXT:    s_or_b32 s14, s14, s17
...
; SI-NEXT:    v_lshlrev_b32_e32 v32, 16, v21
; SI-NEXT:    v_lshlrev_b32_e32 v31, 16, v20
; SI-NEXT:    v_lshlrev_b32_e32 v30, 16, v19
...
; SI-NEXT:    v_add_i32_e32 v13, vcc, s6, v1
...
; GFX9-NEXT:    v_pk_add_u16 v11, s15, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v10, s14, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v9, s13, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v8, s12, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v7, s11, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v6, s10, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v5, s9, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v4, s8, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v3, s7, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v2, s6, 3 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_u16 v1, s5, 3 op_sel_hi:[1,0]
...
; SI-NEXT:    v_or_b32_e32 v15, v3, v1
...
; SI-NEXT:    v_or_b32_e32 v18, v3, v1
...
; SI-NEXT:    v_lshlrev_b32_e32 v0, 16, v2
; SI-NEXT:    v_or_b32_e32 v23, v3, v0
; SI-NEXT:  .LBB18_4: ; %end
; SI-NEXT:    s_or_b64 exec, exec, s[4:5]
; SI-NEXT:    v_mov_b32_e32 v0, v12
; SI-NEXT:    v_mov_b32_e32 v1, v13
...
; VI-NEXT:    v_add_f16_e32 v0, s4, v0
; VI-NEXT:    v_or_b32_e32 v0, v0, v12
; VI-NEXT:    s_setpc_b64 s[30:31]
; VI-NEXT:  .LBB19_3:
...
; GFX9-NEXT:    v_pk_add_f16 v11, s15, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v10, s14, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v9, s13, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v8, s12, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v7, s11, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v6, s10, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v5, s9, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v4, s8, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v3, s7, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v2, s6, v0 op_sel_hi:[1,0]
; GFX9-NEXT:    v_pk_add_f16 v1, s5, v0 op_sel_hi:[1,0]
...
; GFX11-NEXT:  ; %bb.1: ; %Flow
; GFX11-NEXT:    s_and_not1_b32 vcc_lo, exec_lo, s16
...
; SI-NEXT:    v_add_f32_e64 v11, s5, 1.0
; SI-NEXT:    v_add_f32_e64 v10, s4, 1.0
; SI-NEXT:    v_add_f32_e64 v9, s7, 1.0
; SI-NEXT:    v_add_f32_e64 v8, s6, 1.0
; SI-NEXT:    v_lshr_b64 v[12:13], v[10:11], 16
; SI-NEXT:    v_add_f32_e64 v7, s9, 1.0
; SI-NEXT:    v_add_f32_e64 v6, s8, 1.0
; SI-NEXT:    v_lshr_b64 v[13:14], v[8:9], 16
; SI-NEXT:    v_add_f32_e64 v5, s11, 1.0
; SI-NEXT:    v_add_f32_e64 v4, s10, 1.0
; SI-NEXT:    v_lshr_b64 v[14:15], v[6:7], 16
; SI-NEXT:    v_add_f32_e64 v3, s13, 1.0
; SI-NEXT:    v_add_f32_e64 v2, s12, 1.0
; SI-NEXT:    v_lshr_b64 v[15:16], v[4:5], 16
; SI-NEXT:    v_add_f32_e64 v1, s15, 1.0
; SI-NEXT:    v_add_f32_e64 v0, s14, 1.0
...
; SI-NEXT:    v_lshlrev_b32_e32 v29, 16, v14
; SI-NEXT:    v_lshlrev_b32_e32 v28, 16, v13
...
; SI-NEXT:  ; %bb.1: ; %cmp.false
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_or_b32_e32 v12, v0, v39
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v2
; SI-NEXT:    v_or_b32_e32 v14, v0, v37
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v3
; SI-NEXT:    v_or_b32_e32 v15, v0, v36
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v4
; SI-NEXT:    v_or_b32_e32 v16, v0, v35
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v5
; SI-NEXT:    v_or_b32_e32 v17, v0, v34
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v6
; SI-NEXT:    v_or_b32_e32 v18, v0, v33
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v7
; SI-NEXT:    v_or_b32_e32 v19, v0, v32
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v8
; SI-NEXT:    v_or_b32_e32 v20, v0, v31
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v9
; SI-NEXT:    v_or_b32_e32 v21, v0, v30
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v10
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; SI-NEXT:    v_or_b32_e32 v22, v0, v29
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v11
; SI-NEXT:    v_or_b32_e32 v13, v1, v38
; SI-NEXT:    v_or_b32_e32 v23, v0, v28
; SI-NEXT:    ; implicit-def: $vgpr0
; SI-NEXT:    ; implicit-def: $vgpr1
; SI-NEXT:    ; implicit-def: $vgpr2
; SI-NEXT:    ; implicit-def: $vgpr3
...
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_or_b32_e32 v0, v30, v0
; SI-NEXT:    v_add_i32_e32 v21, vcc, s6, v0
; SI-NEXT:    v_add_i32_e32 v0, vcc, 3, v10
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v0
; SI-NEXT:    v_or_b32_e32 v0, v29, v0
; SI-NEXT:    v_add_i32_e32 v1, vcc, 3, v1
...
; SI-NEXT:    v_and_b32_e32 v1, 0xffff, v1
; SI-NEXT:    v_lshlrev_b32_e32 v13, 16, v38
; SI-NEXT:    v_or_b32_e32 v12, v0, v12
; SI-NEXT:    v_or_b32_e32 v13, v1, v13
; SI-NEXT:    v_and_b32_e32 v0, 0xffff, v2
...
; VI-NEXT:    v_mov_b32_e32 v0, 0x200
; VI-NEXT:    v_add_f16_e32 v1, s14, v0
...
; VI-NEXT:    v_add_f16_e32 v1, s7, v0
; VI-NEXT:    s_lshr_b32 s7, s7, 16
; VI-NEXT:    v_mov_b32_e32 v2, s7
; VI-NEXT:    v_add_f16_sdwa v2, v2, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_or_b32_e32 v3, v1, v2
; VI-NEXT:    v_add_f16_e32 v1, s6, v0
; VI-NEXT:    s_lshr_b32 s6, s6, 16
; VI-NEXT:    v_mov_b32_e32 v2, s6
; VI-NEXT:    v_add_f16_e32 v12, s4, v0
...
; VI-NEXT:    v_mov_b32_e32 v1, s4
; VI-NEXT:    v_add_f16_sdwa v1, v1, v0 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
; VI-NEXT:    v_add_f16_e32 v0, s5, v0
