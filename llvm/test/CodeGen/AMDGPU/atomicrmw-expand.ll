...
; GFX1100-NEXT:    flat_load_b32 v0, v[3:4]
; GFX1100-NEXT:  .LBB3_1: ; %atomicrmw.start
; GFX1100-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1100-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1100-NEXT:    v_mov_b32_e32 v1, v0
; GFX1100-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1100-NEXT:    v_add_f32_e32 v0, v1, v2
; GFX1100-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX1100-NEXT:    flat_atomic_cmpswap_b32 v0, v[3:4], v[0:1] glc
; GFX1100-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1100-NEXT:    buffer_gl0_inv
; GFX1100-NEXT:    v_cmp_eq_u32_e32 vcc_lo, v0, v1
...
; GFX90A-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; GFX90A-NEXT:    s_mov_b64 s[4:5], -1
; GFX90A-NEXT:    s_mov_b32 s6, 1
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[6:7], v0, s6
...
; GFX942-NEXT:    v_cmp_ne_u32_e64 s[2:3], v0, s2
...
; GFX1100-NEXT:    v_cmp_ne_u32_e64 s1, v0, s1
; GFX1100-NEXT:    s_and_b32 vcc_lo, exec_lo, s1
; GFX1100-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1100-NEXT:    s_cbranch_vccnz .LBB4_3
; GFX1100-NEXT:  .LBB4_1: ; %Flow
; GFX1100-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s0
; GFX1100-NEXT:    s_mov_b32 s0, 1
; GFX1100-NEXT:    v_cmp_ne_u32_e64 s0, v4, s0
...
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s0
; GFX1200-NEXT:    s_mov_b32 s0, -1
; GFX1200-NEXT:    s_mov_b32 s1, 1
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_cmp_ne_u32_e64 s1, v0, s1
; GFX1200-NEXT:    s_and_b32 vcc_lo, exec_lo, s1
; GFX1200-NEXT:    ; implicit-def: $vgpr0_vgpr1
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    s_cbranch_vccnz .LBB4_3
; GFX1200-NEXT:  .LBB4_1: ; %Flow
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s0
; GFX1200-NEXT:    s_mov_b32 s0, 1
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_cmp_ne_u32_e64 s0, v4, s0
...
; GFX908-NEXT:    flat_atomic_cmpswap_x2 v[0:1], v[0:1], v[4:7] glc
; GFX908-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX908-NEXT:    v_cmp_eq_u64_e64 s[6:7], v[0:1], v[6:7]
...
; GFX90A-NEXT:    s_mov_b32 s4, 1
; GFX90A-NEXT:    v_cmp_ne_u32_e64 s[4:5], v2, s4
; GFX90A-NEXT:    s_and_b64 vcc, exec, s[4:5]
...
; GFX90A-NEXT:    s_add_u32 s4, s4, global@rel32@lo+4
; GFX90A-NEXT:    s_addc_u32 s5, s5, global@rel32@hi+12
; GFX90A-NEXT:    global_load_dwordx2 v[2:3], v0, s[4:5]
; GFX90A-NEXT:    s_mov_b64 s[4:5], 0
...
; GFX90A-NEXT:    global_atomic_cmpswap_x2 v[0:1], v6, v[0:3], s[6:7] glc
; GFX90A-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NEXT:    v_cmp_eq_u64_e64 s[6:7], v[0:1], v[2:3]
...
; GFX942-NEXT:    s_mov_b32 s0, 1
; GFX942-NEXT:    v_cmp_ne_u32_e64 s[0:1], v2, s0
; GFX942-NEXT:    s_and_b64 vcc, exec, s[0:1]
...
; GFX942-NEXT:    global_atomic_cmpswap_x2 v[0:1], v6, v[0:3], s[2:3] sc0 sc1
; GFX942-NEXT:    s_waitcnt vmcnt(0)
; GFX942-NEXT:    v_cmp_eq_u64_e64 s[2:3], v[0:1], v[2:3]
...
; GFX1100-NEXT:    scratch_load_b64 v[0:1], off, s0
; GFX1100-NEXT:    s_waitcnt vmcnt(0)
; GFX1100-NEXT:    v_add_f64 v[2:3], v[0:1], v[2:3]
; GFX1100-NEXT:    scratch_store_b64 off, v[2:3], s0
...
; GFX1100-NEXT:    v_mov_b32_e32 v0, s0
; GFX1100-NEXT:    v_mov_b32_e32 v1, s1
; GFX1100-NEXT:    flat_load_b64 v[0:1], v[0:1]
; GFX1100-NEXT:    s_mov_b32 s0, 0
...
; GFX1100-NEXT:    ; =>This Inner Loop Header: Depth=1
; GFX1100-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1100-NEXT:    v_mov_b32_e32 v7, v1
; GFX1100-NEXT:    v_mov_b32_e32 v6, v0
; GFX1100-NEXT:    v_add_f64 v[4:5], v[6:7], v[2:3]
; GFX1100-NEXT:    s_getpc_b64 s[2:3]
; GFX1100-NEXT:    s_add_u32 s2, s2, global@rel32@lo+4
; GFX1100-NEXT:    s_addc_u32 s3, s3, global@rel32@hi+12
; GFX1100-NEXT:    v_mov_b32_e32 v0, s2
; GFX1100-NEXT:    v_mov_b32_e32 v1, s3
; GFX1100-NEXT:    flat_atomic_cmpswap_b64 v[0:1], v[0:1], v[4:7] glc
; GFX1100-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX1100-NEXT:    v_cmp_eq_u64_e64 s1, v[0:1], v[6:7]
...
; GFX1200-NEXT:    scratch_load_b64 v[0:1], off, s0
; GFX1200-NEXT:    s_wait_loadcnt 0x0
; GFX1200-NEXT:    v_add_f64_e64 v[2:3], v[0:1], v[2:3]
; GFX1200-NEXT:    scratch_store_b64 off, v[2:3], s0
...
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_mov_b32_e32 v1, s1
; GFX1200-NEXT:    flat_load_b64 v[0:1], v[0:1]
; GFX1200-NEXT:    s_mov_b32 s0, 0
...
; GFX1200-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1200-NEXT:    v_mov_b32_e32 v7, v1
; GFX1200-NEXT:    v_mov_b32_e32 v6, v0
; GFX1200-NEXT:    v_add_f64_e64 v[4:5], v[6:7], v[2:3]
; GFX1200-NEXT:    s_getpc_b64 s[2:3]
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    s_sext_i32_i16 s3, s3
; GFX1200-NEXT:    s_add_co_u32 s2, s2, global@rel32@lo+12
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    s_add_co_ci_u32 s3, s3, global@rel32@hi+24
; GFX1200-NEXT:    v_mov_b32_e32 v0, s2
; GFX1200-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX1200-NEXT:    v_mov_b32_e32 v1, s3
; GFX1200-NEXT:    flat_atomic_cmpswap_b64 v[0:1], v[0:1], v[4:7] th:TH_ATOMIC_RETURN scope:SCOPE_SYS
; GFX1200-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1200-NEXT:    v_cmp_eq_u64_e64 s1, v[0:1], v[6:7]
