...
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[10:11]
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v2
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[10:11]
; CHECK-NEXT:    flat_load_dword v12, v[8:9] offset:16
; CHECK-NEXT:    flat_load_dwordx4 v[4:7], v[8:9]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_add_co_u32_e32 v7, vcc, 20, v10
; CHECK-NEXT:    v_addc_co_u32_e32 v8, vcc, 0, v11, vcc
; CHECK-NEXT:    flat_load_dword v5, v[7:8]
; CHECK-NEXT:    v_ashrrev_i32_e32 v0, v4, v1
; CHECK-NEXT:    v_ashrrev_i32_e32 v2, v6, v3
; CHECK-NEXT:    v_mov_b32_e32 v1, -1
; CHECK-NEXT:    v_mov_b32_e32 v3, -1
...
; CHECK-NEXT:    v_mov_b32_e32 v18, v1
; CHECK-NEXT:    v_mov_b32_e32 v17, v0
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[15:16]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_load_dwordx4 v[3:6], v[17:18]
; CHECK-NEXT:    flat_load_dwordx4 v[7:10], v[17:18] offset:16
; CHECK-NEXT:    flat_load_dwordx4 v[11:14], v[15:16] offset:16
; CHECK-NEXT:    v_mov_b32_e32 v1, -1
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v3, -1
; CHECK-NEXT:    v_mov_b32_e32 v5, -1
; CHECK-NEXT:    v_mov_b32_e32 v7, -1
; CHECK-NEXT:    v_ashrrev_i32_e32 v0, v0, v4
; CHECK-NEXT:    v_ashrrev_i32_e32 v2, v2, v6
; CHECK-NEXT:    v_ashrrev_i32_e32 v4, v11, v8
; CHECK-NEXT:    v_ashrrev_i32_e32 v6, v13, v10
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[7:8]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_load_dwordx4 v[3:6], v[9:10]
; CHECK-NEXT:    flat_load_dwordx2 v[11:12], v[9:10] offset:16
; CHECK-NEXT:    flat_load_dword v13, v[7:8] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_ashrrev_i64 v[0:1], v0, v[3:4]
; CHECK-NEXT:    v_ashrrev_i64 v[2:3], v2, v[5:6]
; CHECK-NEXT:    v_ashrrev_i64 v[4:5], v13, v[11:12]
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    v_ashrrev_i64 v[0:1], v0, v[3:4]
; CHECK-NEXT:    v_ashrrev_i64 v[2:3], v2, v[5:6]
; CHECK-NEXT:    v_ashrrev_i64 v[4:5], v11, v[7:8]
; CHECK-NEXT:    v_ashrrev_i64 v[6:7], v13, v[9:10]
; CHECK-NEXT:    s_setpc_b64 s[30:31]
