...
; CHECK-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_mov_b32_e32 v2, v4
; CHECK-NEXT:    v_add_co_u32_e32 v4, vcc, -1, v0
; CHECK-NEXT:    v_mov_b32_e32 v3, v5
; CHECK-NEXT:    v_addc_co_u32_e32 v5, vcc, -1, v1, vcc
; CHECK-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; CHECK-NEXT:    flat_store_dwordx2 v[2:3], v[4:5]
; CHECK-NEXT:    v_cndmask_b32_e64 v1, 0, -1, vcc
; CHECK-NEXT:    v_mov_b32_e32 v0, v1
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
