...
; GISEL11-LABEL: set_inactive_chain_arg:
; GISEL11:       ; %bb.0:
; GISEL11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL11-NEXT:    v_mov_b32_e32 v1, v8
; GISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; GISEL11-NEXT:    v_mov_b32_e32 v0, v10
; GISEL11-NEXT:    s_mov_b32 exec_lo, s0
; GISEL11-NEXT:    v_mov_b32_e32 v2, v9
; GISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; GISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instid1(SALU_CYCLE_1)
; GISEL11-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s0
; GISEL11-NEXT:    s_mov_b32 exec_lo, s0
; GISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL11-NEXT:    v_mov_b32_e32 v3, v0
; GISEL11-NEXT:    global_store_b32 v[1:2], v3, off
; GISEL11-NEXT:    s_endpgm
;
; DAGISEL11-LABEL: set_inactive_chain_arg:
; DAGISEL11:       ; %bb.0:
...
; DAGISEL11-NEXT:    v_dual_mov_b32 v2, v9 :: v_dual_mov_b32 v1, v8
; DAGISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; DAGISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instid1(SALU_CYCLE_1)
; DAGISEL11-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s0
; DAGISEL11-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; DAGISEL11-NEXT:    v_mov_b32_e32 v3, v0
; DAGISEL11-NEXT:    global_store_b32 v[1:2], v3, off
; DAGISEL11-NEXT:    s_endpgm
;
; GISEL10-LABEL: set_inactive_chain_arg:
; GISEL10:       ; %bb.0:
; GISEL10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL10-NEXT:    v_mov_b32_e32 v1, v8
...
; GISEL10-NEXT:    s_or_saveexec_b32 s0, -1
; GISEL10-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s0
; GISEL10-NEXT:    s_mov_b32 exec_lo, s0
; GISEL10-NEXT:    v_mov_b32_e32 v3, v0
; GISEL10-NEXT:    global_store_dword v[1:2], v3, off
; GISEL10-NEXT:    s_endpgm
;
; DAGISEL10-LABEL: set_inactive_chain_arg:
; DAGISEL10:       ; %bb.0:
...
; DAGISEL10-NEXT:    v_mov_b32_e32 v1, v8
; DAGISEL10-NEXT:    s_or_saveexec_b32 s0, -1
; DAGISEL10-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s0
; DAGISEL10-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL10-NEXT:    v_mov_b32_e32 v3, v0
; DAGISEL10-NEXT:    global_store_dword v[1:2], v3, off
; DAGISEL10-NEXT:    s_endpgm
;
; GISEL11_W64-LABEL: set_inactive_chain_arg:
; GISEL11_W64:       ; %bb.0:
; GISEL11_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL11_W64-NEXT:    v_mov_b32_e32 v1, v8
; GISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL11_W64-NEXT:    v_mov_b32_e32 v0, v10
; GISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL11_W64-NEXT:    v_mov_b32_e32 v2, v9
; GISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL11_W64-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instid1(SALU_CYCLE_1)
; GISEL11_W64-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s[0:1]
; GISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL11_W64-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GISEL11_W64-NEXT:    v_mov_b32_e32 v3, v0
; GISEL11_W64-NEXT:    global_store_b32 v[1:2], v3, off
; GISEL11_W64-NEXT:    s_endpgm
;
; DAGISEL11_W64-LABEL: set_inactive_chain_arg:
; DAGISEL11_W64:       ; %bb.0:
...
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v2, v9
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v1, v8
; DAGISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
...
; DAGISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v3, v0
; DAGISEL11_W64-NEXT:    global_store_b32 v[1:2], v3, off
; DAGISEL11_W64-NEXT:    s_endpgm
;
; GISEL10_W64-LABEL: set_inactive_chain_arg:
; GISEL10_W64:       ; %bb.0:
; GISEL10_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL10_W64-NEXT:    v_mov_b32_e32 v1, v8
; GISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL10_W64-NEXT:    v_mov_b32_e32 v0, v10
; GISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL10_W64-NEXT:    v_mov_b32_e32 v2, v9
; GISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL10_W64-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s[0:1]
; GISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL10_W64-NEXT:    v_mov_b32_e32 v3, v0
; GISEL10_W64-NEXT:    global_store_dword v[1:2], v3, off
; GISEL10_W64-NEXT:    s_endpgm
;
; DAGISEL10_W64-LABEL: set_inactive_chain_arg:
; DAGISEL10_W64:       ; %bb.0:
...
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v2, v9
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v1, v8
; DAGISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; DAGISEL10_W64-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s[0:1]
; DAGISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v3, v0
; DAGISEL10_W64-NEXT:    global_store_dword v[1:2], v3, off
...
; GISEL11:       ; %bb.0:
; GISEL11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL11-NEXT:    v_mov_b32_e32 v2, v8
; GISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; GISEL11-NEXT:    v_dual_mov_b32 v0, v10 :: v_dual_mov_b32 v1, v11
; GISEL11-NEXT:    s_mov_b32 exec_lo, s0
; GISEL11-NEXT:    v_mov_b32_e32 v3, v9
; GISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; GISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instid1(SALU_CYCLE_1)
...
; GISEL11-NEXT:    v_mov_b32_e32 v4, v0
; GISEL11-NEXT:    v_mov_b32_e32 v5, v1
; GISEL11-NEXT:    global_store_b64 v[2:3], v[4:5], off
; GISEL11-NEXT:    s_endpgm
;
...
; DAGISEL11-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL11-NEXT:    v_dual_mov_b32 v4, v9 :: v_dual_mov_b32 v3, v8
; DAGISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; DAGISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instid1(SALU_CYCLE_1)
; DAGISEL11-NEXT:    v_cndmask_b32_e64 v2, v0, v13, s0
; DAGISEL11-NEXT:    v_cndmask_b32_e64 v1, v1, v12, s0
; DAGISEL11-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_3)
; DAGISEL11-NEXT:    v_mov_b32_e32 v5, v1
; DAGISEL11-NEXT:    v_mov_b32_e32 v6, v2
; DAGISEL11-NEXT:    global_store_b64 v[3:4], v[5:6], off
; DAGISEL11-NEXT:    s_endpgm
;
; GISEL10-LABEL: set_inactive_chain_arg_64:
; GISEL10:       ; %bb.0:
; GISEL10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL10-NEXT:    v_mov_b32_e32 v2, v8
; GISEL10-NEXT:    s_or_saveexec_b32 s0, -1
; GISEL10-NEXT:    v_mov_b32_e32 v0, v10
; GISEL10-NEXT:    v_mov_b32_e32 v1, v11
; GISEL10-NEXT:    s_mov_b32 exec_lo, s0
; GISEL10-NEXT:    v_mov_b32_e32 v3, v9
; GISEL10-NEXT:    s_or_saveexec_b32 s0, -1
; GISEL10-NEXT:    v_cndmask_b32_e64 v0, v0, v12, s0
; GISEL10-NEXT:    v_cndmask_b32_e64 v1, v1, v13, s0
; GISEL10-NEXT:    s_mov_b32 exec_lo, s0
; GISEL10-NEXT:    v_mov_b32_e32 v4, v0
; GISEL10-NEXT:    v_mov_b32_e32 v5, v1
; GISEL10-NEXT:    global_store_dwordx2 v[2:3], v[4:5], off
; GISEL10-NEXT:    s_endpgm
;
...
; DAGISEL10-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL10-NEXT:    v_mov_b32_e32 v4, v9
...
; DAGISEL10-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL10-NEXT:    v_mov_b32_e32 v5, v1
; DAGISEL10-NEXT:    v_mov_b32_e32 v6, v2
; DAGISEL10-NEXT:    global_store_dwordx2 v[3:4], v[5:6], off
; DAGISEL10-NEXT:    s_endpgm
;
; GISEL11_W64-LABEL: set_inactive_chain_arg_64:
; GISEL11_W64:       ; %bb.0:
; GISEL11_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL11_W64-NEXT:    v_mov_b32_e32 v2, v8
; GISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL11_W64-NEXT:    v_mov_b32_e32 v0, v10
; GISEL11_W64-NEXT:    v_mov_b32_e32 v1, v11
; GISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL11_W64-NEXT:    v_mov_b32_e32 v3, v9
; GISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL11_W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)
; GISEL11_W64-NEXT:    v_cndmask_b32_e64 v0, v0, v12, s[0:1]
; GISEL11_W64-NEXT:    v_cndmask_b32_e64 v1, v1, v13, s[0:1]
; GISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL11_W64-NEXT:    v_mov_b32_e32 v4, v0
; GISEL11_W64-NEXT:    s_delay_alu instid0(VALU_DEP_2)
; GISEL11_W64-NEXT:    v_mov_b32_e32 v5, v1
; GISEL11_W64-NEXT:    global_store_b64 v[2:3], v[4:5], off
; GISEL11_W64-NEXT:    s_endpgm
;
...
; DAGISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v4, v9
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v3, v8
; DAGISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; DAGISEL11_W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)
; DAGISEL11_W64-NEXT:    v_cndmask_b32_e64 v2, v0, v13, s[0:1]
; DAGISEL11_W64-NEXT:    v_cndmask_b32_e64 v1, v1, v12, s[0:1]
; DAGISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v5, v1
; DAGISEL11_W64-NEXT:    s_delay_alu instid0(VALU_DEP_3)
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v6, v2
; DAGISEL11_W64-NEXT:    global_store_b64 v[3:4], v[5:6], off
; DAGISEL11_W64-NEXT:    s_endpgm
;
; GISEL10_W64-LABEL: set_inactive_chain_arg_64:
; GISEL10_W64:       ; %bb.0:
; GISEL10_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL10_W64-NEXT:    v_mov_b32_e32 v2, v8
; GISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL10_W64-NEXT:    v_mov_b32_e32 v0, v10
; GISEL10_W64-NEXT:    v_mov_b32_e32 v1, v11
; GISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL10_W64-NEXT:    v_mov_b32_e32 v3, v9
; GISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; GISEL10_W64-NEXT:    v_cndmask_b32_e64 v0, v0, v12, s[0:1]
; GISEL10_W64-NEXT:    v_cndmask_b32_e64 v1, v1, v13, s[0:1]
; GISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL10_W64-NEXT:    v_mov_b32_e32 v4, v0
; GISEL10_W64-NEXT:    v_mov_b32_e32 v5, v1
; GISEL10_W64-NEXT:    global_store_dwordx2 v[2:3], v[4:5], off
; GISEL10_W64-NEXT:    s_endpgm
;
...
; DAGISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v4, v9
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v3, v8
; DAGISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; DAGISEL10_W64-NEXT:    v_cndmask_b32_e64 v2, v0, v13, s[0:1]
; DAGISEL10_W64-NEXT:    v_cndmask_b32_e64 v1, v1, v12, s[0:1]
; DAGISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v5, v1
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v6, v2
; DAGISEL10_W64-NEXT:    global_store_dwordx2 v[3:4], v[5:6], off
; DAGISEL10_W64-NEXT:    s_endpgm
...
; GISEL11-LABEL: set_inactive_chain_arg_dpp:
; GISEL11:       ; %bb.0:
; GISEL11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL11-NEXT:    v_mov_b32_e32 v2, v8
; GISEL11-NEXT:    s_or_saveexec_b32 s0, -1
...
; GISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instid1(SALU_CYCLE_1)
; GISEL11-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s0
; GISEL11-NEXT:    v_mov_b32_e32 v1, 0
; GISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GISEL11-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; GISEL11-NEXT:    s_mov_b32 exec_lo, s0
; GISEL11-NEXT:    v_mov_b32_e32 v4, v1
; GISEL11-NEXT:    global_store_b32 v[2:3], v4, off
; GISEL11-NEXT:    s_endpgm
;
; DAGISEL11-LABEL: set_inactive_chain_arg_dpp:
; DAGISEL11:       ; %bb.0:
; DAGISEL11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAGISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; DAGISEL11-NEXT:    v_mov_b32_e32 v0, v10
; DAGISEL11-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL11-NEXT:    v_dual_mov_b32 v3, v9 :: v_dual_mov_b32 v2, v8
; DAGISEL11-NEXT:    s_or_saveexec_b32 s0, -1
; DAGISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instid1(SALU_CYCLE_1)
; DAGISEL11-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s0
; DAGISEL11-NEXT:    v_mov_b32_e32 v1, 0
; DAGISEL11-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; DAGISEL11-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; DAGISEL11-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL11-NEXT:    v_mov_b32_e32 v4, v1
; DAGISEL11-NEXT:    global_store_b32 v[2:3], v4, off
; DAGISEL11-NEXT:    s_endpgm
;
; GISEL10-LABEL: set_inactive_chain_arg_dpp:
; GISEL10:       ; %bb.0:
; GISEL10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL10-NEXT:    v_mov_b32_e32 v2, v8
; GISEL10-NEXT:    s_or_saveexec_b32 s0, -1
...
; GISEL10-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; GISEL10-NEXT:    s_mov_b32 exec_lo, s0
; GISEL10-NEXT:    v_mov_b32_e32 v4, v1
; GISEL10-NEXT:    global_store_dword v[2:3], v4, off
; GISEL10-NEXT:    s_endpgm
;
; DAGISEL10-LABEL: set_inactive_chain_arg_dpp:
; DAGISEL10:       ; %bb.0:
; DAGISEL10-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAGISEL10-NEXT:    s_or_saveexec_b32 s0, -1
; DAGISEL10-NEXT:    v_mov_b32_e32 v0, v10
...
; DAGISEL10-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; DAGISEL10-NEXT:    s_mov_b32 exec_lo, s0
; DAGISEL10-NEXT:    v_mov_b32_e32 v4, v1
; DAGISEL10-NEXT:    global_store_dword v[2:3], v4, off
; DAGISEL10-NEXT:    s_endpgm
;
; GISEL11_W64-LABEL: set_inactive_chain_arg_dpp:
; GISEL11_W64:       ; %bb.0:
; GISEL11_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL11_W64-NEXT:    v_mov_b32_e32 v2, v8
; GISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
...
; GISEL11_W64-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; GISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL11_W64-NEXT:    v_mov_b32_e32 v4, v1
; GISEL11_W64-NEXT:    global_store_b32 v[2:3], v4, off
; GISEL11_W64-NEXT:    s_endpgm
;
; DAGISEL11_W64-LABEL: set_inactive_chain_arg_dpp:
; DAGISEL11_W64:       ; %bb.0:
; DAGISEL11_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAGISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v0, v10
; DAGISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v3, v9
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v2, v8
; DAGISEL11_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; DAGISEL11_W64-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; DAGISEL11_W64-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s[0:1]
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v1, 0
; DAGISEL11_W64-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; DAGISEL11_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL11_W64-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; DAGISEL11_W64-NEXT:    v_mov_b32_e32 v4, v1
; DAGISEL11_W64-NEXT:    global_store_b32 v[2:3], v4, off
; DAGISEL11_W64-NEXT:    s_endpgm
;
; GISEL10_W64-LABEL: set_inactive_chain_arg_dpp:
; GISEL10_W64:       ; %bb.0:
; GISEL10_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GISEL10_W64-NEXT:    v_mov_b32_e32 v2, v8
; GISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
...
; GISEL10_W64-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; GISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; GISEL10_W64-NEXT:    v_mov_b32_e32 v4, v1
; GISEL10_W64-NEXT:    global_store_dword v[2:3], v4, off
; GISEL10_W64-NEXT:    s_endpgm
;
; DAGISEL10_W64-LABEL: set_inactive_chain_arg_dpp:
; DAGISEL10_W64:       ; %bb.0:
; DAGISEL10_W64-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; DAGISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v0, v10
; DAGISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v3, v9
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v2, v8
; DAGISEL10_W64-NEXT:    s_or_saveexec_b64 s[0:1], -1
; DAGISEL10_W64-NEXT:    v_cndmask_b32_e64 v0, v0, v11, s[0:1]
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v1, 0
; DAGISEL10_W64-NEXT:    v_mov_b32_dpp v1, v0 row_xmask:1 row_mask:0xf bank_mask:0xf
; DAGISEL10_W64-NEXT:    s_mov_b64 exec, s[0:1]
; DAGISEL10_W64-NEXT:    v_mov_b32_e32 v4, v1
; DAGISEL10_W64-NEXT:    global_store_dword v[2:3], v4, off
; DAGISEL10_W64-NEXT:    s_endpgm
  %tmp = call i32 @llvm.amdgcn.set.inactive.chain.arg.i32(i32 %active, i32 %inactive) #0
