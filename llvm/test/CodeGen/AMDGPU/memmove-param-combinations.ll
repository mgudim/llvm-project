...
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[2:3]
...
; CHECK-NEXT:    flat_load_dwordx3 v[4:6], v[2:3] offset:16
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[2:3]
; CHECK-NEXT:    s_waitcnt vmcnt(3) lgkmcnt(3)
; CHECK-NEXT:    flat_store_byte v[7:8], v9 offset:30
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(3)
; CHECK-NEXT:    flat_store_short v[7:8], v10 offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(3)
; CHECK-NEXT:    flat_store_dwordx3 v[7:8], v[4:6] offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(3)
; CHECK-NEXT:    flat_store_dwordx4 v[7:8], v[0:3]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    flat_load_dword v8, v[4:5] offset:16
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[4:5]
; CHECK-NEXT:    flat_load_ushort v10, v[4:5] offset:28
; CHECK-NEXT:    flat_load_dword v9, v[4:5] offset:24
; CHECK-NEXT:    flat_load_ubyte v11, v[4:5] offset:30
; CHECK-NEXT:    s_waitcnt vmcnt(4) lgkmcnt(4)
; CHECK-NEXT:    flat_store_dword v[6:7], v8 offset:16
; CHECK-NEXT:    flat_load_dword v8, v[4:5] offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(2)
; CHECK-NEXT:    flat_store_byte v[6:7], v11 offset:30
; CHECK-NEXT:    flat_store_short v[6:7], v10 offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(2)
; CHECK-NEXT:    flat_store_dwordx2 v[6:7], v[8:9] offset:20
; CHECK-NEXT:    flat_store_dwordx4 v[6:7], v[0:3]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    v_mov_b32_e32 v6, v0
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    flat_load_ubyte v8, v[4:5] offset:30
; CHECK-NEXT:    flat_load_dword v9, v[4:5] offset:16
; CHECK-NEXT:    flat_load_ushort v10, v[4:5] offset:28
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[4:5]
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(2)
; CHECK-NEXT:    flat_store_dword v[6:7], v9 offset:16
; CHECK-NEXT:    flat_load_dword v9, v[4:5] offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_store_dword v[6:7], v9 offset:20
; CHECK-NEXT:    flat_load_dword v4, v[4:5] offset:24
; CHECK-NEXT:    flat_store_byte v[6:7], v8 offset:30
; CHECK-NEXT:    flat_store_short v[6:7], v10 offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(2)
; CHECK-NEXT:    flat_store_dword v[6:7], v4 offset:24
; CHECK-NEXT:    flat_store_dwordx4 v[6:7], v[0:3]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    v_mov_b32_e32 v4, v0
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[2:3], off
...
; CHECK-NEXT:    global_load_dwordx3 v[4:6], v[2:3], off offset:16
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[2:3], off
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v0
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off offset:16
...
; CHECK-NEXT:    v_mov_b32_e32 v6, v0
; CHECK-NEXT:    s_clause 0x4
; CHECK-NEXT:    global_load_dword v8, v[4:5], off offset:16
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off
; CHECK-NEXT:    global_load_ushort v10, v[4:5], off offset:28
; CHECK-NEXT:    global_load_dword v9, v[4:5], off offset:24
; CHECK-NEXT:    global_load_ubyte v11, v[4:5], off offset:30
; CHECK-NEXT:    s_waitcnt vmcnt(4)
; CHECK-NEXT:    flat_store_dword v[6:7], v8 offset:16
; CHECK-NEXT:    global_load_dword v8, v[4:5], off offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    flat_store_byte v[6:7], v11 offset:30
; CHECK-NEXT:    flat_store_short v[6:7], v10 offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    v_mov_b32_e32 v6, v0
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    global_load_ubyte v8, v[4:5], off offset:30
; CHECK-NEXT:    global_load_dword v9, v[4:5], off offset:16
; CHECK-NEXT:    global_load_ushort v10, v[4:5], off offset:28
; CHECK-NEXT:    global_load_dwordx4 v[0:3], v[4:5], off
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    flat_store_dword v[6:7], v9 offset:16
; CHECK-NEXT:    global_load_dword v9, v[4:5], off offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dword v[6:7], v9 offset:20
; CHECK-NEXT:    global_load_dword v4, v[4:5], off offset:24
; CHECK-NEXT:    flat_store_byte v[6:7], v8 offset:30
; CHECK-NEXT:    flat_store_short v[6:7], v10 offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    flat_store_dword v[6:7], v4 offset:24
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    v_mov_b32_e32 v4, v0
; CHECK-NEXT:    ds_read_b128 v[0:3], v2
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v1
; CHECK-NEXT:    v_mov_b32_e32 v7, v0
; CHECK-NEXT:    ds_read_b32 v6, v2 offset:24
; CHECK-NEXT:    ds_read_u8 v9, v2 offset:30
; CHECK-NEXT:    ds_read_u16 v10, v2 offset:28
; CHECK-NEXT:    ds_read_b64 v[4:5], v2 offset:16
; CHECK-NEXT:    ds_read_b128 v[0:3], v2
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    v_mov_b32_e32 v4, v0
; CHECK-NEXT:    ds_read2_b64 v[0:3], v2 offset1:1
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v1
; CHECK-NEXT:    v_mov_b32_e32 v7, v0
; CHECK-NEXT:    ds_read2_b32 v[4:5], v2 offset0:4 offset1:5
; CHECK-NEXT:    ds_read_b32 v6, v2 offset:24
; CHECK-NEXT:    ds_read_u8 v9, v2 offset:30
; CHECK-NEXT:    ds_read_u16 v10, v2 offset:28
; CHECK-NEXT:    ds_read2_b64 v[0:3], v2 offset1:1
...
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[2:3]
; CHECK-NEXT:    s_waitcnt vmcnt(3) lgkmcnt(3)
; CHECK-NEXT:    global_store_byte v[7:8], v9, off offset:30
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(2)
; CHECK-NEXT:    global_store_short v[7:8], v10, off offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    global_store_dwordx3 v[7:8], v[4:6], off offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx4 v[7:8], v[0:3], off
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    flat_load_dwordx4 v[4:7], v[4:5]
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    global_store_dwordx4 v[8:9], v[0:3], off offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
...
; CHECK-NEXT:    flat_load_ubyte v11, v[4:5] offset:30
; CHECK-NEXT:    s_waitcnt vmcnt(4) lgkmcnt(4)
; CHECK-NEXT:    global_store_dword v[6:7], v8, off offset:16
; CHECK-NEXT:    flat_load_dword v8, v[4:5] offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(1) lgkmcnt(1)
; CHECK-NEXT:    global_store_byte v[6:7], v11, off offset:30
; CHECK-NEXT:    global_store_short v[6:7], v10, off offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dwordx2 v[6:7], v[8:9], off offset:20
...
; CHECK-NEXT:    flat_load_dwordx4 v[0:3], v[4:5]
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(2)
; CHECK-NEXT:    global_store_dword v[6:7], v9, off offset:16
; CHECK-NEXT:    flat_load_dword v9, v[4:5] offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dword v[6:7], v9, off offset:20
; CHECK-NEXT:    flat_load_dword v4, v[4:5] offset:24
; CHECK-NEXT:    global_store_byte v[6:7], v8, off offset:30
; CHECK-NEXT:    global_store_short v[6:7], v10, off offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    global_store_dword v[6:7], v4, off offset:24
; CHECK-NEXT:    global_store_dwordx4 v[6:7], v[0:3], off
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    buffer_load_dword v0, v2, s[0:3], 0 offen offset:16
; CHECK-NEXT:    buffer_load_dword v1, v2, s[0:3], 0 offen offset:20
; CHECK-NEXT:    buffer_load_dword v2, v2, s[0:3], 0 offen offset:24
; CHECK-NEXT:    s_waitcnt vmcnt(3)
; CHECK-NEXT:    global_store_short v[7:8], v10, off offset:28
; CHECK-NEXT:    global_store_byte v[7:8], v9, off offset:30
; CHECK-NEXT:    global_store_dwordx4 v[7:8], v[3:6], off
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    global_store_dwordx3 v[7:8], v[0:2], off offset:16
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[5:6] offset:16
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v1
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[8:9]
; CHECK-NEXT:    flat_load_dwordx3 v[5:7], v[8:9] offset:16
; CHECK-NEXT:    flat_load_ubyte v10, v[8:9] offset:30
; CHECK-NEXT:    flat_load_ushort v8, v[8:9] offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(3) lgkmcnt(3)
; CHECK-NEXT:    ds_write2_b64 v0, v[1:2], v[3:4] offset1:1
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(3)
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    flat_load_ubyte v7, v[5:6] offset:30
; CHECK-NEXT:    flat_load_dword v8, v[5:6] offset:16
; CHECK-NEXT:    flat_load_ushort v9, v[5:6] offset:28
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[5:6]
; CHECK-NEXT:    s_waitcnt vmcnt(2) lgkmcnt(2)
; CHECK-NEXT:    ds_write_b32 v0, v8 offset:16
; CHECK-NEXT:    flat_load_dword v8, v[5:6] offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    ds_write_b32 v0, v8 offset:20
; CHECK-NEXT:    flat_load_dword v5, v[5:6] offset:24
; CHECK-NEXT:    ds_write_b8 v0, v7 offset:30
; CHECK-NEXT:    ds_write_b16 v0, v9 offset:28
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(2)
; CHECK-NEXT:    ds_write_b32 v0, v5 offset:24
; CHECK-NEXT:    ds_write_b128 v0, v[1:4]
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; CHECK-NEXT:    v_mov_b32_e32 v8, v1
; CHECK-NEXT:    s_clause 0x3
; CHECK-NEXT:    global_load_dwordx4 v[1:4], v[8:9], off
; CHECK-NEXT:    global_load_dwordx3 v[5:7], v[8:9], off offset:16
; CHECK-NEXT:    global_load_ushort v10, v[8:9], off offset:28
; CHECK-NEXT:    global_load_ubyte v8, v[8:9], off offset:30
; CHECK-NEXT:    s_waitcnt vmcnt(3)
; CHECK-NEXT:    ds_write2_b64 v0, v[1:2], v[3:4] offset1:1
; CHECK-NEXT:    s_waitcnt vmcnt(2)
; CHECK-NEXT:    ds_write_b64 v0, v[5:6] offset:16
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    s_clause 0x1
; CHECK-NEXT:    global_load_dwordx4 v[1:4], v[5:6], off
; CHECK-NEXT:    global_load_dwordx4 v[5:8], v[5:6], off offset:16
; CHECK-NEXT:    s_waitcnt vmcnt(1)
; CHECK-NEXT:    ds_write2_b64 v0, v[1:2], v[3:4] offset1:1
; CHECK-NEXT:    s_waitcnt vmcnt(0)
...
; CHECK-NEXT:    v_mov_b32_e32 v5, v1
; CHECK-NEXT:    s_clause 0x4
; CHECK-NEXT:    flat_load_dword v7, v[5:6] offset:16
; CHECK-NEXT:    flat_load_dword v8, v[5:6] offset:24
; CHECK-NEXT:    flat_load_ubyte v9, v[5:6] offset:30
; CHECK-NEXT:    flat_load_ushort v10, v[5:6] offset:28
; CHECK-NEXT:    flat_load_dwordx4 v[1:4], v[5:6]
; CHECK-NEXT:    s_waitcnt vmcnt(4) lgkmcnt(4)
; CHECK-NEXT:    buffer_store_dword v7, v0, s[0:3], 0 offen offset:16
; CHECK-NEXT:    flat_load_dword v5, v[5:6] offset:20
; CHECK-NEXT:    s_waitcnt vmcnt(4) lgkmcnt(4)
