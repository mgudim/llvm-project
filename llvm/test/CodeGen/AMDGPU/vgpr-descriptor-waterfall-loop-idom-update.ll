...
; GCN-NEXT:    v_add_co_u32 v6, vcc_lo, v4, 8
; GCN-NEXT:    v_add_co_ci_u32_e32 v7, vcc_lo, 0, v5, vcc_lo
; GCN-NEXT:  .LBB0_1: ; %bb0
; GCN-NEXT:    ; =>This Loop Header: Depth=1
; GCN-NEXT:    ; Child Loop BB0_2 Depth 2
; GCN-NEXT:    s_clause 0x1
; GCN-NEXT:    flat_load_dwordx2 v[2:3], v[6:7]
; GCN-NEXT:    flat_load_dwordx2 v[0:1], v[4:5]
...
; GCN-NEXT:    v_cmp_eq_u64_e32 vcc_lo, s[8:9], v[0:1]
...
; GFX11-NEXT:    flat_load_b128 v[0:3], v[4:5]
