...
; CHECK-NEXT:    flat_load_dword v0, v[10:11] offset:16
...
; CHECK-NEXT:    flat_load_dwordx4 v[8:11], v[15:16]
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    flat_load_dwordx4 v[11:14], v[15:16] offset:16
; CHECK-NEXT:    ; kill: killed $vgpr15 killed $vgpr16
; CHECK-NEXT:    v_lshrrev_b32_e32 v0, v8, v1
; CHECK-NEXT:    v_lshrrev_b32_e32 v2, v10, v3
; CHECK-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; CHECK-NEXT:    v_lshrrev_b32_e32 v4, v11, v5
; CHECK-NEXT:    v_lshrrev_b32_e32 v6, v13, v7
; CHECK-NEXT:    v_mov_b32_e32 v1, 0
; CHECK-NEXT:    v_mov_b32_e32 v3, 0
; CHECK-NEXT:    v_mov_b32_e32 v5, 0
...
; CHECK-NEXT:    s_lshr_b64 s[4:5], s[4:5], s6
...
; CHECK-NEXT:    s_lshr_b64 s[6:7], s[6:7], s9
; CHECK-NEXT:    s_lshr_b64 s[4:5], s[4:5], s8
...
; CHECK-NEXT:    s_lshr_b64 s[8:9], s[8:9], s12
; CHECK-NEXT:    s_lshr_b64 s[6:7], s[6:7], s11
; CHECK-NEXT:    s_lshr_b64 s[4:5], s[4:5], s10
...
; CHECK-NEXT:    s_lshr_b64 s[10:11], s[10:11], s15
; CHECK-NEXT:    s_lshr_b64 s[8:9], s[8:9], s14
; CHECK-NEXT:    s_lshr_b64 s[6:7], s[6:7], s13
; CHECK-NEXT:    s_lshr_b64 s[4:5], s[4:5], s12
