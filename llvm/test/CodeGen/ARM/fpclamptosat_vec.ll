...
; CHECK-NEXT:    rsbs r7, r7, #-2147483648
; CHECK-NEXT:    sbcs r7, r0, r5
...
; CHECK-NEXT:    vmov r0, r1, d9
; CHECK-NEXT:    vbsl q8, q6, q5
; CHECK-NEXT:    rsbs r7, r10, #0
; CHECK-NEXT:    rscs r7, r8, #0
; CHECK-NEXT:    mov r7, #0
...
; CHECK-NEON-NEXT:    bl __aeabi_h2f
; CHECK-NEON-NEXT:    vdup.32 d10, r6
; CHECK-NEON-NEXT:    bl __aeabi_f2lz
...
; CHECK-NEON-NEXT:    mvnne r6, #0
; CHECK-NEON-NEXT:    vmov r7, r5, d11
; CHECK-NEON-NEXT:    bl __aeabi_h2f
; CHECK-NEON-NEXT:    bl __aeabi_f2lz
...
; CHECK-FP16-NEXT:    vmov.32 d9[1], r7
...
; CHECK-FP16-NEXT:    sbcs r7, r0, r6
; CHECK-FP16-NEXT:    vmov r6, r5, d16
...
; CHECK-FP16-NEXT:    rsbs r2, r6, #-2147483648
; CHECK-FP16-NEXT:    sbcs r0, r0, r5
...
; CHECK-FP16-NEXT:    .vsave {d8, d9, d10, d11, d12}
; CHECK-FP16-NEXT:    vpush {d8, d9, d10, d11, d12}
; CHECK-FP16-NEXT:    vmov.u16 r0, d0[3]
; CHECK-FP16-NEXT:    vorr d12, d0, d0
; CHECK-FP16-NEXT:    vmov.u16 r4, d0[1]
; CHECK-FP16-NEXT:    vmov s0, r0
; CHECK-FP16-NEXT:    bl __fixunshfdi
; CHECK-FP16-NEXT:    mov r6, r0
; CHECK-FP16-NEXT:    vmov.u16 r0, d12[0]
; CHECK-FP16-NEXT:    mov r7, r1
; CHECK-FP16-NEXT:    vmov.32 d9[0], r6
; CHECK-FP16-NEXT:    vmov s0, r0
; CHECK-FP16-NEXT:    bl __fixunshfdi
...
; CHECK-FP16-NEXT:    vmov.u16 r0, d12[2]
...
; CHECK-FP16-NEXT:    vmovn.i64 d0, q8
; CHECK-FP16-NEXT:    vpop {d8, d9, d10, d11, d12}
...
; CHECK-NEON-NEXT:    subs r2, r2, r9
; CHECK-NEON-NEXT:    vmov r6, s20
; CHECK-NEON-NEXT:    vmov.32 d16[0], r7
...
; CHECK-NEON-NEXT:    cmp r1, #0
; CHECK-NEON-NEXT:    mvnne r1, #0
; CHECK-NEON-NEXT:    subs r2, r7, r9
; CHECK-NEON-NEXT:    sbcs r2, r5, #0
; CHECK-NEON-NEXT:    vdup.32 d19, r1
; CHECK-NEON-NEXT:    mov r2, #0
; CHECK-NEON-NEXT:    vmov.32 d16[1], r5
...
; CHECK-NEON-NEXT:    vmov r10, r8, d8
; CHECK-NEON-NEXT:    bl __aeabi_h2f
; CHECK-NEON-NEXT:    bl __aeabi_f2lz
...
; CHECK-NEON-NEXT:    mov r2, #0
; CHECK-NEON-NEXT:    vmov.32 d13[1], r7
; CHECK-NEON-NEXT:    movwlt r2, #1
; CHECK-NEON-NEXT:    cmp r2, #0
; CHECK-NEON-NEXT:    mvnne r2, #0
; CHECK-NEON-NEXT:    subs r0, r0, r9
...
; CHECK-NEON-NEXT:    rsbs r7, r10, #0
; CHECK-NEON-NEXT:    rscs r7, r8, #0
; CHECK-NEON-NEXT:    mov r7, #0
...
; CHECK-FP16-NEXT:    vmov.32 d9[0], r7
; CHECK-FP16-NEXT:    vmov s0, r0
; CHECK-FP16-NEXT:    bl __fixhfdi
; CHECK-FP16-NEXT:    mvn r5, #0
; CHECK-FP16-NEXT:    subs r2, r7, r5
; CHECK-FP16-NEXT:    sbcs r2, r6, #0
; CHECK-FP16-NEXT:    vmov.32 d8[0], r0
; CHECK-FP16-NEXT:    mov r2, #0
...
; CHECK-FP16-NEXT:    cmp r2, #0
; CHECK-FP16-NEXT:    mvnne r2, #0
; CHECK-FP16-NEXT:    subs r0, r0, r5
; CHECK-FP16-NEXT:    sbcs r0, r1, #0
; CHECK-FP16-NEXT:    vmov.32 d9[1], r6
; CHECK-FP16-NEXT:    mov r0, #0
; CHECK-FP16-NEXT:    vmov s0, r8
; CHECK-FP16-NEXT:    movwlt r0, #1
; CHECK-FP16-NEXT:    cmp r0, #0
...
; CHECK-FP16-NEXT:    vmov.u16 r0, d12[0]
; CHECK-FP16-NEXT:    mov r7, r1
; CHECK-FP16-NEXT:    vmov.32 d13[0], r6
; CHECK-FP16-NEXT:    vmov s0, r0
; CHECK-FP16-NEXT:    bl __fixhfdi
; CHECK-FP16-NEXT:    subs r2, r6, r5
; CHECK-FP16-NEXT:    vmov.32 d12[0], r0
; CHECK-FP16-NEXT:    sbcs r2, r7, #0
; CHECK-FP16-NEXT:    mov r2, #0
; CHECK-FP16-NEXT:    vmov.32 d13[1], r7
; CHECK-FP16-NEXT:    movwlt r2, #1
; CHECK-FP16-NEXT:    cmp r2, #0
; CHECK-FP16-NEXT:    mvnne r2, #0
; CHECK-FP16-NEXT:    subs r0, r0, r5
...
; CHECK-FP16-NEXT:    vdup.32 d18, r4
...
; CHECK-NEON-NEXT:    bl __fixsfti
; CHECK-NEON-NEXT:    subs r6, r0, r9
; CHECK-NEON-NEXT:    vmov.32 d1[0], r7
; CHECK-NEON-NEXT:    sbcs r6, r1, r5
...
; CHECK-NEXT:    mvn r7, #0
; CHECK-NEXT:    vmov r10, s16
; CHECK-NEXT:    mov r8, #0
; CHECK-NEXT:    str r2, [sp, #4] @ 4-byte Spill
; CHECK-NEXT:    subs r2, r11, r5
; CHECK-NEXT:    sbcs r2, r1, #0
; CHECK-NEXT:    mov r2, #0
; CHECK-NEXT:    movge r11, r5
; CHECK-NEXT:    movwlt r2, #1
; CHECK-NEXT:    cmp r2, #0
...
; CHECK-NEXT:    rsbs r0, r9, #-2147483648
; CHECK-NEXT:    vmov.32 d0[0], r6
; CHECK-NEXT:    sbcs r0, r2, r4
; CHECK-NEXT:    movge r9, r1
; CHECK-NEXT:    vmov.32 d1[1], r11
; CHECK-NEXT:    vmov.32 d0[1], r9
...
; CHECK-FP16-NEXT:    bl __fixunshfdi
; CHECK-FP16-NEXT:    mov r4, r1
; CHECK-FP16-NEXT:    vmov.u16 r1, d12[2]
...
; CHECK-FP16-NEXT:    bl __fixunshfdi
; CHECK-FP16-NEXT:    mov r5, r1
; CHECK-FP16-NEXT:    vmov.u16 r1, d12[0]
...
; CHECK-FP16-NEXT:    vmov.32 d11[1], r5
; CHECK-FP16-NEXT:    vmov.32 d9[1], r4
; CHECK-FP16-NEXT:    vmov.32 d10[1], r6
; CHECK-FP16-NEXT:    vmov.32 d8[1], r1
; CHECK-FP16-NEXT:    vqsub.u64 q9, q5, q8
; CHECK-FP16-NEXT:    vqsub.u64 q8, q4, q8
; CHECK-FP16-NEXT:    vsub.i64 q9, q5, q9
; CHECK-FP16-NEXT:    vsub.i64 q8, q4, q8
; CHECK-FP16-NEXT:    vmovn.i64 d1, q9
; CHECK-FP16-NEXT:    vmovn.i64 d0, q8
; CHECK-FP16-NEXT:    vpop {d8, d9, d10, d11, d12}
; CHECK-FP16-NEXT:    pop {r4, r5, r6, pc}
...
; CHECK-NEON-NEXT:    subs r3, r0, r4
; CHECK-NEON-NEXT:    mov r6, #0
; CHECK-NEON-NEXT:    sbcs r3, r1, #0
; CHECK-NEON-NEXT:    vmov r8, s18
; CHECK-NEON-NEXT:    mov r3, #0
; CHECK-NEON-NEXT:    movge r0, r4
; CHECK-NEON-NEXT:    movwlt r3, #1
; CHECK-NEON-NEXT:    cmp r3, #0
