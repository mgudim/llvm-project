...
; LA32-NEXT:    ld.w $a4, $a0, 4
; LA32-NEXT:    ld.w $a5, $a0, 0
...
; LA32-NEXT:    move $a0, $a5
; LA32-NEXT:    move $a1, $a4
...
; LA32-NEXT:    # =>This Inner Loop Header: Depth=1
; LA32-NEXT:    beq $a4, $s0, .LBB11_4
; LA32-NEXT:  # %bb.3: # %atomicrmw.start
; LA32-NEXT:    # in Loop: Header=BB11_2 Depth=1
; LA32-NEXT:    slt $a0, $s0, $a4
; LA32-NEXT:    b .LBB11_5
; LA32-NEXT:    .p2align 4, , 16
