...
; CHECK-NEXT:    sqdmulh { z6.b, z7.b }, { z6.b, z7.b }, { z4.b, z5.b }
...
; CHECK-NEXT:    mov z4.d, z3.d
; CHECK-NEXT:    mov z6.d, z1.d
; CHECK-NEXT:    sqdmulh { z6.h, z7.h }, { z6.h, z7.h }, { z4.h, z5.h }
; CHECK-NEXT:    mov z0.d, z6.d
; CHECK-NEXT:    mov z1.d, z7.d
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    mov z4.d, z3.d
; CHECK-NEXT:    mov z6.d, z1.d
; CHECK-NEXT:    sqdmulh { z6.s, z7.s }, { z6.s, z7.s }, { z4.s, z5.s }
; CHECK-NEXT:    mov z0.d, z6.d
; CHECK-NEXT:    mov z1.d, z7.d
; CHECK-NEXT:    ret
...
; CHECK-NEXT:    mov z4.d, z3.d
; CHECK-NEXT:    mov z6.d, z1.d
; CHECK-NEXT:    sqdmulh { z6.d, z7.d }, { z6.d, z7.d }, { z4.d, z5.d }
; CHECK-NEXT:    mov z0.d, z6.d
; CHECK-NEXT:    mov z1.d, z7.d
; CHECK-NEXT:    ret
