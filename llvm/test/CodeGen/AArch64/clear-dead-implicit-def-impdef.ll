...
; CHECK-NEXT:    mov w25, #4 ; =0x4
; CHECK-NEXT:    stp x25, x25, [sp, #8]
; CHECK-NEXT:    str x25, [sp]
; CHECK-NEXT:    mov x0, #0 ; =0x0
; CHECK-NEXT:    mov w1, #0 ; =0x0
; CHECK-NEXT:    bl __ZL9testScanfPKcjz
; CHECK-NEXT:    stp x25, xzr, [sp]
; CHECK-NEXT:    mov x0, #0 ; =0x0
; CHECK-NEXT:    mov w1, #0 ; =0x0
; CHECK-NEXT:    bl __ZL9testScanfPKcjz
; CHECK-NEXT:    mov w28, #8 ; =0x8
; CHECK-NEXT:    str x28, [sp]
; CHECK-NEXT:    mov x0, #0 ; =0x0
; CHECK-NEXT:    mov w1, #0 ; =0x0
; CHECK-NEXT:    bl __ZL9testScanfPKcjz
; CHECK-NEXT:    mov w24, #1 ; =0x1
; CHECK-NEXT:    stp xzr, x24, [sp]
; CHECK-NEXT:    mov x0, #0 ; =0x0
; CHECK-NEXT:    mov w1, #0 ; =0x0
; CHECK-NEXT:    bl __ZL9testScanfPKcjz
; CHECK-NEXT:    str x24, [sp]
; CHECK-NEXT:    mov x0, #0 ; =0x0
; CHECK-NEXT:    mov w1, #0 ; =0x0
; CHECK-NEXT:    bl __ZL9testScanfPKcjz
; CHECK-NEXT:    str x25, [sp]
; CHECK-NEXT:  Lloh0:
; CHECK-NEXT:    adrp x24, _.str@GOTPAGE
; CHECK-NEXT:  Lloh1:
; CHECK-NEXT:    ldr x24, [x24, _.str@GOTPAGEOFF]
