...
; CHECK-NEXT:    cbnz w9, .LBB0_10
; CHECK-NEXT:  // %bb.5: // %bb7
; CHECK-NEXT:    cbnz w9, .LBB0_9
; CHECK-NEXT:  // %bb.6: // %bb8
; CHECK-NEXT:    mov x8, x21
; CHECK-NEXT:    mov w21, #0 // =0x0
; CHECK-NEXT:    mov w9, w20
; CHECK-NEXT:    mov x20, x9
; CHECK-NEXT:    mov w8, w8
; CHECK-NEXT:    mov x22, x8
; CHECK-NEXT:  .LBB0_7: // %bb10
; CHECK-NEXT:    // =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    strb w21, [x19]
; CHECK-NEXT:    cbnz x20, .LBB0_7
