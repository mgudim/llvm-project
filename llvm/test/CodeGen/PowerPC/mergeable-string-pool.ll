...
; AIX32-NEXT:    addi r3, r31, 44
; AIX32-NEXT:    stw r30, 56(r1) # 4-byte Folded Spill
; AIX32-NEXT:    bl .callee[PR]
; AIX32-NEXT:    nop
; AIX32-NEXT:    mr r30, r3
; AIX32-NEXT:    addi r3, r31, 32
; AIX32-NEXT:    bl .callee[PR]
; AIX32-NEXT:    nop
; AIX32-NEXT:    add r3, r3, r30
...
; AIX64-NEXT:    addi r3, r31, 44
; AIX64-NEXT:    std r30, 112(r1) # 8-byte Folded Spill
; AIX64-NEXT:    bl .callee[PR]
; AIX64-NEXT:    nop
; AIX64-NEXT:    mr r30, r3
; AIX64-NEXT:    addi r3, r31, 32
; AIX64-NEXT:    bl .callee[PR]
; AIX64-NEXT:    nop
; AIX64-NEXT:    add r3, r3, r30
...
; LINUX64BE-NEXT:    addi r3, r30, 44
; LINUX64BE-NEXT:    bl callee
; LINUX64BE-NEXT:    nop
; LINUX64BE-NEXT:    mr r29, r3
; LINUX64BE-NEXT:    addi r3, r30, 32
; LINUX64BE-NEXT:    bl callee
; LINUX64BE-NEXT:    nop
; LINUX64BE-NEXT:    add r3, r3, r29
...
; LINUX64LE-NEXT:    addi r3, r30, 44
; LINUX64LE-NEXT:    bl callee
; LINUX64LE-NEXT:    nop
; LINUX64LE-NEXT:    mr r29, r3
; LINUX64LE-NEXT:    addi r3, r30, 32
; LINUX64LE-NEXT:    bl callee
; LINUX64LE-NEXT:    nop
; LINUX64LE-NEXT:    add r3, r3, r29
...
; AIX32-NEXT:    bl .calleeInt[PR]
; AIX32-NEXT:    nop
; AIX32-NEXT:    add r30, r3, r30
; AIX32-NEXT:    addi r3, r31, 68
; AIX32-NEXT:    bl .callee[PR]
; AIX32-NEXT:    nop
; AIX32-NEXT:    add r30, r30, r3
; AIX32-NEXT:    addi r3, r31, 273
; AIX32-NEXT:    bl .callee[PR]
; AIX32-NEXT:    nop
; AIX32-NEXT:    add r3, r30, r3
...
; AIX64-NEXT:    bl .calleeInt[PR]
; AIX64-NEXT:    nop
; AIX64-NEXT:    add r30, r3, r30
; AIX64-NEXT:    addi r3, r31, 68
; AIX64-NEXT:    bl .callee[PR]
; AIX64-NEXT:    nop
; AIX64-NEXT:    add r30, r30, r3
; AIX64-NEXT:    addi r3, r31, 273
; AIX64-NEXT:    bl .callee[PR]
; AIX64-NEXT:    nop
; AIX64-NEXT:    add r3, r30, r3
...
; LINUX64BE-NEXT:    lxvw4x vs0, r30, r4
; LINUX64BE-NEXT:    stxvw4x vs0, 0, r3
; LINUX64BE-NEXT:    li r3, 296
; LINUX64BE-NEXT:    lxvw4x vs0, r30, r3
; LINUX64BE-NEXT:    addi r3, r1, 112
; LINUX64BE-NEXT:    stxvw4x vs0, 0, r3
; LINUX64BE-NEXT:    bl calleeInt
; LINUX64BE-NEXT:    nop
...
; LINUX64BE-NEXT:    bl calleeInt
; LINUX64BE-NEXT:    nop
; LINUX64BE-NEXT:    add r29, r3, r29
; LINUX64BE-NEXT:    addi r3, r30, 68
; LINUX64BE-NEXT:    bl callee
; LINUX64BE-NEXT:    nop
; LINUX64BE-NEXT:    add r29, r29, r3
; LINUX64BE-NEXT:    addi r3, r30, 273
; LINUX64BE-NEXT:    bl callee
; LINUX64BE-NEXT:    nop
; LINUX64BE-NEXT:    add r3, r29, r3
...
; LINUX64LE-NEXT:    lxvd2x vs0, r30, r4
; LINUX64LE-NEXT:    stxvd2x vs0, 0, r3
; LINUX64LE-NEXT:    li r3, 296
; LINUX64LE-NEXT:    lxvd2x vs0, r30, r3
; LINUX64LE-NEXT:    addi r3, r1, 32
; LINUX64LE-NEXT:    stxvd2x vs0, 0, r3
; LINUX64LE-NEXT:    bl calleeInt
; LINUX64LE-NEXT:    nop
...
; LINUX64LE-NEXT:    bl calleeInt
; LINUX64LE-NEXT:    nop
; LINUX64LE-NEXT:    add r29, r3, r29
; LINUX64LE-NEXT:    addi r3, r30, 68
; LINUX64LE-NEXT:    bl callee
; LINUX64LE-NEXT:    nop
; LINUX64LE-NEXT:    add r29, r29, r3
; LINUX64LE-NEXT:    addi r3, r30, 273
; LINUX64LE-NEXT:    bl callee
; LINUX64LE-NEXT:    nop
; LINUX64LE-NEXT:    add r3, r29, r3
; LINUX64LE-NEXT:    extsw r3, r3
