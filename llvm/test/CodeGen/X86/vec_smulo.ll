...
; SSE2-NEXT:    addq %r13, %rbp
; SSE2-NEXT:    adcq %r12, %r8
...
; SSE2-NEXT:    adcq %r13, %r12
; SSE2-NEXT:    movq %r12, %r13
; SSE2-NEXT:    sarq $63, %r13
; SSE2-NEXT:    addq %r8, %r12
; SSE2-NEXT:    adcq %rcx, %r13
; SSE2-NEXT:    movq %rsi, %rax
; SSE2-NEXT:    imulq %r9
; SSE2-NEXT:    addq %r12, %rax
; SSE2-NEXT:    adcq %r13, %rdx
; SSE2-NEXT:    movq %rdi, 8(%r11)
...
; SSE2-NEXT:    movq %r12, 24(%r11)
; SSE2-NEXT:    sarq $63, %r12
; SSE2-NEXT:    xorq %r12, %rdx
; SSE2-NEXT:    xorq %rax, %r12
; SSE2-NEXT:    xorl %eax, %eax
; SSE2-NEXT:    orq %rdx, %r12
; SSE2-NEXT:    setne %al
; SSE2-NEXT:    negl %eax
...
; SSSE3-NEXT:    addq %r13, %rbp
; SSSE3-NEXT:    adcq %r12, %r8
; SSSE3-NEXT:    movq %r8, %rcx
...
; SSSE3-NEXT:    adcq %r13, %r12
; SSSE3-NEXT:    movq %r12, %r13
; SSSE3-NEXT:    sarq $63, %r13
; SSSE3-NEXT:    addq %r8, %r12
; SSSE3-NEXT:    adcq %rcx, %r13
; SSSE3-NEXT:    movq %rsi, %rax
; SSSE3-NEXT:    imulq %r9
; SSSE3-NEXT:    addq %r12, %rax
; SSSE3-NEXT:    adcq %r13, %rdx
; SSSE3-NEXT:    movq %rdi, 8(%r11)
...
; SSSE3-NEXT:    movq %r10, %rcx
; SSSE3-NEXT:    sarq $63, %rcx
; SSSE3-NEXT:    imulq %r15, %rcx
...
; SSSE3-NEXT:    addq %r8, %r15
; SSSE3-NEXT:    adcq %rcx, %r9
; SSSE3-NEXT:    movq %r9, %rcx
; SSSE3-NEXT:    sarq $63, %rcx
; SSSE3-NEXT:    movq %rbx, %r8
; SSSE3-NEXT:    sarq $63, %r8
; SSSE3-NEXT:    imulq %r14, %r8
; SSSE3-NEXT:    movq %r14, %rax
; SSSE3-NEXT:    mulq %rbx
; SSSE3-NEXT:    movq %rdx, %r14
; SSSE3-NEXT:    movq %rax, %r12
; SSSE3-NEXT:    addq %r15, %r12
; SSSE3-NEXT:    adcq %r8, %r14
; SSSE3-NEXT:    movq %r14, %r8
; SSSE3-NEXT:    sarq $63, %r8
; SSSE3-NEXT:    addq %r9, %r14
; SSSE3-NEXT:    adcq %rcx, %r8
; SSSE3-NEXT:    movq %r10, %rax
; SSSE3-NEXT:    imulq %rbx
; SSSE3-NEXT:    addq %r14, %rax
; SSSE3-NEXT:    adcq %r8, %rdx
; SSSE3-NEXT:    movq %r12, 24(%r11)
; SSSE3-NEXT:    sarq $63, %r12
; SSSE3-NEXT:    xorq %r12, %rdx
; SSSE3-NEXT:    xorq %rax, %r12
; SSSE3-NEXT:    xorl %eax, %eax
; SSSE3-NEXT:    orq %rdx, %r12
; SSSE3-NEXT:    setne %al
; SSSE3-NEXT:    negl %eax
...
; SSE41-NEXT:    addq %r13, %rbp
; SSE41-NEXT:    adcq %r12, %r8
; SSE41-NEXT:    movq %r8, %rcx
...
; SSE41-NEXT:    adcq %r13, %r12
; SSE41-NEXT:    movq %r12, %r13
; SSE41-NEXT:    sarq $63, %r13
; SSE41-NEXT:    addq %r8, %r12
; SSE41-NEXT:    adcq %rcx, %r13
; SSE41-NEXT:    movq %rsi, %rax
; SSE41-NEXT:    imulq %r9
; SSE41-NEXT:    addq %r12, %rax
; SSE41-NEXT:    adcq %r13, %rdx
; SSE41-NEXT:    movq %rdi, 8(%r11)
...
; SSE41-NEXT:    movq %r10, %rcx
; SSE41-NEXT:    sarq $63, %rcx
; SSE41-NEXT:    imulq %r15, %rcx
...
; SSE41-NEXT:    addq %r8, %r15
; SSE41-NEXT:    adcq %rcx, %r9
; SSE41-NEXT:    movq %r9, %rcx
; SSE41-NEXT:    sarq $63, %rcx
; SSE41-NEXT:    movq %rbx, %r8
; SSE41-NEXT:    sarq $63, %r8
; SSE41-NEXT:    imulq %r14, %r8
; SSE41-NEXT:    movq %r14, %rax
; SSE41-NEXT:    mulq %rbx
; SSE41-NEXT:    movq %rdx, %r14
...
; SSE41-NEXT:    movq %r14, %r8
; SSE41-NEXT:    sarq $63, %r8
; SSE41-NEXT:    addq %r9, %r14
; SSE41-NEXT:    adcq %rcx, %r8
; SSE41-NEXT:    movq %r10, %rax
; SSE41-NEXT:    imulq %rbx
; SSE41-NEXT:    addq %r14, %rax
; SSE41-NEXT:    adcq %r8, %rdx
; SSE41-NEXT:    movq %r12, 24(%r11)
; SSE41-NEXT:    sarq $63, %r12
; SSE41-NEXT:    xorq %r12, %rdx
; SSE41-NEXT:    xorq %rax, %r12
; SSE41-NEXT:    xorl %eax, %eax
; SSE41-NEXT:    orq %rdx, %r12
; SSE41-NEXT:    setne %al
; SSE41-NEXT:    negl %eax
; SSE41-NEXT:    negl %esi
; SSE41-NEXT:    movd %esi, %xmm0
; SSE41-NEXT:    pinsrd $1, %eax, %xmm0
; SSE41-NEXT:    movq %rdi, 16(%r11)
...
; AVX-NEXT:    addq %r13, %rbp
; AVX-NEXT:    adcq %r12, %r8
...
; AVX-NEXT:    adcq %r13, %r12
; AVX-NEXT:    movq %r12, %r13
; AVX-NEXT:    sarq $63, %r13
; AVX-NEXT:    addq %r8, %r12
; AVX-NEXT:    adcq %rcx, %r13
; AVX-NEXT:    movq %rsi, %rax
; AVX-NEXT:    imulq %r9
; AVX-NEXT:    addq %r12, %rax
; AVX-NEXT:    adcq %r13, %rdx
; AVX-NEXT:    movq %rdi, 8(%r11)
...
; AVX-NEXT:    addq %r8, %r15
; AVX-NEXT:    adcq %rcx, %r9
; AVX-NEXT:    movq %r9, %rcx
; AVX-NEXT:    sarq $63, %rcx
; AVX-NEXT:    movq %rbx, %r8
; AVX-NEXT:    sarq $63, %r8
...
; AVX-NEXT:    movq %r12, 24(%r11)
; AVX-NEXT:    sarq $63, %r12
; AVX-NEXT:    xorq %r12, %rdx
; AVX-NEXT:    xorq %rax, %r12
; AVX-NEXT:    xorl %eax, %eax
; AVX-NEXT:    orq %rdx, %r12
; AVX-NEXT:    setne %al
; AVX-NEXT:    negl %eax
; AVX-NEXT:    negl %esi
; AVX-NEXT:    vmovd %esi, %xmm0
; AVX-NEXT:    vpinsrd $1, %eax, %xmm0, %xmm0
; AVX-NEXT:    movq %rdi, 16(%r11)
...
; AVX512F-NEXT:    addq %r13, %rbp
; AVX512F-NEXT:    adcq %r12, %r15
; AVX512F-NEXT:    movq %r15, %r12
; AVX512F-NEXT:    sarq $63, %r12
; AVX512F-NEXT:    movq %rsi, %r13
; AVX512F-NEXT:    sarq $63, %r13
; AVX512F-NEXT:    imulq %rbx, %r13
; AVX512F-NEXT:    movq %rbx, %rax
; AVX512F-NEXT:    mulq %rsi
; AVX512F-NEXT:    movq %rdx, %r14
; AVX512F-NEXT:    movq %rax, %rbx
; AVX512F-NEXT:    addq %rbp, %rbx
; AVX512F-NEXT:    adcq %r13, %r14
; AVX512F-NEXT:    movq %r14, %r13
; AVX512F-NEXT:    sarq $63, %r13
; AVX512F-NEXT:    addq %r15, %r14
; AVX512F-NEXT:    adcq %r12, %r13
; AVX512F-NEXT:    movq %rcx, %rax
; AVX512F-NEXT:    imulq %rsi
; AVX512F-NEXT:    addq %r14, %rax
; AVX512F-NEXT:    adcq %r13, %rdx
; AVX512F-NEXT:    movq %rbx, 24(%r11)
...
; AVX512F-NEXT:    adcq %rbx, %rdi
; AVX512F-NEXT:    movq %rdi, %rbx
; AVX512F-NEXT:    sarq $63, %rbx
; AVX512F-NEXT:    addq %r8, %rdi
; AVX512F-NEXT:    adcq %rsi, %rbx
; AVX512F-NEXT:    movq %r9, %rax
; AVX512F-NEXT:    imulq %r10
; AVX512F-NEXT:    addq %rdi, %rax
; AVX512F-NEXT:    adcq %rbx, %rdx
; AVX512F-NEXT:    movq %r15, 8(%r11)
; AVX512F-NEXT:    sarq $63, %r15
; AVX512F-NEXT:    xorq %r15, %rdx
; AVX512F-NEXT:    xorq %rax, %r15
; AVX512F-NEXT:    orq %rdx, %r15
; AVX512F-NEXT:    setne %al
; AVX512F-NEXT:    andl $1, %eax
...
; AVX512BW-NEXT:    adcq %rbx, %rdi
; AVX512BW-NEXT:    movq %rdi, %rbx
; AVX512BW-NEXT:    sarq $63, %rbx
; AVX512BW-NEXT:    addq %r8, %rdi
; AVX512BW-NEXT:    adcq %rsi, %rbx
; AVX512BW-NEXT:    movq %r9, %rax
; AVX512BW-NEXT:    imulq %r10
; AVX512BW-NEXT:    addq %rdi, %rax
; AVX512BW-NEXT:    adcq %rbx, %rdx
; AVX512BW-NEXT:    movq %r15, 8(%r11)
; AVX512BW-NEXT:    sarq $63, %r15
; AVX512BW-NEXT:    xorq %r15, %rdx
; AVX512BW-NEXT:    xorq %rax, %r15
