...
; X64:       # %bb.0: # %entry
; X64-NEXT:    #DEBUG_VALUE: test_return1:ptr <- $rdi
; X64-NEXT:    .file 1 "/disk5/chh/Debug/ld.loop" "fp128-g.c"
; X64-NEXT:    .loc 1 4 12 prologue_end # fp128-g.c:4:12
; X64-NEXT:    movaps (%rdi), %xmm0
; X64-NEXT:    .loc 1 4 5 is_stmt 0 # fp128-g.c:4:5
; X64-NEXT:    retq
; X64-NEXT:  .Ltmp0:
entry:
...
; X64:       # %bb.0: # %entry
; X64-NEXT:    #DEBUG_VALUE: test_return2:ptr <- $rdi
; X64-NEXT:    .loc 1 9 14 prologue_end is_stmt 1 # fp128-g.c:9:14
; X64-NEXT:    movaps (%rdi), %xmm0
; X64-NEXT:  .Ltmp1:
; X64-NEXT:    #DEBUG_VALUE: test_return2:value <- $xmm0
; X64-NEXT:    .loc 1 10 5 # fp128-g.c:10:5
; X64-NEXT:    retq
; X64-NEXT:  .Ltmp2:
entry:
...
; X64:       # %bb.0: # %entry
; X64-NEXT:    #DEBUG_VALUE: test_return3:ptr <- $rdi
; X64-NEXT:    .loc 1 14 12 prologue_end # fp128-g.c:14:12
; X64-NEXT:    movaps (%rdi), %xmm1
; X64-NEXT:    .loc 1 14 17 is_stmt 0 # fp128-g.c:14:17
; X64-NEXT:    movaps %xmm1, %xmm0
; X64-NEXT:    jmp __addtf3@PLT # TAILCALL
; X64-NEXT:  .Ltmp3:
entry:
...
; X64:       # %bb.0: # %entry
; X64-NEXT:    .loc 1 19 13 prologue_end is_stmt 1 # fp128-g.c:19:13
; X64-NEXT:    movq ld_ptr(%rip), %rax
; X64-NEXT:    .loc 1 19 12 is_stmt 0 # fp128-g.c:19:12
; X64-NEXT:    movaps (%rax), %xmm0
; X64-NEXT:    .loc 1 19 5 # fp128-g.c:19:5
; X64-NEXT:    retq
; X64-NEXT:  .Ltmp4:
entry:
...
; X64:       # %bb.0: # %entry
; X64-NEXT:    .loc 1 23 26 prologue_end is_stmt 1 # fp128-g.c:23:26
; X64-NEXT:    movq ld_ptr(%rip), %rax
; X64-NEXT:    .loc 1 23 25 is_stmt 0 # fp128-g.c:23:25
; X64-NEXT:    movaps (%rax), %xmm0
; X64-NEXT:  .Ltmp5:
; X64-NEXT:    #DEBUG_VALUE: test_return5:value <- $xmm0
; X64-NEXT:    .loc 1 24 5 is_stmt 1 # fp128-g.c:24:5
; X64-NEXT:    retq
; X64-NEXT:  .Ltmp6:
entry:
...
; X64:       # %bb.0: # %entry
; X64-NEXT:    .loc 1 28 13 prologue_end # fp128-g.c:28:13
; X64-NEXT:    movq ld_ptr(%rip), %rax
; X64-NEXT:    .loc 1 28 12 is_stmt 0 # fp128-g.c:28:12
; X64-NEXT:    movaps (%rax), %xmm1
; X64-NEXT:    .loc 1 28 20 # fp128-g.c:28:20
; X64-NEXT:    movaps %xmm1, %xmm0
; X64-NEXT:    jmp __addtf3@PLT # TAILCALL
; X64-NEXT:  .Ltmp7:
entry:
