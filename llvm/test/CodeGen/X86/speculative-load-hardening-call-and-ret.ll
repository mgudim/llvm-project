...
; X64-NOPIC-NEXT:    movq $-1, %r14
; X64-NOPIC-NEXT:    sarq $63, %rax
; X64-NOPIC-NEXT:    movq %rsp, %r15
; X64-NOPIC-NEXT:    shlq $47, %rax
; X64-NOPIC-NEXT:    movq %r15, %rdi
; X64-NOPIC-NEXT:    orq %rax, %rsp
...
; X64-NOPIC-NEXT:    shlq $47, %rax
; X64-NOPIC-NEXT:    movq %r15, %rdi
; X64-NOPIC-NEXT:    movq %r15, %rsi
; X64-NOPIC-NEXT:    movl $42, %edx
; X64-NOPIC-NEXT:    orq %rax, %rsp
; X64-NOPIC-NEXT:    movq $.Lslh_ret_addr6, %r15
; X64-NOPIC-NEXT:    callq __sigsetjmp@PLT
; X64-NOPIC-NEXT:  .Lslh_ret_addr6:
; X64-NOPIC-NEXT:    movq %rsp, %rax
; X64-NOPIC-NEXT:    sarq $63, %rax
; X64-NOPIC-NEXT:    cmpq $.Lslh_ret_addr6, %r15
...
; X64-NOPIC-MCM-NEXT:    movq $-1, %r14
; X64-NOPIC-MCM-NEXT:    sarq $63, %rax
; X64-NOPIC-MCM-NEXT:    movq %rsp, %r15
; X64-NOPIC-MCM-NEXT:    shlq $47, %rax
; X64-NOPIC-MCM-NEXT:    movq %r15, %rdi
; X64-NOPIC-MCM-NEXT:    orq %rax, %rsp
...
; X64-NOPIC-MCM-NEXT:    shlq $47, %rax
; X64-NOPIC-MCM-NEXT:    movq %r15, %rdi
; X64-NOPIC-MCM-NEXT:    movq %r15, %rsi
; X64-NOPIC-MCM-NEXT:    movl $42, %edx
; X64-NOPIC-MCM-NEXT:    orq %rax, %rsp
; X64-NOPIC-MCM-NEXT:    leaq .Lslh_ret_addr6(%rip), %r15
...
; X64-PIC-NEXT:    movq $-1, %r14
; X64-PIC-NEXT:    sarq $63, %rax
; X64-PIC-NEXT:    movq %rsp, %r15
; X64-PIC-NEXT:    shlq $47, %rax
; X64-PIC-NEXT:    movq %r15, %rdi
; X64-PIC-NEXT:    orq %rax, %rsp
...
; X64-PIC-NEXT:    shlq $47, %rax
; X64-PIC-NEXT:    movq %r15, %rdi
; X64-PIC-NEXT:    movq %r15, %rsi
; X64-PIC-NEXT:    movl $42, %edx
; X64-PIC-NEXT:    orq %rax, %rsp
; X64-PIC-NEXT:    leaq .Lslh_ret_addr6(%rip), %r15
