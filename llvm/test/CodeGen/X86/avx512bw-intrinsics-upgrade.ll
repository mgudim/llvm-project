...
; X86-NEXT:    vpsrlw $4, %zmm0, %zmm3 # encoding: [0x62,0xf1,0x65,0x48,0x71,0xd0,0x04]
...
; X64-NEXT:    vpsrlw $4, %zmm0, %zmm3 # encoding: [0x62,0xf1,0x65,0x48,0x71,0xd0,0x04]
...
; X86-NEXT:    vpsraw $4, %zmm0, %zmm3 {%k1} {z} # encoding: [0x62,0xf1,0x65,0xc9,0x71,0xe0,0x04]
...
; X64-NEXT:    vpsraw $4, %zmm0, %zmm3 {%k1} {z} # encoding: [0x62,0xf1,0x65,0xc9,0x71,0xe0,0x04]
...
; X86-NEXT:    vpsllw $4, %zmm0, %zmm3 {%k1} {z} # encoding: [0x62,0xf1,0x65,0xc9,0x71,0xf0,0x04]
...
; X64-NEXT:    vpsllw $4, %zmm0, %zmm3 {%k1} {z} # encoding: [0x62,0xf1,0x65,0xc9,0x71,0xf0,0x04]
...
; X86-NEXT:    vdbpsadbw $4, %zmm1, %zmm0, %zmm4 # encoding: [0x62,0xf3,0x7d,0x48,0x42,0xe1,0x04]
; X86-NEXT:    vmovdqa64 %zmm2, %zmm0 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xc2]
; X86-NEXT:    vmovdqa64 %zmm3, %zmm1 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xcb]
; X86-NEXT:    vmovdqa64 %zmm4, %zmm2 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xd4]
; X86-NEXT:    retl # encoding: [0xc3]
;
...
; X64-NEXT:    vdbpsadbw $4, %zmm1, %zmm0, %zmm4 # encoding: [0x62,0xf3,0x7d,0x48,0x42,0xe1,0x04]
; X64-NEXT:    vmovdqa64 %zmm2, %zmm0 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xc2]
; X64-NEXT:    vmovdqa64 %zmm3, %zmm1 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xcb]
; X64-NEXT:    vmovdqa64 %zmm4, %zmm2 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xd4]
; X64-NEXT:    retq # encoding: [0xc3]
