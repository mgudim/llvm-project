...
; SSE41-NEXT:    cmpunordss %xmm4, %xmm4
; SSE41-NEXT:    movaps %xmm4, %xmm0
; SSE41-NEXT:    blendvps %xmm0, %xmm2, %xmm3
; SSE41-NEXT:    movaps %xmm1, %xmm2
; SSE41-NEXT:    minss %xmm3, %xmm2
; SSE41-NEXT:    cmpunordss %xmm3, %xmm3
