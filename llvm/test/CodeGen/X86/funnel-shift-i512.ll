...
; AVX2-NEXT:    cmovneq {{[0-9]+}}(%rsp), %r14
; AVX2-NEXT:    cmovneq {{[0-9]+}}(%rsp), %r13
; AVX2-NEXT:    testb $-128, %cl
; AVX2-NEXT:    cmovneq %r9, %r10
; AVX2-NEXT:    cmovneq %r15, %r9
; AVX2-NEXT:    cmovneq %rsi, %r15
; AVX2-NEXT:    cmoveq %r14, %r13
; AVX2-NEXT:    cmoveq %rsi, %r14
...
; AVX512F-NEXT:    cmovneq %r12, %rax
; AVX512F-NEXT:    movq %r10, %r15
; AVX512F-NEXT:    cmovneq %r14, %r15
...
; AVX512F-NEXT:    cmovneq {{[0-9]+}}(%rsp), %r14
; AVX512F-NEXT:    cmovneq {{[0-9]+}}(%rsp), %r13
; AVX512F-NEXT:    testb $-128, %cl
; AVX512F-NEXT:    cmovneq %r9, %r10
; AVX512F-NEXT:    cmovneq %r15, %r9
; AVX512F-NEXT:    cmovneq %rsi, %r15
; AVX512F-NEXT:    cmoveq %r14, %r13
; AVX512F-NEXT:    cmoveq %rsi, %r14
...
; AVX512VL-NEXT:    cmovneq %rax, %r11
; AVX512VL-NEXT:    movq %rdx, %r13
; AVX512VL-NEXT:    cmovneq %r15, %r13
; AVX512VL-NEXT:    movq %r10, %r14
...
; AVX512VL-NEXT:    cmoveq %rax, %r15
; AVX512VL-NEXT:    cmoveq %r13, %rax
...
; AVX512VL-NEXT:    shldq %cl, %rax, %rbx
; AVX512VL-NEXT:    shldq %cl, %r14, %rsi
; AVX512VL-NEXT:    movq %r11, %r14
; AVX512VL-NEXT:    shldq %cl, %r8, %r14
...
; AVX512VBMI-NEXT:    cmovneq %rax, %r11
; AVX512VBMI-NEXT:    movq %rdx, %r13
; AVX512VBMI-NEXT:    cmovneq %r15, %r13
; AVX512VBMI-NEXT:    movq %r10, %r14
...
; AVX512VBMI-NEXT:    cmoveq %rax, %r15
; AVX512VBMI-NEXT:    cmoveq %r13, %rax
...
; AVX512VBMI-NEXT:    cmovneq %rbx, %rax
...
; AVX512VBMI-NEXT:    shldq %cl, %rax, %rbx
; AVX512VBMI-NEXT:    shldq %cl, %r14, %rsi
; AVX512VBMI-NEXT:    movq %r11, %r14
; AVX512VBMI-NEXT:    shldq %cl, %r8, %r14
...
; AVX2-NEXT:    cmoveq {{[0-9]+}}(%rsp), %r10
; AVX2-NEXT:    cmoveq {{[0-9]+}}(%rsp), %r14
; AVX2-NEXT:    cmoveq {{[0-9]+}}(%rsp), %r13
; AVX2-NEXT:    testb $-128, %cl
; AVX2-NEXT:    cmoveq %r9, %rbx
; AVX2-NEXT:    cmoveq %r12, %r9
...
; AVX2-NEXT:    cmovneq %rax, %r14
; AVX2-NEXT:    cmovneq %rdx, %r15
; AVX2-NEXT:    cmovneq %r8, %rdx
; AVX2-NEXT:    movq %rdi, %rax
; AVX2-NEXT:    testb $64, %cl
; AVX2-NEXT:    cmoveq %rbx, %rdx
; AVX2-NEXT:    cmoveq %r15, %rbx
; AVX2-NEXT:    cmoveq %r9, %r15
; AVX2-NEXT:    movq %r9, %rdi
; AVX2-NEXT:    cmoveq %rsi, %rdi
; AVX2-NEXT:    cmoveq %r12, %rsi
; AVX2-NEXT:    cmoveq %r14, %r12
...
; AVX2-NEXT:    shrdq %cl, %r12, %r14
; AVX2-NEXT:    shrdq %cl, %rsi, %r12
...
; AVX512F-NEXT:    shrdq %cl, %r12, %r14
; AVX512F-NEXT:    shrdq %cl, %rsi, %r12
; AVX512F-NEXT:    shrdq %cl, %r15, %rdi
; AVX512F-NEXT:    shrdq %cl, %rbx, %r15
; AVX512F-NEXT:    # kill: def $cl killed $cl killed $rcx
...
; AVX512VL-NEXT:    cmoveq {{[0-9]+}}(%rsp), %r14
...
; AVX512VL-NEXT:    testb $64, %cl
; AVX512VL-NEXT:    cmoveq %rbx, %rdx
; AVX512VL-NEXT:    cmoveq %r15, %rbx
; AVX512VL-NEXT:    cmoveq %r9, %r15
; AVX512VL-NEXT:    movq %r9, %r8
; AVX512VL-NEXT:    cmoveq %rsi, %r8
; AVX512VL-NEXT:    cmoveq %r12, %rsi
; AVX512VL-NEXT:    cmoveq %r14, %r12
...
; AVX512VL-NEXT:    shrdq %cl, %rsi, %r12
; AVX512VL-NEXT:    shrdq %cl, %r15, %r8
; AVX512VL-NEXT:    movq %rdi, %rax
; AVX512VL-NEXT:    shrdq %cl, %rbx, %r15
; AVX512VL-NEXT:    # kill: def $cl killed $cl killed $rcx
; AVX512VL-NEXT:    shrdq %cl, %rdx, %rbx
; AVX512VL-NEXT:    movq %rbx, 56(%rdi)
; AVX512VL-NEXT:    movq %r15, 48(%rdi)
; AVX512VL-NEXT:    movq %r8, 40(%rdi)
; AVX512VL-NEXT:    movq %r9, 32(%rdi)
; AVX512VL-NEXT:    movq %r12, 24(%rdi)
...
; AVX512VBMI-NEXT:    movq %rbx, %r12
; AVX512VBMI-NEXT:    cmoveq %r11, %r12
; AVX512VBMI-NEXT:    cmovneq {{[0-9]+}}(%rsp), %rbx
...
; AVX512VBMI-NEXT:    cmoveq {{[0-9]+}}(%rsp), %r14
...
; AVX512VBMI-NEXT:    testb $64, %cl
; AVX512VBMI-NEXT:    cmoveq %rbx, %rdx
; AVX512VBMI-NEXT:    cmoveq %r15, %rbx
; AVX512VBMI-NEXT:    cmoveq %r9, %r15
; AVX512VBMI-NEXT:    movq %r9, %r8
; AVX512VBMI-NEXT:    cmoveq %rsi, %r8
; AVX512VBMI-NEXT:    cmoveq %r12, %rsi
; AVX512VBMI-NEXT:    cmoveq %r14, %r12
...
; AVX512VBMI-NEXT:    shrdq %cl, %rsi, %r12
; AVX512VBMI-NEXT:    shrdq %cl, %r15, %r8
; AVX512VBMI-NEXT:    movq %rdi, %rax
; AVX512VBMI-NEXT:    shrdq %cl, %rbx, %r15
; AVX512VBMI-NEXT:    # kill: def $cl killed $cl killed $rcx
; AVX512VBMI-NEXT:    shrdq %cl, %rdx, %rbx
; AVX512VBMI-NEXT:    movq %rbx, 56(%rdi)
; AVX512VBMI-NEXT:    movq %r15, 48(%rdi)
; AVX512VBMI-NEXT:    movq %r8, 40(%rdi)
; AVX512VBMI-NEXT:    movq %r9, 32(%rdi)
; AVX512VBMI-NEXT:    movq %r12, 24(%rdi)
...
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %r12
; AVX2-NEXT:    movq {{[0-9]+}}(%rsp), %rbx
; AVX2-NEXT:    testl $256, %ebx # imm = 0x100
; AVX2-NEXT:    movq %r9, %r13
; AVX2-NEXT:    cmovneq %rsi, %r13
...
; AVX2-NEXT:    movq %r14, %r8
; AVX2-NEXT:    shldq %cl, %r15, %r8
; AVX2-NEXT:    movq %r11, %r15
; AVX2-NEXT:    shldq %cl, %r14, %r15
; AVX2-NEXT:    movq %rdx, %r14
; AVX2-NEXT:    shldq %cl, %r11, %r14
...
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %r12
; AVX512F-NEXT:    movq {{[0-9]+}}(%rsp), %rbx
; AVX512F-NEXT:    testl $256, %ebx # imm = 0x100
; AVX512F-NEXT:    movq %r9, %r13
; AVX512F-NEXT:    cmovneq %rsi, %r13
...
; AVX512F-NEXT:    cmovneq %rcx, %r10
; AVX512F-NEXT:    cmovneq %rdx, %r11
; AVX512F-NEXT:    cmovneq %r8, %r12
; AVX512F-NEXT:    testb $-128, %bl
; AVX512F-NEXT:    movq %r15, %r9
; AVX512F-NEXT:    cmovneq %r12, %r9
; AVX512F-NEXT:    cmovneq %r11, %r12
...
; AVX512VL-NEXT:    movq {{[0-9]+}}(%rsp), %r15
; AVX512VL-NEXT:    movq {{[0-9]+}}(%rsp), %rbx
; AVX512VL-NEXT:    testl $256, %ebx # imm = 0x100
...
; AVX512VL-NEXT:    testb $-128, %bl
; AVX512VL-NEXT:    movq %r14, %r9
; AVX512VL-NEXT:    cmovneq %r15, %r9
...
; AVX512VL-NEXT:    testb $64, %bl
; AVX512VL-NEXT:    movq %r10, %rdx
; AVX512VL-NEXT:    cmovneq %r11, %rdx
; AVX512VL-NEXT:    cmovneq %rax, %r11
; AVX512VL-NEXT:    cmovneq %r14, %rax
; AVX512VL-NEXT:    cmovneq %r8, %r14
; AVX512VL-NEXT:    cmovneq %r9, %r8
; AVX512VL-NEXT:    cmovneq %rsi, %r9
; AVX512VL-NEXT:    cmoveq %r15, %r10
; AVX512VL-NEXT:    cmovneq %r15, %rsi
; AVX512VL-NEXT:    movq %rsi, %r15
; AVX512VL-NEXT:    movl %ebx, %ecx
; AVX512VL-NEXT:    shldq %cl, %r10, %r15
; AVX512VL-NEXT:    movq %r9, %r12
; AVX512VL-NEXT:    shldq %cl, %rsi, %r12
; AVX512VL-NEXT:    movq %r8, %rsi
; AVX512VL-NEXT:    shldq %cl, %r9, %rsi
; AVX512VL-NEXT:    movq %r14, %r9
; AVX512VL-NEXT:    shldq %cl, %r8, %r9
; AVX512VL-NEXT:    movq %rax, %r8
; AVX512VL-NEXT:    shldq %cl, %r14, %r8
; AVX512VL-NEXT:    movq %r11, %r14
; AVX512VL-NEXT:    shldq %cl, %rax, %r14
; AVX512VL-NEXT:    movq %rdi, %rax
...
; AVX512VBMI-NEXT:    movq {{[0-9]+}}(%rsp), %r15
; AVX512VBMI-NEXT:    movq {{[0-9]+}}(%rsp), %rbx
; AVX512VBMI-NEXT:    testl $256, %ebx # imm = 0x100
...
; AVX512VBMI-NEXT:    testb $-128, %bl
; AVX512VBMI-NEXT:    movq %r14, %r9
; AVX512VBMI-NEXT:    cmovneq %r15, %r9
...
; AVX512VBMI-NEXT:    testb $64, %bl
; AVX512VBMI-NEXT:    movq %r10, %rdx
; AVX512VBMI-NEXT:    cmovneq %r11, %rdx
; AVX512VBMI-NEXT:    cmovneq %rax, %r11
; AVX512VBMI-NEXT:    cmovneq %r14, %rax
; AVX512VBMI-NEXT:    cmovneq %r8, %r14
; AVX512VBMI-NEXT:    cmovneq %r9, %r8
; AVX512VBMI-NEXT:    cmovneq %rsi, %r9
; AVX512VBMI-NEXT:    cmoveq %r15, %r10
; AVX512VBMI-NEXT:    cmovneq %r15, %rsi
; AVX512VBMI-NEXT:    movq %rsi, %r15
; AVX512VBMI-NEXT:    movl %ebx, %ecx
; AVX512VBMI-NEXT:    shldq %cl, %r10, %r15
; AVX512VBMI-NEXT:    movq %r9, %r12
; AVX512VBMI-NEXT:    shldq %cl, %rsi, %r12
; AVX512VBMI-NEXT:    movq %r8, %rsi
; AVX512VBMI-NEXT:    shldq %cl, %r9, %rsi
; AVX512VBMI-NEXT:    movq %r14, %r9
; AVX512VBMI-NEXT:    shldq %cl, %r8, %r9
; AVX512VBMI-NEXT:    movq %rax, %r8
; AVX512VBMI-NEXT:    shldq %cl, %r14, %r8
; AVX512VBMI-NEXT:    movq %r11, %r14
; AVX512VBMI-NEXT:    shldq %cl, %rax, %r14
; AVX512VBMI-NEXT:    movq %rdi, %rax
...
; AVX512VBMI-NEXT:    movq %r12, 8(%rax)
...
; AVX2-NEXT:    testl $256, %ebx # imm = 0x100
; AVX2-NEXT:    movq %r9, %r13
; AVX2-NEXT:    cmoveq %rsi, %r13
; AVX2-NEXT:    movq %r8, %rax
; AVX2-NEXT:    cmoveq %r12, %rax
; AVX2-NEXT:    movq %rcx, %r14
; AVX2-NEXT:    cmoveq %r11, %r14
; AVX2-NEXT:    movq %rdx, %r15
...
; AVX2-NEXT:    cmovneq %rax, %r15
; AVX2-NEXT:    cmovneq %r13, %r14
; AVX2-NEXT:    cmoveq %rax, %r10
; AVX2-NEXT:    movq %rdi, %rax
; AVX2-NEXT:    cmoveq %r13, %r11
; AVX2-NEXT:    testb $64, %bl
...
; AVX512F-NEXT:    testl $256, %ebx # imm = 0x100
; AVX512F-NEXT:    movq %r9, %r13
; AVX512F-NEXT:    cmoveq %rsi, %r13
; AVX512F-NEXT:    movq %r8, %rax
; AVX512F-NEXT:    cmoveq %r12, %rax
; AVX512F-NEXT:    movq %rcx, %r14
; AVX512F-NEXT:    cmoveq %r11, %r14
; AVX512F-NEXT:    movq %rdx, %r15
...
; AVX512VL-NEXT:    testb $-128, %bl
; AVX512VL-NEXT:    movq %r15, %rdx
; AVX512VL-NEXT:    cmoveq %rax, %rdx
; AVX512VL-NEXT:    cmoveq %r10, %rax
; AVX512VL-NEXT:    movq %r14, %r8
; AVX512VL-NEXT:    cmoveq %rsi, %r8
; AVX512VL-NEXT:    cmoveq %r11, %rsi
; AVX512VL-NEXT:    cmovneq %r13, %r15
...
; AVX512VL-NEXT:    movq %r14, 40(%rdi)
; AVX512VL-NEXT:    movq %r15, 32(%rdi)
...
; AVX512VBMI-NEXT:    testb $-128, %bl
; AVX512VBMI-NEXT:    movq %r15, %rdx
; AVX512VBMI-NEXT:    cmoveq %rax, %rdx
; AVX512VBMI-NEXT:    cmoveq %r10, %rax
; AVX512VBMI-NEXT:    movq %r14, %r8
; AVX512VBMI-NEXT:    cmoveq %rsi, %r8
; AVX512VBMI-NEXT:    cmoveq %r11, %rsi
; AVX512VBMI-NEXT:    cmovneq %r13, %r15
...
; AVX512VBMI-NEXT:    movq %r14, 40(%rdi)
; AVX512VBMI-NEXT:    movq %r15, 32(%rdi)
...
; SSE-NEXT:    movq 32(%rdx), %r14
; SSE-NEXT:    testl $256, %eax # imm = 0x100
; SSE-NEXT:    movq 56(%rsi), %r13
; SSE-NEXT:    cmovneq %r8, %r13
; SSE-NEXT:    movq 40(%rdx), %rcx
; SSE-NEXT:    movq 48(%rsi), %rbp
; SSE-NEXT:    cmovneq %r9, %rbp
; SSE-NEXT:    movq 48(%rdx), %r15
; SSE-NEXT:    movq 40(%rsi), %rbx
; SSE-NEXT:    cmovneq %r10, %rbx
; SSE-NEXT:    movq 56(%rdx), %r12
; SSE-NEXT:    movq 32(%rsi), %rsi
; SSE-NEXT:    cmovneq %r11, %rsi
; SSE-NEXT:    cmovneq %r12, %r8
; SSE-NEXT:    cmovneq %r15, %r9
; SSE-NEXT:    cmovneq %rcx, %r10
; SSE-NEXT:    cmovneq %r14, %r11
; SSE-NEXT:    cmovneq 16(%rdx), %r15
; SSE-NEXT:    cmovneq (%rdx), %r14
; SSE-NEXT:    cmovneq 8(%rdx), %rcx
; SSE-NEXT:    cmovneq 24(%rdx), %r12
; SSE-NEXT:    testb $-128, %al
; SSE-NEXT:    cmoveq %r12, %rcx
; SSE-NEXT:    cmoveq %r15, %r14
; SSE-NEXT:    cmoveq %r11, %r15
; SSE-NEXT:    cmoveq %r10, %r12
; SSE-NEXT:    cmoveq %r9, %r11
; SSE-NEXT:    cmoveq %r8, %r10
; SSE-NEXT:    cmoveq %rsi, %r9
; SSE-NEXT:    cmoveq %rbx, %r8
; SSE-NEXT:    cmoveq %rbp, %rsi
; SSE-NEXT:    cmoveq %r13, %rbx
; SSE-NEXT:    testb $64, %al
; SSE-NEXT:    cmovneq %rsi, %rbx
; SSE-NEXT:    cmovneq %r8, %rsi
; SSE-NEXT:    cmovneq %r9, %r8
; SSE-NEXT:    cmovneq %r10, %r9
; SSE-NEXT:    cmovneq %r11, %r10
; SSE-NEXT:    cmovneq %r12, %r11
; SSE-NEXT:    cmovneq %r15, %r12
; SSE-NEXT:    cmoveq %rcx, %r14
; SSE-NEXT:    cmovneq %rcx, %r15
...
; SSE-NEXT:    movq 40(%rsi), %r12
; SSE-NEXT:    cmoveq %r9, %r12
...
; SSE-NEXT:    cmoveq (%rdx), %rcx
; SSE-NEXT:    cmoveq 16(%rdx), %r14
; SSE-NEXT:    testb $-128, %al
; SSE-NEXT:    cmovneq %r14, %rcx
...
; SSE-NEXT:    testl $256, %edx # imm = 0x100
...
; SSE-NEXT:    cmovneq %r14, %rcx
; SSE-NEXT:    testb $-128, %dl
; SSE-NEXT:    movq %rsi, %r14
; SSE-NEXT:    cmovneq %rcx, %r14
...
; SSE-NEXT:    shldq %cl, %r8, %r15
; SSE-NEXT:    movq %r14, %r12
; SSE-NEXT:    shldq %cl, %r10, %r12
; SSE-NEXT:    movq %rbx, %r10
; SSE-NEXT:    shldq %cl, %r14, %r10
; SSE-NEXT:    movq %rsi, %r14
; SSE-NEXT:    shldq %cl, %rbx, %r14
; SSE-NEXT:    movq %r9, %rbx
; SSE-NEXT:    shldq %cl, %rsi, %rbx
...
; AVX2-NEXT:    testl $256, %edx # imm = 0x100
; AVX2-NEXT:    movq %r12, %r15
; AVX2-NEXT:    cmovneq %r11, %r15
; AVX2-NEXT:    movq %rbx, %r13
; AVX2-NEXT:    cmovneq %rcx, %r13
...
; AVX2-NEXT:    cmovneq %rbx, %rcx
; AVX2-NEXT:    testb $-128, %dl
; AVX2-NEXT:    movq %r10, %r14
; AVX2-NEXT:    cmovneq %rcx, %r14
...
; SSE-NEXT:    cmoveq %r13, %r9
; SSE-NEXT:    cmoveq %rbx, %rcx
; SSE-NEXT:    testb $-128, %dl
; SSE-NEXT:    movq %rsi, %r11
; SSE-NEXT:    cmoveq %rcx, %r11
; SSE-NEXT:    cmoveq %r9, %rcx
; SSE-NEXT:    movq %r10, %rbx
; SSE-NEXT:    cmoveq %r8, %rbx
; SSE-NEXT:    cmoveq %rax, %r8
; SSE-NEXT:    cmovneq %r15, %rsi
...
; SSE-NEXT:    cmoveq %r9, %r14
; SSE-NEXT:    cmoveq %r10, %r9
; SSE-NEXT:    cmoveq %rsi, %r10
...
; SSE-NEXT:    shrdq %cl, %r10, %rsi
; SSE-NEXT:    shrdq %cl, %r9, %r10
; SSE-NEXT:    shrdq %cl, %r14, %r9
...
; AVX2-NEXT:    cmoveq %r8, %r15
; AVX2-NEXT:    movq %rbx, %r13
; AVX2-NEXT:    cmoveq %rcx, %r13
; AVX2-NEXT:    movq %rax, %rsi
; AVX2-NEXT:    cmoveq %r10, %rsi
; AVX2-NEXT:    movq %r14, %r11
; AVX2-NEXT:    cmoveq %r9, %r11
; AVX2-NEXT:    cmoveq %r12, %r8
; AVX2-NEXT:    cmoveq %rax, %r10
...
; SSE2-NEXT:    cmovneq %r9, %r12
; SSE2-NEXT:    cmovneq %r13, %r9
; SSE2-NEXT:    cmoveq %r13, %r14
; SSE2-NEXT:    movq %xmm4, %r13
; SSE2-NEXT:    movq %xmm6, %rbp
; SSE2-NEXT:    cmovneq %r11, %rax
; SSE2-NEXT:    cmovneq %rbp, %r11
...
; SSE2-NEXT:    cmoveq %rbp, %rcx
; SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm7[2,3,2,3]
; SSE2-NEXT:    movq %xmm0, %rbp
; SSE2-NEXT:    cmovneq %r8, %r15
; SSE2-NEXT:    cmovneq %rbp, %r8
; SSE2-NEXT:    cmoveq %rbp, %rbx
...
; SSE2-NEXT:    cmoveq %rcx, %r13
; SSE2-NEXT:    cmovneq %rcx, %r14
; SSE2-NEXT:    movq %r14, %r15
; SSE2-NEXT:    movl %esi, %ecx
; SSE2-NEXT:    shldq %cl, %r13, %r15
; SSE2-NEXT:    movq %rbx, %r12
; SSE2-NEXT:    shldq %cl, %r14, %r12
...
; SSE2-NEXT:    movq %r10, 40(%rdi)
; SSE2-NEXT:    movq %r11, 32(%rdi)
; SSE2-NEXT:    movq %rbx, 24(%rdi)
; SSE2-NEXT:    movq %r14, 16(%rdi)
...
; SSE42-NEXT:    movq %xmm5, %r14
; SSE42-NEXT:    movq %xmm7, %r12
; SSE42-NEXT:    testl $256, %esi # imm = 0x100
; SSE42-NEXT:    cmovneq %r9, %r13
; SSE42-NEXT:    cmovneq %r12, %r9
; SSE42-NEXT:    cmoveq %r12, %r14
; SSE42-NEXT:    movq %xmm4, %r12
; SSE42-NEXT:    movq %xmm6, %rbp
; SSE42-NEXT:    cmovneq %r11, %rax
; SSE42-NEXT:    cmovneq %rbp, %r11
; SSE42-NEXT:    cmoveq %rbp, %r12
; SSE42-NEXT:    pextrq $1, %xmm6, %rbp
; SSE42-NEXT:    cmovneq %r10, %rdx
; SSE42-NEXT:    cmovneq %rbp, %r10
; SSE42-NEXT:    cmoveq %rbp, %rcx
; SSE42-NEXT:    pextrq $1, %xmm7, %rbp
; SSE42-NEXT:    cmovneq %r8, %r15
; SSE42-NEXT:    cmovneq %rbp, %r8
; SSE42-NEXT:    cmoveq %rbp, %rbx
; SSE42-NEXT:    testb $-128, %sil
...
; SSE42-NEXT:    cmoveq %rcx, %r12
; SSE42-NEXT:    cmovneq %rcx, %r14
; SSE42-NEXT:    movq %r14, %r15
; SSE42-NEXT:    movl %esi, %ecx
; SSE42-NEXT:    shldq %cl, %r12, %r15
; SSE42-NEXT:    movq %rbx, %r12
; SSE42-NEXT:    shldq %cl, %r14, %r12
...
; AVX2-NEXT:    testl $256, %esi # imm = 0x100
...
; AVX2-NEXT:    cmovneq %r14, %rbx
; AVX2-NEXT:    cmovneq %r12, %r14
; AVX2-NEXT:    cmoveq %rcx, %r15
; AVX2-NEXT:    cmovneq %rcx, %r12
; AVX2-NEXT:    movq %r12, %rdi
...
; SSE2-NEXT:    cmoveq %rbp, %rbx
; SSE2-NEXT:    pshufd {{.*#+}} xmm0 = xmm6[2,3,2,3]
; SSE2-NEXT:    cmovneq %rbp, %r14
; SSE2-NEXT:    movq %xmm0, %rbp
; SSE2-NEXT:    cmoveq %r8, %rax
; SSE2-NEXT:    cmoveq %rdx, %r9
; SSE2-NEXT:    cmoveq %rbp, %r8
; SSE2-NEXT:    cmoveq %r15, %rdx
; SSE2-NEXT:    cmovneq %rbp, %r11
; SSE2-NEXT:    cmovneq %r15, %rcx
; SSE2-NEXT:    movq %xmm5, %r15
; SSE2-NEXT:    movq %xmm7, %rbp
; SSE2-NEXT:    cmoveq %r10, %r13
; SSE2-NEXT:    cmoveq %rbp, %r10
...
; SSE2-NEXT:    cmovneq %rax, %rbx
; SSE2-NEXT:    cmovneq %r12, %rax
; SSE2-NEXT:    testb $64, %sil
; SSE2-NEXT:    cmoveq %r9, %rax
; SSE2-NEXT:    cmoveq %rbx, %r9
; SSE2-NEXT:    cmoveq %r10, %rbx
; SSE2-NEXT:    cmoveq %r8, %r10
; SSE2-NEXT:    cmoveq %rdx, %r8
; SSE2-NEXT:    cmoveq %r14, %rdx
; SSE2-NEXT:    cmoveq %r15, %r14
; SSE2-NEXT:    cmoveq %r11, %r15
; SSE2-NEXT:    cmoveq %rcx, %r11
; SSE2-NEXT:    movl %esi, %ecx
; SSE2-NEXT:    shrdq %cl, %r15, %r11
; SSE2-NEXT:    shrdq %cl, %r14, %r15
; SSE2-NEXT:    shrdq %cl, %rdx, %r14
; SSE2-NEXT:    shrdq %cl, %r8, %rdx
; SSE2-NEXT:    shrdq %cl, %r10, %r8
; SSE2-NEXT:    shrdq %cl, %rbx, %r10
; SSE2-NEXT:    shrdq %cl, %r9, %rbx
; SSE2-NEXT:    shrdq %cl, %rax, %r9
; SSE2-NEXT:    movq %rdi, %rax
; SSE2-NEXT:    movq %r9, 56(%rdi)
; SSE2-NEXT:    movq %rbx, 48(%rdi)
; SSE2-NEXT:    movq %r10, 40(%rdi)
...
; SSE42-NEXT:    pextrq $1, %xmm0, %r8
; SSE42-NEXT:    pextrq $1, %xmm2, %rax
; SSE42-NEXT:    movq %xmm2, %r10
; SSE42-NEXT:    movq %xmm1, %r9
; SSE42-NEXT:    pextrq $1, %xmm1, %rbx
; SSE42-NEXT:    movq %xmm3, %r13
; SSE42-NEXT:    pextrq $1, %xmm3, %r12
; SSE42-NEXT:    movq %xmm4, %rcx
; SSE42-NEXT:    pextrq $1, %xmm4, %r11
; SSE42-NEXT:    pextrq $1, %xmm5, %r14
; SSE42-NEXT:    movq %xmm6, %r15
; SSE42-NEXT:    pextrq $1, %xmm7, %rbp
; SSE42-NEXT:    testl $256, %esi # imm = 0x100
; SSE42-NEXT:    cmoveq %rbx, %r12
; SSE42-NEXT:    cmoveq %rbp, %rbx
; SSE42-NEXT:    cmovneq %rbp, %r14
; SSE42-NEXT:    pextrq $1, %xmm6, %rbp
; SSE42-NEXT:    cmoveq %r8, %rax
; SSE42-NEXT:    cmoveq %rdx, %r10
; SSE42-NEXT:    cmoveq %rbp, %r8
; SSE42-NEXT:    cmoveq %r15, %rdx
; SSE42-NEXT:    cmovneq %rbp, %r11
; SSE42-NEXT:    cmovneq %r15, %rcx
; SSE42-NEXT:    movq %xmm5, %r15
; SSE42-NEXT:    movq %xmm7, %rbp
; SSE42-NEXT:    cmoveq %r9, %r13
; SSE42-NEXT:    cmoveq %rbp, %r9
...
; SSE42-NEXT:    cmovneq %r10, %r9
; SSE42-NEXT:    cmovneq %r13, %r10
; SSE42-NEXT:    cmovneq %r14, %r11
; SSE42-NEXT:    cmovneq %r8, %r14
; SSE42-NEXT:    cmovneq %rbx, %r8
; SSE42-NEXT:    cmovneq %rax, %rbx
; SSE42-NEXT:    cmovneq %r12, %rax
; SSE42-NEXT:    testb $64, %sil
; SSE42-NEXT:    cmoveq %r10, %rax
; SSE42-NEXT:    cmoveq %rbx, %r10
; SSE42-NEXT:    cmoveq %r9, %rbx
; SSE42-NEXT:    cmoveq %r8, %r9
; SSE42-NEXT:    cmoveq %rdx, %r8
; SSE42-NEXT:    cmoveq %r14, %rdx
; SSE42-NEXT:    cmoveq %r15, %r14
; SSE42-NEXT:    cmoveq %r11, %r15
; SSE42-NEXT:    cmoveq %rcx, %r11
; SSE42-NEXT:    movl %esi, %ecx
; SSE42-NEXT:    shrdq %cl, %r15, %r11
; SSE42-NEXT:    shrdq %cl, %r14, %r15
; SSE42-NEXT:    shrdq %cl, %rdx, %r14
; SSE42-NEXT:    shrdq %cl, %r8, %rdx
; SSE42-NEXT:    shrdq %cl, %r9, %r8
; SSE42-NEXT:    shrdq %cl, %rbx, %r9
; SSE42-NEXT:    shrdq %cl, %r10, %rbx
; SSE42-NEXT:    shrdq %cl, %rax, %r10
; SSE42-NEXT:    movq %rdi, %rax
; SSE42-NEXT:    movq %r10, 56(%rdi)
; SSE42-NEXT:    movq %rbx, 48(%rdi)
...
; AVX2-NEXT:    cmoveq %rbp, %r14
; AVX2-NEXT:    cmoveq %r12, %r8
; AVX2-NEXT:    cmovneq %rbp, %r15
; AVX2-NEXT:    cmovneq %r12, %rbx
; AVX2-NEXT:    vmovq %xmm3, %r12
; AVX2-NEXT:    vmovq %xmm1, %rbp
; AVX2-NEXT:    cmoveq %r10, %r13
; AVX2-NEXT:    cmoveq %rdx, %r9
; AVX2-NEXT:    cmoveq %rbp, %r10
; AVX2-NEXT:    cmoveq %r12, %rdx
; AVX2-NEXT:    cmovneq %r12, %rcx
...
; AVX2-NEXT:    cmoveq %rcx, %rbx
; AVX2-NEXT:    movl %esi, %ecx
; AVX2-NEXT:    shrdq %cl, %r12, %rbx
; AVX2-NEXT:    shrdq %cl, %r15, %r12
; AVX2-NEXT:    shrdq %cl, %rdx, %r15
; AVX2-NEXT:    shrdq %cl, %r8, %rdx
; AVX2-NEXT:    shrdq %cl, %r10, %r8
; AVX2-NEXT:    shrdq %cl, %r14, %r10
...
; SSE42-NEXT:    cmovneq %r14, %rbx
; SSE42-NEXT:    cmovneq %r9, %r14
; SSE42-NEXT:    cmoveq %rcx, %rdx
; SSE42-NEXT:    cmovneq %rcx, %r9
; SSE42-NEXT:    movq %r9, %r15
; SSE42-NEXT:    movl %esi, %ecx
; SSE42-NEXT:    shldq %cl, %rdx, %r15
; SSE42-NEXT:    movq %r14, %r12
; SSE42-NEXT:    shldq %cl, %r9, %r12
; SSE42-NEXT:    movq %rbx, %r9
; SSE42-NEXT:    shldq %cl, %r14, %r9
; SSE42-NEXT:    movq %r10, %r14
; SSE42-NEXT:    shldq %cl, %rbx, %r14
; SSE42-NEXT:    movq %r8, %rbx
; SSE42-NEXT:    shldq %cl, %r10, %rbx
; SSE42-NEXT:    movq %rax, %r10
; SSE42-NEXT:    shldq %cl, %r8, %r10
; SSE42-NEXT:    movq %r11, %r8
; SSE42-NEXT:    shldq %cl, %rax, %r8
...
; SSE2-NEXT:    movq %r10, %r11
; SSE2-NEXT:    cmoveq %rcx, %r11
; SSE2-NEXT:    cmoveq %rdx, %rcx
; SSE2-NEXT:    movq %r9, %rbx
; SSE2-NEXT:    cmoveq %r8, %rbx
...
; SSE2-NEXT:    cmoveq %r9, %rdx
; SSE2-NEXT:    cmoveq %r10, %r9
; SSE2-NEXT:    cmoveq %rbx, %r10
; SSE2-NEXT:    cmoveq %r11, %rbx
; SSE2-NEXT:    cmoveq %r8, %r11
; SSE2-NEXT:    cmoveq %rcx, %r8
; SSE2-NEXT:    cmovneq %rcx, %rax
; SSE2-NEXT:    movq %rax, %r15
; SSE2-NEXT:    movl %esi, %ecx
; SSE2-NEXT:    shrdq %cl, %r8, %r15
; SSE2-NEXT:    shrdq %cl, %r11, %r8
; SSE2-NEXT:    shrdq %cl, %rbx, %r11
; SSE2-NEXT:    shrdq %cl, %r10, %rbx
; SSE2-NEXT:    shrdq %cl, %r9, %r10
...
; SSE42-NEXT:    testl $256, %esi # imm = 0x100
; SSE42-NEXT:    movq %r15, %r14
; SSE42-NEXT:    cmoveq %r8, %r14
; SSE42-NEXT:    movq %xmm3, %rax
; SSE42-NEXT:    movq %rbx, %r12
; SSE42-NEXT:    cmoveq %rcx, %r12
; SSE42-NEXT:    movq %xmm1, %r13
; SSE42-NEXT:    movq %r13, %r9
; SSE42-NEXT:    cmoveq %rax, %r9
; SSE42-NEXT:    movq %r11, %r10
; SSE42-NEXT:    cmoveq %rdx, %r10
; SSE42-NEXT:    cmoveq %r15, %r8
; SSE42-NEXT:    cmoveq %r13, %rax
; SSE42-NEXT:    cmoveq %r11, %rdx
; SSE42-NEXT:    cmoveq %rbx, %rcx
; SSE42-NEXT:    testb $-128, %sil
; SSE42-NEXT:    movq %r10, %r11
; SSE42-NEXT:    cmoveq %rcx, %r11
; SSE42-NEXT:    cmoveq %rdx, %rcx
; SSE42-NEXT:    movq %r9, %rbx
; SSE42-NEXT:    cmoveq %r8, %rbx
; SSE42-NEXT:    cmoveq %rax, %r8
; SSE42-NEXT:    cmovneq %r12, %r10
...
; SSE42-NEXT:    cmoveq %r9, %rdx
; SSE42-NEXT:    cmoveq %r10, %r9
; SSE42-NEXT:    cmoveq %rbx, %r10
; SSE42-NEXT:    cmoveq %r11, %rbx
; SSE42-NEXT:    cmoveq %r8, %r11
; SSE42-NEXT:    cmoveq %rcx, %r8
; SSE42-NEXT:    cmovneq %rcx, %rax
; SSE42-NEXT:    movq %rax, %r15
; SSE42-NEXT:    movl %esi, %ecx
; SSE42-NEXT:    shrdq %cl, %r8, %r15
; SSE42-NEXT:    shrdq %cl, %r11, %r8
; SSE42-NEXT:    shrdq %cl, %rbx, %r11
; SSE42-NEXT:    shrdq %cl, %r10, %rbx
; SSE42-NEXT:    shrdq %cl, %r9, %r10
; SSE42-NEXT:    shrdq %cl, %rdx, %r9
