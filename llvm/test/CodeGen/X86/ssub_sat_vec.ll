...
; SSE41-NEXT:    movapd {{.*#+}} xmm2 = [9223372036854775808,9223372036854775808]
...
; SSE41-NEXT:    movapd {{.*#+}} xmm10 = [9223372036854775807,9223372036854775807]
; SSE41-NEXT:    movapd {{.*#+}} xmm4 = [9223372036854775808,9223372036854775808]
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm11 = xmm12[1,1,3,3]
; SSE41-NEXT:    por %xmm0, %xmm11
...
; SSE41-NEXT:    pshufd {{.*#+}} xmm11 = xmm6[0,0,2,2]
; SSE41-NEXT:    pcmpeqd %xmm0, %xmm5
; SSE41-NEXT:    pshufd {{.*#+}} xmm0 = xmm5[1,1,3,3]
