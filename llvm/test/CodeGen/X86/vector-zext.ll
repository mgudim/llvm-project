...
; SSE2-NEXT:    pshuflw {{.*#+}} xmm1 = xmm0[0,1,3,2,4,5,6,7]
; SSE2-NEXT:    pxor %xmm0, %xmm0
...
; SSSE3:       # %bb.0:
; SSSE3-NEXT:    movdqa %xmm0, %xmm1
; SSSE3-NEXT:    pshufb {{.*#+}} xmm1 = xmm1[0,1],zero,zero,xmm1[2,3],zero,zero,xmm1[6,7],zero,zero,xmm1[14,15],zero,zero
; SSSE3-NEXT:    movdqa %xmm1, %xmm0
; SSSE3-NEXT:    retq
;
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    movdqa %xmm0, %xmm1
; SSE41-NEXT:    pshufb {{.*#+}} xmm1 = xmm1[0,1],zero,zero,xmm1[2,3],zero,zero,xmm1[6,7],zero,zero,xmm1[14,15],zero,zero
; SSE41-NEXT:    movdqa %xmm1, %xmm0
; SSE41-NEXT:    retq
;
...
; SSE2-NEXT:    pshufhw {{.*#+}} xmm1 = xmm0[0,1,2,3,6,6,6,6]
; SSE2-NEXT:    pxor %xmm0, %xmm0
...
; SSSE3:       # %bb.0:
; SSSE3-NEXT:    movdqa %xmm0, %xmm1
; SSSE3-NEXT:    pshufb {{.*#+}} xmm1 = xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero
; SSSE3-NEXT:    movdqa %xmm1, %xmm0
; SSSE3-NEXT:    retq
;
...
; SSE41:       # %bb.0:
; SSE41-NEXT:    movdqa %xmm0, %xmm1
; SSE41-NEXT:    pshufb {{.*#+}} xmm1 = xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero,xmm1[14],zero
; SSE41-NEXT:    movdqa %xmm1, %xmm0
; SSE41-NEXT:    retq
;
