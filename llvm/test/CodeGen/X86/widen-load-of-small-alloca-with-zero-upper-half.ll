...
; X64-NO-BMI2-NO-SHLD-NEXT:    movb %cl, (%rdx)
...
; X64-SHLD-NEXT:    shll $3, %esi
; X64-SHLD-NEXT:    xorl %edi, %edi
; X64-SHLD-NEXT:    movl %esi, %ecx
; X64-SHLD-NEXT:    shrdq %cl, %rdi, %rax
; X64-SHLD-NEXT:    testb $64, %sil
; X64-SHLD-NEXT:    cmovneq %rdi, %rax
...
; X64-NO-BMI2-NO-SHLD-NEXT:    testb $64, %sil
; X64-NO-BMI2-NO-SHLD-NEXT:    cmoveq %rax, %rcx
; X64-NO-BMI2-NO-SHLD-NEXT:    movw %cx, (%rdx)
; X64-NO-BMI2-NO-SHLD-NEXT:    retq
;
...
; X64-NO-BMI2-NO-SHLD-NEXT:    testb $64, %sil
; X64-NO-BMI2-NO-SHLD-NEXT:    cmoveq %rax, %rcx
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %ecx, (%rdx)
; X64-NO-BMI2-NO-SHLD-NEXT:    retq
;
...
; X64-NO-BMI2-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NEXT:    shrq %cl, %rdi
; X64-NO-BMI2-NEXT:    movl -64(%rsp,%rsi,8), %esi
; X64-NO-BMI2-NEXT:    addl %esi, %esi
; X64-NO-BMI2-NEXT:    andb $56, %al
; X64-NO-BMI2-NEXT:    notb %al
; X64-NO-BMI2-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NEXT:    shlq %cl, %rsi
; X64-NO-BMI2-NEXT:    orl %edi, %esi
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movzbl %cl, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -72(%rsp,%rcx,8), %rsi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -64(%rsp,%rcx,8), %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %rsi, %rdi
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrb $6, %cl
; X64-NO-BMI2-NO-SHLD-NEXT:    movzbl %cl, %esi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -72(%rsp,%rsi,8), %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -64(%rsp,%rsi,8), %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %r9d
; X64-NO-BMI2-NO-SHLD-NEXT:    notb %r9b
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%r8,%r8), %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r9d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %rdi, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -56(%rsp,%rsi,8), %rax
; X64-NO-BMI2-NO-SHLD-NEXT:    addq %rax, %rax
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r9d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %rax
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r8, %rax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    andb $24, %bl
...
; X86-SHLD-NEXT:    xorps %xmm1, %xmm1
; X86-SHLD-NEXT:    shll $3, %eax
; X86-SHLD-NEXT:    movaps %xmm1, {{[0-9]+}}(%esp)
; X86-SHLD-NEXT:    movaps %xmm1, {{[0-9]+}}(%esp)
; X86-SHLD-NEXT:    movaps %xmm1, {{[0-9]+}}(%esp)
; X86-SHLD-NEXT:    movaps %xmm0, {{[0-9]+}}(%esp)
; X86-SHLD-NEXT:    movl %eax, %ecx
; X86-SHLD-NEXT:    shrb $5, %cl
; X86-SHLD-NEXT:    movzbl %cl, %ebp
; X86-SHLD-NEXT:    movl 24(%esp,%ebp,4), %edi
; X86-SHLD-NEXT:    movl 16(%esp,%ebp,4), %edx
; X86-SHLD-NEXT:    movl 20(%esp,%ebp,4), %ebx
; X86-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-SHLD-NEXT:    movl %eax, %ecx
; X86-SHLD-NEXT:    shrdl %cl, %edi, %ebx
; X86-SHLD-NEXT:    movl 28(%esp,%ebp,4), %esi
; X86-SHLD-NEXT:    shrdl %cl, %esi, %edi
; X86-SHLD-NEXT:    movl 32(%esp,%ebp,4), %ebp
; X86-SHLD-NEXT:    shrdl %cl, %ebp, %esi
; X86-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-SHLD-NEXT:    movl %esi, 12(%ecx)
; X86-SHLD-NEXT:    movl %edi, 8(%ecx)
; X86-SHLD-NEXT:    movl %ebx, 4(%ecx)
...
; X64-NO-BMI2-NEXT:    movq -128(%rsp,%rsi), %rdi
; X64-NO-BMI2-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NEXT:    shrq %cl, %rdi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    pushl %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    pushl %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    subl $132, %esp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movups (%edx), %xmm0
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movaps %xmm1, {{[0-9]+}}(%esp)
; X86-NO-BMI2-NO-SHLD-NEXT:    movaps %xmm0, (%esp)
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (,%ecx,8), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    andl $60, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl (%esp,%ecx), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 4(%esp,%ecx), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    notb %bl
; X86-NO-BMI2-NO-SHLD-NEXT:    addl %edx, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %esi, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %dl, (%eax)
; X86-NO-BMI2-NO-SHLD-NEXT:    addl $132, %esp
; X86-NO-BMI2-NO-SHLD-NEXT:    popl %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    popl %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    retl
;
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movaps %xmm1, {{[0-9]+}}(%esp)
; X86-NO-BMI2-NO-SHLD-NEXT:    movaps %xmm0, (%esp)
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (,%ecx,8), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    andl $60, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl (%esp,%ecx), %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movw %di, (%eax)
; X86-NO-BMI2-NO-SHLD-NEXT:    addl $132, %esp
; X86-NO-BMI2-NO-SHLD-NEXT:    popl %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    popl %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    retl
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 8(%esp,%edi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    addl %edx, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %esi, %edx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 16(%esp,%esi), %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 24(%esp,%esi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%edx,%edx), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %al, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 28(%esp,%esi), %ebp
...
; X86-SHLD-NEXT:    andl $60, %ebx
; X86-SHLD-NEXT:    movl 24(%esp,%ebx), %edi
; X86-SHLD-NEXT:    movl 16(%esp,%ebx), %edx
; X86-SHLD-NEXT:    movl 20(%esp,%ebx), %ebp
; X86-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-SHLD-NEXT:    shll $3, %eax
; X86-SHLD-NEXT:    andl $24, %eax
; X86-SHLD-NEXT:    movl %eax, %ecx
; X86-SHLD-NEXT:    shrdl %cl, %edi, %ebp
; X86-SHLD-NEXT:    movl 28(%esp,%ebx), %esi
; X86-SHLD-NEXT:    shrdl %cl, %esi, %edi
; X86-SHLD-NEXT:    movl 32(%esp,%ebx), %ebx
; X86-SHLD-NEXT:    shrdl %cl, %ebx, %esi
; X86-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-SHLD-NEXT:    movl %esi, 12(%ecx)
; X86-SHLD-NEXT:    movl %edi, 8(%ecx)
; X86-SHLD-NEXT:    movl %ebp, 4(%ecx)
; X86-SHLD-NEXT:    movl %ecx, %esi
; X86-SHLD-NEXT:    movl %eax, %ecx
; X86-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-SHLD-NEXT:    shrdl %cl, %eax, %edx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    andl $56, %esi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -128(%rsp,%rsi), %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -120(%rsp,%rsi), %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r8d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r8d, %r11d
; X64-NO-BMI2-NO-SHLD-NEXT:    notb %r11b
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -112(%rsp,%rsi), %r9
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %rsi
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r10, %rsi
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movaps %xmm1, -{{[0-9]+}}(%rsp)
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movaps %xmm0, -{{[0-9]+}}(%rsp)
; X64-NO-BMI2-HAVE-SHLD-NEXT:    leal (,%rsi,8), %r9d
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movl %r9d, %eax
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r8, %r10
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrq %cl, %r10
; X64-NO-BMI2-HAVE-SHLD-NEXT:    notl %r9d
; X64-NO-BMI2-HAVE-SHLD-NEXT:    andl $63, %r9d
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -112(%rsp,%rsi), %r11
; X64-NO-BMI2-HAVE-SHLD-NEXT:    leaq (%r11,%r11), %rbx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movl %r9d, %ecx
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrxq %rax, %r8, %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    notl %ecx
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shlxq %rcx, %r11, %r11
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    orq %r9, %r11
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -104(%rsp,%rsi), %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrxq %rax, %r9, %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -96(%rsp,%rsi), %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    addq %rsi, %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shlxq %rcx, %rsi, %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    orq %rbx, %rsi
...
; X86-SHLD-NEXT:    movl %eax, %ebx
; X86-SHLD-NEXT:    andl $60, %ebx
; X86-SHLD-NEXT:    movl 40(%esp,%ebx), %edx
; X86-SHLD-NEXT:    movl 36(%esp,%ebx), %esi
...
; X86-SHLD-NEXT:    shrdl %cl, %edx, %esi
; X86-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-SHLD-NEXT:    movl 44(%esp,%ebx), %esi
; X86-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-SHLD-NEXT:    movl 48(%esp,%ebx), %edx
; X86-SHLD-NEXT:    shrdl %cl, %edx, %esi
; X86-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-SHLD-NEXT:    movl 52(%esp,%ebx), %edi
; X86-SHLD-NEXT:    shrdl %cl, %edi, %edx
; X86-SHLD-NEXT:    movl 56(%esp,%ebx), %esi
; X86-SHLD-NEXT:    shrdl %cl, %esi, %edi
; X86-SHLD-NEXT:    movl 60(%esp,%ebx), %ebp
; X86-SHLD-NEXT:    shrdl %cl, %ebp, %esi
; X86-SHLD-NEXT:    movl 32(%esp,%ebx), %ecx
; X86-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-SHLD-NEXT:    movl 64(%esp,%ebx), %ebx
; X86-SHLD-NEXT:    movl %eax, %ecx
; X86-SHLD-NEXT:    shrdl %cl, %ebx, %ebp
; X86-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %ebx
; X86-SHLD-NEXT:    movl %ebp, 28(%ebx)
; X86-SHLD-NEXT:    movl %esi, 24(%ebx)
; X86-SHLD-NEXT:    movl %edi, 20(%ebx)
; X86-SHLD-NEXT:    movl %edx, 16(%ebx)
; X86-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-SHLD-NEXT:    movl %ecx, 12(%ebx)
; X86-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-SHLD-NEXT:    movl %ecx, 8(%ebx)
; X86-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-SHLD-NEXT:    movl %ecx, 4(%ebx)
; X86-SHLD-NEXT:    movl %eax, %ecx
; X86-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-SHLD-NEXT:    shrdl %cl, %eax, %edx
; X86-SHLD-NEXT:    movl %edx, (%ebx)
; X86-SHLD-NEXT:    addl $172, %esp
; X86-SHLD-NEXT:    popl %esi
; X86-SHLD-NEXT:    popl %edi
; X86-SHLD-NEXT:    popl %ebx
; X86-SHLD-NEXT:    popl %ebp
