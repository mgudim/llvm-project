...
; X86-NEXT:    vmpsadbw $3, %zmm1, %zmm0, %zmm2 {%k1} # encoding: [0x62,0xf3,0x7e,0x49,0x42,0xd1,0x03]
; X86-NEXT:    vmpsadbw $4, %zmm1, %zmm0, %zmm4 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0xc9,0x42,0xe1,0x04]
; X86-NEXT:    vmovdqa64 %zmm3, %zmm0 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xc3]
; X86-NEXT:    vmovdqa64 %zmm2, %zmm1 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xca]
...
; X64-NEXT:    vmpsadbw $3, %zmm1, %zmm0, %zmm2 {%k1} # encoding: [0x62,0xf3,0x7e,0x49,0x42,0xd1,0x03]
; X64-NEXT:    vmpsadbw $4, %zmm1, %zmm0, %zmm4 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0xc9,0x42,0xe1,0x04]
; X64-NEXT:    vmovdqa64 %zmm3, %zmm0 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xc3]
; X64-NEXT:    vmovdqa64 %zmm2, %zmm1 # encoding: [0x62,0xf1,0xfd,0x48,0x6f,0xca]
