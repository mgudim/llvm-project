...
; X86-BMI-NEXT:    movl %esi, %edx
; X86-BMI-NEXT:    mulxl %ecx, %edx, %esi
; X86-BMI-NEXT:    addl %edi, %edx
; X86-BMI-NEXT:    adcl %ebp, %esi
; X86-BMI-NEXT:    setb %dl
; X86-BMI-NEXT:    movzbl %dl, %edi
; X86-BMI-NEXT:    movl %eax, %edx
; X86-BMI-NEXT:    mulxl %ecx, %eax, %edx
...
; X86-NOBMI-NEXT:    movl {{[0-9]+}}(%esp), %eax
; X86-NOBMI-NEXT:    movl (%eax,%esi,8), %ebp
; X86-NOBMI-NEXT:    movl 4(%eax,%esi,8), %ebx
...
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-BMI-NEXT:    movl (%ecx,%eax,8), %ebp
; X86-BMI-NEXT:    movl 4(%ecx,%eax,8), %esi
...
; X86-BMI-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-BMI-NEXT:    movl %esi, %edx
; X86-BMI-NEXT:    mulxl %ecx, %edi, %esi
; X86-BMI-NEXT:    addl {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Folded Reload
; X86-BMI-NEXT:    adcl $0, %esi
; X86-BMI-NEXT:    movl %ebp, %edx
; X86-BMI-NEXT:    mulxl {{[0-9]+}}(%esp), %ebp, %ecx
; X86-BMI-NEXT:    addl %edi, %ebp
; X86-BMI-NEXT:    adcl %esi, %ecx
; X86-BMI-NEXT:    movl (%esp), %edx # 4-byte Reload
; X86-BMI-NEXT:    mulxl {{[0-9]+}}(%esp), %esi, %edx
; X86-BMI-NEXT:    setb (%esp) # 1-byte Folded Spill
; X86-BMI-NEXT:    addl %ecx, %esi
; X86-BMI-NEXT:    movzbl (%esp), %ecx # 1-byte Folded Reload
...
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %ecx
; X86-BMI-NEXT:    movl %edi, (%ecx,%eax,8)
; X86-BMI-NEXT:    movl %ebp, 4(%ecx,%eax,8)
; X86-BMI-NEXT:    movl {{[0-9]+}}(%esp), %ebp
; X86-BMI-NEXT:    addl $1, %eax
; X86-BMI-NEXT:    adcl $0, %ebx
; X86-BMI-NEXT:    movl %eax, %ecx
; X86-BMI-NEXT:    xorl {{[0-9]+}}(%esp), %ecx
; X86-BMI-NEXT:    movl %ebx, %edi
; X86-BMI-NEXT:    xorl %ebp, %edi
; X86-BMI-NEXT:    orl %ecx, %edi
