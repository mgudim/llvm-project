...
; X86-NEXT:    vmpsadbw $3, %xmm1, %xmm0, %xmm2 {%k1} # encoding: [0x62,0xf3,0x7e,0x09,0x42,0xd1,0x03]
; X86-NEXT:    vmpsadbw $4, %xmm1, %xmm0, %xmm4 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0x89,0x42,0xe1,0x04]
; X86-NEXT:    vmovdqa %xmm3, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xc3]
; X86-NEXT:    vmovdqa %xmm2, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xca]
...
; X64-NEXT:    vmpsadbw $3, %xmm1, %xmm0, %xmm2 {%k1} # encoding: [0x62,0xf3,0x7e,0x09,0x42,0xd1,0x03]
; X64-NEXT:    vmpsadbw $4, %xmm1, %xmm0, %xmm4 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0x89,0x42,0xe1,0x04]
; X64-NEXT:    vmovdqa %xmm3, %xmm0 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xc3]
; X64-NEXT:    vmovdqa %xmm2, %xmm1 # EVEX TO VEX Compression encoding: [0xc5,0xf9,0x6f,0xca]
...
; X86-NEXT:    vmpsadbw $3, %ymm1, %ymm0, %ymm2 {%k1} # encoding: [0x62,0xf3,0x7e,0x29,0x42,0xd1,0x03]
; X86-NEXT:    vmpsadbw $4, %ymm1, %ymm0, %ymm4 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0xa9,0x42,0xe1,0x04]
; X86-NEXT:    vmovdqa %ymm3, %ymm0 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xc3]
; X86-NEXT:    vmovdqa %ymm2, %ymm1 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xca]
...
; X64-NEXT:    vmpsadbw $3, %ymm1, %ymm0, %ymm2 {%k1} # encoding: [0x62,0xf3,0x7e,0x29,0x42,0xd1,0x03]
; X64-NEXT:    vmpsadbw $4, %ymm1, %ymm0, %ymm4 {%k1} {z} # encoding: [0x62,0xf3,0x7e,0xa9,0x42,0xe1,0x04]
; X64-NEXT:    vmovdqa %ymm3, %ymm0 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xc3]
; X64-NEXT:    vmovdqa %ymm2, %ymm1 # EVEX TO VEX Compression encoding: [0xc5,0xfd,0x6f,0xca]
