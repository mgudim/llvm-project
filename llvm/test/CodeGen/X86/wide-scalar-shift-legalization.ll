...
; X86-NO-BMI2-NO-SHLD-NEXT:    xorl %edi, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    testb $32, %ch
; X86-NO-BMI2-NO-SHLD-NEXT:    cmovnel %edx, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    cmovel %edx, %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 4(%esi), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movb (%ecx), %ch
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ch, %cl
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, 4(%eax)
; X86-NO-BMI2-NO-SHLD-NEXT:    popl %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    popl %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    retl
;
...
; X86-NO-BMI2-NO-SHLD-NEXT:    testb $32, %ch
; X86-NO-BMI2-NO-SHLD-NEXT:    cmovnel %edi, %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 12(%esp,%edi), %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, 12(%ebx)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, 8(%ebx)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, (%ebx)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, 4(%ebx)
...
; X64-NO-BMI2-NO-SHLD-NEXT:    testb $64, %sil
; X64-NO-BMI2-NO-SHLD-NEXT:    cmovneq %rax, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    cmoveq %rax, %rcx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movsbl %cl, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 32(%esp,%ebx), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 36(%esp,%ebx), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %al, %ah
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 40(%esp,%ebx), %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, 8(%esi)
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rdi, %rax
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    sarq %cl, %rax
; X64-NO-BMI2-NO-SHLD-NEXT:    sarq $63, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    testb $64, %sil
; X64-NO-BMI2-NO-SHLD-NEXT:    cmovneq %rax, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    cmoveq %rax, %rdi
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -56(%rsp,%rdi,8), %rsi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rsi, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %r11d
; X64-NO-BMI2-NO-SHLD-NEXT:    andb $63, %r11b
; X64-NO-BMI2-NO-SHLD-NEXT:    xorb $63, %r11b
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -48(%rsp,%rdi,8), %rbx
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%rbx,%rbx), %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r11d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r8
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -40(%rsp,%rdi,8), %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%rdi,%rdi), %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r11d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %rbx, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %rdi
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -72(%rsp,%rax,8), %r8
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%rax,8), %r9
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r9, %r10
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rdi, %r10
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, %eax
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -72(%rsp,%rax,8), %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%rax,8), %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r9, %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, %ecx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rdi, %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -48(%rsp,%rax,8), %rax
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rax, %rdi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %r9, %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrxq %rsi, %rax, %rax
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 24(%ebp), %ecx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 32(%esp,%esi,4), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 36(%esp,%esi,4), %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    andb $31, %ah
; X86-NO-BMI2-NO-SHLD-NEXT:    xorb $31, %ah
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 40(%esp,%esi,4), %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 44(%esp,%ebp,4), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 48(%esp,%ebp,4), %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %esi, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 52(%esp,%ebp,4), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 56(%esp,%ebp,4), %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 60(%esp,%ecx,4), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%edi,%edi), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ah, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, 16(%eax)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, 20(%eax)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, 8(%eax)
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl (%ebp), %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 4(%ebp), %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movzbl (%eax), %eax
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 20(%ebp), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 24(%ebp), %ecx
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrb $5, %cl
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movzbl %cl, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 40(%esp,%edi,4), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 36(%esp,%edi,4), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 48(%esp,%edi,4), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 44(%esp,%edi,4), %edx
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 56(%esp,%edi,4), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 52(%esp,%edi,4), %esi
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 32(%esp,%edi,4), %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 60(%esp,%edi,4), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, 24(%edi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, 28(%edi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 16(%edi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, 20(%edi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 20(%eax), %ebp
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[0-9]+}}(%esp)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrb $5, %cl
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movzbl %cl, %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 24(%esp,%edx,4), %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 20(%esp,%edx,4), %esi
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 32(%esp,%edx,4), %ebp
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 40(%esp,%edx,4), %ebx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 36(%esp,%edx,4), %edi
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 16(%esp,%edx,4), %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 44(%esp,%edx,4), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %ebx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 24(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrxl %eax, %ecx, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 28(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 16(%edx)
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -32(%rsp,%r9), %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -24(%rsp,%r9), %rsi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rsi, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r10, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -8(%rsp,%r9), %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -16(%rsp,%r9), %r9
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rsi, 16(%rdx)
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -16(%rsp,%rax), %r8
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rdi, %r8
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -40(%rsp,%rax), %r9
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -32(%rsp,%rax), %rax
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rax, %rdi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r9, %rax
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -16(%rsp,%rax), %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, %ecx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rdi, %r8
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shlxq %rsi, %r9, %rcx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %rdi, 16(%rdx)
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 64(%esp,%esi), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 68(%esp,%esi), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %al, %ah
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 76(%esp,%esi), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 72(%esp,%esi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ah, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 80(%esp,%esi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ah, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %ebp
...
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %edx, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 92(%esp,%esi), %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %ebx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 88(%esp,%esi), %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %ah, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, 24(%eax)
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    andb $28, %cl
; X86-NO-BMI2-HAVE-SHLD-NEXT:    negb %cl
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movsbl %cl, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 72(%esp,%edx), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 76(%esp,%edx), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebp, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %esi, %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 68(%esp,%edx), %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edi, %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 80(%esp,%edx), %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 84(%esp,%edx), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %ebx, %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %ebp, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 64(%esp,%edx), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 88(%esp,%edx), %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 92(%esp,%edx), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edi, %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 8(%edx)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[0-9]+}}(%esp)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrb $3, %cl
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    andb $28, %cl
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    negb %cl
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movsbl %cl, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 72(%esp,%edi), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 76(%esp,%edi), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 64(%esp,%edi), %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 88(%esp,%edi), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 92(%esp,%edi), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %esi
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, 24(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, 28(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 16(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 20(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 8(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 12(%edi)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shlxl %eax, %edx, %ecx
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrb $6, %cl
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movzbl %cl, %esi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -56(%rsp,%rsi,8), %rdi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -72(%rsp,%rsi,8), %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%rsi,8), %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r9, %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rdi, %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -48(%rsp,%rsi,8), %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %rsi, %rdi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdq %cl, %r9, %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    sarxq %rax, %rsi, %rax
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %rdi, 16(%rdx)
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %rax, 24(%rdx)
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r8, (%rdx)
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r10, 8(%rdx)
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 4(%edx), %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 24(%edx), %ecx
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 4(%edx), %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 24(%edx), %ecx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 24(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    sarxl %eax, %ecx, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 28(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 16(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, 20(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
...
; X64-NO-BMI2-NO-SHLD-NEXT:    shrl $3, %eax
; X64-NO-BMI2-NO-SHLD-NEXT:    andl $56, %eax
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -128(%rsp,%rax), %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -120(%rsp,%rax), %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rdi, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r10
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ebx
; X64-NO-BMI2-NO-SHLD-NEXT:    notl %ebx
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -112(%rsp,%rax), %r14
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%r14,%r14), %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r10, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %r10d
; X64-NO-BMI2-NO-SHLD-NEXT:    xorb $63, %r10b
; X64-NO-BMI2-NO-SHLD-NEXT:    addq %rdi, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r10d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r9, %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -104(%rsp,%rax), %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %r9, %r12
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r12
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -96(%rsp,%rax), %r15
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%r15,%r15), %r11
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %ecx
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -88(%rsp,%rax), %r14
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %r14, %r13
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r13
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -80(%rsp,%rax), %rbp
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -72(%rsp,%rax), %rax
; X64-NO-BMI2-NO-SHLD-NEXT:    leaq (%rax,%rax), %rbx
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r10d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %rbx
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %rbp, %rbx
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %rax
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rax, 56(%rdx)
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 72(%esp,%ebp), %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    leal (%ecx,%ecx), %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    xorb $31, %al
; X86-NO-BMI2-NO-SHLD-NEXT:    addl %esi, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 80(%esp,%ebp), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edi # 4-byte Reload
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 108(%esp,%edi), %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %esi, %edx
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %edx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    shll %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    orl %ebp, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 116(%esp,%edi), %ebp
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebx, %ecx
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 120(%esp,%edi), %edx
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 124(%esp,%eax), %edx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 68(%esp,%edx), %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edi, %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 80(%esp,%edx), %ebp
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 88(%esp,%edx), %ebx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 96(%esp,%edx), %ebp
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 104(%esp,%edx), %ebx
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 108(%esp,%edx), %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %esi, %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edi, %ebx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 120(%esp,%edx), %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 116(%esp,%edx), %ebx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebx, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %ebp, %edi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %ebx, %esi
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 64(%esp,%edx), %ebx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl 124(%esp,%edx), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrdl %cl, %edx, %ebp
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %edx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 56(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %esi, 48(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %edi, 52(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 40(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 44(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 32(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 36(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 24(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 28(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 16(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
...
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ecx # 4-byte Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %ecx, 12(%edx)
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    shrxl %eax, {{[-0-9]+}}(%e{{[sb]}}p), %esi # 4-byte Folded Reload
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-HAVE-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -64(%rsp,%rbx), %rdi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -56(%rsp,%rbx), %rsi
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rsi, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %r10d
; X64-NO-BMI2-NO-SHLD-NEXT:    xorb $63, %r10b
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %rdi, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r10d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r9, %r8
; X64-NO-BMI2-NO-SHLD-NEXT:    movq -40(%rsp,%rbx), %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    movq %r9, %r14
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shlq %cl, %r14
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r10d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %rsi
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r15, %rsi
...
; X64-NO-BMI2-NO-SHLD-NEXT:    movl %r10d, %ecx
; X64-NO-BMI2-NO-SHLD-NEXT:    shrq %cl, %r9
; X64-NO-BMI2-NO-SHLD-NEXT:    orq %r13, %r9
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %rax, -{{[0-9]+}}(%rsp)
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movl %esi, %eax
; X64-NO-BMI2-HAVE-SHLD-NEXT:    andl $63, %eax
...
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -48(%rsp,%r10), %rsi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -40(%rsp,%r10), %r11
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r11, %rdi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rsi, %rdi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%r10), %r9
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -56(%rsp,%r10), %r8
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r8, %rsi
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -32(%rsp,%r10), %rbx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -24(%rsp,%r10), %r14
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq %r14, %r15
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rbx, %r15
; X64-NO-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r11, %rbx
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -16(%rsp,%r10), %r11
; X64-NO-BMI2-HAVE-SHLD-NEXT:    movq -8(%rsp,%r10), %r10
...
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movslq %esi, %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -48(%rsp,%r9), %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -40(%rsp,%r9), %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r10, %rdi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rsi, %rdi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -64(%rsp,%r9), %r11
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -56(%rsp,%r9), %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r8, %rsi
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -32(%rsp,%r9), %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -24(%rsp,%r9), %r14
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq %r14, %r15
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %rbx, %r15
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r10, %rbx
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -16(%rsp,%r9), %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    movq -8(%rsp,%r9), %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r10, %r9
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r14, %r10
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shldq %cl, %r11, %r8
; X64-HAVE-BMI2-HAVE-SHLD-NEXT:    shlxq %rax, %r11, %rax
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 12(%edi), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    andl $31, %eax
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 28(%edi), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %ebx, %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %ebp, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 32(%edi), %ebp
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edx, %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 40(%edi), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 44(%edi), %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 60(%edi), %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %ebx, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl (%edi), %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ecx, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 52(%edi), %edi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %eax, %ecx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %edi, %ebx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    negl %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl 176(%esp,%esi), %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[0-9]+}}(%esp), %esi
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebx, 56(%esi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edx, 60(%esi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %edx # 4-byte Reload
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %ebx # 4-byte Reload
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %ebx, %edx
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shll %cl, %ebx
...
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
; X86-NO-BMI2-HAVE-SHLD-NEXT:    shldl %cl, %eax, %ebp
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %ebp, 48(%esi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl %edi, 52(%esi)
; X86-NO-BMI2-HAVE-SHLD-NEXT:    movl {{[-0-9]+}}(%e{{[sb]}}p), %eax # 4-byte Reload
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %esi
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 96(%esp,%ebp), %edi
...
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %ebp, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 100(%esp,%ebp), %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl %eax, {{[-0-9]+}}(%e{{[sb]}}p) # 4-byte Spill
; X86-NO-BMI2-NO-SHLD-NEXT:    movb %bl, %cl
; X86-NO-BMI2-NO-SHLD-NEXT:    shrl %cl, %eax
; X86-NO-BMI2-NO-SHLD-NEXT:    movl 104(%esp,%ebp), %ebp
