...
; X64-NEXT:    sets %dil
; X64-NEXT:    addl $32767, %edi # imm = 0x7FFF
; X64-NEXT:    movl %esi, %ecx
; X64-NEXT:    shll %cl, %eax
; X64-NEXT:    movswl %ax, %r8d
; X64-NEXT:    sarl %cl, %r8d
; X64-NEXT:    cmpw %r8w, %dx
