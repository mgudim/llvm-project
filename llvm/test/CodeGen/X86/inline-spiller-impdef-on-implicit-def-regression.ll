...
; CHECK-NEXT:    movabsq $87960930222080, %r9 # imm = 0x500000000000
...
; CHECK-NEXT:    movzbl 544(%r12), %edi
; CHECK-NEXT:    andl $1, %edi
; CHECK-NEXT:    # kill: def $r9d killed $r9d killed $r9 def $r9
