...
; CHECK-NEXT:    blah %r2
; CHECK-NEXT:    #NO_APP
; CHECK-NEXT:    jl .LBB32_2
; CHECK-NEXT:  # %bb.1: # %store
; CHECK-NEXT:    st %r3, 0(%r4)
; CHECK-NEXT:  .LBB32_2: # %exit
; CHECK-NEXT:    lr %r2, %r3
; CHECK-NEXT:    br %r14
entry:
...
; CHECK-NEXT:    blah %r2
; CHECK-NEXT:    #NO_APP
; CHECK-NEXT:    jle .LBB33_2
; CHECK-NEXT:  # %bb.1: # %exit
; CHECK-NEXT:    lgr %r2, %r3
; CHECK-NEXT:    br %r14
; CHECK-NEXT:  .LBB33_2: # %store
; CHECK-NEXT:    stg %r3, 0(%r4)
; CHECK-NEXT:    lgr %r2, %r3
; CHECK-NEXT:    br %r14
entry:
...
; CHECK-LABEL: f35:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    ltgfr %r0, %r3
; CHECK-NEXT:    lgr %r2, %r0
; CHECK-NEXT:    #APP
; CHECK-NEXT:    blah %r2
; CHECK-NEXT:    #NO_APP
; CHECK-NEXT:    jle .LBB34_2
; CHECK-NEXT:  # %bb.1: # %exit
; CHECK-NEXT:    lgr %r2, %r0
; CHECK-NEXT:    br %r14
; CHECK-NEXT:  .LBB34_2: # %store
...
; CHECK-NEXT:    blah %r2
; CHECK-NEXT:    #NO_APP
; CHECK-NEXT:    jle .LBB38_2
; CHECK-NEXT:  # %bb.1: # %exit
; CHECK-NEXT:    lgr %r2, %r0
; CHECK-NEXT:    br %r14
; CHECK-NEXT:  .LBB38_2: # %store
; CHECK-NEXT:    stg %r0, 0(%r4)
; CHECK-NEXT:    lgr %r2, %r0
; CHECK-NEXT:    br %r14
entry:
...
; CHECK-NEXT:    blah %r2
; CHECK-NEXT:    #NO_APP
; CHECK-NEXT:    jle .LBB39_2
; CHECK-NEXT:  # %bb.1: # %exit
; CHECK-NEXT:    lgr %r2, %r0
; CHECK-NEXT:    br %r14
; CHECK-NEXT:  .LBB39_2: # %store
; CHECK-NEXT:    stg %r0, 0(%r4)
; CHECK-NEXT:    lgr %r2, %r0
; CHECK-NEXT:    br %r14
entry:
