...
; RV32I-NEXT:    mv a0, a2
; RV32I-NEXT:    call __umodsi3
; RV32I-NEXT:    andi a1, s0, 63
; RV32I-NEXT:    andi s1, s1, 31
; RV32I-NEXT:    andi a2, s2, 7
; RV32I-NEXT:    sh a1, 0(s3)
; RV32I-NEXT:    sh s1, 2(s3)
; RV32I-NEXT:    sh a2, 4(s3)
; RV32I-NEXT:    sh a0, 6(s3)
; RV32I-NEXT:    lw ra, 28(sp) # 4-byte Folded Reload
; RV32I-NEXT:    lw s0, 24(sp) # 4-byte Folded Reload
; RV32I-NEXT:    lw s1, 20(sp) # 4-byte Folded Reload
...
; RV64I-NEXT:    mv a0, a2
; RV64I-NEXT:    call __umoddi3
; RV64I-NEXT:    andi a1, s0, 63
; RV64I-NEXT:    andi s1, s1, 31
; RV64I-NEXT:    andi a2, s2, 7
; RV64I-NEXT:    sh a1, 0(s3)
; RV64I-NEXT:    sh s1, 2(s3)
; RV64I-NEXT:    sh a2, 4(s3)
; RV64I-NEXT:    sh a0, 6(s3)
; RV64I-NEXT:    ld ra, 40(sp) # 8-byte Folded Reload
; RV64I-NEXT:    ld s0, 32(sp) # 8-byte Folded Reload
; RV64I-NEXT:    ld s1, 24(sp) # 8-byte Folded Reload
...
; RV32IM-NEXT:    sw s6, 0(s0)
; RV32IM-NEXT:    sw s7, 4(s0)
