...
; RV64IDINX-NEXT:    mv s1, a0
; RV64IDINX-NEXT:    li a0, -449
; RV64IDINX-NEXT:    slli a0, a0, 53
; RV64IDINX-NEXT:    fle.d s0, a0, s1
; RV64IDINX-NEXT:    mv a0, s1
; RV64IDINX-NEXT:    call __fixdfti
; RV64IDINX-NEXT:    li a2, -1
; RV64IDINX-NEXT:    bnez s0, .LBB4_2
; RV64IDINX-NEXT:  # %bb.1:
...
; RV64IDINX-NEXT:    flt.d a3, a3, s1
; RV64IDINX-NEXT:    beqz a3, .LBB4_4
; RV64IDINX-NEXT:  # %bb.3:
; RV64IDINX-NEXT:    srli a1, a2, 1
; RV64IDINX-NEXT:  .LBB4_4:
; RV64IDINX-NEXT:    feq.d a2, s1, s1
; RV64IDINX-NEXT:    neg a4, s0
