...
; RV32-NEXT:    vslideup.vi v24, v16, 4
...
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, ma
; RV32-NEXT:    vslideup.vi v20, v16, 2
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a4, 76
; RV32-NEXT:    mul a1, a1, a4
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vsetivli zero, 16, e32, m4, ta, mu
; RV32-NEXT:    vslideup.vi v20, v8, 8, v0.t
; RV32-NEXT:    csrr a1, vlenb
; RV32-NEXT:    li a4, 52
; RV32-NEXT:    mul a1, a1, a4
; RV32-NEXT:    add a1, sp, a1
...
; RV32-NEXT:    addi a1, a1, 16
; RV32-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV32-NEXT:    vrgatherei16.vv v24, v8, v22
...
; RV32-NEXT:    vrgatherei16.vv v24, v12, v22
...
; RV64-NEXT:    add a3, sp, a3
; RV64-NEXT:    addi a3, a3, 16
; RV64-NEXT:    vs4r.v v16, (a3) # vscale x 32-byte Folded Spill
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
...
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs4r.v v4, (a2) # vscale x 32-byte Folded Spill
...
; RV64-NEXT:    vmv.s.x v0, a2
; RV64-NEXT:    vslideup.vi v4, v24, 6
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 85
; RV64-NEXT:    mul a2, a2, a3
; RV64-NEXT:    add a2, sp, a2
...
; RV64-NEXT:    add a2, sp, a2
; RV64-NEXT:    addi a2, a2, 16
; RV64-NEXT:    vs1r.v v24, (a2) # vscale x 8-byte Folded Spill
; RV64-NEXT:    csrr a2, vlenb
; RV64-NEXT:    li a3, 53
; RV64-NEXT:    mul a2, a2, a3
; RV64-NEXT:    add a2, sp, a2
...
; RV64-NEXT:    vl8r.v v8, (a1) # vscale x 64-byte Folded Reload
; RV64-NEXT:    vsetivli zero, 16, e64, m8, ta, ma
; RV64-NEXT:    vrgatherei16.vv v0, v8, v26
...
; RV64-NEXT:    vmerge.vvm v8, v12, v20, v0
; RV64-NEXT:    csrr a1, vlenb
; RV64-NEXT:    li a2, 85
; RV64-NEXT:    mul a1, a1, a2
; RV64-NEXT:    add a1, sp, a1
