...
; CHECK-NEXT:    vfcvt.x.f.v v10, v9, v0.t
; CHECK-NEXT:    fsrm a0
...
; CHECK-NEXT:    fmv.w.x fa5, a0
; CHECK-NEXT:    vmflt.vf v24, v8, fa5
; CHECK-NEXT:    fsrmi a0, 2
...
; ZVFH-NEXT:    slli a0, a0, 10
; ZVFH-NEXT:    fmv.h.x fa5, a0
; ZVFH-NEXT:    vmflt.vf v24, v16, fa5
; ZVFH-NEXT:    fsrmi a0, 2
...
; CHECK-NEXT:    lui a0, 307200
; CHECK-NEXT:    fmv.w.x fa5, a0
; CHECK-NEXT:    vmflt.vf v24, v16, fa5
; CHECK-NEXT:    fsrmi a0, 2
; CHECK-NEXT:    vmv1r.v v0, v24
...
; RV32ZFH-NEXT:    vmflt.vf v9, v9, fa5
; RV32ZFH-NEXT:    fsrmi a0, 2
; RV32ZFH-NEXT:    vmv.v.v v0, v9
...
; RV64ZFH-NEXT:    vmflt.vf v9, v9, fa5
; RV64ZFH-NEXT:    fsrmi a0, 2
; RV64ZFH-NEXT:    vmv.v.v v0, v9
...
; RV32ZFHMIN-NEXT:    vmflt.vf v9, v9, fa5
; RV32ZFHMIN-NEXT:    fsrmi a0, 2
; RV32ZFHMIN-NEXT:    vmv.v.v v0, v9
...
; RV64ZFHMIN-NEXT:    vmflt.vf v9, v9, fa5
; RV64ZFHMIN-NEXT:    fsrmi a0, 2
; RV64ZFHMIN-NEXT:    vmv.v.v v0, v9
...
; RV32ZFH-NEXT:    vmflt.vf v12, v10, fa5
; RV32ZFH-NEXT:    fsrmi a0, 2
...
; RV64ZFH-NEXT:    slli a0, a0, 52
; RV64ZFH-NEXT:    fmv.d.x fa5, a0
; RV64ZFH-NEXT:    vmflt.vf v12, v10, fa5
; RV64ZFH-NEXT:    fsrmi a0, 2
...
; RV32ZFHMIN-NEXT:    vmflt.vf v12, v10, fa5
; RV32ZFHMIN-NEXT:    fsrmi a0, 2
; RV32ZFHMIN-NEXT:    vmv1r.v v0, v12
; RV32ZFHMIN-NEXT:    vfcvt.x.f.v v10, v8, v0.t
; RV32ZFHMIN-NEXT:    fsrm a0
; RV32ZFHMIN-NEXT:    vfcvt.f.x.v v10, v10, v0.t
...
; RV64ZFHMIN-NEXT:    slli a0, a0, 52
; RV64ZFHMIN-NEXT:    fmv.d.x fa5, a0
; RV64ZFHMIN-NEXT:    vmflt.vf v12, v10, fa5
; RV64ZFHMIN-NEXT:    fsrmi a0, 2
; RV64ZFHMIN-NEXT:    vmv1r.v v0, v12
; RV64ZFHMIN-NEXT:    vfcvt.x.f.v v10, v8, v0.t
; RV64ZFHMIN-NEXT:    fsrm a0
; RV64ZFHMIN-NEXT:    vfcvt.f.x.v v10, v10, v0.t
...
; RV32ZFH-NEXT:    vmflt.vf v16, v12, fa5
; RV32ZFH-NEXT:    fsrmi a0, 2
...
; RV64ZFH-NEXT:    slli a0, a0, 52
; RV64ZFH-NEXT:    fmv.d.x fa5, a0
; RV64ZFH-NEXT:    vmflt.vf v16, v12, fa5
; RV64ZFH-NEXT:    fsrmi a0, 2
...
; RV32ZFHMIN-NEXT:    vmflt.vf v16, v12, fa5
; RV32ZFHMIN-NEXT:    fsrmi a0, 2
; RV32ZFHMIN-NEXT:    vmv1r.v v0, v16
...
; RV64ZFHMIN-NEXT:    slli a0, a0, 52
; RV64ZFHMIN-NEXT:    fmv.d.x fa5, a0
; RV64ZFHMIN-NEXT:    vmflt.vf v16, v12, fa5
; RV64ZFHMIN-NEXT:    fsrmi a0, 2
; RV64ZFHMIN-NEXT:    vmv1r.v v0, v16
...
; RV32ZFH-NEXT:    vmflt.vf v24, v16, fa5
; RV32ZFH-NEXT:    fsrmi a0, 2
...
; RV64ZFH-NEXT:    slli a0, a0, 52
; RV64ZFH-NEXT:    fmv.d.x fa5, a0
; RV64ZFH-NEXT:    vmflt.vf v24, v16, fa5
; RV64ZFH-NEXT:    fsrmi a0, 2
...
; RV32ZFHMIN-NEXT:    vmflt.vf v24, v16, fa5
; RV32ZFHMIN-NEXT:    fsrmi a0, 2
; RV32ZFHMIN-NEXT:    vmv1r.v v0, v24
...
; RV64ZFHMIN-NEXT:    slli a0, a0, 52
; RV64ZFHMIN-NEXT:    fmv.d.x fa5, a0
; RV64ZFHMIN-NEXT:    vmflt.vf v24, v16, fa5
; RV64ZFHMIN-NEXT:    fsrmi a0, 2
; RV64ZFHMIN-NEXT:    vmv1r.v v0, v24
