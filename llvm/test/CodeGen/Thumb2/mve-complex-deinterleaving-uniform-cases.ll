...
; CHECK-NEXT:    vldr s15, [sp, #184]
; CHECK-NEXT:    vmov.f32 s10, s5
; CHECK-NEXT:    vldr s13, [sp, #168]
; CHECK-NEXT:    vmov.f32 s9, s3
; CHECK-NEXT:    vldr s12, [sp, #160]
...
; CHECK-NEXT:    vldr s17, [sp, #156]
; CHECK-NEXT:    vmov.f32 s4, s0
; CHECK-NEXT:    vmul.f32 q0, q6, q2
; CHECK-NEXT:    vmov.f32 s21, s14
; CHECK-NEXT:    vneg.f32 q0, q0
; CHECK-NEXT:    vstrw.32 q0, [sp, #16] @ 16-byte Spill
; CHECK-NEXT:    vmul.f32 q0, q5, q2
; CHECK-NEXT:    vldr s14, [sp, #176]
; CHECK-NEXT:    vfma.f32 q0, q6, q1
; CHECK-NEXT:    vldr s16, [sp, #148]
; CHECK-NEXT:    vsub.f32 q6, q3, q0
; CHECK-NEXT:    vldrw.u32 q0, [sp, #16] @ 16-byte Reload
; CHECK-NEXT:    vldr s9, [sp, #152]
; CHECK-NEXT:    vstrw.32 q4, [sp] @ 16-byte Spill
; CHECK-NEXT:    vfma.f32 q0, q5, q1
; CHECK-NEXT:    vldr s8, [sp, #144]
; CHECK-NEXT:    vadd.f32 q1, q7, q0
; CHECK-NEXT:    vldrw.u32 q7, [sp, #32] @ 16-byte Reload
; CHECK-NEXT:    vldr s13, [sp, #200]
; CHECK-NEXT:    vmul.f32 q0, q4, q7
; CHECK-NEXT:    vldrw.u32 q4, [sp, #48] @ 16-byte Reload
; CHECK-NEXT:    vneg.f32 q0, q0
; CHECK-NEXT:    vldr s12, [sp, #192]
; CHECK-NEXT:    vfma.f32 q0, q2, q4
; CHECK-NEXT:    vmul.f32 q2, q2, q7
; CHECK-NEXT:    vldrw.u32 q7, [sp] @ 16-byte Reload
; CHECK-NEXT:    vldr s21, [sp, #204]
; CHECK-NEXT:    vldr s20, [sp, #196]
; CHECK-NEXT:    vfma.f32 q2, q7, q4
; CHECK-NEXT:    vsub.f32 q3, q3, q2
