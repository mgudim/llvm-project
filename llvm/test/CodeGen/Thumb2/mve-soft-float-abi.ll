...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[0]
...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[1]
; CHECK-MVE-NEXT:    bl __aeabi_h2f
; CHECK-MVE-NEXT:    mov r4, r0
; CHECK-MVE-NEXT:    mov r0, r5
; CHECK-MVE-NEXT:    bl __aeabi_h2f
...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[2]
; CHECK-MVE-NEXT:    bl __aeabi_h2f
; CHECK-MVE-NEXT:    mov r4, r0
; CHECK-MVE-NEXT:    mov r0, r5
; CHECK-MVE-NEXT:    bl __aeabi_h2f
...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[3]
; CHECK-MVE-NEXT:    bl __aeabi_h2f
; CHECK-MVE-NEXT:    mov r4, r0
; CHECK-MVE-NEXT:    mov r0, r5
; CHECK-MVE-NEXT:    bl __aeabi_h2f
...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[4]
; CHECK-MVE-NEXT:    bl __aeabi_h2f
; CHECK-MVE-NEXT:    mov r4, r0
; CHECK-MVE-NEXT:    mov r0, r5
; CHECK-MVE-NEXT:    bl __aeabi_h2f
...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[5]
; CHECK-MVE-NEXT:    bl __aeabi_h2f
; CHECK-MVE-NEXT:    mov r4, r0
; CHECK-MVE-NEXT:    mov r0, r5
; CHECK-MVE-NEXT:    bl __aeabi_h2f
...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[6]
; CHECK-MVE-NEXT:    bl __aeabi_h2f
; CHECK-MVE-NEXT:    mov r4, r0
; CHECK-MVE-NEXT:    mov r0, r5
; CHECK-MVE-NEXT:    bl __aeabi_h2f
...
; CHECK-MVE-NEXT:    vmov.u16 r5, q4[7]
; CHECK-MVE-NEXT:    bl __aeabi_h2f
; CHECK-MVE-NEXT:    mov r4, r0
; CHECK-MVE-NEXT:    mov r0, r5
; CHECK-MVE-NEXT:    bl __aeabi_h2f
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[0]
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[1]
; CHECK-BE-NEXT:    bl __aeabi_h2f
; CHECK-BE-NEXT:    mov r4, r0
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    bl __aeabi_h2f
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[2]
; CHECK-BE-NEXT:    bl __aeabi_h2f
; CHECK-BE-NEXT:    mov r4, r0
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    bl __aeabi_h2f
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[3]
; CHECK-BE-NEXT:    bl __aeabi_h2f
; CHECK-BE-NEXT:    mov r4, r0
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    bl __aeabi_h2f
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[4]
; CHECK-BE-NEXT:    bl __aeabi_h2f
; CHECK-BE-NEXT:    mov r4, r0
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    bl __aeabi_h2f
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[5]
; CHECK-BE-NEXT:    bl __aeabi_h2f
; CHECK-BE-NEXT:    mov r4, r0
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    bl __aeabi_h2f
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[6]
; CHECK-BE-NEXT:    bl __aeabi_h2f
; CHECK-BE-NEXT:    mov r4, r0
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    bl __aeabi_h2f
...
; CHECK-BE-NEXT:    vmov.u16 r5, q4[7]
; CHECK-BE-NEXT:    bl __aeabi_h2f
; CHECK-BE-NEXT:    mov r4, r0
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    bl __aeabi_h2f
...
; CHECK-MVE-NEXT:    mov r2, r5
; CHECK-MVE-NEXT:    mov r3, r4
...
; CHECK-MVE-NEXT:    add r0, sp, #40
; CHECK-MVE-NEXT:    vldrw.u32 q4, [r0]
; CHECK-MVE-NEXT:    mov r4, r1
; CHECK-MVE-NEXT:    mov r0, r2
; CHECK-MVE-NEXT:    mov r1, r3
; CHECK-MVE-NEXT:    vmov r12, lr, d9
; CHECK-MVE-NEXT:    mov r2, r12
; CHECK-MVE-NEXT:    mov r3, lr
...
; CHECK-MVE-NEXT:    mov r1, r4
; CHECK-MVE-NEXT:    bl __aeabi_dadd
; CHECK-MVE-NEXT:    mov r2, r6
; CHECK-MVE-NEXT:    mov r3, r7
; CHECK-MVE-NEXT:    vpop {d8, d9}
...
; CHECK-BE-NEXT:    mov r0, r2
; CHECK-BE-NEXT:    mov r1, r3
; CHECK-BE-NEXT:    vrev64.8 q4, q0
; CHECK-BE-NEXT:    vmov r12, lr, d9
; CHECK-BE-NEXT:    mov r2, lr
; CHECK-BE-NEXT:    mov r3, r12
; CHECK-BE-NEXT:    bl __aeabi_dadd
; CHECK-BE-NEXT:    vmov r3, r2, d8
; CHECK-BE-NEXT:    mov r6, r0
; CHECK-BE-NEXT:    mov r7, r1
; CHECK-BE-NEXT:    mov r0, r5
; CHECK-BE-NEXT:    mov r1, r4
; CHECK-BE-NEXT:    bl __aeabi_dadd
; CHECK-BE-NEXT:    mov r2, r6
; CHECK-BE-NEXT:    mov r3, r7
